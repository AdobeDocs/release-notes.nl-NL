...
* [!DNL EXPERIENCE CLOUD] | Webinar | De perfecte overvloeiing: Adobe Analytics + Adobe Commerce | **22 augustus @ 11:00 MT** | [Registreren](https://register.gotowebinar.com/register/8741953502398625879?source=ExL)

* [!DNL EXPERIENCE CLOUD] | Webinar | De perfecte overvloeiing: Marketo + Workfront | **31 augustus om 11:00 uur** | [Registreren](https://register.gotowebinar.com/register/1243658035029822043?source=ExL)
...
| ------- | -------|
| Aankondigingen | Aankondigingen zijn **Algemeen**, **Wolk**, of **Product**-level berichten met een brede impact. Een voorbeeld uit het verleden zou een Covid-19 bericht zijn. Andere voorbeelden zijn globale beveiligingskwetsbaarheden zoals Log4j, of supportcentrum omlaag, enzovoort. Aankondigingen zijn niet gekoppeld aan een uitgifte of onderhoud. Deze functie wordt gebruikt om te communiceren met klanten over updates op cloud- of productniveau.<p>Abonnees kunnen nu nieuwe abonnementen maken of hun abonnementen bewerken om aankondigingen toe te voegen naast uitgaven en onderhoud. De abonnees ontvangen een aankondiging, afhankelijk van het feit of de producten waarop zij zijn geabonneerd door de aankondiging worden beïnvloed. Abonnees ontvangen deze berichten via de gebruikelijke berichtkanalen (e-mail/Slack) en kunnen de gebeurtenis op zien [status.adobe.com](https://status.adobe.com/) webpagina&#39;s. |
| Verbeteringen | <ul><li>Prestatieverbeteringen op de [status.adobe.com](https://status.adobe.com/) Overzicht pagina.</li><li>Uitgebreid Acrobat Online-abonnementsaanbod.</li><li>[!DNL Adobe Advertising] - Het verouderde tv-aanbod is gepensioneerd en de abonnees worden erop gewezen [!UICONTROL Demand Side Platform] aanbieden.</li><li>Banner op productaanbiedingspagina&#39;s geeft nu de status van het productaanbod weer in plaats van de gebeurtenissen in het hele product weer te geven.</li><li>Wanneer een effect van een product wordt gesloten en tegelijkertijd naar onbeduidend wordt teruggebracht, wordt een sluitingsbericht verzonden naar klanten over de downgrade.</li></ul> |
...
[!DNL Analytics] releasedatum: **9 augustus 2023**
...
[!DNL Customer Journey Analytics] releasedatum: **9 augustus 2023**
...
Kijk naar de [Video over het overzicht van de release van juli 2023](https://video.tv.adobe.com/v/3422016/) voor een samenvatting van de kenmerken die zijn toegevoegd in de release van 2023.07.0 (juli 2023).

### [!DNL Experience Manager Sites] als [!DNL Cloud Service]

_Nieuwe functie_

* **MSM voor inhoudsfragmenten:** Adobe Experience Manager (AEM) Multisite Manager is nu beschikbaar voor inhoudsfragmenten, zodat u Actieve kopieën van inhoudsfragmenten kunt maken voor distributie van bulkinhoud. De korrelige overervingscontroles zijn beschikbaar neer aan het Element van het Fragment van de Inhoud en het niveau van de Variatie.

_Nieuwe functie in prereleasekanaal_

* De [Console voor inhoudsfragmenten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/content-fragments-console.html?lang=en) Hiermee kunnen gebruikers nu tags weergeven en zoeken op tags die als metagegevens zijn toegepast op Inhoudsfragmenten. Gebruikers hoeven voor deze mogelijkheid niet meer over te schakelen op de gebruikersinterface Middelen, de contextomschakeling te verminderen en de efficiëntie te verbeteren.
...
* **Handelingencentrum** - Abonneer u op e-mailmeldingen die u waarschuwen wanneer er zich kritieke incidenten voordoen die onmiddellijke actie vereisen, en ook op persoonlijke titel aanbevelingen om uw site te optimaliseren. Het Centrum van acties dient als hub waar u deze alarm, zoals geblokkeerde replicatierijen of het verlopen van geloofsbrieven kunt herzien, en hen kunt merken zoals opgelost.
...
* **Andere wijzigingen in de Stichting** - In de week van 7 augustus retourneert AEM 2023 foutcode 429 in plaats van foutcode 503 wanneer aanvragen om AEM instanties een gezond niveau overschrijden. [Meer informatie](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/development-guidelines.html?lang=en).

### [!DNL Cloud Manager]

_Nieuwe functies_

* Kaarten op de landingspagina van Cloud Manager geven nu aan of [verbeterde beveiliging](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/programs/creating-production-programs.html?lang=en) is ingeschakeld voor hun programma&#39;s.
* Indien een ontwikkeling [pijpleiding](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html?lang=en) bevat geen teststappen. Gebruikers kunnen desgewenst teststappen opnemen als ze [begin van de pijpleiding](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/managing-pipelines.html?lang=en#running-pipelines). Deze functionaliteit zal geleidelijk worden ingevoerd.
* Wanneer [annuleren, uitvoering](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/managing-pipelines.html?lang=en#view-details), vraagt de goedkeuringsstap van de pijpleiding nu de gebruiker om een reden voor annulering te verstrekken. Deze functionaliteit zal geleidelijk worden ingevoerd.
* Gebruikers kunnen nu toegang krijgen [logboeken van het proces van de exemplaarinhoud](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=en#accessing-logs). Deze optie is alleen beschikbaar als zowel de bron- als de doelomgeving zich op AEM 2023.7.12549 of hoger bevindt.

**Bugfixes**

* Navigeren naar de ontwerpgebruikersinterface vanuit [!DNL Cloud Manager] kan niet meer worden omgeleid naar [!DNL Experience Cloud] na aanmelding.
...
De releasedatum voor de laatste versie 1.9.11 van [!DNL Workfront] for [!DNL Experience Manager] verbeterde aansluiting is 19 juni 2023.
...
| ----------| ---------- | ---------- | ---------- |---------- |
| Augustus 2023 | [!DNL AEM] | [Beveiligingsstrategieën in Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | Video | Leer hoe u ervoor kunt zorgen dat uw digitale ervaringen veilig en beveiligd zijn. |
| Augustus 2023 | [!DNL AEM Assets] | [Basisnavigatie in AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/navigation.html) | Bijgewerkte video | De basisbeginselen van navigatie verkennen [!DNL AEM Assets]. |
| Augustus 2023 | [!DNL AEM Cloud Manager] | [[!DNL AEM Cloud Manager] Kantooruren](https://experienceleague.adobe.com/docs/events/aem-champion-office-hours/2023/may.html) | Video | Meer informatie over [!DNL AEM Cloud Manager] beste praktijken van AEM Champions. |
| Augustus 2023 | [!DNL AEM Forms] | [Formuliergegevens in Azure Storage behouden](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/prefill-azure-storage/introduction.html) | Artikel | Leer hoe u het invullen van een adaptief formulier kunt opslaan en hervatten met Azure Storage om de formuliergegevens te behouden. |
| Augustus 2023 | [!DNL AEM Forms] | [E-mails verzenden met SendGrid vanuit AEM Forms](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/send-grid.html) | Artikel | Leren gebruiken [!DNL SendGrid] om e-mails van AEM Forms te verzenden. |
| Augustus 2023 | [!DNL AEM Sites] | [CSRF-bescherming voor ontwikkelaars](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/advanced/csrf-protection.html) | Artikel | Leer hoe u AEM CSRF-tokens toevoegt aan POST-, PUT- en DELETE-aanvragen voor AEM voor geverifieerde gebruikers. |
| Augustus 2023 | [!DNL AEM Sites] | [[!DNL AEM Sites] Kantooruren](https://experienceleague.adobe.com/docs/events/aem-champion-office-hours/2023/march.html) | Video | Meer informatie over [!DNL AEM Sites] beste praktijken van AEM Champions. |
...
|---------|--------|---------|---------|
| Juli 2023 | [Assets Uploaden mislukt met een foutbericht met bulkinhoud](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22476.html) | Nieuw artikel | Leer de oplossing voor het probleem waarbij het uploaden van meerdere middelen naar een map een fout veroorzaakt. |
| Juli 2023 | [AEM installatiefout *Er is geen stijl gevonden totdat de drempel voor het zoekpad is bereikt*](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22472.html) | Nieuw artikel | Leer de oplossing voor de kwestie waar de fout _Er is geen stijl gevonden totdat de drempel voor het zoekpad is bereikt_ na de installatie van AEM 6.5.17. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Augustus 2023 | [Trage uitleg voor MySQL-replicatie](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/galera-db-slow-replication.html) | Video | Meer informatie over Galera DB-replicatie en verwante MySQL-trage query&#39;s. |
| Augustus 2023 | [MySQL-query-cache](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/mysql-query-cache.html) | Video | Meer informatie over Mysql Query Cache. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| Juli 2023 | [Kwaliteitspatches (QPT)](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html) | Nieuwe artikelen | Er zijn nieuwe artikelen gepubliceerd over het toepassen van patches die beschikbaar zijn in QPT 1.1.32, QPT 1.1.33 en QPT 1.1.34. Deze artikelen staan in de desbetreffende secties. |
| Juli 2023 | [_Het bestand kan niet worden verwijderd. Waarschuwing!unlink: bestands- of mapfout is niet beschikbaar in de beheerdersmap_](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/file-cannot-be-deleated-no-file-or-directory.html) | Nieuwe artikelen | Leer de oplossing voor de kwestie waar de gebruiker een fout ziet _Het bestand kan niet worden verwijderd. Waarschuwing!ontkoppelen: bestands- of mapfout bestaat niet_ in de Commerce Admin wanneer u een JavaScript/CSS-doorloopbewerking uitvoert. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Juli 2023 | [Automatisch reageren op de e-mails die zijn ontvangen van ACC-platform](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22514.html) | Nieuw artikel | Leer de tijdelijke oplossing voor het implementeren van een automatische reactie op e-mailberichten die van het platform worden verzonden. |
| Juli 2023 | [Problemen met gegevenssynchronisatie als gevolg van time-out van opslagruimte in OOTB](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22499.html) | Nieuw artikel | Ontdek de oplossing voor het probleem waarbij OTB `ffdaReplicateStagingData` gegevens worden niet gesynchroniseerd. |
| Juli 2023 | [Inconsistenties in gegevens die worden opgehaald uit ACS via Adobe Analytics](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22483.html) | Nieuw artikel | Leer de oplossing voor de kwestie van inconsistenties in gegevens terugwinning van ACS. |
| Juli 2023 | [Compatibiliteit tussen Adobe Campaign Classic en HIGH-2023](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22496.html) | Nieuw artikel | Meer informatie over de compatibiliteit tussen [!DNL Campaign Classic] v7.3 en HIGH-2023. |
| Juli 2023 | [Afbeeldingen worden niet weergegeven in de ontwerper van e-mail](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22179.html) | Nieuw artikel | Leer de oplossing voor het probleem waarbij afbeeldingen die naar e-mails/leveringen zijn geüpload niet worden weergegeven (het pictogram voor een verbroken afbeelding wordt weergegeven) in de interface van de e-mailontwerper. |
| Juli 2023 | [Kan e-mail niet zien in DCE-modus voor leveringsactiviteit](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22417.html) | Nieuw artikel | Leer de oplossing voor de kwestie waar de DCE wijze rolbar gebruiker verhindert om volledige e-mail in leveringsactiviteit te zien. |
| Juli 2023 | [Bestand uploaden naar [!DNL Azure Blob] opslag - CRL-290029 Verboden](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22375.html) | Nieuw artikel | Leer hoe u de fout verhelpt die wordt weergegeven wanneer gebruikers een bestandsoverdrachtactiviteit proberen toe te voegen (uploaden naar ActionScript) aan [!DNL Azure Blob]. |
| Juli 2023 | [Workflowwaarschuwingen niet verzonden naar gebruikers van de supervisorgroep](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22371.html) | Nieuw artikel | Leer de oplossing voor de kwestie waar het werkschemaalarm niet naar gebruikers van supervisorgroep wordt verzonden. |
| Juli 2023 | [Afbeeldingen die niet naar openbare middelen zijn geüpload](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22395.html) | Nieuw artikel | Leer hoe u de fout kunt oplossen terwijl u probeert afbeeldingen in productie te uploaden in een map met openbare bronnen. |
| Juli 2023 | [Workflow loopt vast op de clientconsole](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22393.html) | Nieuw artikel | Leer hoe u het probleem kunt oplossen waarbij de clientconsole vastloopt met de workflow. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| ----------| ---------- | ---------- |---------- |
| Juli 2023 | [Een pushmeldingscampagne configureren en verzenden](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/push-channel/create-a-push-campaign.html) | Video | Leer hoe u een pushmelding met een campagne configureert en verzendt. |
| Juli 2023 | [Personalisatie op basis van profiel en doelgroep](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/personalize-content/profile-and-audience-membership-based-personalization.html) | Bijgewerkte video | Leer hoe u op profiel gebaseerde personalisatie aan een bericht toevoegt en hoe u het lidmaatschap van een publiek als voorwaarde aan een verpersoonlijkingsblok kunt gebruiken. |
| Juli 2023 | [Direct Mail Channel](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/direct-mail-channel/direct-mail.html) | Video | Leer hoe u het Direct Mail-kanaal instelt en hoe u direct-mailcampagnes maakt en er een voorvertoning van weergeeft. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| ----------| ---------- | ---------- |---------- |
| Augustus 2023 | [Overzicht van de betrokkenheidskaart](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/engagement-maps/engagement-map-overview.html) | Video | Leer hoe u herbruikbare campagnes kunt maken en de snelheid kunt verhogen met [!UICONTROL Engagement Map]. |
| Augustus 2023 | [Geneste campagnes voor de toewijzing van betrokkenheid](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/engagement-maps/engagement-map-nested-campaign.html) | Video | Ontdek onderling verbonden en diep genestelde campagnes om betere zichtbaarheid in de volledige klantenreis te krijgen gebruikend [!UICONTROL Engagement Map]. |
| Augustus 2023 | [Detectie en resolutie van fouten in de betrokkenheidskaart](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/programs-and-campaigns/engagement-maps/engagement-map-error-detection-and-resolution.html) | Video | Meer informatie [!UICONTROL Engagement Map] Hulp bij het oplossen van problemen en het snel oplossen van campagneproblemen. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| ----------| ---------- | ---------- |---------- |
| Augustus 2023 | [Projectfinanciën voor beheerders](https://experienceleague.adobe.com/docs/courses/using/workfront-a-1-2023-1-finances.html) | Cursus | Leer hoe u financiële instellingen instelt voor consistentie in facturering en rapportage in uw [!DNL Workfront] instantie of groep. |
| Augustus 2023 | [Projectfinanciën voor gebruikers](https://experienceleague.adobe.com/docs/courses/using/workfront-u-1-2023-1-finances.html) | Cursus | Leer hoe u financiële informatie voor projecten kunt bijhouden, kosten en inkomstentypes kunt instellen en factureringstarieven kunt overschrijven. |
| Augustus 2023 | [Instellingen voor een stroomaanvraag begrijpen](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/request-queues/understand-settings-for-a-flow-request.html) | Video | Leer hoe de aanvraagstroom verloopt in [!DNL Workfront] werkt. Dan creeer het verpletteren van regels, onderwerpgroepen, en rijonderwerpen. |
| Augustus 2023 | [Voorgangers voor meerdere projecten begrijpen](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/intermediate-projects/understand-cross-project-predecessors.html?lang=en) | Video | Leer hoe u voorgangertaken voor twee of meer projecten kunt gebruiken en bijhouden. |
| Augustus 2023 | [Projecttijdlijnen begrijpen](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/project-timelines/understand-project-timelines.html?lang=en) | Video | Leer hoe te om projecten van de begin of voltooiingsdatum te plannen, dan leren hoe de duur, predecessors, en taakbeperkingen het projectplan beïnvloeden. |
| Augustus 2023 | [Een project delen](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/projects/share-a-project.html?lang=en) | Video | Leer hoe u een project kunt delen, zodat belanghebbenden en anderen die in het project geïnteresseerd zijn, inzicht kunnen krijgen in het werk dat wordt uitgevoerd met  [!DNL Workfront]. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juli 2023 | [Probleem met proefdrukken tijdens het uploaden van proefdrukken, blauw schuiven door de balk voor onbepaalde tijd](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22364.html) | Nieuw artikel | Leer hoe u de fout verhelpt die optreedt bij het uploaden van een nieuwe proefdruk. |
...
Nieuwe video&#39;s, zelfstudies of cursussen gepubliceerd voor [!DNL Creative Cloud] voor ondernemingen.

+++Details

| Gepubliceerd | Naam | Type | Beschrijving |
| ----------| ---------- | ---------- |---------- |
| Augustus 2023 | [Grafische inhoud maken voor blogs met Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-blog-graphics.html) | Video | Leer hoe u met Tekst naar afbeelding, aangedreven door Adobe Firefly, in Adobe Express unieke grafische inhoud voor een blog kunt maken. |
| Augustus 2023 | [Aanwervingsmateriaal en inhoud aan boord met Firefly maken](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-on-boarding.html) | Video | Leer hoe u Text to Image kunt gebruiken, aangedreven door Adobe Firefly, in Adobe Express om unieke afbeeldingen te maken voor het werven van werknemers en het aan boord nemen van inhoud. |
| Augustus 2023 | [Filterinhoud maken voor marketingcampagne met Firefly](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresstutorials/create-local-marketing.html) | Video | Leer hoe u Text to Image kunt gebruiken, aangedreven door Adobe Firefly, in Adobe Express om gelokaliseerde inhoud te maken van een wereldwijde marketingcampagne voor hotels. |
