...
* **[!DNL Workfront]** | _Snel Begin, Schaal Slimme: Het activeren van Team-Vlakke Succes met de Planning van Workfront_ | Het uitrollen van een nieuwe planningsoplossing over een onderneming kan als het koken van de oceaan-duur voelen, langzaam, en los van de behoeften van de teams die enkel dingen nu willen doen. In deze zitting, zullen wij het federale versus staatsmodel van implementatie uitpakken en u tonen hoe de vroege adopters de Planning van Workfront gebruiken om waarde snel-zonder het wachten op ondernemingsbrede consensus te ontgrendelen.  | **Woensdag, 28 mei** | [ Register ](https://events.teams.microsoft.com/event/2fa2a2f4-ada5-4810-9014-aa7fe34d0354@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
| ----------| ---------- | ---------- | ---------- |---------- |
| April 2025 | [!DNL Experience Platform] | [ evalueer partijpubliek op bestelling ](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/audiences/evaluate-audiences-on-demand) | Nieuwe video | Evalueer het publiek van de partij op bestelling met flexibele publieksevaluatie. |
