...
**December 2025:** Nieuwe [ cursussen ](https://experienceleague.adobe.com/en/courses) zijn beschikbaar op Experience League. Ze bieden gestructureerd, door experts gemaakt leren waarmee u vaardigheden sneller kunt opbouwen, expertise kunt valideren en betrouwbaarder kunt vooruitgaan in alle Adobe-oplossingen.
...
[Meer informatie](https://experienceleague.adobe.com/en/courses)
...
| [!DNL Experience Cloud] | [ Agent AI in de toepassingen van Experience Cloud ](https://experienceleague.adobe.com/en/docs/core-services/interface/features/agentic-ai) | Nieuwe hulp op [ gepubliceerde agenten van AEM ](https://experienceleague.adobe.com/en/docs/core-services/interface/features/agentic-ai#ai-first-experience-cloud-applications). Zoek hulp en controleer de beschikbaarheid van AI-agents in Experience Cloud. | zaterdag 21 november 2025 |
...
| **fixes en verbeteringen van de insect** | <ul><li>De aankondigingen werden verkeerd geëtiketteerd als _onderhoud_ op de de gebeurtenisbanner van de Aankondiging.</li><li>Sommige namen van Business Service zijn niet gebruiksvriendelijk.</li><li>Klanten konden geen CSO&#39;s bekijken die langer dan 40 dagen open bleven, of CSO&#39;s sloten 40 dagen geleden, na de nieuwe updates.</li><li>Adobe heeft Slack-abonnees met onvoltooide Slack-installaties op de hoogte gesteld van de stappen die zij moesten ondernemen en heeft stappen ondernomen om hun Slack-kanaal op te zetten.</li><li>Prestatieverbeteringen voor de koptekst en voettekst van de website.</li></ul> |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| November 2025 | [ de plaatsingsgeschiedenis van de classificaties ](https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/components/classifications/classification-sets-job-history) | Video | Zie de taakgeschiedenis van het uploaden en downloaden van classificatiesetgegevens. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| November 2025 | [ waarom toont de **[!UICONTROL Workspace]** **[!UICONTROL Page]** afmeting meer dan 100 bytes (paginalengte overschrijdt 100 bytelimiet)?](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28067) | Nieuw artikel | Leer meer over de oplossingen voor het probleem wanneer een pagina die in de **[!UICONTROL Page]** -dimensie wordt weergegeven, een tekenreekswaarde van meer dan 100 bytes lijkt te hebben, ook al heeft de pagina-dimensie een limiet van 100 bytes. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| November 2025 | [ het verifiëren van login succes en mislukking in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27844) | Nieuw artikel | Leer hoe u succesvolle en mislukte aanmeldingspogingen kunt verifiëren in Adobe Experience Manager as a Cloud Service (AEMaaCS)-auteuromgevingen en hoe u het IP-bronadres voor elke poging kunt identificeren. |
| November 2025 | {het geheime voorgeheugen van Dispatcher wordt ontruimd en opgewarmd na plaatsing in AEMaaCS [](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28034) | Nieuw artikel | Leer over de oplossingen aan de kwestie waar de details over welke pagina&#39;s worden opgewarmd en hoe zij worden gekozen onduidelijk zijn wanneer het systeem automatisch een proces van de geheim voorgeheugenwarmte na flushing begint, wanneer het verzenergeheime voorgeheugen na plaatsing wordt ontruimd. |
| November 2025 | [ CDN de veranderingen van het basisauthentificatiewachtwoord niet die in AEMaaCS worden toegepast ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27925) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het bijwerken van het wachtwoord voor CDN basisauthentificatie in Adobe Experience Manager as a Cloud Service (AEMaaCS) door de geheime omgevingsvariabele te wijzigen past niet de nieuwe waarde toe, omdat de geheime omgevingsvariabelen onveranderlijk zijn zodra opgesteld. |
| November 2025 | [ de initialisatiefouten van de de redacteur van het inhoudsfragment van het Oplossen van problemen in AEM ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27909) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het proberen om inhoudsfragmenten in Adobe Experience Manager as a Cloud Service (AEMaaCS) gebrek aan de nieuwe redacteur van het inhoudsfragment uit te geven, die niet met de fout laadt, *Kon niet app initialiseren.* |
| November 2025 | [ Inconsistente vraagresultaten in de Bouwer API van de Vraag van AEM ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27833) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het uitvoeren van een vraag met de Bouwer van de Vraag API keert inconsistente resultaten terug als een onbedoelde index wordt gebruikt. |
| November 2025 | [ Lichtbakomslag niet automatisch gecreeerd voor niet-admin gebruikers in AEM 6.5 ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28044) | Nieuw artikel | Leer meer over de oplossingen voor het probleem wanneer met de functie Lichtbak niet automatisch de map Lichtbak wordt gemaakt voor gebruikers die geen beheerder zijn wanneer elementen worden toegevoegd. |
| November 2025 | [ Snelle  [!DNL MySQL]  omslaggroei die door binlogaccumulatie in AEM ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27829) wordt veroorzaakt | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer de [!DNL MySQL] omslag in een AEM on-premise milieu zich snel uitbreidt en significante schijfruimte, wegens bewaarde binaire logboekdossiers (binlog) verbruikt. |
| November 2025 | [ de bouwstijl van de Pijpleiding ontbreekt van unpinned knoop/NPM en mist `package-lock.json` in AEM Cloud Manager ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27922) | Nieuw artikel | Leer over de oplossingen aan de kwestie in AEM Cloud Manager wanneer de pijpleiding bouwt ontbreken wanneer de knoop en de versies NPM niet in `frontend-maven-plugin` worden geplaatst, en het `package-lock.json` dossier niet wordt begaan. |
...
| November 2025 | [ de plaatsingen van Cloud Manager wijzen `/conf` meta-gegevensveranderingen in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27944) niet op | Nieuw artikel | Leer over de oplossingen aan de kwestie in AEMaaCS wanneer de veranderingen in het onderzoek van AEM of meta-gegevensconfiguraties onder de `/conf` weg, zoals het toevoegen van nieuwe predikaten of groepspredikaten, niet in de milieu&#39;s UI op DEV of QA na plaatsing verschijnen. |
...
| November 2025 | [ CDN configuratie niet toegepast in de Plaats van Edge Delivery voor [!UICONTROL X-Walk] architectuur ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28000) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het gebruiken van Adobe Experience Manager (AEM) voor creatie en Edge Delivery Services (EDS) voor levering in een [!UICONTROL X-Walk] opstelling, die CDN configuraties aan de verkeerde de dienstresultaten in geen effect opstelt. |
| November 2025 | [ Oak LDAP IdentityProvider synchroniseert geen gebruikers en groepen in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27863) | Nieuw artikel | Leer meer over de oplossingen voor het probleem wanneer de Oak LDAP `IdentityProvider` in Adobe Experience Manager as a Cloud Service (AEMaaCS) gebruikers en groepen niet synchroniseert vanuit een externe LDAP-directory (Lightweight Directory Access Protocol). |
| November 2025 | [ Veranderingen in filter dat niet in AEM UI weerspiegelt ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27897) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer de veranderingen in groepspreidingen of onlangs toegevoegde predikaten in AEM niet in UI verschijnen, zelfs na succesvolle pijpleidingsplaatsingen. |
| November 2025 | [ het oplossen van problemen front-end pijpleidingsmislukkingen in AEM as a Cloud Service ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28088) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het omzetten van een full-stack pijpleiding in een front-end (FE) slechts pijpleiding in AEM as a Cloud Service, bouwstijlmislukkingen voorkomen toe te schrijven aan platform-specifieke gebiedsdelen en strikte het verbinden vereisten. |
| November 2025 | [[!DNL Tika]  configuratie die niet in AEMaaCS-Assets ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27615) werkt | Nieuw artikel | Leer meer over de oplossingen voor het probleem in AEMaaCS-Assets als aangepaste [!DNL Tika] -configuraties (zoals het uitsluiten van PDF&#39;s) worden genegeerd in de cloud-omgeving, die standaard de instellingen voor &#39;out-of-the-box&#39; (OOTB) gebruikt. |
| November 2025 | [ Ontbrekende versietakken na omschakeling aan privé bewaarplaats GitHub in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27923) | Nieuw artikel | Leer over de oplossingen aan de kwestie in AEMaaCS wanneer het vormen van plaatsingspijpleidingen gebruikend een privé bewaarplaats GitHub, toont het drop-down van de takselectie niet alle versietakken. |
| November 2025 | [**[!UICONTROL Universal Editor]**laadt een onjuiste AEM-auteurinstantie in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27935) | Nieuw artikel | Leer meer over de oplossingen voor het probleem in AEMaaCS wanneer u de Edge Delivery Services-indexpagina (EDS) opent in de **[!UICONTROL Universal Editor]** op een auteurinstantie en laadt inhoud uit een andere auteursomgeving. |
...
| November 2025 | [ het kopiëren van grote omslagen DAM ontbreekt wanneer het gebruiken van **[!UICONTROL Content Copy Tool]** in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27936) | Nieuw artikel | Leer meer over de oplossingen voor het probleem in AEMaaCS wanneer het kopiëren van grote mappen tussen auteursomgevingen die **[!UICONTROL Content Copy Tool]** gebruiken ontbreekt. |
| November 2025 | [ Logboek door:sturen eindpunt keert na AEM rollout in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27945) terug | Nieuw artikel | Leer over de oplossingen aan de kwestie in AEMaaCS wanneer de logboek het door:sturen configuratie aan een vorig eindpunt na een rollout terugkeert. |
| November 2025 | [ Het oplossen van `StackOverflowError` in de pijpleiding van AEM as a Cloud Service bouwt ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27979) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het terugkomen `StackOverflowError` tijdens pijpleidingsbouw voorkomt. |
| November 2025 | [ de kwesties van de rijke knoop van de tekstredacteur van de Oplossing na het migreren aan  [!DNL CoralUI3] ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27985) | Nieuw artikel | Leer meer over de oplossingen voor dit probleem in AEMaaCS wanneer u aangepaste dialoogvensters en clientbibliotheken van [!DNL CoralUI2] naar [!DNL CoralUI3] verplaatst, zodat knoppen voor tekstredacteur met tekstopmaak voor lettertype, tekengrootte en kleur niet meer werken. |
...
| November 2025 | [ de infrastructuuruitzondering van het Netwerk wanneer het creëren van specifieke uitgang IP in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27884) | Nieuw artikel | Leer over de oplossingen aan de kwestie in AEMaaCS - Plaatsen wanneer het creëren van een specifieke uitgang IP toe te schrijven aan een ontbrekende primaire gebiedparameter. |
| November 2025 | [**[!UICONTROL Generate Variations]**knop ontbreekt in AEMaaCS ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27894) | Nieuw artikel | Leer meer over de oplossingen voor het probleem in AEMaaCS - Sites als de knop **[!UICONTROL Generate Variations]** ontbreekt in [!UICONTROL Content Fragment Editor] . |
| November 2025 | [ Behoud `X-Correlation-Id` in AEMaaCS foutenreacties (404/500) ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27918) | Nieuw artikel | Leer over de oplossingen aan de kwestie in AEMaaCS wanneer de `X-Correlation-Id` kopbal in *404 niet Gevonden* of *500 Interne de foutenreacties van de Server* mist, alhoewel de logboeken van AEM bevestigen het werd geplaatst. |
| November 2025 | [ de plaatsingspijpleiding van AEM ontbreekt toe te schrijven aan ongeldig OSGi configuratiebezit ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27930) | Nieuw artikel | Leer meer over de oplossingen voor het probleem in AEMaaCS wanneer implementatiepijplijnen in werkgebied- en productieomgevingen mislukken tijdens de substap **[!UICONTROL Update services]** nadat deze gedurende meerdere uren zijn uitgevoerd. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| November 2025 | [ Salesforce Commerce de architectuur van de wolkenstartkit van de wolk ](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/adobe-commerce-optimizer/sfcc-starter-kit/architecture-overview) | Video | Meer informatie over de architectuur en functionaliteit van de startkit voor Commerce Optimizer Connector. De startkit integreert Salesforce Commerce Cloud (SFCC) en Adobe App Builder. |
| November 2025 | [ installeer de patroon SFCC ](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/adobe-commerce-optimizer/sfcc-starter-kit/installation-sfcc-cartridge) | Video | Leer hoe u de Adobe Commerce Optimizer-cartridge voor een Salesforce Commerce Cloud-instantie installeert en configureert. |
| November 2025 | [ BedrijfsGroei met de Visie van Adobe Door:sturen roadmap ](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/webinars-and-events/business-growth/vision-forward) | Video | Beschrijving |
...
| November 2025 | [ GraphQL vergat wachtwoordtarief beperkend kwestie in Adobe Commerce op wolkeninfrastructuur 2.4.8 ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28007) | Nieuwe artikelen | Leer over de oplossingen aan de kwestie wanneer de tarief beperkende configuratie voor de vergeten wachtwoordeigenschap niet wordt afgedwongen wanneer het gebruiken van GraphQL eindpunten. |
| November 2025 | [ los beperkte toegangsfout in Adobe I/O ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27859) op | Nieuwe artikelen | Leer over de oplossingen aan de kwestie wanneer a *Beperkte toegang* fout in Adobe I/O ontwikkelaars verhindert om tot de **[!UICONTROL Developer]** console en/of **[!UICONTROL Admin]** console (niet het paneel van Adobe Commerce **[!UICONTROL Admin]**) toegang te hebben. |
| November 2025 | [ Controle ontbreekt wanneer JS minificatie en bundeling worden toegelaten ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27997) | Nieuwe artikelen | Leer meer over de oplossingen voor dit probleem wanneer de uitcheckfuncties onjuist zijn wanneer minificatie, bundeling en (in sommige gevallen) samenvoeging van JavaScript-elementen (JS) zijn ingeschakeld. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| November 2025 | [ los quarantainediscrepanties tussen marketing en midsourcing instanties in Adobe Campaign ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-28059) op | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer de marketing instantie meer quarantined e-mailadressen dan de midden-sourcing (RT/MID) instantie toont, die tot inconsistenties in quarantaine verslagen leidt. |
| November 2025 | [ de Uitvoer van grote dossiers van Snowflake ontbreekt in Adobe Campaign toe te schrijven aan symbolische afloop ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27943) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer het uitvoeren van dossiers groter dan 30 GB van Snowflake die de **[!UICONTROL FileExport]** activiteit in de werkschema&#39;s van Adobe Campaign gebruiken ontbreekt met de fout *ODB-240000 ODBC fout: De download van het segment van de pijl mislukte maximum uitgevoerde pogingen*, die door de vervaldatum van het authentificatietoken wordt veroorzaakt. |
| November 2025 | [ Verklaring op opties met betrekking tot **[!UICONTROL Workflow High Availability]** (WKFHA) ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27919) | Nieuw artikel | Meer informatie over de belangrijkste opties voor **[!UICONTROL Workflow High Availability]** (WKFHA) in Adobe Campaign. |
| November 2025 | [ Onbekwaam om specifieke middelen van het doopvontdossier in Adobe Campaign te uploaden Beheerde Cloud ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27626) | Nieuw artikel | Meer informatie over de oplossingen voor dit probleem wanneer bepaalde bestandstypen niet correct kunnen worden geüpload in Adobe Campaign Managed Cloud, ook al lijken de bestanden te zijn geüpload naar de server. |
...
| November 2025 | [ Profielen betreden geen reizen in Adobe Journey Optimizer ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27937) | Nieuw artikel | Leer over de oplossingen aan de kwestie wanneer de profielen geen reizen ingaan alhoewel de kwalificerende gebeurtenisgegevens in de relevante dataset worden gestroomd. |
...
Zie [ 2025.10.16 - de nota&#39;s van de Versie ](https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/release-notes#latest) voor GenStudio for Performance Marketing
...
| November 2025 | Acrobat | [ verwijdert gevoelige informatie ](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/advanced-tasks/redact) | Video | Leer hoe je persoonlijke of vertrouwelijke gegevens permanent van je PDF verwijdert. |
| November 2025 | Acrobat | [ Papier aan PDF ](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/getting-started/scan-and-ocr) | Video | Leer hoe u een papieren document verandert in een slim, doorzoekbaar, bewerkbaar PDF-bestand. |
