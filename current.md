...
| ----------| ---------- | ---------- |---------- |
| September 2025 | [ Federated Audience Composition tutorial ](https://experienceleague.adobe.com/en/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | Video | Neem rechtstreeks vanuit het gegevenspakhuis contact op met het publiek via Federated Audience Composition (FAC). |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Augustus 2025 | [*niet meer contact (door om het even welk kanaal)* gebiedsupdates verkeerd in Adobe Campaign ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27296) | Nieuw artikel | Als u via een landingspagina in Adobe Campaign V8 de abonnementsvoorkeuren beheert, wordt het veld **[!UICONTROL No longer contact (by any channel)]** onjuist bijgewerkt. |
| Augustus 2025 | [ E-mail inbox teruggevende kwesties in Adobe Campaign v8 WebUI ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27408) | Nieuw artikel | Leer meer over de oplossingen voor dit probleem wanneer rendering in Postvak In Adobe Campaign Managed Cloud v8 niet werkt zoals u had verwacht bij gebruik van de WebUI. |
| Augustus 2025 | [ de fout van de gegevensvoorlading van de Reparatie in het Web van Adobe Campaign apps ](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27417) | Nieuw artikel | Wanneer u een webtoepassing in Adobe Campaign test, wordt er een fout bij het vooraf laden van gegevens gegenereerd die wordt veroorzaakt door ontbrekende machtigingen voor maptoegang. In deze video ziet u hoe u dit probleem verhelpt. |
...
| September 2025 | [ werk de taakstatus ](https://experienceleague.adobe.com/en/docs/workfront-learn/tutorials-workfront/manage-work/tasks/update-the-task-status) bij | Video | Leer hoe, waarom en hoe vaak u de taakstatus bijwerkt. |
| September 2025 | [ werk de kwesties status ](https://experienceleague.adobe.com/en/docs/workfront-learn/tutorials-workfront/manage-work/issues-requests/update-the-issue-status) bij | Video | meer informatie over de status van uitgaven en tips en trucs voor het gebruik ervan. |
...
| September 2025 | [ creeer een KPI- rapport op een Dashboard van het Canvas ](https://experienceleague.adobe.com/en/docs/workfront-learn/tutorials-workfront/reporting/canvas-dashboards/create-a-kpi-report-on-a-canvas-dashboard) | Video | Leer hoe u een KPI-rapport maakt op een Canvas-dashboard. |
...
Zie [ 2025.08.15 - de nota&#39;s van de Versie ](https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/release-notes#latest) voor GenStudio for Performance Marketing
