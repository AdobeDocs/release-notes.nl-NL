...
* Probleem verholpen in [Algemene rapporten](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reporting/general-reports.html?lang=en#reporting), waarbij een gebruiker een datum in de **[!UICONTROL For Dates Through]** controle zou selecteren maar de rapportgegevens één dag zouden worden verschoven. (AAM-57702)
* Probleem verholpen in [Beheer > Groepen](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/administration-overview.html?lang=en#create-group), waarbij gebruikers een _Uw groep konden ophalen, maar er was een fout opgetreden bij het opslaan van de groepsmachtigingen_-fout bij het opslaan van groepsmachtigingen vanwege time-outs. (AAM-57406, AAM-57411)
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Sites Experience Managers als Cloud Service**
      ...
      * [Een Progressieve versie van de Web App (PWA) van een ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html) sitecan wordt nu toegelaten op het projectniveau als eenvoudige configuratie.
...
| April 2021 | [Indexen van verouderde geordende eigenschappen](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/dopi.html) | Artikel | Het oudere project heeft niet-ondersteunde indextypen van geordende eigenschappen. Zoals de huidige beperkingen suggereren, wordt indexbeheer op [!UICONTROL AEM as a Cloud Service] alleen ondersteund voor indexen van het type _lucene_. |
| April 2021 | [Testen of er een  [!DNL Salesforce] formulier met leidende informatie wordt verzonden](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/integrate-with-salesforce/create-lead-submitting-form.html?lang=en#forms) | Video | Maak een adaptief formulier op basis van het formuliergegevensmodel. Controleer of het object Lead is gemaakt in de Salesforce-database bij het verzenden van formulieren. |
...
| April 2021 | [[!UICONTROL Unsupported Runmode Configuration]](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/urc.html) | Referenties  | Hoe u [!UICONTROL runmode] configuraties volgzaam met Experience Manager als Cloud Service kunt maken, aangezien slechts Auteur en Publish [!UICONTROL runmodes] zijn. |
