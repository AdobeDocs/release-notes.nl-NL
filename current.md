...
* [[!DNL Adobe Experience Manager]](#aem) (bijgewerkt op 13  **oktober 2021**)
* [[!DNL Adobe Campaign]](#ac)
* [[!DNL Adobe Advertising Cloud]](#adcloud) (bijgewerkt op 7  **oktober 2021**)
...
| Oktober 2021 | [ [!DNL Journey Optimizer] Configureren voor beheerders van reizen](https://experienceleague.adobe.com/?recommended=JourneyOptimizer-A-1-2021.1) | Cursus | Begrijp de [!DNL Journey Optimizer] architectuur en de punten van integratie. Leer hoe u [!DNL Journey Optimizer] configureert. |
...
## ![](/assets/experience_platform_appicon_24.png) IconOffer-beslissing {#offer-decisioning}
...
**Update 10/13/2021:** Ontdek de Release- [overviewvideo van ](https://video.tv.adobe.com/v/337381) september 2021 voor een overzicht van de nieuwe functies.
...
| Oktober 2021 | [[!UICONTROL Content Transfer Tool]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/content-migration/content-transfer-tool.html?lang=en) | Video | Leer hoe u met [!UICONTROL Content Transfer Tool] inhoud kunt migreren naar AEM as a Cloud Service vanuit AEM 6.3+. |
...
| Oktober 2021 | [[!UICONTROL Dispatcher]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/dispatcher.html?lang=en) | Video | Meer informatie over AEM [!UICONTROL Dispatcher] voor AEM as a Cloud Service, waarbij u zich richt op opmerkelijke wijzigingen van [!UICONTROL Dispatcher] voor AEM 6, het [!UICONTROL Dispatcher]-conversieprogramma en hoe u de SDK van Dispatcher Tools gebruikt. |
...
| Oktober 2021 | [Onboarding van AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/onboarding.html?lang=en) | Video | Leer over aan boord gaan om as a Cloud Service vanaf de contractfase helemaal door vestiging de milieu&#39;s te AEM gebruikend [!UICONTROL Cloud Manager]. |
...
| Oktober 2021 | [AEM [!UICONTROL Modernization Tools]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/aem-modernization-tools.html?lang=en) | Video | Leer hoe AEM [!UICONTROL Modernization Tools] worden gebruikt om een bestaand AEM project en inhoud te bevorderen om as a Cloud Service compatibel AEM te zijn. |
