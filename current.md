...
* [Releaseopmerkingen bij Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html). (Vrijgegeven: (31 maart 2021)
...
| April 2021 | [Aangepaste datumbereiken toepassen op mobiele scorebordprojecten](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/additional-tools/analytics-dashboards/apply-custom-date-ranges-to-mobile-scorecard-projects.html) | Video | In deze video ziet u hoe u de verschillende opties voor datumbereiken kunt beheren wanneer u uw analyseprojecten voor mobiele apparaten instelt, waarbij u onder andere kunt kiezen welke out-of-the-box-bereiken u wilt weergeven en uw eigen aangepaste datumbereiken kunt maken.Opties |
...
| April 2021 | [Indexen van verouderde geordende eigenschappen](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/dopi.html) | Artikel | Het oudere project heeft niet-ondersteunde indextypen van geordende eigenschappen. Aangezien de huidige beperkingen indexbeheer op [!UICONTROL AEM as a Cloud Service] voorstellen wordt slechts gesteund voor indexen van type lucene. |
...
| April 2021 | [INST: Door derden geïnstalleerde artefacten](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/inst.html) | Referenties  | Verouderd project is afhankelijk van een pakket of aansluiting van derden en installeert dit als onderdeel van het project of via pakketbeheer. |
| April 2021 | [[!UICONTROL URC:Runmodes]](https://experienceleague.adobe.com/docs/experience-manager-pattern-detection/table-of-contents/urc.html) | Referenties  | Geef een voorbeeld van hoe klanten [!UICONTROL runmodes] configuratie compatibel kunnen maken met AEM cloudservice, aangezien alleen de auteur en publicatie [!UICONTROL runmodes] zijn. |
