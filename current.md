...
De opmerkingen in de release van september betreffen de releaseperiode van 13 september 2023 tot 3 oktober 2023. Adobe Analytics-releases werken op een [continu leveringsmodel](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html?lang=en), wat voor een scalable, gefaseerde benadering van eigenschapplaatsing toestaat. Deze releaseopmerkingen worden daarom meerdere keren per maand bijgewerkt. Controleer ze regelmatig.

## Nieuwe of verbeterde functies {#features}

| Functie | Beschrijving | [Uitvoeren start](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html) | [Algemene beschikbaarheid](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html) |
| ----------- | ---------- | ------- | ---- |
...
* [Opmerkingen bij de vorige release voor 2022](https://experienceleague.adobe.com/docs/analytics/release-notes/previous/2022.html?lang=en)
