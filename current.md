---
title: Opmerkingen bij de centrale release
...
* **Workfront** | _het Maken van JSON die met de Fusie van Workfront + JSONata_ gebruikt | 17 september 2025 | [ Register ](https://events-emea5.adobeconnect.com/content/adobeconnect/43/5415868397/en/events/event/shared/5757312223/event_landing.html?sco-id=5757320868&campaign-id=ExL&_charset_=utf-8)

* **Doel** | _Leveraging Adobe Target AI voor de Uitmuntendheid en Schaal van de Optimalisering_ | 18 september 2025 | [ Register ](https://event.adobe.com/leveragingadobetargetai)
...
| ------- | ------- | ------- | ------- |
| [!DNL Experience Cloud] | [ Generatieve AI in  [!DNL Experience Cloud] ](https://experienceleague.adobe.com/nl/docs/core-services/interface/features/generative-ai) | Vraag hulp bij generatieve AI (GenAI) en AI-assistent in Experience Cloud-toepassingen. | Bijgewerkt september 2025 |
...
Geplande versie: **25 September, 2025**

(Datum te wijzigen.)

| Datum | Bijwerken | Beschrijving |
| -----------| -----------| ---------- |
| Geplant: **25 September, 2025** | Steun voor IP Lijsten van de Toegang | Voor organisaties die IP de Lijsten van de Toegang in Admin Console beschikbaar en toegelaten hebben, zal Experience Cloud die IP beperkingen om tot toepassingen op het `https://experience.adobe.com` domein toegang te hebben naleven. Deze update heeft invloed op alle webtoepassingen die via dat domein worden benaderd, en controles worden uitgevoerd bij aanmelding en nieuwe pagina&#39;s worden geladen in die organisatie. |
...
&lbrace;19 augustus 2025 **werkt bij:**

* **Alarm:** het stromen alarm van de productiecapaciteit
* **de Dienst van de Catalogus:** Behoud van Gegevens voor het Profiel van de Klant in real time.
* **Doelen:** Echte de bestemming van de Verbinding van het Publiek van identiteitskaart, en meer.
* **model-Gebaseerde Schema&#39;s:** vereenvoudig uw gegevensmodellering met Model-Gebaseerde Schema&#39;s.
* **Sandboxes:** voorwerp van de Afhankelijkheid deduplicatie in het invoeren werkschema; Volledige zandbaksteun voor over orgs pakket het delen.
* **de Dienst van de Segmentatie:** schattingen van het publiek.
* **Bronnen:** Algemene beschikbaarheid van de bron van Oracle NetSuite, en meer.
...
| ----------| ---------- | ---------- |---------- |
| September 2025 | [ Federated Audience Composition tutorial ](https://experienceleague.adobe.com/nl/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | Tutorial | Neem rechtstreeks vanuit het gegevenspakhuis contact op met het publiek via Federated Audience Composition (FAC). |
| September 2025 | [ merk-aan-merk samenwerking ](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/collaboration/brand-to-brand-collaboration) | Video | Lees meer over gebruiksgevallen die worden ondersteund door samenwerking tussen merken en merken en over specifieke functies die zijn geïntroduceerd om deze workflows te ondersteunen. |
| September 2025 | [ ontdekt publiek overlapt binnen de projecten van Collaboration ](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/collaboration/discover-audience-overlaps-in-projects) | Video | Leer hoe u overlappingen met het publiek in Real-Time CDP Collaboration-projecten kunt vergelijken. |
| September 2025 | [ activeer publiek in de projecten van Collaboration ](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/collaboration/activate-audiences-in-projects) | Video | Leer hoe u het publiek activeert voor uw samenwerkingspartners in Real-Time CDP Collaboration-projecten. |
| September 2025 | [ Gebruik het gebruikersinterface en het werkschema van Real-Time Customer Data Platform ](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/rtcdp/understanding-the-real-time-customer-data-platform-user-interface) | Video | Leer hoe u door de Real-time Customer Data Platform (CDP)-gebruikersinterface kunt navigeren om te zien hoe de functies samenkomen om realtimeactivering tijdens de digitale journey van de klant mogelijk maken. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2025 | [ creeer publiek van segmenten ](https://experienceleague.adobe.com/nl/docs/customer-journey-analytics-learn/tutorials/components/filters/create-audiences-from-segments) | Video | Leer hoe u publiek maakt en publiceert van Customer Journey Analytics naar de Real-Time Customer Data Platform. |
...
| September 2025 | [ creeer douanesjablonen ](https://experienceleague.adobe.com/nl/docs/customer-journey-analytics-learn/tutorials/analysis-workspace/templates/create-custom-templates) | Video | Leer hoe u een aangepaste sjabloon maakt in Customer Journey Analytics. |
...
| ----------| ---------- | ---------- | ---------- |---------- |
| September 2025 | [!DNL AEM Assets] | [ Dynamische video van Media en viewer beste praktijken ](https://experienceleague.adobe.com/nl/docs/experience-manager-learn/assets/dynamic-media/video/dynamic-media-video-best-practices) | Video | Leer meer over de beste werkwijzen voor het publiceren en optimaliseren van video in AEM Dynamic Media, zoals adaptief streamen, slim uitsnijden voor verschillende schermgrootten, aangepaste viewer-voorinstellingen en ondersteuning voor bijschriften, audiotracks en hoofdstukmarkeringen. |
| September 2025 | [!DNL AEM CS] | [ Gedrag dat richt ](https://experienceleague.adobe.com/nl/docs/experience-manager-learn/cloud-service/personalization/use-cases/behavioral-targeting) | Video | Leer hoe u inhoud kunt aanpassen op basis van gebruikersgedrag met Adobe Experience Platform en Adobe Target. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2025 | [ installeer App Builder apps van Adobe Exchange ](https://experienceleague.adobe.com/nl/docs/commerce-learn/tutorials/adobe-developer-app-builder/install-app-builder-app) | Video | Ontdek hoe u Adobe Commerce App Builder-apps met Adobe Exchange kunt installeren en valideren. |
...
* [!DNL Web User Interface]: Augustus 2025 - [ de nota&#39;s van de Versie ](https://experienceleague.adobe.com/nl/docs/campaign-web/v8/release-notes/release-notes) | [ documentatie van het Product ](https://experienceleague.adobe.com/nl/docs/campaign-web/v8/campaign-web-home)
...
Laatste versie: **September 2025**

Updates:

* Reispad optimaliseren
* Aangepaste delegatiemethode voor subdomeinen
* Adobe Experience Platform-gegevens gebruiken voor personalisatie en besluitvorming
...
| Gepubliceerd | Applicaties | Naam | Type | Beschrijving |
| ----------| ---------- | ---------- | ---------- |---------- |
| September 2025 | [!DNL Journey Optimizer] | [ Inleiding aan Orchestrated Campaigns in Adobe Journey Optimizer ](https://experienceleague.adobe.com/nl/docs/journey-optimizer-learn/tutorials/create-campaigns/orchestrated-campaigns/introduction-to-orchestrated-campaigns) | Video | Ontdek hoe georkestreerde campagnes in Adobe Journey Optimizer marktleiders in staat stellen om op merk-gestarte, publiek-gebaseerde campagnes te beheren met behulp van geavanceerde mogelijkheden voor gegevensbeheer. |
| September 2025 | [!DNL Journey Optimizer] | [ Monitor en analyseer uw reis met levende rapporten ](https://experienceleague.adobe.com/nl/docs/journey-optimizer-learn/tutorials/report-and-monitor/monitor-and-analyze-your-journey-with-live-reports) | Video | Leer hoe u Adobe Journey Optimizer Live Report effectief kunt gebruiken om de prestaties van uw reizen en berichten in real-time te controleren en te analyseren. Leer hoe u dashboards, exportrapporten en reisspecifieke metriek kunt aanpassen om uw marketingstrategieën te optimaliseren. |
| September 2025 | [!DNL Journey Optimizer] | [ Relationele Basisbegrippen van de Opslag in Journey Optimizer ](https://experienceleague.adobe.com/nl/docs/journey-optimizer-learn/tutorials/create-campaigns/orchestrated-campaigns/relational-store-basics) | Video | Leer de stichtingsconcepten van de relationele opslag die in Journey Optimizer wordt gebruikt campagne organisatie-die schemaontwerp, gegevensopname, gesteunde bronnen, en zeer belangrijke verschillen van de het profielopslag in real time behandelt. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2025 | [ creeer een vorm van het verslagtype verzoek ](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/workfront-planning/create-a-record-type-request-form) | Video | Stroomlijn het werk door te leren hoe te om de vormen van het douaneverzoek te creëren om taken te organiseren, zeer belangrijke informatie te verzamelen, en teamefficiency te verhogen. |
| September 2025 | [ werk de taakstatus ](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/manage-work/tasks/update-the-task-status) bij | Video | Leer hoe, waarom en hoe vaak u de taakstatus bijwerkt. |
| September 2025 | [ werk de kwesties status ](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/manage-work/issues-requests/update-the-issue-status) bij | Video | meer informatie over de status van uitgaven en tips en trucs voor het gebruik ervan. |
| September 2025 | [ begrijp BESTAANDE filters ](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/reporting/intermediate-reporting/understand-exists-filters) | Video | Leer wat een filter EXISTS is, wat het voor u kan doen, en hoe u één van kras kunt bouwen. Zie ook veel nuttige voorbeelden van EXISTS-filters. |
| September 2025 | [ Inleiding aan de Dashboards van het Canvas ](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/reporting/canvas-dashboards/introduction-to-canvas-dashboards) | Video | Leer hoe u naar en binnen Canvasdashboards kunt navigeren en hoe u een eenvoudig dashboard met bestaande rapporten kunt maken. |
| September 2025 | [ creeer een KPI- rapport op een Dashboard van het Canvas ](https://experienceleague.adobe.com/nl/docs/workfront-learn/tutorials-workfront/reporting/canvas-dashboards/create-a-kpi-report-on-a-canvas-dashboard) | Video | Leer hoe u een KPI-rapport maakt op een Canvas-dashboard. |
...
* Nieuwe Firefly-modellen voor het genereren van afbeeldingen ondersteund
* Buiten-de-box vertaling voor e-mail

Zie [ 2025.08.15 - de nota&#39;s van de Versie ](https://experienceleague.adobe.com/nl/docs/genstudio-for-performance-marketing/user-guide/release-notes#latest) voor GenStudio for Performance Marketing
...
| September 2025 | Acrobat Sign | [ Migreer de malplaatjes van het Document ](https://experienceleague.adobe.com/nl/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/docusign-templates) | Bijgewerkte video | Leer hoe u in drie eenvoudige stappen probleemloos Docusign-sjablonen en workflows naar Acrobat Sign kunt migreren. |
| September 2025 | Acrobat Sign | [ worden begonnen met Acrobat Sign ](https://experienceleague.adobe.com/nl/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/new-sender) | Bijgewerkte video | Leer hoe u documenten ter ondertekening kunt verzenden als een nieuwe afzender in Adobe Sign. |
| September 2025 | Acrobat Sign | [ verzend een document naar één enkele ondertekenaar ](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/send-to-single-recipient.html?lang=nl-NL) | Bijgewerkte video | Ontdek hoe u documenten ter ondertekening naar één ontvanger kunt verzenden met Adobe Sign. |
