...
* **[!DNL WORKFRONT]** | Chat Vragen en antwoorden | _Vragen aan de klant: Voordelen en beste praktijken met Fusion_ | **26 september @ 11:00 AM CT** | [Registreren](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,wwMNpBFpyU6JRZ7t-hkIIQ,SV8DFIlim0ivqJp7uYE5zg,-iWPFBz0s0aNbozaOGyGsQ?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL EXPERIENCE MANAGER SITES]** | Leren van uw collega&#39;s | _Een diepe insteekmodule voor AEM Sites_ | **28 september om 8:00 uur PT** | [Registreren](https://engage.adobe.com/AEM_Tools_Deep_Dive_Registration.html?utm_source=ExL)

* **[!DNL WORKFRONT]** | Leren van uw collega&#39;s | _Een diepe insteekmodule voor AEM Sites_ | **28 september om 8:00 uur PT** | [Registreren](https://engage.adobe.com/AEM_Tools_Deep_Dive_Registration.html?utm_source=ExL)
...
* **[!DNL AEM]** en **[!DNL COMMERCE]** | Developers Live | _Inhoud en handel: een diepe duik over [!UICONTROL Edge Delivery Services], ongeëvenaarde mogelijkheden, rekbaarheid, composability en productiviteitshulpmiddelen_ | **6 november om 9.00 uur MT** | [Registreren](https://developerevents.adobe.com/events/details/adobe-developer-events-developer-experience-presents-adobe-developers-live-content-and-commerce/?code=release)
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2023 | [Inzichten met histogrammen ontgrendelen: boven de gemiddelden in Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/unlocking-insights-with-histograms.html?lang=en) | Video | Ontdek het effect van histogrammen in analyses op inzichten boven gemiddelden. Histogrammen tonen gegevenspatronen in het gedrag van de klant, de betrokkenheid van de bezoeker, technische prestaties, en vormfouten, toelatend diepere inzichten en geïnformeerde besluiten in de Werkruimte van de Adobe. |
| September 2023 | [Koppeling binnen of buiten uw project](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/linking-inside-or-outside-of-your-project.html) | Video | Leer hoe u interne of externe koppelingen maakt in uw [!UICONTROL Analysis Workspace] project. |
| September 2023 | [Afmetingen gebruiken in berekende metriek](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/calculated-metrics/using-dimensions-in-calculated-metrics.html) | Bijgewerkte video | Meer informatie over het gebruik van dimensies in [!UICONTROL calculated metric] bouwer. Ze kunnen aan elke [!UICONTROL calculated metric] formule om nieuwe metrisch aan een afmeting of afmetingswaarde te beperken. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2023 | [Het gegevenswoordenboek gebruiken](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/data-dictionary/use-data-dictionary.html) | Video | Meer informatie over de [!UICONTROL Data Dictionary] in Analysis Workspace for Customer Journey Analytics. |
...
Kijk naar de [Video over het overzicht van de release van augustus 2023](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/2023/2023-8-0.html) voor een overzicht van de functies die zijn toegevoegd in de release van 2023.08.0 (augustus 2023).

### [!DNL Experience Manager Sites] als [!DNL Cloud Service]

_Nieuwe functies_

* De [Console voor inhoudsfragment](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/managing.html?lang=en) Gebruikers kunnen nu tags weergeven en zoeken op tags die als metagegevens zijn toegepast op Inhoudsfragmenten. Gebruikers hoeven voor deze mogelijkheid niet meer over te schakelen op de gebruikersinterface Middelen, waardoor contextomschakeling wordt beperkt en de efficiëntie wordt verbeterd.
...
* **Bulkimportelementen uit gegevensbronnen** - Beheerders kunnen nu [veel elementen importeren](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/assets-view/bulk-import-assets-view.html?lang=en) van een gegevensbron naar AEM Assets. De beheerders hoeven geen afzonderlijke elementen of mappen meer te uploaden naar AEM Assets. Tot de ondersteunde gegevensbronnen voor bulkimport behoren Azure, AWS, Google Cloud en Dropbox.
* **Gereedschappen voor het bewerken van afbeeldingen aangedreven door Adobe Express** - Eenvoudig en intuïtief [gereedschappen voor het bewerken van afbeeldingen, aangedreven door Adobe Express](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/assets-view/edit-images-assets-view.html?lang=en) direct beschikbaar in AEM Assets om het hergebruik van inhoud te verhogen en de snelheid van inhoud te versnellen.
* **Flexibiliteit bij het vastzetten van items voor Mijn werkruimte Snelle toegang** - De mogelijkheid om items voor uw organisatie of voor een lijst met groepen te selecteren en vast te zetten, zodat deze worden weergegeven in het dialoogvenster [Sectie Snelle toegang van Mijn werkruimte](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/assets-view/my-workspace-assets-view.html?lang=en).

_Nieuwe functies in de beheerweergave_

* Beheerders kunnen nu [de batchgrootte van elementen configureren](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/search-assets.html?lang=en#configure-asset-batch-size) die worden weergegeven wanneer u een zoekopdracht uitvoert. De resultaten van het activaonderzoek tonen in veelvouden van het gevormde aantal van de partijgrootte wanneer u verder neer scrolt om de resultaten te laden. U kunt kiezen uit de beschikbare batchformaten van 200, 500 en 1000 elementen. Als u een lagere batch-grootte instelt, resulteert dit in snellere zoekresponstijden.
* Experience Manager Assets bevat nu een nieuwe versie 9 van het `damAssetLucene` index. `damAssetLucene-9` wijzigt het gedrag van het tellen van Oak Query-facetten in [niet langer het toegangsbeheer op factentellingen evalueren](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/search-assets.html?lang=en) wordt geretourneerd door de onderliggende zoekindex, wat resulteert in snellere zoekresponstijden.

_Nieuwe functies in prereleasekanaal_

* **Dynamic Media** - [Ondersteuning voor meerdere ondertitels en audiotracks in video&#39;s](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/dynamicmedia/video.html?lang=en#about-msma). In [!DNL Dynamic Media]kunt u nu eenvoudig meerdere ondertitels en meerdere audiotracks toevoegen aan een primaire video. Dit betekent dat uw video&#39;s toegankelijk zijn voor een breed publiek. U kunt één gepubliceerde primaire video aanpassen aan een wereldwijd publiek in meerdere talen en de richtlijnen voor toegankelijkheid voor verschillende geografische regio&#39;s naleven. Auteurs kunnen de ondertitels en audiotracks ook beheren vanaf één tabblad in de gebruikersinterface.
* **Activa** - Mogelijkheid om ZIP-archieven te selecteren die in Experience Manager worden beheerd en [bestanden rechtstreeks uitpakken in Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/manage-digital-assets.html?lang=en#extract-zip-archives) zonder ze te downloaden.

### [!DNL Experience Manager Forms] als [!DNL Cloud Service]

_Nieuwe functies_

* **[Google reCAPTCHA-bedrijfsondersteuning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-components-to-an-adaptive-form/captcha-adaptive-forms.html?lang=en)** - Gebruik Google reCAPTCHA Enterprise in een adaptieve vorm om een betere bescherming te bieden tegen frauduleuze activiteiten en spam, zodat de gebruiker veiliger wordt. Met een geavanceerde risicoanalyse en naadloze integratie kunnen echte gebruikers eenvoudig formulieren indienen terwijl de bots effectief worden geblokkeerd.

_Nieuwe functies in prereleasekanaal_

* **Adobe Analytics with Experience Cloud Setup Automation for Forms** - U kunt nu Adobe Analytics met de Automatisering van de Opstelling van het Experience Cloud met een omdraaiing van een paar knopen toelaten. Hiermee kunt u verbinding maken [!DNL AEM Forms as a Cloud Service] met Experience Platform-tags en Adobe Analytics om prestatiegegevens voor gepubliceerde formulieren vast te leggen en bij te houden.
* **Adobe Analytics-rapportsjabloon voor Adaptive Forms** - [!DNL Forms as a Cloud Service] bevat nu een Adobe Analytics-rapport dat niet meer beschikbaar is. Zo kunt u gemakkelijk de prestaties van uw formulieren begrijpen. De maatstaven op formulierniveau bieden u inzicht in hoe het formulier presteert met meerdere prestatie-indicatoren (KPI&#39;s), zoals uitvoeringen, bezoekers, verzendingen en gemiddelde vultijd. Door gebruikersgedrag en feedback te volgen, kunt u delen van het formulier identificeren die verwarring veroorzaken en verbeteringen aanbrengen in het ontwerp en de functionaliteit van het formulier.
* [[!UICONTROL Form Fragments] in [!UICONTROL Adaptive Forms] gebaseerd op kerncomponenten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/adaptive-form-fragments-core-components.html?lang=en) - Neem de afscheid van duplicatie, optimaliseer uw digitale inventaris en verbeter de samenwerking wanneer u uw ervaring met het maken van formulieren vergroot met [!UICONTROL Form Fragments]. Deze herbruikbare componenten integreren naadloos in meerdere formulieren, waardoor het maken van consistente en professioneel ogende formulieren wordt gestroomlijnd. [!UICONTROL Form Fragments] zorgen voor herbruikbaarheid, standaardisering en consistentie van merken via _één keer veranderen en overal spiegelen_ functionaliteit. Ervaar meer onderhoudsgemak en efficiëntie, aangezien updates die op één plaats worden gemaakt, automatisch worden verspreid over alle vormen die deze fragmenten gebruiken.
* [Verbeterde Acrobat Sign Workflow-stap](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=en#sign-document-step-sign-document-step) - de [!DNL Acrobat Sign] De stap van het werkschema wordt uitgebreid om het volgende te omvatten:

   * **Verificatie op basis van overheidsidentiteitskaart voor Acrobat Sign** - Verificatie op basis van Acrobat Sign-overheidsidentificatie biedt een extra verificatielaag door gebruikers in staat te stellen hun identiteit te verifiëren met behulp van door de overheid uitgegeven id&#39;s (rijbewijs, nationale id, paspoort). Door vertrouwde identificatiedocumenten te gebruiken, voegt deze verbetering een extra niveau van vertrouwen aan het ondertekeningsproces toe, die het ideaal maakt voor scenario&#39;s die verhoogde veiligheid, naleving, en gebruikersbevestiging vereisen.
   * **Audittrail voor Acrobat Sign-documenten** - Gebruik de functie Audittrail voor meer informatie over de levenscyclus van uw Acrobat Sign-documenten. Met het audittrail, kunt u een uitvoerig verslag van alle acties en interactie handhaven met betrekking tot uw documenten. Deze record bevat gegevens zoals wie het document heeft bekeken, bewerkt of ondertekend, en tijdstempels voor elke gebeurtenis. Deze recordverbetering is van cruciaal belang voor het handhaven van de naleving, het oplossen van geschillen en het waarborgen van de integriteit van uw digitale overeenkomsten.
   * **Nieuwe rollen voor ontvangers van de Overeenkomst voorbij enkel de Ondertekenaar** - Met Adobe Acrobat Sign kunt u nu de rollen voor overeenkomstontvangers uitbreiden naar een andere plaats dan alleen de ondertekenaar, zodat ze beter aansluiten op hun workflowvereisten. Wanneer toegelaten, heeft elke ontvanger in een Overeenkomst zijn rol individueel configureerbaar, met Ondertekenaar die het gebrek is.

* [Protect uw documenten met Document Assurance-API&#39;s (onderdeel van communicatie-API&#39;s)](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?lang=en#document-assurance-doc-assurance) - Met de API&#39;s voor documentverzekering kunt u gevoelige informatie beveiligen door de documenten te ondertekenen en te versleutelen. Door versleuteling wordt de inhoud van een document omgezet in een onleesbare indeling, zodat alleen geautoriseerde gebruikers toegang hebben. Deze versterkte beschermingslaag beschermt niet alleen waardevolle gegevens tegen ongeoorloofde ogen, maar zorgt ook voor gemoedsrust. Met de handtekening-API&#39;s kunt u de beveiliging en privacy van Adobe PDF-documenten die door uw organisatie worden gedistribueerd en ontvangen, beschermen. Deze service gebruikt digitale handtekeningen en certificering om ervoor te zorgen dat alleen de beoogde ontvangers documenten kunnen wijzigen.
...
* [Fout bij afhandeling van aangepaste fouthandlers in de regeleditor](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/add-custom-error-handler-adaptive-forms-core-components.html?lang=en) - U kunt nu een aangepaste functie aanroepen als reactie op een fout die door een externe service is geretourneerd, en eindgebruikers een op maat gemaakte reactie geven. Bijvoorbeeld, kunt u een douanewerkschema in de achtergrond voor specifieke foutencodes aanhalen of de klant informeren dat de dienst neer is.

### Forms-programma voor vroege adoptie zonder adapter

Gebruiken [Forms zonder hoofdadapter](https://experienceleague.adobe.com/docs/experience-manager-headless-adaptive-forms/using/overview.html?lang=en) om ontwikkelaars toe te staan om interactieve formulieren te maken, te publiceren en te beheren die via API&#39;s kunnen worden benaderd en waarmee interactie mogelijk is, in plaats van via een traditionele grafische gebruikersinterface. Met behulp van hoofdloze adaptieve formulieren kunt u:
...
U kunt [Stuur een e-mail naar aem-forms-headless@adobe.com](mailto:aem-forms-headless@adobe.com) van uw officiële e-mailadres om deel te nemen aan het vroege adoptieprogramma.

### [!DNL Experience Manager] als [!DNL Cloud Service Foundation]

* **CDN-logs** - Download CDN-logbestanden vanuit Cloud Manager. Dit is handig voor optimalisatie van de cache-raakverhouding en een betere zichtbaarheid in de leveringsstroom van de inhoud. Leer over het CDN logboekformaat. Deze functie is bedoeld voor de uitrol aan klanten begin september.
* **Voortijdig-adoptieprogramma voor CDN- en WAF-regels** - Het verkeer van de filter bij CDN die op wordt gebaseerd:
  ...
  Wilt u de functie proberen en feedback delen? Als u meer wilt weten over het programma voor vroege adoptie, stuurt u een e-mail naar [aemcs-waf-adopter@adobe.com](mailto:aemcs-waf-adopter@adobe.com) van uw officiële e-mailadres. De ruimte is beperkt.

  Meer informatie over de functie in het artikel [hier](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/security/cdn-and-waf-rules.html?lang=en).

### [!DNL Cloud Manager]

_Nieuwe functies_

* Wanneer u inhoud configureert die is ingesteld op [inhoud kopiëren, contextbewuste configuraties](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/configurations.html?lang=en) zijn nu toegestaan in inhoudssets in de gebruikersinterface.
...
_Programma voor vroegtijdige adoptie_
...
* **Self-Service inhoud herstellen** - [Een nieuwe functie voor het terugzetten van selfservice-inhoud](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/restore.html?lang=en) biedt nu back-upherstel voor maximaal zeven dagen en is beschikbaar voor vroege gebruikers voor evaluatiedoeleinden met:

   * Het herstel van de point-in-time back-up in de afgelopen 24 uur.
   * Herstel van vaste tijd tot zeven dagen.

  Als u deze nieuwe functie wilt testen en feedback wilt delen, stuurt u een e-mail naar [aemcs-restorefrombackup-adopter@adobe.com](mailto:aemcs-restorefrombackup-adopter@adobe.com) van uw e-mail die aan uw Adobe ID is gekoppeld. Let op het volgende:
...
* **Experience Audit Dashboard** - [Cloud Manager Experience Audit-dashboard](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/experience-audit-dashboard.html) bevat een trendweergave van de prestatiesscores van uw pagina, samen met inzichten en aanbevelingen om u te helpen deze te verbeteren. Experience Audit is opgenomen als een stap in de productiepijplijn van Cloud Manager.
  ...
  Geïnteresseerd in het testen van het nieuwe dashboard? Een e-mail verzenden naar [aem-lighthouse-pilot@adobe.com](mailto:aem-lighthouse-pilot@adobe.com) via je e-mail die aan je Adobe ID en Adobe is gekoppeld.

**Bugfixes**

* Het menu Omgevingen wordt nu gesloten nadat het [Inhoud kopiëren](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=en) modal.
* [Een wederuitvoering van de pijpleiding](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/deploy-code.html?lang=en#reexecute-deployment) is niet meer toegestaan als de vorige uitvoering geen commitId heeft die op de staat van de bouwstijlfase wordt geplaatst.
...
* De `contentSetName` de waarde ontbreekt niet meer in logbestanden en wordt nu in de invoer opgegeven wanneer een [inhoudskopie](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=en) -bewerking.
...
* Wanneer een certificaat verloopt, worden de domeinnamen en IP lijsten van gewenste personen verbonden aan het certificaat niet meer verwijderd uit CDN.
   ...
   * De [Gebruikersinterface van Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html?lang=en) bevat zichtbaardere waarschuwingen over het verlopen van het SSL-certificaat.
...
>[!IMPORTANT]
>
>Adobe beveelt aan [upgrade naar de nieuwste versie 1.9.12](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=en) van de Workfront for Experience Manager Enhanced connector.
...
* [AEM Gebruikers - Deel uw feedback op Gartner Peer Insights!](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-experience-manager-users-share-your-feedback-on-gartner/td-p/613702)
...
* [Huidige releaseopmerkingen voor as a Cloud Service Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=en)
* [Informatie over as a Cloud Service release van Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/home.html?lang=en)
...
* [Opmerkingen bij de release van Experience Manager Assets Dynamic Media](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/release-notes/s7rn2017.html?lang=en)
...
| Gepubliceerd | Toepassingen | Naam | Type | Beschrijving |
| ----------| ---------- | ---------- | ---------- |---------- |
| September 2023 | AEM Foundation | [Gebruik ModSecurity om uw AEM site te beschermen tegen DoS-aanvallen](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/modsecurity-crs-dos-attack-protection.html) | Video | Leer hoe te om ModSecurity toe te laten om uw plaats tegen Ontkenning van de aanvallen van de Dienst (Dos) te beschermen gebruikend de Reeks van de Regel van de Kern van de Veiligheid ModSecurity (CRS) op Adobe Experience Manager (AEM) Publish Dispatcher. |
| September 2023 | AEM Foundation | [De SSL-wizard in AEM gebruiken](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/use-the-ssl-wizard.html) | Video | Leer hoe u SSL in Adobe Experience Manager instelt om deze via HTTPS uit te voeren met behulp van de ingebouwde SSL-wizard. |
| September 2023 | AEM Forms | [Log de waarde van de variabelen in AEM workflow](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/variables-aem-workflow/part6.html%3Flang%3Dit) | Artikel | Log de waarde van AEM werkstroomvariabelen. Op deze manier kunnen ontwikkelaars bijhouden en begrijpen hoe een AEM werkstroom wordt uitgevoerd, problemen vaststellen en de gegevensstroom binnen een AEM werkstroom controleren. |
| September 2023 | AEM Forms | [Formulierverzendingen opslaan in Azure Storage](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/store-form-data-in-azure-storage.html?lang=en) | Video | Leer hoe u REST-oproepen kunt maken om verzonden AEM Forms-gegevens op te slaan in Azure Storage. |
| September 2023 | AEM CS | [Activa-share-commons-3.4.0](https://github.com/adobe/asset-share-commons/releases/tag/asset-share-commons-3.4.0) | Codevoorbeeld | Release van Asset Share Commons v3.4.0 reference Asset Share implementation with bug-fixes and vulnerability updates. |
| September 2023 | AEM Foundation | [Interne API&#39;s met persoonlijke certificaten aanroepen](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/security/call-internal-apis-having-private-certificate.html) | Artikel | Leer hoe te om vraag HTTPS van AEM aan Web APIs te maken gebruikend privé of zelf-ondertekende certificaten. |
| September 2023 | AEM Sites | [Lanceringen](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/launches.html) | Bijgewerkte video | [!UICONTROL Launches] in [!DNL AEM Sites] bieden een manier om inhoud te maken, te schrijven en te reviseren voor toekomstige release. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| Augustus 2023 | [Kan niet selecteren [!DNL Adobe Target] als Cloud-oplossing voor een [!DNL IMS] configuratie](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22693.html) | Nieuw artikel | Leer de oplossing om een fout terug te keren wanneer het proberen om tot een [!DNL Adobe Target IMS] te integreren configuratie [!DNL AEM] with [!DNL Adobe Target]. |
| Augustus 2023 | [[!DNL Adobe Experience Manager]: De zoekbalk inschakelen in Afbeelding van paginaminiatuur selecteren](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22690.html) | Nieuw artikel | Leer hoe u de zoekbalk kunt inschakelen in Afbeelding van paginaminiatuur selecteren. |
| Augustus 2023 | [[!DNL Adobe Experience Manager Forms]: How to change [!DNL JBoss®] logpad?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22689.html) | Nieuw artikel | Leer hoe u de [!DNL JBoss®] logpad ingeschakeld [!DNL AEM Forms] in een [!DNL Windows Server] milieu. |
| Augustus 2023 | [Inhoud niet gepubliceerd via Voorvertoning na verwijdering op auteur](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22685.html) | Nieuw artikel | Leer de tijdelijke oplossing tot wanneer een pagina die al eerder is gepubliceerd om voor te vertonen, wordt verwijderd zonder deze eerst uit de voorvertoning te deactiveren. De pagina wordt niet uit de voorvertoning verwijderd. |
| Augustus 2023 | [Miniatuur is zwart op geüploade MP4-video-elementen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22671.html) | Nieuw artikel | Leer de oplossing na het uploaden van MP4-bestanden. De gegenereerde miniaturen zijn zwart. |
| Augustus 2023 | [[!DNL GraphQL API] in [!DNL AEMaaCS] is niet uitbreidbaar](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22619.html) | Nieuw artikel | Meer informatie over de [!DNL GraphQL API] in [!DNL AEMaaCS] is niet uitbreidbaar. |
| Augustus 2023 | [[!DNL AEM GraphQL] configuratieproblemen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22615.html) | Nieuw artikel | Leer hoe de configuratie wanneer het ontwikkelen van een website die gegevens van zijn zou moeten terugwinnen [!DNL AEM] instanties gebruiken [!DNL AEM] eindeloze oplossing. |
| Augustus 2023 | [Geen productie-instantie in [!DNL New Relic]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22582.html) | Nieuw artikel | Leer de oplossing voor de productie-instantie die niet wordt weergegeven in de service voor toepassingscontrole *[!DNL New Relic]*. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2023 | [B2B-korting op verkoopprijsaanhalingstekst](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/b2b/b2b-quote/quote-line-item-notes.html?lang=en) | Video | Leer hoe u de notities voor regelitems gebruikt voor een Adobe Commerce B2B-aanhalingsteken. |
| September 2023 | [Live zoeken naar aanbevelingen](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/marketing/live-search-recommendations.html) | Video | Leer hoe u Live zoeken naar productaanbevelingen aan uw winkel kunt toevoegen en bijzonder aantrekkelijke, relevante en gepersonaliseerde winkelervaringen kunt maken. |
| September 2023 | [Augmented Reality Viewer voor Adobe Commerce](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/augmented-reality.html) | Video | Meer informatie over de Augmented Reality Viewing module beschikbaar op de Commerce Marketplace. |
| September 2023 | [Opties voor het importeren van een catalogus](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/catalog/catalog-import.html) | Video | Leer hoe u een aantal native opties gebruikt om uw catalogus te importeren in uw Adobe Commerce-winkel. |
| September 2023 | [Percona Toolkit pt-query-digest](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/backend-development/pt-query-digest.html) | Video | Leer waarom u de pt-vraag-samenvatting en sommige echte voorbeelden gebruikt helpen het redeneren verdiepen. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| Augustus 2023 | [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/support-tools/patches/patches-available-in-qpt-tool-overview.html) | Nieuwe artikelen | Nieuwe artikelen over het toepassen van patches in [!DNL QPT] 1.1.34. [!DNL QPT] 1.1.35 en [!DNL QPT] 1.1.36 werden gepubliceerd en zijn te vinden in de desbetreffende paragrafen. |
| Augustus 2023 | [[!DNL USPS Ground Advantage] hotfix voor verzendmethode [!DNL AC-9182]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/usps-ground-advantage-shipping-method-support-hotfix-for-ac-9182.html) | Nieuwe artikelen | Meer informatie over een patch om het probleem op te lossen [!DNL AC-9182] voor de nieuwe [!DNL USPS Ground Advantage] verzendmethode in Adobe Commerce 2.4.4 - 2.4.6-p2. |
| Augustus 2023 | [_[!DNL Error opensearch search engine doesn't exist. Falling back to livesearch.]_](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/error-opensearch-search-engine-doesnt-exist-falling-back-to-livesearch.html) | Nieuwe artikelen | Leer de oplossing voor de kwestie waar u de fout ziet: _[!DNL Error: opensearch search engine doesn't exist. Falling back to livesearch.]_in Adobe Commerce over cloudinfrastructuur waar [!DNL Live Search] wordt gebruikt. |
| Augustus 2023 | [[!DNL JQuery UI] security vulnerability [!DNL CVE-2022-31160] oplossing voor 2.4.4-, 2.4.5- en 2.4.6-releases](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/jquery-cve-2022-31160-fix-2.4.4-2.4.5-2.4.6.html) | Nieuwe artikelen | Meer informatie over een kwetsbaarheid op het gebied van beveiliging [!DNL CVE-2022-31160] gerapporteerd voor [!DNL jQuery-UI] bibliotheekversie 1.13.1 die wordt gebruikt als afhankelijkheid in Adobe Commerce 2.4.4, 2.4.5 en 2.4.6. |
| Augustus 2023 | [Verlagen verlopen _[!DNL oauth_tokens]_vóór upgrade naar 2.4.6](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/reduce-expired-oauth-tokens-before-2.4.6-upgrade.html) | Nieuwe artikelen | Meer informatie over een oplossing voor het probleem, waar u veel *[!DNL oauth_tokens]* in uw *[!DNL oauth_token]* tabel, die een lange vertraging kan veroorzaken bij de upgrade naar versie 2.4.6. |
| Augustus 2023 | [Implementatiefouten bij het uitvoeren van onjuiste bestanden](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/deployment/deployment-error-when-committing-incorrect-files.html) | Nieuwe artikelen | Leer de oplossing voor de kwestie wanneer het krijgen van plaatsingsfouten die door onjuiste begaat aan de bewaarplaats van dossiers/omslagen worden veroorzaakt die niet hadden moeten worden toegevoegd. |
| Augustus 2023 | [Adobe Commerce 2024-releaseplanning](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/2024-release-schedule.html) | Nieuwe artikelen | Meer informatie over onze bijgewerkte releasestrategie voor 2023 om het supportvenster uit te breiden, meer beveiligingsupdates te bieden en de acceptatie van innovatie te versnellen. |
| Augustus 2023 | [[!DNL Admin] aanmelden werkt niet - toegestane sessiegrootte is overschreden](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/admin-login-not-working-allowed-session-max-size-exceed.html) | Nieuwe artikelen | Leer de oplossing voor wanneer u aan login aan uw probeert [!DNL Admin] , maar het formulier wordt vernieuwd en u kunt zich niet aanmelden. |
...
* Nieuw! Campagne v8.5.2: [Opmerkingen bij de release](https://experienceleague.adobe.com/docs/campaign/campaign-v8/releases/release-notes.html?lang=en)
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Augustus 2023 | [[!DNL Error: "URL-140005 Unable to decode URLs of schema ' https'. Not implemented"]](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22594.html) | Nieuw artikel | Leer de oplossing om een fout te krijgen wanneer het registreren in een [!DNL ACC (Adobe Campaign Classic)] account. |
| Augustus 2023 | [[!DNL Adobe Campaign Classic: 'Feedback_loop_'] stuiteren voor mislukte e-mailleveringen](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22531.html) | Nieuw artikel | Leer de oplossing om [!DNL 'Feedback_loop_'] stuiteren voor mislukte e-mailleveringen. |
| Augustus 2023 | [Fout bij verzenden van leveringen naar ontvangers die zich niet in de database bevinden](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22570.html) | Nieuw artikel | Leer de tijdelijke oplossing voor het verzenden van leveringen naar Handmatige kopieën van ontvangers van databasemopnamen die niet in de database zijn opgeslagen ([!DNL DB]) via een extern bestand wordt een fout gegenereerd tijdens de voorbereiding van de levering. |
| Augustus 2023 | [Handmatige kopie van databasemopname](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22530.html) | Nieuw artikel | Leer hoe u een handmatige kopie van een databasemopname maakt. |
| Augustus 2023 | [Beheerders worden niet op de hoogte gesteld van fouten in [!DNL OOTB ffdaReplicateStagingData] werkstroom](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22525.html) | Nieuw artikel | Leer de oplossing aan wanneer als gebruiker Admin u niet wordt meegedeeld wanneer er fouten in zijn in [!DNL OOTB ffdaReplicateStagingData] workflow. |
| Augustus 2023 | [[!DNL Campaign Classic]: error enriching [!DNL BigQuery] data](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22687.html) | Nieuw artikel | Leer de oplossing aan wanneer u een werkschema creeert dat gegevens van een leest [!DNL BigQuery] dan een verrijkingsactiviteit toevoegen om de gegevens te verrijken met een [!DNL ACC] en het uitvoeren van de workflow een fout veroorzaakt. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2023 | [Nieuwe functies in Workfront-zelfstudies](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/home.html?lang=en#what%E2%80%99s-new%3F) | Meerdere video&#39;s | Bekijk de laatste zelfstudies die de afgelopen maand zijn gepubliceerd. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Augustus 2023 | [Kan geen nieuwe versie toevoegen aan een proefdruk](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22747.html) | Nieuw artikel | Leer de oplossing wanneer een fout voorkomt wanneer het proberen om een nieuwe versie van een proef aan een bestaand bewijs te uploaden. |
...
| Gepubliceerd | Toepassing | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |---------- |
| September 2023 | Acrobat Sign | [Documenten onderweg ondertekenen](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/mobile/mobile-tutorials/sign-mobile.html?lang=en) | Video | Leer hoe u documenten ondertekent met de mobiele Acrobat Sign-app voor iOS of Android™. |
| September 2023 | Acrobat Sign | [Microsoft® Dynamics 365 for Sales](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/dynamics-sales.html) | Video | Leer hoe Acrobat Sign en Microsoft® Dynamics 365 for Sales worden gebruikt om het ondertekeningsproces van verkoopprijsaanbiedingen te automatiseren. In dit voorbeeld helpt Microsoft® Dynamics 365 for Sales het verkoopteam bij [!DNL Contoso] om deals sneller af te sluiten en beter te profiteren van de mogelijkheden met één klantweergave en een geïntegreerd ondertekeningsproces. |
| September 2023 | Acrobat Sign | [Microsoft® Dynamics 365 for Field Service](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/microsoft/dynamics-field-service.html?lang=en) | Video | Leer hoe een de dienstverzender en technicus van de gebiedsdienst gebruiken [!DNL Acrobat Sign], [!DNL Power Automate], en [!DNL Dynamics 365] om servicecontracten in het veld te stroomlijnen. |
