...
| ----------| ---------- | ---------- |---------- |
| September 2025 | [ Federated Audience Composition tutorial ](https://experienceleague.adobe.com/nl/docs/platform-learn/engage-with-audiences-from-your-data-warehouse-using-fac/overview) | Video | Neem rechtstreeks vanuit het gegevenspakhuis contact op met het publiek via Federated Audience Composition (FAC). |
