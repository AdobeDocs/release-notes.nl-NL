...
# Vroege toegang - Opmerkingen bij de release van Adobe Experience Cloud - juni 2020
...
| -----------| ---------- | ---------- |
| [Inleiding tot Adobe Experience Platform](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2020.1) | Cursus | Leer hoe Adobe Experience Platform u de juiste ervaring biedt door uw gegevens om te zetten in robuuste realtime klantprofielen en door AI aangedreven inzichten die u in elk kanaal kunt activeren. Deze cursus op inleidend niveau geeft u een overzicht van de mogelijkheden van het Experience Platform, gebruiksgevallen, relatie met Adobe Experience Cloud, basisarchitectuur, interface, en projectrollen. |
...
Release Q2 is gepubliceerd. [Meer informatie](https://docs.adobe.com/content/help/nl-NL/journeys/using/release-notes/release-notes.html)
...
| Mogelijkheid om projecten te [!UICONTROL Workspace] bewerken | 18 juni 2020 | Ontvangers die aan de _[!UICONTROL Can Edit]_rol zijn toegevoegd, kunnen een project opslaan dat aan hen is gedeeld. Dit geldt zowel voor beheerders als niet-beheerders.[Meer informatie...](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/curate-share/share-projects.html) |
| Bijgewerkt leeg deelvenster in [!UICONTROL Workspace] | 18 juni 2020 | Het deelvenster Lege in bevat [!UICONTROL Workspace] nu deelvensters en visualisaties, zodat u een naadloze manier hebt om de analyseworkflow te kiezen die het beste voor u werkt. |
| Eerste-partijdomeinen beschikbaar in China RDC | 18 juni 2020 | Laat klanten met een `.cn` domein toe om een 1st-partijdomein voor gebruik binnen het Chinese vasteland aan te vragen. (Documentatie beschikbaar bij de aankoop van China Performance Optimization SKU.) |
| Deelvenster Snelle inzichten in [!UICONTROL Workspace] | 25 juni 2020 | Quick Insights biedt hulp aan niet-analisten en nieuwe gebruikers van [!UICONTROL Analysis Workspace] informatie over hoe u zakelijke vragen snel en eenvoudig kunt beantwoorden. [Meer informatie...](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/panels/quickinsight.html) |
...
### Nieuwe cursussen en zelfstudies in Experience Manager
