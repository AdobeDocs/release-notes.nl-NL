...
| Adobe Analytics | Video - [Kanaalkenmerk in CJA](https://docs.adobe.com/content/help/en/platform-learn/tutorials/cja/cross-channel-attribution-in-customer-journey-analytics.html) | Leer hoe u visualisaties kunt gebruiken om de attributie (creditering) te tonen over kanalen in [!UICONTROL Customer Journey Analytics]. |
...
| Adobe Analytics | Video - Je berekende cijfers [verplaatsen van Adobe Analytics naar Customer Journey Analytics](https://docs.adobe.com/content/help/en/platform-learn/tutorials/cja/moving-your-calculated-metrics-from-adobe-analytics-to-customer-journey-analytics.html) | Zoek naar tips voor het opnieuw maken van de [!UICONTROLCberekende Metriek] voor Analytics in [!UICONTROL Customer Journey Analytics]. |
