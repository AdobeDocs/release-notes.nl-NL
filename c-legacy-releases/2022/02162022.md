...
| -----------| ---------- | ---------- | ---------- |
| Februari 2022 | [Adobe Experience Cloud implementeren met Web SDK](https://experienceleague.adobe.com/docs/platform-learn/implement-web-sdk/overview.html) | Zelfstudie met meerdere pagina&#39;s | Leer hoe te om de toepassingen van het Experience Cloud uit te voeren gebruikend het Web SDK van Adobe Experience Platform. Deze zelfstudie laat u zien hoe u de SDK van het Web Platform implementeert met behulp van een voorbeeldwebsite die in de detailhandel wordt genoemd _Luminantie_. De [Luminantie](https://luma.enablementadobe.com/content/luma/us/en.html) site heeft een rijke gegevenslaag en functionaliteit waarmee u een realistische implementatie kunt maken. Ga nu aan de slag! |
...
* Adobe Analytics [releaseopmerkingen](https://experienceleague.adobe.com/docs/analytics/release-notes/latest.html) (**nieuwe locatie**)
...
* Customer Journey Analytics [releaseopmerkingen](https://experienceleague.adobe.com/docs/analytics-platform/using/releases/latest.html)  (**nieuwe locatie**)
...
Voor hulpmiddelen voor zelfhulp raadpleegt u [Documentatie en zelfstudies voor Audience Managers](https://experienceleague.adobe.com/docs/audience-manager.html) over Experience League
...
* **Experience Manager GEM&#39;s Webinar: _Sneller sites maken met Experience Manager Headless en App Builder_**
  ...
  **Luidspreker**: Duy Nguyen, Adobe Software Development Engineer
  [Registreer u voor de webinar op https://adobe.ly/3oCkEsh](https://adobe.ly/3oCkEsh)
...
| Februari 2022 | [Lettertypen insluiten in gegenereerde PDF](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/intellij-set-up.html#add-the-fonts-module) | Artikel | Leer hoe u kunt installeren [!DNL IntelliJ] communautaire editie. | AEM FORMS CS |
...
| Februari 2022 | [Migreren van oude AEM archetype](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/updating-project-archetype.html) | Video | Desc. | FORMS CS |
...
| Februari 2022 | [Workshop Adobe Commerce 2.4-upgrade](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/upgrade-workshop.html) | Video | Leer de stappen en beste praktijken om te volgen wanneer het voorbereidingen treffen voor uw volgende verbetering aan 2.4.4 of hoger. |
| Februari 2022 | [Het gereedschap Compatibiliteit bijwerken gebruiken op PHPStorm](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/uct-phpstorm.html) | Video | Leer hoe u de `PhpStorm` insteekmodule |
