...
Gebeurtenissen van het Experience League zijn een uitstekende plaats om te leren, interactie, en antwoorden van productdeskundigen bij Adobe te krijgen! Zie [Gebeurtenissen](https://experienceleague.adobe.com/events/) inzake Experience League dat voor juli 2022 moet worden bijgewerkt.

Bijgewerkt **10 augustus 2022**

| Gebeurtenis | Type | Beschrijving |
| -----------|---------- | ----|
| [Adobe Analytics](https://engage.adobe.com/NA_FY22_Q3_WBR_Adobe_Analytics_Data_Validation.html) | Webinar | _De successen van morgen voeden: kwaliteit en acceptatie van gegevens_ - Doe mee aan Adobe Analytics Champions Frederik Werner en Sarah Owen tijdens dit live webinar om te leren hoe u gegevenskwaliteit kunt bouwen in elk aspect van de analyse en een gedeelde cultuur rondom de analyse kunt creëren.<p>**Datum:** 25 augustus @ 11:00 uur ET - [Details en registratie](https://engage.adobe.com/NA_FY22_Q3_WBR_Adobe_Analytics_Data_Validation.html) |
...
Bijgewerkt: **2 augustus 2022** - Zie [Opmerkingen bij de release en logbestanden wijzigen](https://developer.adobe.com/client-sdks/documentation/release-notes/) voor de Adobe Experience Platform Mobile SDK&#39;s.
...
* [Video over de release van juni 2022](https://video.tv.adobe.com/v/344308/?quality=12)
...
* [Video overzicht release maart 2022](https://video.tv.adobe.com/v/341465)
...
* **Omzetten in PDF/A - Een stap voor workflow voor Experience Managers** - PDF/A is een archiefindeling voor langdurige bewaring van de inhoud van het document, alle lettertypen worden ingesloten en het bestand wordt niet gecomprimeerd. Nu kunt u met de stap Omzetten in PDF/A en AEM Workflow uw documenten of bestanden in elke indeling converteren naar PDF/A-indeling.

### Experience Manager as a Cloud Service Stichting

_Nieuwe functies_

* De [Browser voor opslagplaats](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/repository-browser.html) heeft nu een veld voor padinvoer, zodat u rechtstreeks naar een specifieke map in de hiërarchie van de opslagplaats kunt gaan
* SCD (Sling Content Distribution) ondersteunt nu een expliciete actie &#39;invalidatie&#39; om inhoud ongeldig te maken zonder dat die inhoud wordt gepubliceerd. Zie de [Caching in as a Cloud Service Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/caching.html#explicit-invalidation) voor meer informatie.
* `mod_macro` is nu beschikbaar in as a Cloud Service Experience Manager. [Zie deze tabel](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html) voor een lijst met ondersteunde Apache-modules.

_Verbeteringen voor Experience Manager as a Cloud Service SDK Dispatcher Tools_

* Apache kan worden gestart met `update_sdk.sh` script, dat automatisch alle volgende wijzigingen in de configuratie van Apache en Dispatcher laadt en valideert, waardoor de ontwikkelsnelheid wordt verbeterd. Alleen ondersteund voor de flexibele modus van Dispatcher-gereedschappen. Zie ook [Fouten opsporen in uw Apache- en Dispatcher-configuratie](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/validation-debug.html#automatic-loading) voor meer informatie over automatisch laden en valideren.
...
* as a Cloud Service Experience Manager is nu geïntegreerd met Verenigde Shell om de gebruikerservaring te verbeteren en het met alle andere toepassingen van het Experience Cloud te verenigen. Zie [Experience Manager as a Cloud Service op Verenigde Shell](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/overview/aem-cloud-service-on-unified-shell.html).
...
* Het pop-upmenu op het tabblad [Inhoud herstellen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/operations/backup.html) tabblad van de pagina met omgevingsdetails bevat nu een handige lijst met it-opdrachten waarmee de gebruiker wijzigingen lokaal kan bekijken.

### Adobe Learning Manager-connectors

_Nieuwe functie_

* De nieuwe Adobe Learning Manager heeft connectors naar Adobe Experience Manager Sites, Marketo Engage en Adobe Commerce. Zie de [Adobe Learning Manager-gebruikershandleiding](https://helpx.adobe.com/learning-manager/user-guide.html).
...
* [Opmerkingen bij de release Campagne v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/release-notes.html)
...
* [Release van regelpaneel juli](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html)
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Augustus 2022 | [Zelfstudies voor Marketo&#39;s Engage](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/overview.html) | Video&#39;s | Ga naar [Zelfstudie over Marketo Engage naar huis](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/overview.html) over Experience League voor alle vroegere en nieuwe zelfstudies voor Marketo Engage. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Augustus 2022 | [Workfront-zelfstudies](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/home.html) | Zelfstudie naar huis | Ga naar de nieuwe startpagina voor Workfront-zelfstudies over Experience League. |
...
| Augustus 2022 | [Workfront Proof - proefdrukken uploaden](https://experienceleague.adobe.com/?recommended=Workfront-U-1-2022.2.proof) | Cursus | Leer proefdrukken te uploaden voor revisie en goedkeuring. |
| Augustus 2022 | [Workfront Proof - Evaluatie en goedkeuring van werkzaamheden](https://experienceleague.adobe.com/?recommended=Workfront-L-1-2022.1.proof) | Cursus | Leer Workfront Proof te gebruiken als revisor of fiatteur. |
...
| Augustus 2022 | [Tussenfilters maken](https://experienceleague.adobe.com/?recommended=Workfront-U-1-2022.2.reporting) | Cursus | U krijgt meer inzicht in jokertekens, OF-filters en tekstmodus. Open ingebouwde project-, taak- en uitgiftefilters en bekijk de details van wat er echt aan de hand is. |
...
| Augustus 2022 | [Onlinebetalingen instellen](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/set-up-online-payments.html) | Video | Leer hoe u online betalingen in uw documenten instelt en accepteert. | Acrobat Sign |
