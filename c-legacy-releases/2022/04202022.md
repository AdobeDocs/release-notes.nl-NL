...
| april 2022 | [Een document wijzigen na verzending](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/modify-in-flight.html?lang=en) | Video | Leer hoe te om een document te wijzigen dat reeds verzonden voor handtekening-als is wanneer het verkeerde document door fout wordt verzonden. | Adobe Sign |
