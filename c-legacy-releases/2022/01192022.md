...
Afgelopen episodes zijn beschikbaar bij [ Levende Experience League ](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html).
...
Zie [ de versienota&#39;s van Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) om het recentste te lezen.
...
| Januari 2022 | [ vorm Attributie AI ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/intelligent-services/configure-attribution-ai.html) | Video | Leer hoe u een instantie van Attribution AI maakt om de impact van uw marketingkanalen en campagnes te begrijpen. |
...
Voor de recentste updates op de versies van AppMeasurement (Versie 2.22.4), gelieve te verwijzen naar [ AppMeasurement voor de versienota&#39;s van JavaScript ](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
* [ de Documentatie van het Product van Customer Journey Analytics ](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html)
...
| Januari 2022 | [ AEM Headless snelle opstelling voor AEM as a Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/quick-setup/cloud-service.html) | Video | Bekijk de AEM Headless Quick Setup. Het krijgt u hands-on met AEM Headless gebruikend inhoud van het WKND steekproefproject van de Plaats, en een steekproef React App (een KUUROORD) die de inhoud over AEM Headless GraphQL APIs verbruikt. | AEM as a Cloud Service |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [ de Zelfstudies van de Wolk van de Reclame ](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/intro.html) | Video&#39;s | Er zijn vijf nieuwe videozelfstudies beschikbaar over Advertising Cloud DSP. |
