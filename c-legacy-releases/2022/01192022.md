...
[Experience League LIVE](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) is een live streaming show die wordt gemaakt door het team van het Experience League. Het is een kans om contact te maken met Adobe-productexperts. Leer actiemotionele tips, trucs en strategieën die u kunt toepassen met de Adobe Experience Cloud-toepassingen.
...
Lees de [Opmerkingen bij de laatste release](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html) for [!DNL Adobe System Status].
...
| Januari 2022 | [Segmentvergelijking in Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-comparison-in-analysis-workspace.html) | Bijgewerkte video | Leer hoe Segment IQ, een onderdeel van Analysis Workspace in Adobe Analytics, analyses vereenvoudigt door twee Analytics-segmenten te bekijken in al uw dimensies en metriek om automatisch de meest statistisch significante verschillen te ontdekken. |
...
* [Customer Journey Analytics Productdocumentatie](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html)
...
| Januari 2022 | [Geavanceerde netwerken](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/advanced-networking.html) | Video (meerdere) | Leer hoe AEM as a Cloud Service drie opties biedt voor het beheren van connectiviteit met externe services: Flexibele havenuitgang, specifiek uitgang IP adres, en virtueel privé netwerk. Een programma van de Manager van de Wolk en milieu&#39;s in AEM as a Cloud Service kunnen slechts één enkel type van geavanceerde voorzien van een netwerkconfiguratie tegelijkertijd gebruiken. | AEM as a Cloud Service |
...
## Hulplijnen Experience Manager {#xml-doc}
...
* Voor actuele releasegegevens raadpleegt u [Opmerkingen bij de doelversie](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html).
