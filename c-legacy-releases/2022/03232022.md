...
| -----------| ---------- | ---------- | ---------- |
| Maart 2022 | [ voer Adobe Experience Cloud in mobiele apps leerprogramma uit ](https://experienceleague.adobe.com/docs/platform-learn/implement-mobile-sdk/overview.html) | Cursus | Leer hoe u Adobe Experience Cloud-toepassingen implementeert in uw mobiele app met de Adobe Experience Platform Mobile SDK. |
...
| Maart 2022 | [ vorm gegevensstromen ](https://experienceleague.adobe.com/docs/platform-learn/data-collection/edge-network/configure-datastreams.html) | Video | Leer hoe te om gegevensstromen voor de implementaties van SDK van het Web en van de Mobiele te creëren en te vormen. |
...
Releasedatum: **donderdag 23 maart 2022**
...
* **Experience Manager GEMs Webinar: _bouwt Vager Plaatsen met Experience Manager Headless en App Builder_**
   ...
   * Heb je Adobe Summit 2022 bij het openen van het keynote gemist? Controle [ maakt de Digitale Economie Persoonlijk ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2022-opening-keynote-make-the-digital-economy/td-p/444612).
   * Adobe Summit 2022 | [ Volledige lijst van de Zitting van de Experience Manager ](https://adobe.ly/3rti6gF).
...
| -----------| ---------- | ---------- | ---------- | ------|
| Maart 2022 | [ begin het ontwikkelen met AEM Zwaartepunt ](https://experienceleague.adobe.com/landing/experience-manager/headless/developer.html?lang=nl) | Cursus | Maak AEM openingspagina zonder kop die alle inhoud op AEM headless in ExL samenvoegt. | AEM zonder kop |
...
| Maart 2022 | [ Workfront voor Experience Manager verbeterde schakelaarDeskundige Reeks ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/aem-experts-series/overview.html) | Video | Deelnemen aan deze videoreeks met vier delen aan de Workfront- en Experience Manager Assets-experts van Adobe, waar ze de in- en uitgangen van de Workfront for Experience Manager Enhanced-connector demonstreren en bespreken. | AEM Assets, Workfront |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Maart 2022 | [ hoe te om een standaardvertoningsplaatsing ](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/dsp/placement-create.html) te creëren | Video | Leer hoe u een standaardplaatsing voor een Advertising Cloud DSP-campagne kunt maken. |
