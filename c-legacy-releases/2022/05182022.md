...
* [[!DNL Experience League]  gebeurtenissen ](#events) (Bijgewerkte **27 mei**)
...
Bijgewerkt: **zaterdag 27 mei 2022**

| Gebeurtenis | Type | Beschrijving |
| -----------|---------- | ----|
| [ Van de Ervaring het Forum van de Regering van Makers ](https://adobegovforum.govexec.com/agenda/) | Video op aanvraag | Het 13e jaarlijkse AEMGF op 10 mei was een succes, met een combinatie van virtuele en persoonlijke deelnemers. De montages en de brainstormzittingen concentreerden zich op het thema van _Digitale Ervaringen die Mensen eerst_ zetten. De hoogste zittingen omvatten _Manhunters: Hoe wij Pablo Escobar_, _de Toekomst van CX_, en _de Gouden Leeftijd van Creativiteit en de Moderne Werkplaats_ namen. |
| [ Vraag de deskundigen: De grondbeginselen van Web SDK ](https://www.youtube.com/watch?v=g0KajUfq-S4) | Webinar | Tips en trucs voor het verzamelen van gegevens. <br>[ Programma &amp; voorbije gebeurtenissen ](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) |
| [ Gemeenschap van Adobe Target ](https://experienceleaguecommunities.adobe.com/t5/adobe-target-discussions/at-community-q-amp-a-coffee-break-4-27-22-8am-pt-jim-mctiernan/m-p/446940#M3096) | Koffie-einde &amp;vragen | Sluit u aan bij Brent Kostak en Drew Burns van het Adobe Target-productteam, die uw Adobe Target-vragen kunnen beantwoorden over gedeeld publiek, Real-Time CDP, gegevens van de eerste partij, complete workflows voor personalisatie en nog veel meer.<br> bekijk recente [ Echte - tijd Personalization webinar ](https://experienceleaguecommunities.adobe.com:443/t5/adobe-target-discussions/webinar-recording-4-28-22-real-time-personalization-with-adobe/td-p/449012) en breng uw follow-up Vragen aan de deskundigen op de [ draad van de Break van de Koffie ](https://adobe.ly/3MyiDHa) in de Gemeenschap van Adobe Target!<br>**Datum:** mei 25, 2022 @ 8 a.m. PDT <br>[ Details en registratie ](https://adobe.ly/3MyiDHa) |
...
| [ Uitwisseling van de Vaardigheid van Marketo ](https://experienceleague.adobe.com/docs/skill-exchange-events/events/marketo/aug2021/marketo-roadmap.html) | Video&#39;s op aanvraag | Lees meer over het belang van je Marketo-routekaart en hoe je slechte planning kunt voorkomen. Krijg advies over het ontsluiten van het potentieel van de Gebieden van de Douane van het Lid van het Programma, uiteinden en trucs van het Marketo Engage, en veel meer in de [!DNL Marketo] Uitwisseling van de Vaardigheid van Augustus 2021, nu op Experience League. |
...
| -----------| ---------- | ---------- | ---------- |
| Mei 2022 | [ worden begonnen met Report Builder ](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/get-started-with-report-builder.html) | Video | Leer de grondbeginselen van het gebruik van Report Builder, met inbegrip van installatie, login, en gegevensverzoeken. |
...
| Mei 2022 | [!UICONTROL Report Builder] Geavanceerde leveringsopties van het 0} Gebruik voor Power BI ](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/use-report-builder-advanced-delivery-options-for-power-bi.html)[ | Video | Leer hoe te opstelling een geavanceerd programma om een werkboek van de Report Builder naar Power BI te verzenden. |
| Mei 2022 | [ Plan een Report Builder verzoek ](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/report-builder/schedule-a-report-builder-request.html) | Video | Leer hoe te opstelling een basisprogramma voor een werkboek van de Report Builder. |
...
* **Experience Manager Sites as a Cloud Service**
   ...
   * U kunt inhoudsmodelgegevenstypes nu bepalen als [ vertaalbaar ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/content-fragments/content-fragments-models.html#properties) gebruikend checkbox in de redacteur van het inhoudsmodel. Ook, worden de de vertaalregels en configuraties van de Experience Manager automatisch bijgewerkt.

  _Nieuwe eigenschap in prereleasekanaal_

   * Publish Experience Fragments to Preview - Voor een voorvertoning van de laatste ervaringen die uw bezoekers kunnen zien, kunt u standalone Experience Fragments publiceren naar Experience Manager as a Cloud Service Preview Service.
...
* **Experience Manager Forms as a Cloud Service**
   ...
   * **Mededelingen - de steun van APIs van de Manipulatie van het Document in Forms as a Cloud Service SDK** - [ de Manipulatie APIs van het Document ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications.html) helpen om, PDF documenten te combineren te herschikken en te bevestigen. U kunt nu communicatie - API&#39;s voor documentgeneratie gebruiken in een lokale ontwikkelomgeving met behulp van Experience Manager Forms as a Cloud Service SDK.
...
* **as a Cloud Service Experience Managers Screens**
...
* **Experience Manager as a Cloud Service Stichting**
  ...
  De as a Cloud Service SDK van de Experience Manager bouwt Analyzer Geweven Insteekmodule ontdekt problemen in een bepaald project, met inbegrip van ontbrekende gebiedsdelen. Het biedt ontwikkelaars de mogelijkheid om problemen tijdens lokale ontwikkeling te ontdekken, ruim voordat ze met Cloud Manager naar Cloud-omgevingen implementeren.
...
* **Analyzer van Beste praktijken**
   ...
   * Mogelijkheid om het gebruik van sjablonen voor inhoudsfragmenten te detecteren. Inhoudsfragmentsjablonen worden niet meer ondersteund voor het maken van nieuwe inhoudsfragmenten op Experience Manager as a Cloud Service. Klanten moeten modellen van inhoudsfragmenten maken om sjablonen voor inhoudsfragmenten te vervangen.
   * Mogelijkheid om activa met meer dan 100 afstammingen onder het metadatknooppunt van het actief in de repository te detecteren. De Adobe raadt u aan om metagegevensknooppunten te verwijderen die u niet nodig hebt, zodat u de prestaties kunt verbeteren wanneer u mappen laadt die uit dergelijke elementen bestaan.
...
* **Opgenomen Experience Manager GEMs Webinar**
   ...
   * [_integreer AEM &amp; CIF kader om een rijke en immersive e-commerceervaring_ te bouwen ](https://adobe.ly/3jorz5r).
...
| Mei 2022 | [ Beelden met AEM Zwaartepunt ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/how-to/images.html) | Video | Leer hoe u een rijke, aantrekkelijke AEM headless ervaring kunt ontwikkelen met afbeeldingen en nog veel meer. | AEM zonder kop |
| Mei 2022 | [ Rijke tekst met AEM Zwaartepunt ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/how-to/localized-content.html) | Video | Leer hoe u het tekstveld Meerdere regels gebruikt, een gegevenstype van Content Fragments waarmee auteurs RTF-inhoud kunnen maken. | AEM zonder kop |
...
Experience Manager Guides (voorheen XML Documentation for Experience Manager) is een toepassing die op AEM wordt geïmplementeerd. Het is een krachtige oplossing voor componentcontentbeheer op bedrijfsniveau (CCMS) die native DITA-ondersteuning in Adobe Experience Manager mogelijk maakt en AEM in staat stelt om op DITA gebaseerde content creation en delivery af te handelen.
...
**Latest versie:** [ versie 22.2 van het Campaign Standard ](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/e-release-notes.html) (Juni 2022)
...
| ------- | ----------- |
| [!UICONTROL Custom Reports] | (31 mei; bèta-functie) Advertising Cloud DSP kan nu eerste-partijsegmenten opnemen die bestaan uit geverifieerde signalen die zijn ingebouwd in een CDP (Customer Data Platform). |
