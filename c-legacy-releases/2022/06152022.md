...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juni 2022 | [&#x200B; Begonnen het worden met MBI &#x200B;](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/mbi/webinars/getting-started.html?lang=nl-NL) | Video | Leer rechtstreeks van het Commerce-productteam over de kernfunctionaliteit van MBI, met een diepe duik in vooraf geconfigureerde dashboards en aanpassingsopties. |
