...
| Juni 2022 | [&#x200B; de verwezenlijking van Verbindingen en geeft ervaring uit &#x200B;](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections/cja-connections-creation-and-edit-experience.html?lang=nl-NL) | Video | Leer hoe te om het rollen venster van het gegevensbehoud toe te laten, om backfill gegevens toe te laten en te verzoeken die op gebeurtenissen timestamp worden gebaseerd, en bestaande gegevens door dataset in te voeren. |
...
* [[!DNL Experience Manager Guides] &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/overview.html?lang=nl-NL) - zelfstudies over Experience League
