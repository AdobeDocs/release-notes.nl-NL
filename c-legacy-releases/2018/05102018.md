...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 
   &gt;[!BELANGRIJK] &gt;Nu GDPR op 25 mei 2018 in werking treedt, zal Adobe <b>automatische verwijdering van bestanden die in FTP-accounts overblijven die worden beheerd door Data Connector (voorheen Genesis)-partners implementeren.</b> (Dit geldt NIET voor alle FTP-accounts die eigendom zijn van klanten van Analytics.) Momenteel worden gegevens in FTP-mappen voor onbepaalde tijd bewaard, waardoor bedrijven het risico lopen niet klaar te zijn voor GDPR. Vanaf 25 mei 2018 verwijdert Adobe alle bestanden op door de partner beheerde FTP-servers van de Data Connector 30 dagen na hun aankomst op de server.
   </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr.html" format="html" scope="external">  <span class="wintitle"> Auditiebeheer </span> en GDPR </a> </p> </td> 
   <td colname="col2"> <p>Hoe te om GDPR- verzoeken aan de Manager van het <span class="wintitle"> Publiek voor te leggen </span>, en antwoorden op gemeenschappelijke vragen over hoe de Manager van het Publiek GDPR vereisten behandelt. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.campaign.adobe.com/doc/standard/getting_started/en/ACS_GDPR.html" format="html" scope="external"> Campagne </a> </p> </td> 
   <td colname="col2"> <p>Meer informatie over de nieuwe functionaliteit in Adobe Campaign for GDPR. </p> </td> 
  </tr> 
 </tbody> 
</table>

De nota&#39;s van de versie voor de interface van de kerndiensten, met inbegrip van [!UICONTROL Activa], [!UICONTROL Diervoeders], [!UICONTROL Meldingen], Mensen, de [!UICONTROL Mobiele] Diensten, Lancering, en Dynamisch Beheer van de Markering. Bevat ook releasegegevens voor Experience Cloud ID Service (voorheen bekend als *`Visitor ID service`* en *`Visitor API`* in Analytics, en *`Marketing Cloud ID service`*).
...
<table id="table_FC7B5C6C59BD45238220D606D7BFC0A1"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Wanneer u zich aanmeldt bij de Experience Cloud en naar de pagina Administration navigeert, is er een nieuwe intuïtieve interface beschikbaar waarmee u snel toegang krijgt tot uw Experience Cloud-oplossingen en Core Services. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Met Advertising Analytics kunt u gegevens van uw zoekprogramma's doorgeven aan Adobe Analytics van Google AdWords, Yahoo! en Bing. </p> <p>U hebt de volgende metriek beschikbaar om naast het melden met de rest gegevens van Analytics te doen: </p> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/aha2aw/" format="https" scope="external"> Ad hoc-analyseproject converteren </a> </p> </td> 
   <td colname="col2"> <p>De Ad hoc Convertor van het Project van de Analyse zet uw Ad hoc projecten in de Werkruimte van de <span class="uicontrol"> Analyse </span>, met de klik van knoop om. </p> <p>De gekopieerde projecten kunnen dan worden gebruikt, worden gewijzigd, en worden gepland zoals nodig in de Werkruimte <span class="uicontrol"> van de</span>Analyse. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="https://powerbi.microsoft.com/en-us/blog/power-bi-desktop-april-2018-feature-summary/" format="https" scope="external"> Adobe Analytics Connector </a> (in het Microsoft Power BI-bureaublad) </p> </td> 
   <td colname="col2"> <p>De Adobe Analytics Connector is beschikbaar als een native gegevensconnector in de Power BI-bureaubladervaring. Wanneer u de app start, kunt u de verificatie uitvoeren met uw bestaande Adobe-id. U kunt tot een makkelijk te gebruiken navigator aan de gegevenselementen van de rapportreeks toegang hebben en gegevensverzoeken bouwen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> Verbeteringen van de </span> analysewerkruimte </p> </td> 
   <td colname="col2"> 
    <ul id="ul_40C583EE96F146DAB1978EF7A1F15116"> 
     <li id="li_773940B3D52F4442B37CC7A7D731B797"><b>Tips van de dag</b>: Tips worden regelmatig gegenereerd en worden (samen met een korte video) weergegeven in de rechterbenedenhoek van de interface. Ze zijn bedoeld om u vertrouwd te maken met de functies [!UICONTROL Analysis Workspace]. U kunt Tips negeren door op de X dicht bij de tip te klikken of door op <span class="uicontrol"> Help </span> &gt; Tip van de dag <span class="uicontrol"> uitschakelen te klikken </span>. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Geplande release van kracht op 15 mei 2018</b> </p> <p> <span class="term"> mc_audiences is </span> kolom toegevoegd. <span class="term"> mc_audiences </span> is de het segmentIdentiteitslijst van de Analyse van het Publiek van de Manager van de <span class="wintitle"> Publiek van Adobe </span>. </p> <p>Opmerking:  Dit omvat geen vriendelijke namen omdat het een classificatie van identiteitskaart is. </p> 
    <!--<p>https://jira.corp.adobe.com/browse/AN-154807</p>--> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Landen rapporteren in ad-hocanalyse </p> </td> 
   <td colname="col2"> <p>Het landenrapport in ad hoc analyse is omgedoopt tot landen/regio's. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">Probleem verholpen die optrad bij het openen van de Berekende metrische bouwer van [!UICONTROL-analysewerkruimte]. Hierdoor werden in de vervolgkeuzelijst Functie geen opties weergegeven. (AN-160698) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      ...
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">Probleem verholpen dat optrad wanneer u zich aanmeldt bij Analytics via de Experience Cloud: wanneer meerdere aanmeldbedrijven aan een gebruikersnaam waren gekoppeld, werd soms een onjuist aanmeldingsbedrijf geselecteerd. (AN-160880) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>We hebben DIL versie 7.0 uitgebracht, die de volgende upgrades en oplossingen bevat: </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      <li id="li_FDBFB52DA5214B50B3D77482925B8FA4">Probleem verholpen met een zeldzame situatie in Launch met de <a href="https://marketing.adobe.com/resources/help/en_US/aam/r_dil_sc_init.html" format="html" scope="external"> DIL SiteCatalyst-module </a>. (CORE-10266) </li> 
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">Geïmplementeerde UX-revisies van de DIL Launch-extensie. (CORE-8143) </li> 
     </ul> </p> <p>Neem contact op met uw Adobe-consultant of de klantenservice voor de nieuwste versie, of krijg deze via <a href="https://marketing.adobe.com/resources/help/en_US/dtm/c_overview.html" format="https" scope="external"> Digital Tag Management (DTM) </a> of <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/t_quick-start.html" format="https" scope="external"> Adobe Launch </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>GDPR gereedheid </p> </td> 
   <td colname="col2"> <p>Op de 25 mei 2018, de datum waarop de Europese verordening inzake algemene gegevensbescherming (GDPR) in werking treedt, hebben we documentatie opgesteld om u te helpen bij het beheer van consumentengegevens in <span class="wintitle"> Audience Manager </span> om aan de GDPR-verplichtingen te voldoen. Lees verder: </p> <p> 
...
* Probleem verholpen waarbij klanten geen lijst met alle kenmerken konden ophalen via API-aanroepen. (AM-36824)
* Probleem verholpen in de codeweergave [Segment Builder](https://marketing.adobe.com/resources/help/en_US/aam/c_segment_builder.html) , waarbij expressies met ronde haakjes de ronde haakjes zouden neerzetten als klanten het segment opnieuw zouden bewerken. (AM-36393)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Meer informatie over de voordelen van de herstructurering van de <a href="https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/repository-restructuring-in-aem64.html" format="https" scope="external"> AEM 6.4-opslagplaats voor het vereenvoudigen van uw AEM-upgradeervaring </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p>Referentiemateriaal voor AEM-ontwikkelaars </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>De jaarlijkse virtuele algemene conferentie biedt diepgaande sessies voor bedrijfsontwikkelaars, architecten en wetenschappers op alle ervaringsniveaus. Er worden live sessies gehouden in de tijdzones India Standard, British Summer en Pacific. Tickethouders hebben ook gedurende één jaar onbeperkte toegang tot alle opnamen. </p> <p>Adobe IMMERSE is de jaarlijkse virtuele algemene conferentie voor elke ontwikkelaar die oplossingen ontwikkelt voor Adobe Experience Manager. Dit jaar hebben we ook extra sessies op Adobe Cloud Platform, Adobe I/O, Adobe Sensei, ColdFusion en FrameMaker. </p> <p>Ontdek diepgaande productreleinleidingen, 'hoe kan ik'-recepten, best practices en codevoorbeelden van experts in Adobe en de ontwikkelaarscommunity. Live sessies worden uitgezonden over drie tijdzones: </p> <p> 
     ...
     </ul> </p> <p>Bekijk de agenda en registreer vervolgens de kortingscode <b>MR.765z</b> voor een USD korting van 25,00: <a href="https://adobe.ly/immerse18" format="https" scope="external"> https://adobe.ly/immerse18 </a>. Mis niet over op de grootste conferentie voor ontwikkelaars die door Adobe wordt gehost! </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM Technologist Meeting Group </p> </td> 
   <td colname="col3"> <p>Deze virtuele groep biedt u meldingen voor AEM GEM's, Vraag het aan de AEM Community Expert-webinars zodra deze gepland zijn. U wordt ook op de hoogte gebracht van persoonlijke gebeurtenissen en regionale vergaderingen van gebruikersgroepen. </p> <p> Sluit zich aan bij het volgende: https://adobe.ly/2sVoSwy <a href="https://adobe.ly/2sVoSwy" format="https" scope="external"></a> </p> </td> 
  </tr> 
  <tr> 
