...
* Toegevoegde Auditor-kaart in de activeringsgebruikersinterface voor de geleverde gebruikers. (CORE-3667) Zie [Experience Cloud Product Documentation](https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html) voor producthulp.
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Het Ontmantelen van <span class="wintitle"> Doel </span> werkschema's in de <span class="uicontrol"> Mobiele </span> Diensten </p> </td> 
     <td colname="col2"> <p> Vanaf maart 2018 is, als onderdeel van het uitschakelen van de Adobe <span class="wintitle"> Target- </span> workflows in Adobe <span class="uicontrol"> Mobile </span> Services, de mogelijkheid om nieuwe doelen/activiteiten, doelgroepen/doelgroepen en doel/inhoud te maken uitgeschakeld in deze release. </p> <p> U kunt de bestaande activiteiten, soorten publiek en inhoud tot maart 2018 blijven weergeven, wijzigen en verwijderen. </p> <p>Voor meer informatie, zie de Werkschema's van het Doel van de Ontmanteling in de Mobiele Diensten <a href="https://docs.adobe.com/content/help/en/mobile-services/using/home.htmlc_mob_remove-target-faqs.html" format="html" scope="external"> </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Aangepaste werkruimtesjablonen </p> </td> 
   <td colname="col2"> <p>U kunt nu uw eigen werkruimtesjablonen maken en deze opslaan zodat andere gebruikers in uw organisatie kunnen beginnen met gegevens die voor hen van belang zijn. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/starter_projects.html" format="html" scope="external"> Meer... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Nieuwe projectlanceringsmodaal </p> </td> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Klikken met rechtermuisknop op ondersteuning voor kopiëren </p> </td> 
   <td colname="col2"> <p>We hebben een klik toegevoegd met de rechtermuisknop op de optie 'Kopiëren naar klembord', zodat u cellen/tabellen consistent kunt kopiëren. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> Meer... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Verbetering voor kolom % </p> </td> 
   <td colname="col2"> <p>Het in kolommen weergegeven "percentage van het totaal" is beperkt tot 100%, zelfs als bepaalde scenario's ertoe leiden dat rijen meer dan 100% van het totaal bedragen (bijvoorbeeld met gemiddelden). </p> <p>We laten nu percentages zien die hoger zijn dan 100 procent, om nauwkeuriger te zijn. We verplaatsen het bovenste gebonden plafond ook naar 1000% om ervoor te zorgen dat kolommen te groot kunnen worden. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/column-settings.html" format="html" scope="external"> Meer... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Voorwaardelijke opmaak ingeschakeld voor onderverdelingen </p> </td> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Wijzigingen in de standaardkalenderweergave </p> </td> 
   <td colname="col2"> <p>De werkruimtekalender wordt nu standaard de huidige maand en vorige maand weergegeven in plaats van de huidige maand en volgende maand. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/calendar.html" format="html" scope="external"> Meer... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Verbeterde lever-/selectiekleuren in Workspace-tabellen </p> </td> 
   <td colname="col2"> <p>Het verschil in kleuren wanneer u de muisaanwijzer boven een cel van een Freeform houdt en wanneer u op een cel klikt, is duidelijker. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F22339DDE4C475F89B53D0E6FF33183"> 
      ...
      <li id="li_7AB00F90761A49C8B3C02E30494622D1">Probleem verholpen waarbij het klikken van een Gedeelde verbinding van het Project de gebruiker aan de [!UICONTROL Werkruimte van de Analyse] overzichtspagina in plaats van aan het gedeelde project nam. (AN-152917) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_70C87228892242C99129CF1625A88B24"> <b>Waarschuwingen</b>: Probleem verholpen dat optrad bij het selecteren van een regelitem <span class="wintitle"> Geen </span> in [!UICONTROL-analysewerkruimte] en met de rechtermuisknop klikken op ‘Berichtgeving maken van selectie’. De waarschuwingsBuilder bevatte alleen "Niet opgegeven" als een optie, maar niet "Geen". Als u doorgaat, verschijnt "Unspecified" in [!UICONTROL-analysewerkruimte]. (AN-146879) </li> 
      <li id="li_A4AA1A05384D45A5878C543BE753BAAC"> <b>Admin (Machtigingen)</b>: Probleem met machtigingen verholpen waarbij gebruikers zich niet konden aanmelden bij ad-hocanalyse via de Marketing Cloud. (AN-156033) </li> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Gebruikersbeheer in de beheerconsole </p> </td> 
   <td colname="col2"> <p> <b>Hulpprogramma voor migratie van gebruikers-id</b> </p> <p>Met de migratie van gebruikers-id's voor Analytics kunnen beheerders eenvoudig gebruikersaccounts migreren van Analytics User Management naar Adobe Admin Console. Nadat uw gebruikers zijn gemigreerd, hebben ze toegang tot de oplossingen en kernservices die beschikbaar zijn in de Experience Cloud. De migratie wordt aan klanten in fasen opgestart die later deze maand beginnen. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/" format="https" scope="external"> Meer informatie over de migratie van gebruikers-id's voor Analytics </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* We hebben de laadtijd in de gebruikersinterface verbeterd bij het zoeken naar mogelijkheden voor bedrijven met duizenden kenmerken. (AM-34254)
...
* Oplossing voor een bug in Internet Explorer 11 waarbij klanten geen nieuwe segmenttestgroepen konden maken in Audience Lab omdat de knop **[!UICONTROL Volgende]** ontbrak. (AM-34503)
* Probleem verholpen waarbij de instellingen voor recentie en frequentie werden genegeerd toen er geen recentie was gedefinieerd. (AM-34115)
* Probleem verholpen waarbij een onjuist foutbericht zou worden weergegeven als een klant een segment zonder integratiecode aan een automatisch te vullen bestemming met meerdere sleutels probeerde toe te wijzen. De tweede toewijzingswaarde zou zijn uitgeschakeld en verhinderen dat de gebruiker het segment kan toewijzen. (AM-33765)
* Probleem verholpen met foutsampling voor gegevensbronnen. Hoewel gebruikers op het selectievakje voor foutsampling zouden klikken, zou foutsampling niet werken vanwege een onjuiste API-aanvraag die de interface verzendt. (AM-34516)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>De <a href="https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/querybuilder-predicate-reference.html" format="https" scope="external"> documentatie van de Verwijzing van de Vraag van AEM Builder </a> is nu beschikbaar. De documentatie behandelt alle ingebouwde productvoorspellingen. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Adobe IMMERSE'18 komt voor 12-14 juni 2018 in IST, BST, en PDT met 8 zittingen elke dag. </p> <p>De deadline van de oproep tot het indienen van presentaties is verlengd tot maandag 5 februari 2018, einde-dag. 
     <ul id="ul_F57E78C4746D42AD98330498F3A01DA0"> 
      <li id="li_01D4D267E35148068613B42FB25BD31E"> <a href="https://immerse18.adobe-devs.adobeevents.com/speaker-application/" format="https" scope="external"> Oproep tot het indienen van presentatiegegevens en het indieningsformulier </a></li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>U kunt nu alle webinars voor bedrijfsontwikkelaars vinden op het AEM HelpX Forum. Markeer de volgende koppelingen als bladwijzer: </p> <p> 
     <ul id="ul_10C986E4FC2F417C9AEA1DA6E0E4CA91"> 
      ...
      <li id="li_82D67EBD4DF74A86A14E97BE98BBB558"> <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html" format="https" scope="external"> Vraag de Communautaire Deskundige AEM </a> duikt dieper in onderwerpen die in het Forum HelpX worden besproken. </li> 
      <li id="li_BF54BEF7E269407A982CD7E1CFE6DCC0">Onze <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/ccoo-index.html" format="https" scope="external"> kantooruren van de klantendienst van Adobe </a>; De deskundigen van Adobe delen beste praktijken van hun ervaringen met klantenimplementaties over de hele wereld. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Klik op het Help-pictogram voor meer informatie in het product:  **[!UICONTROL ?]** > **[!UICONTROL Help-inhoud]** .
