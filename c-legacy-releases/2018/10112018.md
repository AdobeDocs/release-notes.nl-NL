...
* Vanaf februari 2019 biedt de **Adobe Analytics Reporting API** geen ondersteuning meer voor TLS 1.0-codering. Klanten die toegang hebben tot de API moeten controleren of dit geen gevolgen heeft.
