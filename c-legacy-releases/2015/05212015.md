...
* Oplossing voor een probleem dat ervoor zorgde dat de pagina met [Adobe Target-productdocumentatie](https://marketing.adobe.com/resources/help/ja_JP/target/a4t/) niet kon worden weergegeven in het Japans.
...
Nieuwe functies en oplossingen in de [!DNL  Adobe Mobile Services] interface.
...
Nieuwe functies en oplossingen in de SDK&#39; [!DNL  Adobe Mobile Services] s.
...
<table id="table_1A8173DB38E8426D96BB7C57BF8FD2D5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vanaf iOS SDK versie 4.5 kunt u met een nieuwe iOS-extensie gebruiksgegevens verzamelen van de Apple Watch Apps, Today Widgets, Photo Editing widgets en alle andere iOS-extensies. </p> <p>Zie de <a href="https://docs.adobe.com/content/help/en/mobile-services/ios/ios-ext/ios-ext.html" format="https" scope="external"> iOS-extensie-implementatie </a> in de <a href="https://docs.adobe.com/content/help/en/mobile-services/ios/overview.html" format="https" scope="external"> iOS SDK 4.x voor de </a> handleiding Marketing Cloud Solutions. </p> </td> 
  </tr> 
  <tr> 
...
>[!IMPORTANT]
>
>Adobe raadt u ten zeerste aan om geen eigen omslagen voor onze SDK&#39;s te maken en variabelen bij te houden met behulp van oudere versies. Dit zal waarschijnlijk problemen met uw gegevens veroorzaken.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Toegevoegde "van het Kanaal van de Marketing laatste Aanraakinstanties"metrisch voor het melden van het Pakhuis van Gegevens. </td> 
  </tr> 
  <tr> 
...
* Correctie van een probleem met speciale tekens in [!DNL  Target] campagnemenamen, zodat deze niet in Rapporten &amp; Analytics konden worden gerapporteerd.
   * Een *`Access Denied`* fout die wanneer het creëren van onderbrekingen in de rapporten van het Kanaal [!UICONTROL  van de Marketing, en in berekende metriek op een] Rapport van Campagnes  toont.
   * Een interfacereeks waarin het rapport in verschillende veranderde toen het toepassen van veranderingen op een segment.
* Probleem verholpen waarbij in [!UICONTROL  Bots] -rapporten in dashboards geen juiste gegevens werden weergegeven.
* Probleem verholpen met het pictogram Bewerken (potlood) bij het bewerken van segmenten in Internet Explorer 11. Dit probleem heeft u gedwongen tweemaal op het pictogram Bewerken te klikken om Segmentbeheer te laden.
* Probleem verholpen waarbij een onjuiste metrische naam en valuta-eenheid werden weergegeven in een rapport [!UICONTROL  Bijdrage-analyse] .
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Het pakhuis van gegevens steunt Analytics Meldend API 1.4. </p> <p>Zie <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external"> Report.Queue </a> in de documentatie van API van het Pakhuis van Gegevens over de Verbinding van de Ontwikkelaar. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Opname van de Marketing Cloud Visitor ID Service API 1.4.
* Bijgewerkte module Audience Manager voor het gebruik van DIL versie 6.0.
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Er zijn momenteel statistieken die we ontvangen van sociale netwerken waarop geen melding kan worden gemaakt in <span class="keyword"> Adobe Analytics </span>. Met nieuwe gereserveerde gebeurtenissen kunt u aangepaste rapporten maken in <span class="wintitle"> Analytics </span> om sociale gegevens naast webgegevens weer te geven. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p> <span class="keyword"> Adobe Social </span> Mobile-app </p> </td> 
   <td colname="col2"> <p>De app <span class="keyword"> Adobe Social </span> Mobile voor iOS is in juni 2015 beschikbaar in de Apple App Store. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Op 1 maart 2015 stopte Adobe Social de ondersteuning voor geo-targeting van tweets. Nadat u met Twitter hebt gewerkt, is er weer geo-targeting beschikbaar. </p> 
...
* Probleem verholpen waarbij onjuiste gegevens werden weergegeven voor Facebook-pagina&#39;s in het rapport [!UICONTROL  Concurrent Analytics] .
* Probleem verholpen die tot discrepanties in het aantal gerapporteerde Twitter-volgers leidde.
* Probleem verholpen waarbij het bijhouden van parameters niet kon worden toegevoegd aan publicaties die zijn gemaakt met de functie [!UICONTROL  overal] publiceren.
...
In de integratie van de module BezoekerAPI/AppMeasurement Audience Manager worden twee iFrame-aanvragen voor bestemmingpublicatie gedaan in IE6-9: [!DNL  //fast.<subdomain>.demdex.net/dest5.html] en [!DNL  //fast.<subdomain>.demdex.net/dest4.html]. Het juiste gedrag, zoals in andere browsers, is alleen laden [!DNL  //snel.<subdomain>.demdex.net/dest5.html].
