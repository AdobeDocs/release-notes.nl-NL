...
Zie [Geschiedenis van de Versie AppMeasurement](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) het volgende voor een versiegeschiedenis van [!DNL  AppMeasurement] op de volgende platforms:
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Verbeterde methode <span class="keyword"> Sociaal </span> gebruikt om afbeeldingen op te halen en weer te geven in directe Twitter-berichten in moderatie-feeds. 
     <!--AS-30675--></p> </td> 
  </tr> 
  <tr valign="top"> 
