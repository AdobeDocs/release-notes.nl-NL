...
keywords: Aanvullende informatie over
...
### Interface 15.5.1 {#marketing_cloud_interface} van de Marketing Cloud

Nieuwe eigenschappen en moeilijke situaties in de [!DNL  Adobe Marketing Cloud] interface.
...
* De menuselecties <span class="term"> Audience Library </span> en <span class="term"> Customer Attributes </span> staan nu onder <span class="term"> Audiences</span>.
* De <span class="term"> Uitwisseling </span> menuselectie werd bewogen van het drop-down menu van de Hulp aan de linkernavigatiespoor.
...
* Probleem verholpen waarbij de pagina [Adobe Target-productdocumentatie](https://marketing.adobe.com/resources/help/ja_JP/target/a4t/) niet in het Japans kon worden weergegeven.
* Probleem verholpen waarbij het gebruik van Japanse tekst in opmerkingen tussen [!DNL  Creative Cloud] en [!DNL  Marketing Cloud] werd voorkomen.

Zie [Productdocumentatie Marketingen Cloud](https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html) voor producthulp.

### Adobe Mobile Services {#mobile}

Nieuwe eigenschappen en moeilijke situaties in de [!DNL  Adobe Mobile Services] interface.
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Er is een regionale overschrijving voor inkoopkoppelingen toegevoegd aan de bureaubladbrowser. Met deze instelling kunt u de regiospecifieke App Store selecteren waarnaar u een acquisitiekoppeling wilt sturen wanneer een gebruiker op de koppeling klikt vanuit een desktopbrowser. </p> <p> Deze functie kan alleen worden ingesteld door gebruikers met beheerdersrechten voor het maken van verwervingskoppelingen (Mobile App Admins). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Rapporten </p> </td> 
   <td colname="col2"> <p>PDF/CSV-export voor <span class="wintitle"> met </span>, <span class="wintitle"> Trended </span>, <span class="wintitle"> Retentie </span>, <span class="wintitle"> Trechter </span>, <span class="wintitle"> Geo Location </span> en <span class="wintitle"> Sunburst </span> rapporten. (Openbare bètaversie) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Het probleem waarbij sommige IMS-gebruikers werden omgeleid van [!DNL  marketing.adobe.com] en er geen apps werden weergegeven in [!DNL  mobilemarketing.adobe.com], is opgelost.
* Extra aangepaste kalenderondersteuning in Behoud voor 4-5-4 en 4-4-5 (aangepast en handelsversie).
Nieuwe functies en oplossingen in de SDK&#39;s van [!DNL  Adobe Mobile Services].
...
### Nieuwe functies/wijzigingen in analyses {#features_analytics}
...
* Probleem verholpen waarbij campagnerapporten [!DNL  Target] niet werden weergegeven in Rapporten &amp; Analytics.
* Correctie van een probleem met speciale tekens in [!DNL  Target]-campagnemenamen waardoor rapportage in Rapporten &amp; Analytics werd voorkomen.
   * Een *`Access Denied`* fout die wanneer het creëren van onderbrekingen in [!UICONTROL Marketing Channel] rapporten, en in berekende metriek op een [!UICONTROL Campaigns] rapport toont.
   * Een interfacereeks waarin het rapport in verschillende veranderde toen het toepassen van veranderingen op een segment.
* Probleem verholpen waarbij [!UICONTROL Bots]-rapporten in dashboards geen juiste gegevens weergeven.
* Probleem verholpen met het pictogram Bewerken (potlood) bij het bewerken van segmenten in Internet Explorer 11. Dit probleem dwingt u tweemaal op het pictogram Bewerken te klikken om [!UICONTROL Segment Manager] te laden.
...
Zie [Geschiedenis van de Versie AppMeasurement](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) het volgende voor een versiegeschiedenis van [!DNL  AppMeasurement] op de volgende platforms:
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Facebook donkere berichten </p> </td> 
   <td colname="col2"> <p>Maak op Facebook posts die niet op de tijdlijn worden weergegeven, maar die toegankelijk zijn via directe koppelingen. Met deze optie kunnen makers van inhoud publicaties maken die worden gepromoot als gesponsorde (betaalde) advertenties. </p> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Momenteel zijn er cijfers die we ontvangen van sociale netwerken die niet kunnen worden gerapporteerd in <span class="keyword"> Adobe Analytics </span>. Met nieuwe gereserveerde gebeurtenissen kunt u aangepaste rapporten maken in <span class="wintitle"> Analytics </span> om sociale gegevens naast webgegevens weer te geven. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p> <span class="keyword"> Adobe Social  </span> Mobile-toepassing </p> </td> 
...
Zie [Nieuwe functies in mei 2015](https://bit.ly/1JSO2k5) voor trainingsvideo&#39;s over deze nieuwe functies.
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Selecteer een stilstaand frame vanaf een willekeurige locatie in de video om te uploaden en te gebruiken als miniatuurafbeelding van die video in de post. Eerder selecteert <span class="keyword"> Sociaal </span> het openingsframe dat als miniatuurafbeelding moet worden gebruikt. 
  ...
  <tr valign="top"> 
   <td colname="col1"> <p>Twitter-gericht </p> </td> 
   <td colname="col2"> <p>Op 1 maart 2015 heeft Adobe Social de steun voor geo-targeting van tweets stopgezet. Nadat u met Twitter hebt gewerkt, kunt u geo-targeting weer gebruiken. </p> 
  ...
  <tr valign="top"> 
   <td colname="col1"> <p>Afbeeldingen met directe twitter-berichten </p> </td> 
   <td colname="col2"> <p>Verbeterde methode <span class="keyword"> Sociaal </span> gebruikt om afbeeldingen op te halen en weer te geven in Twitter direct-berichten in moderatie-feeds. 
     <!--AS-30675--></p> </td> 
  </tr> 
  <tr valign="top"> 
...
* Probleem verholpen die tot discrepanties in het aantal gemelde Twitter-volgers leidde.
* Probleem verholpen waarbij het bijhouden van parameters niet kon worden toegevoegd aan advertenties die zijn gemaakt met de functie [!UICONTROL Publish Anywhere].
...
|---|---|
| [Audience Marketplace](https://marketing.adobe.com/resources/help/en_US/aam/c_audience_marketplace.html) | [!DNL  Audience Marketplace] biedt gespecialiseerde functies waarmee kopers van gegevens en gegevensleveranciers gegevenstransacties op een zelfbedieningswijze met minimale moeite kunnen uitvoeren. Neem contact op met uw [!DNL  Audience Manager] consultant om aan de slag te gaan. Ze kunnen [!DNL  Audience Marketplace] voor u activeren. |
...
* [Bevoegdheden](https://marketing.adobe.com/resources/help/en_US/aam/c_wildcard_permissions.html) voor jokertekens begrijpen: Gebruik  [!DNL  Wild Card Permissions] om groepsleden automatisch toegang te geven tot nieuwe gegevensbronnen. Met standaardtoestemmingen, moet u nieuwe gegevensbronnen aan een groep manueel toewijzen.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In <span class="uicontrol"> Admin Tools </span> &gt; <span class="uicontrol"> Classification Rule Builder </span> &gt; <span class="term"> &amp;lt;rule set name&amp;gt; Met twee nieuwe opties kunt u een overschrijvingsmodus selecteren:</span> </p> 
    <ul id="ul_14E61CC9E94B431090539CB47A9B83D6"> 
     <li id="li_F77AEF4B136540E5A6E1040215999E85"> <b>Regels overschrijven bestaande waarden:</b> (standaardinstelling) Overschrijf altijd bestaande classificatietoetsen, inclusief classificaties die via de importer zijn geüpload (SAINT). </li> 
     <li id="li_0E82075DFBF04D1D8D686A5B95FCFB3E"> <b>Regels overschrijven alleen ongestelde waarden:</b> Alleen lege (niet-ingestelde) cellen invullen. Bestaande classificaties worden niet gewijzigd. </li> 
