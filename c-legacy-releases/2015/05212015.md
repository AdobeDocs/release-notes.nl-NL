...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Toegevoegde "Marketing Channel Last Touch Instances" metrisch voor het melden van Data warehouse. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Wijziging van gegevensbronnen in juni 2015 </td> 
   <td colname="col2"> <p>Rapporten en Analytics hebben geen ondersteunde gegevensbronnen van het type "Verkeersgegevensbron" sinds de introductie van SiteCatalyst 15. De gegevensbronnen gebruikersinterface staat u nog toe om een Gegevensbron van het Verkeer tot stand te brengen, maar dit soort gegevensbron kan slechts op datumwaaiers voorafgaand aan de datum worden toegepast wanneer uw bedrijf van SiteCatalyst 14 aan SiteCatalyst 15 migreerde. Volgende maand (juni 2015), is Adobe van plan om de Gegevensbronnen van het Verkeer als optie te verwijderen. In juni, zullen wij ook nieuwe mogelijkheden in Rapporten &amp; Analytics introduceren die u zullen toestaan om eenvoudige verkeersmetriek zonder de behoefte aan de Bronnen van de Gegevens van het Verkeer tot stand te brengen. </p> </td> 
  </tr> 
 </tbody> 
</table>

### Rapporten en Analytics {#fixes_reports_analytics}

**Oplossingen**

* Probleem verholpen waarbij [!DNL  Target] campagnerapporten niet werden weergegeven in Reports &amp; Analytics.
* Probleem verholpen met speciale tekens in [!DNL  Target] campagnemenamen, zodat deze niet konden worden gerapporteerd in Rapporten &amp; Analytics.
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Data warehouse ondersteunt Analytics Reporting API 1.4. </p> <p>Zie <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external"> Report.Queue </a> in de Data warehouse API documentatie op de Verbinding van de Ontwikkelaar. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Bijgewerkte module Audience Manager voor gebruik van DIL versie 6.0.
