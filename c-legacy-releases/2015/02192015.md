...
<table id="table_4ABE0F980A704B069BA9044E7F32ECFE"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Analytics- </span> classificatieregels - bestaande waarden overschrijven </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Updates voor <span class="wintitle"> Analytics- </span> navigatie worden gerapporteerd </td> 
   <td colname="col2"> 
    <ul id="ul_156855264F144041A33CAB2D0B6D6F4D"> 
     ...
     <li id="li_C77D3CE4DF62476F9729519E153BA6E5"> 
      <!--AN-91912-->De rapportsuite-kiezer is nu beschikbaar via <span class="uicontrol"> Alle rapporten weergeven </span> in Rapporten en Analytics. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9F4F40B4329443AC88F07B74660407C3"> 
     ...
     <li id="li_8EEB2C69113C43349F2B5E3AD9352B7B">De mogelijkheid toegevoegd om een set metriek uit te voeren zonder deze als standaard op te slaan. Dit is nu consistenter dan standaard rapporten en Analytics-rapporten. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Analytics- </span> classificatieregels - bestaande waarden overschrijven </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Opmerking:  </p> <p>1. Met de metrische polariteit kunt u aangeven of Adobe <span class="wintitle"> Analytics het als goed of slecht </span> moet beschouwen als een bepaalde aangepaste gebeurtenis (metrisch) wordt verhoogd. </p> <p>2. Hiermee kan Adobe <span class="wintitle"> Analytics </span> richtingsindicatoren (pijlen) weergeven voor verschillende metriek om context toe te voegen (bijvoorbeeld vergelijkingen van week tot week). Voorbeeld: Als "Bugs Submission" week in week uit gaat, moet Adobe <span class="wintitle"> Analytics dat goed of slecht </span> vinden? Andere voorbeelden: Een toename in e-mailregistraties is waarschijnlijk goed. Maar een toename in de fouten bij het verzenden van formulieren is waarschijnlijk slecht. </p> <p>In <span class="ignoretag"> Analytics <span class="uicontrol"> &gt; </span> Hulpmiddelen Admin <span class="uicontrol"> &gt; </span> geef Montages <span class="uicontrol"> &gt; </span> Omzetting <span class="uicontrol"> &gt; de Gebeurtenissen van de Succes , </span> <span class="uicontrol"> </span> </span><span class="uicontrol"> </span> zie de kolom van de Polariteit. Je kunt <span class="uicontrol"> Omhoog controleren is goed </span> of <span class="uicontrol"> Omhoog is slecht </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>


### Marketingrapporten en Analytics {#fixes_reports_analytics}
...
Deze wijzigingen zijn van toepassing op alle uniforme segmentatiefuncties in Adobe [!DNL Analytics], inclusief de mogelijkheden Rapporten en Analytics en Ad hoc.
...
>[!NOTE]
>
>De toegang van Data warehouse van Versie 14 zal in deze versie worden verwijderd.[Meer informatie](https://docs.adobe.com/content/help/en/analytics/components/segmentation/seg-home.html)
