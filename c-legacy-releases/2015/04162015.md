...
* Door het [!UICONTROL  Provide Feedback] *`Bug`* hulpmiddel te gebruiken om typekwesties voor te leggen, worden deze kwesties nu rechtstreeks naar de klantenservice verzonden en wordt een ticket gemaakt. De klantenservice dient u binnenkort te raadplegen.
...
* Het favicon-pictogram dat in de adresbalken van browsers wordt weergegeven, is bijgewerkt en afgestemd op de nieuwe branding van Adobe.
