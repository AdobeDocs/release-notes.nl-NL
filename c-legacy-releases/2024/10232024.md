...
* [!DNL Analytics] [&#x200B; versienota&#39;s &#x200B;](https://experienceleague.adobe.com/nl/docs/analytics/release-notes/latest) <!-- (https://experienceleague-review.corp.adobe.com/docs/analytics/release-notes/latest.html) -->
...
| Oktober 2024 | [&#x200B; Onbekwaam om  [!DNL AEM Assets Brand Portal]  met  [!DNL Federated ID] &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-25114) toegang te hebben | Nieuw artikel | Leer hoe u het probleem kunt oplossen waarbij een gebruiker met toegang tot [!DNL AEM Assets Brand Portal] via een [!DNL Federated ID] onder bepaalde omstandigheden geen toegang tot de oplossing kan krijgen. |
| Oktober 2024 | [[!DNL PDF]  uploadt ontbreekt &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-25116) | Nieuw artikel | Leer hoe u het probleem kunt oplossen waarbij een [!DNL PDF] upload naar [!DNL Dynamic Media Classic] of synchronisatie van [!DNL AEM] naar [!DNL DMS7] kan mislukken. |
...
| November 2024 | [&#x200B; Verlopen SSL Certificaat &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-learn/tutorials/adobe-commerce-cloud/troubleshooting/invalid-ssl) | Video | Leer hoe u een verlopen SSL-certificaat kunt identificeren en hoe u een certificaat opnieuw kunt genereren voor de integratie met Adobe Commerce Cloud of voor andere ontwikkelomgevingen. |
| Oktober 2024 | [&#x200B; Adobe Commerce &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-learn/tutorials/getting-started/migrating-to-adobe-commerce/qa/code-freeze) | Meerdere video&#39;s | Bekijk nieuwe video&#39;s over Commerce Marketecture, wereldwijd leveringsmodel, beheerrollen, winkelopties en meer. |
| Oktober 2024 | [&#x200B; migrerend aan Adobe Commerce &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-learn/tutorials/getting-started/migrating-to-adobe-commerce/overview) | Video | Een overzicht van voorbereiding, aangepaste code, QA, prestaties en beveiliging bij het migreren naar Adobe Commerce. |
| Oktober 2024 | [&#x200B; terugstellen admin URI gebruikend de klem &#x200B;](https://experienceleague.adobe.com/nl/docs/commerce-learn/tutorials/admin/reset-admin-uri) | Video | Leer hoe u de URI van de beheerder opnieuw instelt met de opdracht Adobe Commerce Cloud cli. Dit is handig als de admin-URL is gewijzigd ten opzichte van de beheerder, maar er een fout is gemaakt en u geen toegang meer hebt tot de admin. |
...
| September 2024 | [&#x200B; [!UICONTROL Switch Accounts] dropdown mist van uw rekening &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-24983) | Nieuwe artikelen | Leer hoe u het probleem kunt oplossen waarbij het vervolgkeuzemenu **[!UICONTROL Switch Accounts]** van uw account ontbreekt en u geen toegang meer hebt om tickets te verzenden namens de handelaar. |
| September 2024 | [&#x200B; Adobe Commerce: De gealigneerde  [!DNL JavaScript]  Kwesties op checkout pagina in  [!DNL Content Security Policy]  (CSP) beperkte wijze &#x200B;](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-25030) | Nieuwe artikelen | Leer de gedetailleerde uitleg en oplossingen voor problemen die optreden wanneer de aangepaste [!DNL JavaScript] via Adobe Commerce [!UICONTROL Admin] en [!DNL Google] [!UICONTROL Tag Manager] in Adobe Commerce 2.4.7 wordt toegevoegd tijdens het uitchecken wanneer de modus voor CSP-beperking is ingeschakeld. |
...
| Oktober 2024 | [&#x200B; Meting &amp; het Melden - Overzicht &#x200B;](https://experienceleague.adobe.com/nl/docs/journey-optimizer-learn/tutorials/report-and-monitor/measurement-and-reporting-overview) | Video | Meer weten over rapporten in Journey Optimizer? |
