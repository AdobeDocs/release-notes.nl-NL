...
| Mei 2024 | [[!DNL Campaign]: [!UICONTROL Org unit folder] niet zichtbaar wanneer de gebruiker met veelvoudige organisatorische eenheden wordt geassocieerd ](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-24202) | Nieuw artikel | Leer over de oplossing van de kwestie wanneer [!UICONTROL org unit folder] niet toont wanneer u aan veelvoudige organisatie eenheden wordt toegewezen. |
| Mei 2024 | [ het logboek van de Controle registreert geen fout wanneer  [!DNL OOTB]  werkschema ](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-24179) ontbreekt | Nieuw artikel | Leer meer over de oplossing van het probleem wanneer u een fout [!DNL Out-of-the-box (OOTB)] of [!UICONTROL custom workflow] in [!DNL Adobe Campaign Classic v7] tegenkomt in een toestand die niet is gelukt zonder fouten in het auditlogboek. |
| Mei 2024 | [ Cirkelafhankelijkheid van [!UICONTROL schema extension] fout ](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-24175) | Nieuw artikel | Leer meer over de oplossing van het probleem wanneer de fout [!DNL Adobe Campaign Classic] : cirkelafhankelijkheid van [!UICONTROL schema extension] `nms:recipient` . |
