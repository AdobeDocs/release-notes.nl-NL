...
| ----------| ---------- | ---------- | ---------- |---------- |
| Februari 2024 | Real-time Customer Data Platform, Journey Optimizer | ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/use-case-playbooks/overview.html) Van het Geval gebruik Playbooks [ | Meerdere video&#39;s | Leer hoe met Use Case Playbooks klanten van Real-time Customer Data Platform en Journey Optimizer sneller tijd-aan-waarde kunnen krijgen. De Playbooks van het Geval van het gebruik is een catalogus van tientallen malplaatjes die veelvoudige industrieën en marketing doelstellingen behandelen. |
...
| Februari 2024 | AEM CS | [AEM Eventing ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/aem-eventing/overview.html?lang=en) | Meerdere video&#39;s | Leer over AEM gebeurtenis, wat het is, waarom en wanneer om het en voorbeelden van het te gebruiken. |
...
| Januari 2024 | [ Fout *[!DNL org.apache.sling.api.request.TooManyCallsException]* in de Console van de Douane ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23463.html) | Nieuw artikel | Leer hoe u de fout *[!DNL org.apache.sling.api.request.TooManyCallsException]* kunt oplossen in Aangepaste console. |
...
| Januari 2024 | [[!DNL OOTB]  functie `nms.eventHisto.GetMirrorUrl` keert om het even welk  [!DNL URL]  niet terug of keert onjuist  [!DNL URL] terug ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23477.html) | Nieuw artikel | Leer de oplossing voor het probleem wanneer in een werkstroom met een [!DNL JS] activiteit, wanneer het roepen van [!DNL Out-of-the-box (OOTB)] function `nms.eventHisto.GetMirrorUrl`, het geen [!DNL URL] terugkeert of een onjuist [!DNL URL] terugkeert. |
| Januari 2024 | [ Toegang tot  [!DNL SFTP]  omslagen `/usr/local/neolane/nl6` of `/usr/local/neolane/nl6/var/` ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23493.html) | Nieuw artikel | Leer wat u moet doen als u [!DNL SFTP] mappen `/usr/local/neolane/nl6` of `/usr/local/neolane/nl6/var/` in [!DNL Adobe Campaign Classic] wilt openen. |
...
| Februari 2024 | [ Publish een reis en reisstatussen ](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/create-journeys/publish-a-journey.html) | Video | Begrijp de verschillende statussen van een journey en de gevolgen van publiceren. |
