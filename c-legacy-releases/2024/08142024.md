...
| ----------| ---------- | ---------- | ---------- |---------- |
| Augustus 2024 | [!DNL Experience Platform] | [&#x200B; de tijdbeperkingen van het Gebruik in segmentdefinities &#x200B;](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/audiences/audience-builder/time-constraints) | Video | Leer hoe u de verschillende datum- en tijdopties gebruikt in de Adobe Experience Platform-interface voor het maken van publiek. |
...
* Zie {de documentatie van B2B edition van 0} Journey Optimizer [&#x200B; voor versienota&#39;s en zelfhulp.](https://experienceleague.adobe.com/nl/docs/journey-optimizer-b2b/user/guide-overview)
* Zie [&#x200B; Journey Optimizer B2B edition &#x200B;](https://business.adobe.com/nl/products/journey-optimizer-b2b-edition.html) voor productinformatie.
