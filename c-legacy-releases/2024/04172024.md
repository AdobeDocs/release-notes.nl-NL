...
| ----------| ---------- | ---------- | ---------- |---------- |
| April 2024 | Experience Platform | [ creeer en activeer rekeningspubliek voor B2B en B2P ](https://experienceleague.adobe.com/nl/docs/platform-learn/tutorials/audiences/create-audiences-with-b2b-data) | Video | Leer meer over Account-Based Marketing-mogelijkheden in de B2B- en B2P-edities van Real-Time Customer Data Platform, inclusief het maken en activeren van accountpubliek. |
...
* **Dashboard van de Controle van de Ervaring 1&rbrace; - [ het dashboard van de Controle van de Ervaring van Cloud Manager ](https://experienceleague.adobe.com/nl/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/experience-audit-dashboard) omvat een trended mening van uw scores van paginaprestaties samen met inzichten en aanbevelingen om u te helpen hen verbeteren.** De Experience Audit is opgenomen als een stap in de Cloud Manager-productiepijplijn.
...
* Zie {de Gidsen van de Diensten van 0} Adobe Commerce [&#128279;](https://experienceleague.adobe.com/nl/docs/commerce-merchant-services/user-guides/home) om de de versieinformatie en documentatie van de Diensten van Commerce te zien.
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Maart 2024 | `TargetData` vertoning  [!DNL Campaign]  kwestie van het oplossen van problemen van 0&rbrace; &lbrace;het oplossen van problemen voor douanedoelafbeelding in directe postleveringen [&#128279;](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-23799) | Nieuw artikel | Leer hoe te om de uitdagingen van de gegevensvertoning in direct-mailcampagnes te navigeren door de afbeeldingen van het douanedoel met het brede logboekschema van [!DNL Campaign] te integreren. |
...
| Maart 2024 | [ hoe te werkschema&#39;s vinden die lopend zijn ](https://experienceleague.adobe.com/nl/docs/experience-cloud-kcs/kbarticles/ka-23881) | Nieuw artikel | Leer een paar trucs voor het vinden van actieve werkschema&#39;s in [!DNL Adobe Campaign]. |
