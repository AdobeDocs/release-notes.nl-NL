...
* **WORKFRONT** | Workshop klant | _Leer: 10 Tips van de Wijze van de Tekst in Adobe Workfront_ | Wilt u de rapportkennis uitbreiden met de tekstmodus? Kijk niet verder! Deze workshop zal een korte inleiding aan de grondbeginselen van de tekstwijze en de Ontdekkingsreiziger van API verstrekken die door 10 tips van de tekstwijze in Adobe Workfront wordt gevolgd. | **April 18 @ 9:00 AM PT** | [ Register ](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,--xUIfX6gEqCcuYNDuE5IA,S8LJKpyI4kywiEO88_bvdg,Z6HaWjLNV0CaMzwT0JeWQg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Communautaire gebeurtenis | _verbind: Collectief Workfront_ | Sluit u aan bij uw collega Workfront Sys Admins voor deze maandelijkse brainstorming- en deelsessie, waar we de nieuwste updates en best practices bespreken. | **April 22 @ 6:00 AM PT** | [ Register ](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,PLjes69h2kitBUQrGr_tSQ,9hwaemfUG0uEqL-RwJW9fQ,OzGfEfueq0yp19zAhpjfwA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **WORKFRONT** | Chat Vragen en antwoorden | _Vraag: Het migreren aan het Bedrijfs Platform van de Adobe_ | Word samen met onze technici van de Technische Steun voor Vragen en antwoorden om te leren wat te verwachten en hoe te op de migratie van het Bedrijfs Platform van de Adobe het best voor te bereiden. | **April 23 @ 8:00 AM PT** | [ Register ](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,wXdzewqwQEO_SiY5SC4i2Q,r3bZVp0PVkObL30IXUw5iA,1p0c3CZ2qEGQBAZpsDvvEw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
## ](/assets/experience-league.png) de Leveringsketen van de Inhoud van de Adobe van 0} Pictogram {![ {#content-supply-chain}

Leer over [ de Keten van de Levering van de Inhoud ](https://business.adobe.com/solutions/adobe-genstudio.html), oplossing van begin tot eind van de Adobe om uw inhoud met generatieve AI en intelligente automatisering te versnellen en te vereenvoudigen.

+++Details

| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Februari 2024 | {de Tutorials van de Keten van de Levering van 0} Inhoud ](https://experienceleague.adobe.com/docs/content-supply-chain-learn/tutorials/overview.html)[ | Video&#39;s | Zelfstudies voor de inhoudsdistributieketen op het Experience League weergeven. De toeleveringsketen voor inhoud is een end-to-end oplossing van de Adobe om de toeleveringsketen voor inhoud te versnellen en te vereenvoudigen met behulp van generatieve AI en intelligente automatisering. |
...
**Toestemmingen van het Experience Platform**
...
Onderzoek de nieuwe [ Extension Manager in AEM Sites ](https://developer.adobe.com/uix/docs/extension-manager/) zodat kunt u uw AEM opstelling personaliseren door uitbreidingen te vormen UI.

De Extension Manager in AEM Sites laat ontwikkelaars en artsen toe om tot [ uitbreidingen UI ](https://developer.adobe.com/uix/docs/) toegang te hebben te beheren en aan te passen die met [ Adobe App Builder ](https://developer.adobe.com/app-builder/) worden gebouwd om de functionaliteit van AEM Sites te verbeteren.
...
Adobe zoekt actief naar feedback en nieuwe gebruiksgevallen voor UI-extensies. Als u zou willen verbinden, verzend een e-mail naar [ uix@adobe.com ](mailto:uix@adobe.com).
...
* **[legt een Aangepast Vorm aan het Scenario van de Fusie van Adobe Workfront voor ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/submit-adaptive-form-to-workfront-fusion.html?lang=en)** - de as a Cloud Service aanbiedingen van Forms uit-van-de-doos opties om een Aangepast Vorm met Adobe Workfront moeiteloos aan te sluiten. Dit vereenvoudigt het proces om een Adaptief Formulier aan een scenario van Adobe Workfront voor te leggen, toelatend u een scenario van de Fusie van Workfront op voorlegging van een Aangepast Vorm teweegbrengt.
...
* Cloud Manager bevestigt nu de vervaldata niet alleen voor het belangrijkste [ certificaat ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html), maar ook voor intermediaire certificaten.
...
* **breng uw eigen GitHub** - als u GitHub gebruikt om uw bewaarplaatsen te beheren, [ kunt u code direct binnen uw bewaarplaatsen GitHub door Cloud Manager ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/managing-code/byo-github.html) nu bevestigen. Door deze integratie is het niet nodig de code consistent te synchroniseren met de opslagplaats van de Adobe en kunt u terugtrekkingsverzoeken verifiëren voordat u ze samenvoegt in de hoofdvertakkingen.
...
>[!IMPORTANT]
>
>De Adobe adviseert dat u [ aan de recentste versie 1.9.16 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html) van Workfront voor Experience Manager verbeterde schakelaar bevordert.
...
* **aankondigend de Volledige AEM Zittingen en Laboratoria bij Adobe Summit 2024** - Onderzoek de uitvoerige lijst van Adobe Summit 2024 AEM zittingen en laboratoria, uw ultieme roadmap voor een diepere AEM ervaring. Zie [ https://adobe.ly/3HD1mw3 ](https://adobe.ly/3HD1mw3).
* **AEM as a Cloud Service 2024.1.0** - leer over de update in [ https://adobe.ly/3w2lhBL ](https://adobe.ly/3w2lhBL).
* **Geleste Blogs door AEM Communautaire Gebruikers**
   ...
   * [ het ontdekken AEM Verborgen Macht: Het ontgrendelen van OSGi Marvels ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/exploring-aem-s-hidden-power-unlocking-osgi-marvels/ba-p/648162)
...
| Februari 2024 | Experience Manager Sites | [ werkschema&#39;s van het Document ](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-workflows.html) | Video | Ontdek hoe u documentworkflows kunt gebruiken met AEM documentontwerpen. |
| Februari 2024 | Experience Manager Sites | [ de versies van het Document ](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions.html) | Video | Leer hoe u documenten versieert die zijn gemaakt met AEM documentontwerp. |
...
| Februari 2024 | AEM zonder kop | [ de gebieden van de Douane ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/extensibility/ui/content-fragments/examples/editor-custom-field.html?lang=en) | Video | Leer hoe u aangepaste velden maakt in de AEM Content Fragment Editor. |
...
| Februari 2024 | [ leer over het veranderen van de Server en  [!DNL JVM]  timezone aan Europa/Parijs in  [!DNL AEM as a Cloud Service] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23702.html) | Nieuw artikel | In [!DNL AEM as a Cloud Service] vindt u meer informatie over het wijzigen van de tijdzone Server en [!DNL JVM] in Europe/Paris. |
...
| Februari 2024 | [ Recommendations  [!DNL JS]  fouten na verbetering aan versie 2.4.5 van Adobe Commerce ](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/recommendations-js-errors-after-upgrade-to-adobe-commerce-version-2-4-5.html) | Nieuwe artikelen | Dit artikel biedt een oplossing voor het probleem dat zich na de upgrade naar Adobe Commerce (alle implementatiemethoden) [!DNL JS] fouten voordoen in de console die betrekking hebben op de Recommendations-modules/eenheden van het product. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Februari 2024 | [ kan niet het venster van leveringsmalplaatjes correct zien wanneer verbonden met  [!DNL Campaign Console]  via  [!DNL VPN] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html) | Nieuw artikel | Wanneer u verbinding maakt met [!DNL Adobe Campaign Console] via [!DNL VPN] , kunt u de gegevens van de leveringssjablonen in het venster niet zien. |
...
| Februari 2024 | [!DNL Adobe Firefly] | [ het Bestaan pagina ](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/fireflyoverview/firefly-tutorials/landing-page.html?lang=en) | Video | Leer hoe u Adobe Firefly gaat gebruiken. |
