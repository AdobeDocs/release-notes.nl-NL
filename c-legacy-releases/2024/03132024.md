...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Februari 2024 | [&#x200B; creeer gegevenselementen in de markeringen van Experience Platform voor de implementatie van Analytics &#x200B;](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/experience-platform-tags/creating-data-elements-in-tags-for-the-analytics-implementation.html?lang=nl-NL) | Video | Creeer gegevenselementen voor uw [!DNL Analytics] implementatie in markeringen die op de variabelen en de gebeurtenissen worden gebaseerd die in een document van de Verwijzing van het Ontwerp van de Oplossing (SDR) worden gedocumenteerd. |
