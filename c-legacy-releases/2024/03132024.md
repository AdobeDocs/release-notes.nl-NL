...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Februari 2024 | [ kan niet het venster van leveringsmalplaatjes correct zien wanneer verbonden met  [!DNL Campaign Console]  via  [!DNL VPN] ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-23622.html?lang=nl-NL) | Nieuw artikel | Wanneer u verbinding maakt met [!DNL Adobe Campaign Console] via [!DNL VPN] , kunt u de gegevens van de leveringssjablonen in het venster niet zien. |
