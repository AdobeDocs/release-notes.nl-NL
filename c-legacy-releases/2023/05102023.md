...
Zie {de Gebeurtenissen van 0} Experience League [&#128279;](https://experienceleague.adobe.com/events/?lang=nl-NL)

+++

## ![ Pictogram ](/assets/certification-badge.png) Certificatie{#certification}

Let op alle certificatiekandidaten voor Adobe! Bezoek de nieuwe Experience Cloud [ Certificatie ](https://experienceleague.adobe.com/docs/certification/program/overview.html?lang=nl-NL) plaats op Experience League.
...
| Mei 2023 | [ de segmenten en profielattributen van het Aandeel ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/target/activate-segments-and-profile-attributes.html?lang=nl-NL) | Video | Leer hoe u segmenten en profielkenmerken van Adobe [!DNL Real-Time Customer Data Platform] tot en met [!DNL Adobe Target] kunt delen om realtime gepersonaliseerde inhoud weer te geven op uw websites, mobiele apps en andere digitale eigenschappen. | [!DNL Adobe Target] |
...
| Mei 2023 | [ Overzicht van Filters ](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/filters/introduction-to-filters-in-cja.html?lang=nl-NL) | Video | Leer over de belangrijkste componenten van de Bouwer van de Filter in Customer Journey Analytics. |
...
| April 2023 | [ Onverwachte AAM UI toegang ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21831.html?lang=nl-NL) | Nieuw artikel | Leer hoe te om de kwestie op te lossen waar de gebruikers toegang tot AAM UI maar hebben geen specifieke AAM toestemmingen hebben. |
...
* **[verbind AEM Forms met JDBC-Gesteunde gegevensbestanden ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/use-form-data-model/configure-data-sources.html?lang=nl-NL#configure-relational-database-configure-relational-database)** - verbind rechtstreeks met ondernemingsgegevensbestanden van AEM de dienst van de Wolk gebruikend protocol JDBC, zonder de behoefte om hen over REST API bloot te stellen.
...
* Het [ AEM Archetype van het Project ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html?lang=nl-NL) is bijgewerkt aan versie 41.
...
>[!IMPORTANT]
>
>De Adobe adviseert dat u [ aan de recentste versie 1.9.9 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=nl-NL) van Workfront voor Experience Manager verbeterde schakelaar bevordert.
...
| Mei 2023 | [ hoe te om geoptimaliseerde beelden van AEM Zwaartepunt te gebruiken ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/images.html?lang=nl-NL) | Video | Leer hoe u geoptimaliseerde afbeeldingen kunt gebruiken in AEM Headless. | AEM CS |
| Mei 2023 | [ hoe te met grote resultaten in AEM Zwaartepunt ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/large-result-sets.html?lang=nl-NL) te werken | Video | Leer hoe u met grote resultaatsets werkt met AEM Headless. | AEM CS |
...
| April 2023 | [ die omhoog gepubliceerde pagina&#39;s met [!UICONTROL Query Builder] API ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21884.html?lang=nl-NL) een lijst maken | Nieuw artikel | Leer hoe u de pagina&#39;s kunt weergeven die op een AEM auteur zijn gepubliceerd. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| April 2023 | [ wint gegevens van extern gegevensbestand waar de waarden 255 karakters ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21880.html?lang=nl-NL) overschrijden | Nieuw artikel | Leer hoe u gegevens kunt ophalen uit een externe database waarin waarden groter zijn dan 255 tekens. |
| April 2023 | [ Fout: _XSV-350064 in [!DNL Google BigQuery] externe rekening_ ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21895.html?lang=nl-NL) | Nieuw artikel | Leer hoe te om _XSV-350064 in [!DNL Google BigQuery] externe rekening_ fout te bevestigen. |
| April 2023 | [ Bouw 9356: De externe verbindingen openen nog in  [!DNL Internet Explorer]  post verbetering ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21907.html?lang=nl-NL) | Nieuw artikel | Leer hoe u het probleem kunt oplossen waarbij de externe koppelingen na de upgrade naar 9356 nog steeds naar [!DNL Internet Explorer] worden gestuurd in plaats van [!DNL Microsoft Edge] . |
