...
Zie {de Gebeurtenissen van 0} Experience League ](https://experienceleague.adobe.com/events/)[
...
| Mei 2023 | [ de segmenten en profielattributen van het Aandeel ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/target/activate-segments-and-profile-attributes.html) | Video | Leer hoe u segmenten en profielkenmerken van Adobe [!DNL Real-Time Customer Data Platform] tot en met [!DNL Adobe Target] kunt delen om realtime gepersonaliseerde inhoud weer te geven op uw websites, mobiele apps en andere digitale eigenschappen. | [!DNL Adobe Target] |
...
* Wanneer a [ certificaat ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html) verloopt, [ domeinnamen ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/custom-domain-names/introduction.html) en [ IP lijsten van gewenste personen ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/ip-allow-lists/introduction.html) verbonden aan het certificaat worden niet meer verwijderd uit CDN. In dergelijke gevallen is de site nog bereikbaar.
* Cloud Manager UI verstrekt meer zichtbare waarschuwingen dat het [ SSL certificaat ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/introduction.html) op het punt staat te verlopen.
...
>[!IMPORTANT]
>
>De Adobe adviseert dat u [ aan de recentste versie 1.9.9 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=en) van Workfront voor Experience Manager verbeterde schakelaar bevordert.
...
* [ Adobe Developers Live: Composable Ervaringen ](https://adobe.ly/3GWSdOL) | Dinsdag 23 mei 2023, 7:30 (GMT+5:30)
...
| Gepubliceerd | Naam | Type | Beschrijving | Applicaties |
| -----------| ---------- | ---------- | ---------- | ------|
| Mei 2023 | [ integreer het Web SDK van het Experience Platform ](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform/web-sdk.html#create-datastream---experience-platform) | Video | Leer hoe u AEM as a Cloud Service kunt integreren met Experience Platform Web SDK. | AEM Sites |
...
| Mei 2023 | [ hoe te om geoptimaliseerde beelden van AEM Zwaartepunt te gebruiken ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/images.html) | Video | Leer hoe u geoptimaliseerde afbeeldingen kunt gebruiken in AEM Headless. | AEM CS |
| Mei 2023 | [ hoe te met grote resultaten in AEM Zwaartepunt ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/large-result-sets.html) te werken | Video | Leer hoe u met grote resultaatsets werkt met AEM Headless. | AEM CS |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| April 2023 | [ Veranderingen in GraphQL behandeling van ongeldige waarden ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21792.html) | Nieuw artikel | Leer hoe u het mogelijke onverwachte gedrag in de toepassingscode (in [!DNL Experience Manager as a Cloud Service] ) kunt oplossen door de recente verbeteringen die zijn aangebracht in de GraphQL-implementatie. |
...
| April 2023 | [ die omhoog gepubliceerde pagina&#39;s met [!UICONTROL Query Builder] API ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21884.html) een lijst maken | Nieuw artikel | Leer hoe u de pagina&#39;s kunt weergeven die op een AEM auteur zijn gepubliceerd. |
...
| Mei 2023 | [ Zelf-ontvangend overzicht van Adobe Commerce ](https://experienceleague.adobe.com/docs/commerce-operations/implementation-playbook/infrastructure/self-hosting/overview.html) | Video | Leer over zelf-ontvangende beste praktijken om te overwegen wanneer het overgaan naar een e-commerceplatform. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| April 2023 | [ wint gegevens van extern gegevensbestand waar de waarden 255 karakters ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21880.html) overschrijden | Nieuw artikel | Leer hoe u gegevens kunt ophalen uit een externe database waarin waarden groter zijn dan 255 tekens. |
| April 2023 | [ Fout: _XSV-350064 in [!DNL Google BigQuery] externe rekening_ ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21895.html) | Nieuw artikel | Leer hoe te om _XSV-350064 in [!DNL Google BigQuery] externe rekening_ fout te bevestigen. |
| April 2023 | [ Bouw 9356: De externe verbindingen openen nog in  [!DNL Internet Explorer]  post verbetering ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21907.html) | Nieuw artikel | Leer hoe u het probleem kunt oplossen waarbij de externe koppelingen na de upgrade naar 9356 nog steeds naar [!DNL Internet Explorer] worden gestuurd in plaats van [!DNL Microsoft Edge] . |
