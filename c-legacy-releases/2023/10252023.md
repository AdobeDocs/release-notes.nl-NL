...
description: Vind de recentste versienota's voor Adobe  [!DNL Experience Cloud]  producten en de diensten. Ontdek meer over aanstaande gebeurtenissen en nieuwe documentatie over Experience League. Ontdek de recentste leerprogramma's en cursussen voor  [!DNL Experience Cloud]  toepassingen.
...
| Oktober 2023 | [ Begonnen het worden met synchronisatie Salesforce ](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/integrations/salesforce-sync-setup.html?lang=en) | Video | Leer hoe Marketo Engage en [!DNL Salesforce] samenwerken om uw verkoop- en marketinggegevens synchroon te houden. |
