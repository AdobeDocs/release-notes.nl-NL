...
| -----------| ---------- |---------- |---------- |
| April 2023 | [ gegevens van de Stroom met HTTP API ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-http-api.html) | Video | Leer hoe u gegevens in real-time kunt streamen naar Adobe Experience Platform met behulp van het HTTP API-eindpunt. | Data-opname |
