...
Let op alle certificatiekandidaten voor Adobe! De Adobe is opgewekt om de lancering van de nieuwe Experience Cloud [ Certificatie ](https://experienceleague.adobe.com/docs/certification/certification/overview.html?lang=nl-NL) plaats op Experience League aan te kondigen.
...
En meer! Hoofd over aan [ Certificatie van de Adobe ](https://experienceleague.adobe.com/docs/certification/certification/overview.html?lang=nl-NL) op Experience League en begin vandaag uw certificatiereis!
...
Voor hulp, zie de [ Gids van de Interface van het Experience Cloud en van het Beleid ](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=nl-NL) (omvat [!UICONTROL Customer Attributes] en [!UICONTROL Audiences]).
...
| Maart 2023 | [ is Adobe Experience Platform neer?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21594.html?lang=nl-NL) | Nieuw artikel | Leer wat u kunt doen als uw AEP niet zoals verwacht werkt. |
...
| Maart 2023 | [ AAM de Definities van de Metriek van de Bevolking API van de Trait ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21616.html?lang=nl-NL) | Nieuw artikel | Meer informatie over de cijfers van de API voor AAM-takenpopulatie. |
...
>[!IMPORTANT]
>
>De Adobe adviseert dat u [ aan de recentste versie 1.9.8 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=nl-NL) van Workfront voor Experience Manager verbeterde schakelaar bevordert.
...
| April 2023 | [ Verre SPA - Overzicht ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/spa-editor/remote-spa/overview.html?lang=nl-NL) | Video | Bezoek de meerdelige zelfstudie voor ontwikkelaars die een bestaande React-based (of Next.js) Verre SPA met bewerkbare AEM inhoud willen uitbreiden gebruikend AEM Redacteur. | AEM CS |
...
| April 2023 | [ verifieer om Auteur te AEM gebruikend OKTA ](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/authentication/okta-saml-integration.html?lang=nl-NL) | Video | Begrijp diverse configuratiemontages voor het gebruiken van enig teken-binnen met OKTA. | AEM 6.5 |
...
| Maart 2023 | [ hoe te om tot uw AEM instantie in AEM as a Cloud Service met cURL toegang te hebben?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21737.html?lang=nl-NL) | Nieuw artikel | Leer hoe u toegang krijgt tot uw AEM-exemplaar in AEM as a Cloud Service met cURL. |
...
| Maart 2023 | [ AEM de veranderingen van GraphQL betreffende behandeling van ongeldige waarden ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21792.html?lang=nl-NL) | Nieuw artikel | Leer over de recente verbeteringen in de implementatie van GraphQL die onverwacht gedrag kunnen veroorzaken. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Maart 2023 | [ hoe te om de breedste MTA logboeken terug te winnen?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21659.html?lang=nl-NL) | Nieuw artikel | Leer de stappen om uitgebreide MTA- logboeken toe te laten. |
| Maart 2023 | [ Negatieve campagnemetriek die in Adobe Analytics wordt verzonden ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21660.html?lang=nl-NL) | Nieuw artikel | Leer waarom er negatieve waarden voorkomen en de remedie om negatieve campagnemetriek te richten. |
| Maart 2023 | [ Discrepancy tussen geleverde en geopende e-mails in het rapport van de leveringssamenvatting ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21661.html?lang=nl-NL) | Nieuw artikel | Ontdek waarom er een discrepantie is tussen geleverde en geopende e-mails in de leveringssamenvatting en de bijbehorende resolutie. |
