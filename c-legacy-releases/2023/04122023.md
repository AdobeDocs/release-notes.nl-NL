...
Let op alle Adobe-certificeringskandidaten! Adobe is opgetogen om de lancering van de nieuwe Experience Cloud [ Certificatie ](https://experienceleague.adobe.com/docs/certification/certification/overview.html) plaats op Experience League aan te kondigen.
...
En meer! Hoofd over aan [ de Certificatie van Adobe ](https://experienceleague.adobe.com/docs/certification/certification/overview.html) op Experience League en begin vandaag uw certificatiereis!
...
| Maart 2023 | [ is Adobe Experience Platform neer?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21594.html) | Nieuw artikel | Ontdek wat je kunt doen als je AEP niet naar behoren functioneert. |
...
| Maart 2023 | [ Hints van de Plaats, de Regionale Nodes van AAM DCS, en Hints van de Plaats van de Dienst van identiteitskaart ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21677.html) | Nieuw artikel | Meer informatie over de relatie tussen AEP WebSDK-locatiehints, Experience Cloud ID Service-locatiehints en AAM DCS Regional Nodes. |
...
| Maart 2023 | [ de Definities van de Metriek van de Bevolking API van AAM van de Bevolking ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21616.html) | Nieuw artikel | Meer informatie over de cijfers van de AAM-API voor kenmerkpopulatie. |
...
>[!IMPORTANT]
>
>Adobe adviseert dat u [ aan recentste versie 1.9.8 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=en) van Workfront voor Experience Manager verbeterde schakelaar bevordert.
...
| April 2023 | [ Verre KUUROORD - Overzicht ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/spa-editor/remote-spa/overview.html) | Video | Bezoek de meerdelige zelfstudie voor ontwikkelaars die een bestaande React-based (of Next.js) Verre SPAs met editable AEM inhoud willen uitbreiden gebruikend de Redacteur van AEM SPA. | AEM CS |
...
| April 2023 | [ verifieer aan de Auteur van AEM gebruikend OKTA ](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/authentication/okta-saml-integration.html) | Video | Begrijp diverse configuratiemontages voor het gebruiken van enig teken-binnen met OKTA. | AEM 6.5 |
...
| Maart 2023 | [ hoe te om tot uw instantie van AEM in AEM as a Cloud Service met cURL toegang te hebben?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21737.html) | Nieuw artikel | Leer hoe u toegang krijgt tot uw AEM-exemplaar in AEM as a Cloud Service met cURL. |
...
| Maart 2023 | [ GraphQL van AEM verandert betreffende behandeling van ongeldige waarden ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21792.html) | Nieuw artikel | Leer over de recente verbeteringen in de implementatie van GraphQL die onverwacht gedrag kunnen veroorzaken. |
