...
* [ de versienota&#39;s van de Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) - geplande versie - **Maart 29, 2023**
...
| -----------| ---------- | ---------- | ---------- |
| Februari 2023 | [ Geen publieksgrootte in  [!DNL Microsoft Bing]  bestemming AEP ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21544.html) | Nieuw artikel | Leer waarom [!DNL Bing] de publieksgrootte niet toont voor de segmenten AEP die naar de bestemming AEP [!DNL Bing] worden verzonden. |
| Februari 2023 | [ wat is het aantal milieu&#39;s (dev, het opvoeren, productie) die met de vergunning RTCDP komen?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21590.html) | Nieuw artikel | Meer informatie over het aantal omgevingen en sandboxen dat bij de RTCDP-licentie wordt geleverd. |
| Februari 2023 | [ past _transformatie_ optie op bestemmingsactivering normaliseren (b.v. kleine letter) alvorens te hashing?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21591.html) | Nieuw artikel | Meer weten over algemene gegevensnormalisatie en de oplossing daarvoor? |
...
* De Rapporten van Assets omvatten nu de capaciteit voor Beheerders om [ activa te produceren downloadt rapporten ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/admin/asset-reports.html) van [!DNL Experience Manager Assets] als [!DNL Cloud Service] plaatsing. Deze gegevens stellen Admins verder in staat om inzichten af te leiden van de belangrijkste succesmaatstaven om de acceptatie van Assets binnen uw onderneming en door klanten te meten.
...
| Februari 2023 | [ hoe te om activa met cURL te downloaden?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21528.html) | Nieuw artikel | Leer hoe u elementen kunt downloaden met cURL. |
...
| Februari 2023 | [ de plaatsing van de Pijpleiding ontbreekt tijdens de bouwstijlstap ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21419.html) | Nieuw artikel | Kom de oplossing voor de kwestie te weten waar de pijpleiding tijdens de bouwstijlstap ontbreekt, toe te schrijven aan fouten in de `ui.frontend` code. |
| Februari 2023 | [ Geen steun van teken verfrist zich voor ingekapseld teken ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21491.html) | Nieuw artikel | Kom de oplossing voor de kwestie te weten waar geen steun voor token zich voor ingekapselde token vernieuwt. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Maart 2023 | [ vorm Adobe Commerce ](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/adobe-developer-app-builder/io-events/configure-commerce.html) | Video | Leer hoe u Adobe Commerce configureert om gebeurtenissen beschikbaar te maken. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Februari 2023 | [ wordt TLS 1.3 gesteund?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21516.html) | Nieuw artikel | Bekijk de ondersteuningsstatus van TLS 1.3. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|-------|--------|---------|
| Februari 2023 | [ Opt-ins niet bij het landen van pagina ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21416.html) | Nieuw artikel | Ontdek de oplossing voor het probleem waar opt-ins niet op de landingspagina staan. |
| Februari 2023 | [ Ontbrekende dataflow berichten ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21415.html) | Nieuw artikel | Ontdek de oplossing voor de kwestie waar u geen berichten over gegevensstromen ontvangt. |
