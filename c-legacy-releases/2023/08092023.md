...
Het aankondigen van onze nieuwe [ leerprogramma&#39;s van de Integratie huis voor de toepassingen van het Experience Cloud ](https://experienceleague.adobe.com/docs/integrations-learn/experience-cloud/overview.html?) op Experience League!

Leer over de gemeenschappelijkste de toepassingsintegratie van het Experience Cloud. Doorblader integratieleerprogramma&#39;s door [ oplossing ](https://experienceleague.adobe.com/docs/integrations-learn/experience-cloud/solution-categories/overview.html?lang=en) of [ toepassing ](https://experienceleague.adobe.com/docs/integrations-learn/experience-cloud/integrations-between-applications/overview.html?lang=en).
...
* **vorm vertoning van kolommen voor de mening van de Lijst van Assets** - de Assets Essentials laten u nu de kolommen selecteren die in de mening van de Lijst van Assets, zoals Naam, Status, Formaat, Dimensionen, Grootte, en Gewijzigd tonen.
* **de onderzoeksresultaten van de Sortering die op relevantie** worden gebaseerd - de Assets Essentials sorteren nu de onderzoeksresultaten die op Relevantie, door gebrek worden gebaseerd. U kunt de gezochte elementen in toenemende of afnemende volgorde van `Name`, `Relevance`, `Size`, `Modified` en `Created` sorteren.

### [!DNL Experience Manager Forms] als een [!DNL Cloud Service]

_Nieuwe eigenschappen_

* **[uit de vakthema&#39;s en malplaatjes ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/using-themes-in-core-components.html?lang=en)** - Kickstart uw proces van de vormverwezenlijking met gebruiksklare, out-of-the-box thema&#39;s en malplaatjes van de Adobe, die wordt gemaakt om zowel gekruiste beroeps als nieuwe vormauteurs te machtigen. Dankzij deze nauwgezette thema&#39;s en sjablonen, die naadloos zijn gebouwd met Adaptive Forms Core Components, kunt u snel formulieren maken voor veelgebruikte toepassingen.
...
* **[creeer AanpassingsForms met herhaalbare secties ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/create-forms-repeatable-sections.html?lang=en)** - u kunt [ Accordeon ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/accordion.html?lang=en), [ Tovenaar ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/wizard.html?lang=en), [ Comité ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/panel-container.html?lang=en), en [ Horizontale componenten van Lusjes ](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/adaptive-forms-components/horizontal-tabs.html?lang=en) componenten maken gebaseerde Aangepaste Vorm herhaalbaar voor veelvoudige gegevens registreren vangt. Met deze herhaalbare secties kunt u eenvoudig meerdere gegevensitems opgeven. Dit is handig wanneer de vereiste instanties van gegevens vooraf onbekend zijn. Een invuller van een formulier kan eenvoudig secties toevoegen of verwijderen, waardoor formulieren kunnen worden aangepast aan verschillende scenario&#39;s voor gegevensinvoer en de verzameling van meerdere exemplaren van dezelfde gegevensrecord kan worden vereenvoudigd.
...
* **Andere Veranderingen van de Stichting** - tijdens de week van 7 Augustus, zal AEM 2023 foutencode 429 in plaats van foutencode 503 terugkeren wanneer de verzoeken om instanties te AEM een gezond niveau overschrijden. [Meer informatie](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/development-guidelines.html?lang=en).
...
>[!IMPORTANT]
>
>De Adobe adviseert dat u [ aan de recentste versie 1.9.11 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=en) van Workfront voor Experience Manager verbeterde schakelaar bevordert.
