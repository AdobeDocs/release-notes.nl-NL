---
title: Opmerkingen bij de centrale release - februari 2023
...
# Release-aantekeningen Experience Cloud - februari 2023
...
Zie {de Gebeurtenissen van 0} Experience League [ voor een volledig programma.](https://experienceleague.adobe.com/events/)
...
Zie de [ Gids van de Interface en van het Beleid van Experience Cloud ](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) voor hulp op deze eigenschappen, [!UICONTROL Customer Attributes], en [!UICONTROL Audiences].
...
| -----------| ---------- | ---------- | ---------- |
| Februari 2023 | [ Onbekende identiteitsnaamruimten ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21306.html) | Kennisbank, artikel | Ontdek waarom er niet-standaardnaamruimten voorkomen in de gebruikersinterface van [!DNL Adobe Experience Platform] (AEP) Identities (UI). |
...
De datum van de versie: **8 Februari, 2023**
...
| Februari 2023 | [ hoe zijn de Namespaces van de Identiteit van AEP met betrekking tot de Gegevensbronnen van AAM?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21305.html) | Nieuw artikel | Ontdek hoe AEP [!DNL Identity Namespaces] verwant is aan AAM [!DNL Data Sources] . |
...
>[!IMPORTANT]
>
>Adobe adviseert dat u aan [ verbetering aan de recentste versie 1.9.6 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=en) van [!DNL Workfront] voor Experience Manager verbeterde schakelaar.

### Community

* **aanstaande webinar van Experience Manager GEMs:** _versnelt de ontwikkeling van Experience Manager as a Cloud Service met de Snelle Milieu&#39;s van de Ontwikkeling_. [ Register hier ](https://bit.ly/3x1Cl8x).
* **Opgenomen webinar van Experience Manager GEMs:** _de Analysator van Beste praktijken van Experience Manager voor Op-gebouw en AMS (Adobe leidt de Diensten)_ is nu beschikbaar [ ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager-blogs/aem-gems-aem-best-practices-analyzer-for-on-premise-amp-ams/ba-p/565506).
* **de Communautaire Lens van Adobe Experience Manager:** benadrukt de recentste updates van de Gemeenschap van Experience Manager, allen op één plaats. [ las nu de 4de uitgave ](https://bit.ly/3CAxuy2).
...
| Februari 2023 | [ de opstelling van het Project ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/project-archetype/project-setup.html) | Video | Maak een Maven Multi Module Project om de code en configuraties voor een Experience Manager Site te beheren. | AEM Sites |
| Februari 2023 | [ Mijn Workspace in de Hoofdzaak van Activa ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/configuring/my-workspace.html) | Video | Leer hoe u efficiënter kunt werken met Mijn door de gebruiker ingestelde widgets voor Workspace. | AEM Assets |
...
| Februari 2023 | {de toegang van de Hoofdzaak van activa 0} ontkende [](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21212.html) | Nieuw artikel | Ontdek de oplossing wanneer toegang tot [!DNL Assets Essentials] wordt geweigerd. |
