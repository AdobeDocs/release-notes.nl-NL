...
| -----------| ---------- | ---------- | ---------- |
| Februari 2023 | [ Onbekende identiteitsnaamruimten ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21306.html?lang=nl-NL) | Kennisbank, artikel | Ontdek waarom er niet-standaardnaamruimten voorkomen in de gebruikersinterface van [!DNL Adobe Experience Platform] (AEP) Identities (UI). |
...
|January 2023|[Use the experimentation panel](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/panels/use-the-experimentation-panel.html?lang=nl-NL)|Video |Learn how to configure and use the experimentation panel, which automatically builds some visualizations based on your experiment data.|
...
| Februari 2023 | [ Mijn Workspace in de Hoofdzaak van Activa ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/configuring/my-workspace.html?lang=nl-NL) | Video | Leer hoe u efficiënter kunt werken met Mijn door de gebruiker ingestelde widgets voor Workspace. | AEM Assets |
