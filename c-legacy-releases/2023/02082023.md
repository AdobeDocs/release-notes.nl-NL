...
Zie {de Gebeurtenissen van 0} Experience League [&#x200B; voor een volledig programma.](https://experienceleague.adobe.com/events/?lang=nl-NL)
...
<!-- For the latest release information, see Adobe System Status [release notes](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html?lang=nl-NL#status). -->
...
Zie de [&#x200B; Gids van de Interface en van het Beleid van Experience Cloud &#x200B;](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=nl-NL) voor hulp op deze eigenschappen, [!UICONTROL Customer Attributes], en [!UICONTROL Audiences].
...
| -----------| ---------- | ---------- | ---------- |
|January 2023|[Schedule Customer Journey Analytics workbooks using Report Builder](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/exporting/report-builder/schedule-cja-workbooks-using-report-builder.html?lang=nl-NL)|Video |Learn how to schedule workbooks in Report Builder for Customer Journey Analytics. Scheduling workbooks lets users automate the process of refreshing Report Builder workbooks with the latest data and sending it to stakeholders on a regular, pre-defined schedule.|
...
|January 2023|[First-time and returning sessions](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/use-cases/data-views-use-cases/first-time-and-returning-sessions.html?lang=nl-NL)|Video |Learn how to distinguish between first-time and returning sessions for your users. This is accomplished through a 13-month look-back applied to your report.|
...
| Februari 2023 | [&#x200B; hoe zijn de Namespaces van de Identiteit van AEP met betrekking tot de Gegevensbronnen van AAM?](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21305.html?lang=nl-NL) | Nieuw artikel | Ontdek hoe AEP [!DNL Identity Namespaces] verwant is aan AAM [!DNL Data Sources] . |
...
>[!IMPORTANT]
>
>Adobe adviseert dat u aan [&#x200B; verbetering aan de recentste versie 1.9.6 &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/workfront-connector-install.html?lang=nl-NL) van [!DNL Workfront] voor Experience Manager verbeterde schakelaar.
...
| Februari 2023 | [&#x200B; de opstelling van het Project &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/project-archetype/project-setup.html?lang=nl-NL) | Video | Maak een Maven Multi Module Project om de code en configuraties voor een Experience Manager Site te beheren. | AEM Sites |
...
Meer informatie over [[!DNL Experience Manager Guides] &#x200B;](https://business.adobe.com/nl/products/experience-manager/guides/features.html).
...
| Februari 2023 | {de toegang van de Hoofdzaak van activa 0} ontkende [&#128279;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21212.html?lang=nl-NL) | Nieuw artikel | Ontdek de oplossing wanneer toegang tot [!DNL Assets Essentials] wordt geweigerd. |
