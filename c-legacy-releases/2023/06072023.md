...
Let op alle certificatiekandidaten voor Adobe! Bezoek de nieuwe Experience Cloud [ Certificatie ](https://experienceleague.adobe.com/docs/certification/program/overview.html) plaats op Experience League.
...
[!DNL Adobe System Status] biedt uitgebreide informatie, statusupdates en e-mailmeldingen over uitval van Adobe producten en services, onderbrekingen en onderhoudsgebeurtenissen. Ga naar [status.adobe.com](https://status.adobe.com/).

Zie [ Maart 2023 versienota&#39;s ](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2023/03082023.html#status) voor de Status van de Adobe om de recentste updates te bekijken.
...
Voor hulp op de interface van het Experience Cloud gemeenschappelijke componenten, zie de [ Gids van de Interface en van het Beleid van het Experience Cloud ](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) (omvat [!UICONTROL Customer Attributes], [!DNL Experience Cloud Assets], en [!UICONTROL Audiences]).
...
* [ de versienota&#39;s van SDK van het Experience Platform Mobiele ](https://developer.adobe.com/client-sdks/documentation/release-notes/)
...
| -----------| ---------- |---------- |
| Juni 2023 | [ Ingest gegevens van  [!DNL Marketo Engage] ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-marketo.html) | Video | Leer hoe u gegevens van [!DNL Marketo Engage] kunt opnemen in [!DNL Real-Time Customer Data Platform] , B2B Edition en [!DNL Adobe Experience Platform] via de bronconnector en twee workflows. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Mei 2023 | [ hoe te om toegangstoestemming aan Data Warehouse ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21666.html) te verlenen | Leer welke toestemming zou moeten worden toegevoegd om toegangstoestemming aan Data Warehouse te verlenen. |
...
* [ de as a Cloud Service versie van de Experience Manager werkt ](https://experienceleague.adobe.com/docs/events/aemcs-release-update-recordings/overview.html) bij - de overzichten van de eigenschapvideo van huidige en vroegere versies van [!DNL Experience Manager as a Cloud Service].
...
* Ondersteuning voor het nieuwe protocol (DASH - Dynamic Adaptive Streaming over HTTP) dat is gestart voor Adaptive streaming in Dynamic Media-video (met CMAF ingeschakeld): <!-- OLD. UPDATE FOR JUNE 7 -->
...
* **[verbind AEM Forms met JDBC-Gesteunde gegevensbestanden ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/use-form-data-model/configure-data-sources.html#configure-relational-database-configure-relational-database)** - verbind rechtstreeks met ondernemingsgegevensbestanden van AEM de dienst van de Wolk gebruikend protocol JDBC, zonder de behoefte om hen over REST API bloot te stellen.<!-- OLD. UPDATE FOR JUNE 7 -->
...
De versiedatum voor de recentste versie 1.9.10 van Workfront voor Experience Manager verbeterde schakelaar is 18 Mei, 2023.<!-- NEW. LEAVE IN FOR JUNE 7 -->
...
>[!IMPORTANT]
>
>De Adobe adviseert dat u [ aan recentste versie 1.9.10 ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) van Workfront voor Experience Manager verbeterde schakelaar bevordert. <!-- NEW. LEAVE IN FOR JUNE 7 -->
...
| -----------| ---------- | ---------- | ---------- | ------|
| Juni 2023 | [ AEM eerste zelfstudie zonder kop ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/headless-first/overview.html) | Video | Leer het maken van een dynamische en interactieve webtoepassing door de kracht van React, Adobe van [!DNL Experience Manager] Headless API&#39;s en [!DNL GraphQL] te combineren. | AEM CS |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|--------|---------|---------|
| Mei 2023 | [ hoe te om aan douane login pagina van een AEM OAuth stroommislukking ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21954.html) om te leiden | Nieuw artikel | Leer waarom er een omleiding naar de aangepaste aanmeldingspagina nodig is in het geval van AEM `OAuth` -stroomfout en hoe u dit doet. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
|---------|----|----|-----------|
| Mei 2023 | [ Ongeveer het invoeren van Adobe  [!DNL Target]  voederdossiers ](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21827.html) | Nieuw artikel | Leer meer of de waarden worden overschreven of niet wanneer het invoeren van Adobe [!DNL Target] voederdossiers. |
...
| Juni 2023 | [ ga het gebruikersinterface van het Marketo Engage ](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/fundamentals/ui-navigation.html) binnen | Video | Leer hoe u door de gebruikersinterface kunt navigeren en vertrouwd raakt met uw weg rond het [!DNL Marketo Engage] -platform. |
...
>[!NOTE]
>
>**Brand update:** _de Diensten van het Document van de Adobe_ is nu _de Diensten van Adobe Acrobat_. Leer over het [ hier ](https://blog.developer.adobe.com/adobe-document-services-is-now-adobe-acrobat-services-f8e3e506b7b1).
