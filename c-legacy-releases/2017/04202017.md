...
<table id="table_7888822703184513A437A3CEFC599CAA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> In Analysis Workspace kunt u de personenmeting toepassen om bezoekers op hun apparaten te identificeren. </p> <p>Leer hoe te om toegang tot metrisch van Mensen in de <a href="https://marketing.adobe.com/resources/help/en_US/mcdc/mcdc-people.html" format="html" scope="external"> Coop- </a> documentatie van het Apparaat van de Adobe Marketing Cloud te krijgen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Personensjabloon </p> </td> 
   <td colname="col2"> <p>Opmerking:  Het malplaatje van Mensen en zijn bijbehorende metrisch van Mensen is beschikbaar voor gebruik slechts als deel van Co-op van het Apparaat van de <a href="https://marketing.adobe.com/resources/help/en_US/mcdc/mcdc-people.html" format="html" scope="external"> Adobe Marketing Cloud </a>. </p> <p>Het malplaatje is gebaseerd op metrisch van Mensen, die een de-gedupliceerde versie van de Unieke metrische Bezoekers is. Met de maatstaf Mensen wordt gemeten hoe vaak consumenten die meerdere apparaten gebruiken, met uw merk communiceren. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
...
Oplossingen en kleine updates die zijn toegepast op de interfacegereedschappen en componenten van Adobe Analytics (zoals Analysis Workspace, Reports &amp; Analytics, Report Builder, enzovoort).
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      ...
      <li id="li_215E6C18553B4A889E50AB2B1A42CB13">Probleem verholpen waarbij een klant zich niet kon aanmelden bij Report Builder via de aanmelding voor de marketingcloud. (AN-138557) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0B70B5AEE69143D9A5FFA290478E845D"> 
      ...
      <li id="li_AB99880B33E7451BA5DB26F46DA816BF">Probleem verholpen waarbij op sommige webpagina's de timing van het laden van de Analytics-tag in het laden van de pagina een zeldzame omstandigheid veroorzaakte die ervoor zorgde dat de <span class="keyword"> </span> Activity Map na de aanmelding niet correct kon worden geïnitialiseerd. Door dit probleem kon de toepassing geen overlays weergeven, tenzij de gebruiker de webpagina na de aanmelding vernieuwde. (AN-139325) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Naast de bestaande verwerkingsregels wordt een videosessie gesloten, ook als: </p> <p> 
     ...
     </ul> </p> <p>Deze updates zijn beschikbaar op de verwerkingsservice van Video Analytics en hoeven niet te worden gewijzigd in uw Player-implementatie of Analytics-rapportering. </p> </td> 
  </tr> 
  <tr> 
...
* De segmenten-API-methoden zijn gemigreerd naar Swagger. Zie Migratie van [Audience Manager API-code](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AAM-28601)
...
* Probleem verholpen waarbij verkeerde pictogrammen werden weergegeven in het modaal voor het opnieuw instellen van wachtwoorden, in Audience Marketplace en in sorteerkolommen op lijstpagina&#39;s in de gebruikersinterface. (AAM-28953)
* Probleem verholpen in de interface Audience Manager Admin waar een eindgebruiker van Audience Marketplace niet aan een bedrijf kon worden toegevoegd. (AAM-28953)
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>De integratie tussen Adobe Campaign en Dreamweaver is nu live. Het werkt nu met de officiële laatst gepubliceerde versie van Dreamweaver (17.0.2). </p> <p>Hiervoor moet Adobe Campaign Integration-extensie van <a href="https://adobe.ly/acdw_addon" format="http" scope="external"> Adobe Add-ons worden geïnstalleerd </a>. </p> <p> Voor meer informatie kunt u de <a href="https://docs.campaign.adobe.com/doc/standard/en/Videos/ACS_Dreamweaver.mp4" format="mp4" scope="external"> Dreamweaver- en Adobe Campaign Standard Integration- </a> video bekijken. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Er is nu een nieuwe versie van de Dispatcher, het gereedschap voor het in cache plaatsen van Adobe Experience Managers en taakverdeling, <a href="https://www.adobeaemcloud.com/content/companies/public/adobe/dispatcher/dispatcher.html" format="https" scope="external"> beschikbaar </a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Een nieuwe versie van de reverse data feed van Advertising Cloud naar Analytics verbetert de gegevensnauwkeurigheid aanzienlijk. Alle adverteerders met Analytics-integratie zullen de komende weken worden opgewaardeerd tot de nieuwe reverse feed. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>U kunt nu Google-soorten (lijsten voor het opnieuw op de markt brengen van zoekopdrachten) maken met behulp van e-maillijsten of segmenten van uw bestaande Adobe Experience Cloud-publiek: </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Segmenten Adobe Audience Manager: (Alleen bètaversie is niet toegestaan voor adverteerders) van &amp;Bindammer van campagnes;gt; Publiek&amp;gt; Soorten publiek, kunt u een Google website op tag-gebaseerde publiek van om het even welk van uw Audience Manager segmenten tot stand brengen die Advertising Cloud als bestemming hebben. Dit kunnen Adobe Analytics-segmenten zijn die naar Adobe Experience Cloud zijn gepubliceerd en segmenten die in Adobe Experience Cloud zijn gemaakt met de People core-service. Advertising Cloud stuurt automatisch een URL voor het bijhouden van Google naar de Audience Managers zodat Google het publiek kan volgen. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Alleen bètaversie voor niet-toegestane adverteerders) De week na de release wordt een nieuwe gebruikersinterface voor zoekopdrachten beschikbaar, met: </p> <p> 
     <ul id="ul_4D73AB12C2524DD4B0D72AFF1EC5FC0B"> 
      ...
      <li id="li_649DA70ACC7A4A46B2EF91C9C028DE26">Een menu Publiek, met Bibliotheek, Doelen, en Uitsluitingen. In de bibliotheek staan al uw Google-doelgroepen (lijsten voor opnieuw in de handel brengen) en u kunt Google-doelgroepen maken met behulp van segmenten uit de Adobe Audience Manager. U kunt elk publiek in Google-campagnes gebruiken als doelen op groepsniveau en uitsluitingen op campagnemeniveau en op groepsniveau. </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
