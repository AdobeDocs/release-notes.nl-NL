...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Zie ook:</b> Service <a href="../../c-legacy-releases/2017/04202017.md#mcvid" format="dita" scope="local"> voor marketingcloud-id </a> (voorheen <span class="term"> bezoekersidentiteitsservice </span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* De segmenten-API-methoden zijn gemigreerd naar Swagger. Zie [Audience Manager API Code Migration](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html). (AM-28601)
