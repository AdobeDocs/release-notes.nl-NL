---
description: Nieuwe interface Analytics Data Feed;Analysis Workspace-indeling naar vaste locatie in tabellen;algemene oplossingen voor de onderhoudsreleases in de Adobe Marketing Cloud.
keywords: release notes
seo-description: Nieuwe interface Analytics Data Feed;Analysis Workspace-indeling naar vaste locatie in tabellen;algemene oplossingen voor de onderhoudsreleases in de Adobe Marketing Cloud.
...
<table id="table_1F7E1CF091604D22B1D9F3F1AE4DB2D7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Met deze eigenschap wordt de container-id ingesteld die door <span class="keyword"> Audience Manager wordt gebruikt </span> voor ID-syncs. Zie <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-idsyncontainerid.html" format="https" scope="external"> idSyncContainerID </a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Deze openbare methode voegt <span class="wintitle"> Supplemental identiteitskaart van Gegevens </span> (SDID) als parameter van het vraagkoord aan een omleidingsURL toe. Zie <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-appendsupplementaldataidto.html" format="https" scope="external"> appendSupplementalDataTo </a>. (MCID-285) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
[Het gebruiken van DNS Prefetch met Verschillende Oplossingen en de Diensten van de Marketing Cloud](https://marketing.adobe.com/resources/help/en_US/mcloud/dns-prefetch.html)
...
<table id="table_C8291B06B7614B02AC17F7BE419FE4B0"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Marketers kunnen nu interstitiële landingspagina's aanpassen met aangepaste HTML/CSS/JS, zodat u uw pagina's kunt markeren. See <a href="https://marketing.adobe.com/resources/help/en_US/mobile/t_Interstitials.html" format="html" scope="external"> Interstitials </a> for more information. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table frame="all" colsep="1" rowsep="1" id="table_812CAB7DDC364DAABB7CDEDE55532E39"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   <td colname="1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/acquisition_main.html" format="html" scope="external"> Acquisitie </a> </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>In het verleden moesten beheerders van gegevenstoevoer op de klantenservice van Adobe vertrouwen om een statusupdate van hun taken voor gegevenstoevoer te krijgen of hun gegevensdoorvoer te wijzigen. De gebruikersinterface van de gegevensfeed is nu beschikbaar voor alle Adobe Analytics-beheerders. </p> <p>Gebruik de interface Gegevensfeed Analytics om: </p> <p> 
  ...
  <tr> 
   <td colname="col1"> <p>Analysis Workspace: Uitsplitsing naar positie </p> </td> 
   <td colname="col2"> <p>U kunt onderverdelingen uitvoeren op basis van een vaste locatie in een tabel voor vrije vorm. U kunt bijvoorbeeld opgeven dat de bovenste zeven rijen van altijd worden opgesplitst. Deze instelling is standaard uitgeschakeld. </p> <p>Eerder was de lijst met waarden in de uitsplitsing "vergrendeld". This issue led to a situation where, for example, if you broke down <span class="term"> Date </span> by <span class="term"> Page </span>, you got a list of the top 50 pages for your selected date range. </p> <p>Als u dat rapport opsloeg en een maand later weer zou uitvoeren, zouden de bovenste 50 pagina's waarschijnlijk allemaal anders zijn. Analysis Workspace gebruikte echter de resultaten van de oorspronkelijke uitsplitsing en retourneerde dezelfde pagina's, maar met de huidige maand als het datumbereik. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/table-settings.html" format="https" scope="external"> Meer... </a></p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">Probleem verholpen waarbij geen gegevens werden weergegeven in de voorinstelling van de <span class="term"> 2 maanden geleden- </span> kalender. (AN-137808) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_EE874B3A8F77478F818663664AA2752E">Probleem verholpen waarbij de Aanmeldingsdatum gebruiker niet in de Admin Console werd bijgewerkt nadat de gebruiker zich had aangemeld bij de Marketing Cloud Single Sign-On. (AN-130665) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DB9E921671FF481CB0AC02EBA11F792C"> 
     <li id="li_1B31F72A083448168C850D1257EEDA1B">Probleem verholpen in de <span class="keyword"> Data Warehouse </span> waarbij "0,0" verscheen in rapporten met deelname en datumgranulariteit (AN-137529). </li> 
     <li id="li_D4F6ADFFDE93434789C01696EC161A1D"> Verbeterde Admin Module in <span class="keyword"> Data Warehouse </span> om foutencodes in verkeerd voorgelegde verzoeken (AN-126174) te behandelen. </li> 
     <li id="li_4C5383789AC84A7FB6DE139581D4D921"> Probleem verholpen in <span class="keyword"> Data Warehouse </span> die tot onjuiste multi-column evaluaties van de segmentregel leidde wanneer het doelkoord "&amp;" (AN-138137) bevat. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement </span> voor JavaScript</b> </p> 
    ...
    </ul> <p> <b>Zie ook:</b> <a href="../../c-legacy-releases/2017/02162017.md#mcvid" format="dita" scope="local"> Marketing Cloud-id-service </a> (voorheen <span class="term"> bezoekersidentiteitsservice </span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Oplossing voor een probleem dat sommige klanten die RBAC (Role Based Access Controls) aan gebruikersgroepen hebben toegewezen, verhinderde segmenten in de algemene rapporten te selecteren. (AAM-28195)
* Probleem verholpen waarbij een interfaceprobleem waarbij de API voor segmenten ten onrechte werd aangeroepen in plaats van de API voor gegevensbronnen om een *`MergeRule`* naam op te halen. (AAM-27473)
* Knopinfo is toegevoegd aan realtime en de totale segmentpopulatie in de pagina Segmentoverzicht om de getallen beter uit te leggen. (AAM-28077)
* Probleem verholpen waarbij voor een bepaalde klant een gegevensbron ontbrak in de lijst met nieuwe gegevensfeeds in Audience Marketplace. (AAM-28280)
* Probleem verholpen waarbij een verwijderde gegevensbron nog steeds zichtbaar was in algoritmische modellen voor een klant, zodat deze de modellen niet met succes kon uitvoeren. (AAM-28179)
* Oplossing voor een probleem in de overzichtspagina van het segment en de overzichtspagina van de diagrammen, waar de grafieken informatie weergaven met een recentie van drie dagen in plaats van de gebruikelijke 24-36 uur. (AAM-27988)
* Verbeterde prestaties in de responstijd van de API voor mappen. (AAM-28202)
* Bijgewerkt het diagram van Venn om Adresseerbare termijnen van het Publiek te verklaren. See [Addressable Audience documentation](https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences.html). (AAM-27559)
...
* Probleem verholpen waardoor bepaalde klanten segmenten niet konden bewerken. (AAM-28412)
...
<table id="table_5AB641198DF34491AE6D411A9BA32B51"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> Verbeterde documentatie over het aanpassen van de websiteconsole; toegevoegde informatie over MSM-parameters in de volgende AEM 6.2 en AEM 6.1 documentatie: <p> 
