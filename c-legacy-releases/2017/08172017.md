...
<table id="table_948CCE041DCC4F8E852999473E9AE82C"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Gebruikershandleiding Admin Console (voor alle Adobe Cloud-producten) </p> </td> 
   <td colname="col2"> <p> <a href="https://helpx.adobe.com/enterprise/administering/user-guide.html" format="html" scope="external"> Gebruikershandleiding voor beheer </a>. Leer hoe de Adobe Admin Console een centrale locatie biedt voor het beheer van uw rechten voor Adobe in uw hele organisatie. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_2D2E3E490C7347399F25F056AC601E39">
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Een optionele, Booleaanse configuratie die bepaalt of de id-service gegevens naar de Adobe Marketing Cloud Device Co-op verzendt (of niet verzendt). Zie <a href="https://docs.adobe.com/content/help/en/id-service/using/home.html/mcvid-coopsafe.html.html" format="https" scope="external"> CoopSafe </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Op 22 augustus zal Adobe Analytics [Geo Segementation](https://marketing.adobe.com/resources/help/en_US/reference/reports_geosegmentation.html) -rapporten voor alle klanten mogelijk maken. Deze verandering is in afwachting van de aanstaande verwijdering van de geo segmentatie montages in de Admin Console.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>U kunt nu tags toevoegen aan een project terwijl u het project opslaat. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> <b>Tags, kolom in bestemmingspagina van project</b> </p> </td> 
   <td colname="col2"> <p>Added a <span class="wintitle"> Tags </span> column on the Workspace landing page (project list page). Deze kolom toont de tags voor elk project. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/freeform_overview.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> <b>Flowvisualisaties exporteren als CSV-bestanden</b> </p> </td> 
   <td colname="col2"> <p>You can download Flow visualizations as <span class="filepath"> .csv </span> files, which lets you analyze Flow results within Microsoft Excel (visualized as a table) or elsewhere. </p> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/flow.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> <b>Dimension toevoegen aan linkerspoor</b> </p> </td> 
  ...
  <tr> 
   <td> <p>Slimme meldingen </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p></p> </td> 
   <td colname="col1"> <p> <b>Aanvullende betrouwbaarheidsintervallen</b> </p> </td> 
   <td colname="col2"> <p>Bij de waarschuwingen voor anomaliedetectie zijn nu twee nieuwe betrouwbaarheidsniveaus toegevoegd (99,75% en 99,9%). De standaardinstellingen voor bepaalde selecties voor granulariteit zijn ook gewijzigd: </p> 
    <ul id="ul_CB2605E834F14B88908FDA4AE997A392"> 
     <li id="li_659E0B3A5EFC4545B81D6E526DB84D48">Per uur: nu 99,75% </li> 
     <li id="li_A20C0B5722814604A223F4D508E83617">Per dag: nu 99% </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C4E913B41B1E46E7821A312C42FFDADB"> 
      <li id="li_F194FD3B25ED458D81351CAE2F978C87">Oplossing voor een probleem met machtigingen waardoor klanten het aantal toegewezen geplande Report Builder-rapporten niet konden aanpassen. (AN-138801) </li> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Op 22 augustus zal Adobe Analytics <a href="https://marketing.adobe.com/resources/help/en_US/reference/reports_geosegmentation.html" format="html" scope="external"> Geo Segementation- </a> rapporten voor alle klanten inschakelen. Deze verandering is in afwachting van de aanstaande verwijdering van de geo segmentatie montages in de Admin Console. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_41A7B52EFE5A4A2CBBEDC38389E17E13"> 
      <li id="li_89D4145EE47A4C49A209C9DEFA7C3811"> Het probleem waarbij Data Warehouse-uurbanen werden gecreëerd, is opgelost tijdens het verkeerde uur rondom de zomertijd (AN-140128). </li> 
...
* Gebruikers die zijn gekoppeld aan [organisatie-id&#39;s](https://marketing.adobe.com/resources/help/en_US/aam/ids-in-aam.html) kunnen zich nu aanmelden bij de gebruikersinterface van de Audience Manager met hun Adobe ID in plaats van met hun gebruikersnaam en wachtwoord. (AAM-28161)
...
* Een nieuwe configuratie toegevoegd ` isCoopSafe`. Dit is een optionele, Booleaanse configuratie die bepaalt of DIL gegevens naar de [!DNL  Adobe Marketing Cloud Device Co-op]server verzendt. Zie [isCoopSafe](https://marketing.adobe.com/resources/help/en_US/aam/dil-coopsafe.html). (CORE-4334)
...
<table id="table_BFC1B2ABAC8C41B69A7AE72B1BF191DA"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Er zijn nieuwe metriek toegevoegd aan <span class="keyword"> Adobe Analytics </span> die samen met <span class="keyword"> Adobe Social moet worden gebruikt </span>. Deze omvatten: </p> <p> <b>Facebook Video Metrics</b> </p> <p> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Er zijn nieuwe metriek toegevoegd aan <span class="keyword"> Adobe Analytics </span> die samen met <span class="keyword"> Adobe Social moet worden gebruikt </span>. Deze omvatten: </p> <p> 
...
* [Opmerkingen bij de release AEM](../../c-legacy-releases/2017/08172017.md#section_A26CA0B1CC014A59A59EE6406C61771C)
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.3 GVB 6.3.0.2, uitgebracht op 8 augustus 2017, is een belangrijke update die belangrijke klantfixes omvat die sinds de algemene beschikbaarheid van AEM 6.3 april 2017 worden vrijgegeven. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Bij Adobe, vernieuwen wij constant om onze klantenbehoeften te vereenvoudigen en in de zelfde geest voort te zetten, brengen wij aan u de nieuw-nieuwe <a href="https://forums.adobe.com/community/experience-cloud/marketing-cloud/experience-manager?cid=AEMReleaseNoteJuly_1" format="https" scope="external"> AEM Gemeenschap </a>. </p> <p> <b>Wat zit er in?</b> ( <a href="https://helpx.adobe.com/content/dam/help/images/Marketing_Cloud/ATCE/AEMCommunity.mov?cid=cid=AEMReleaseNoteJuly_2" format="https" scope="external"> Video </a>) 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Ontdek alle recente AEM GEM's, zoals "Building Health Checks for AEM", en "AEM Sustenance Best Practices for Deploying AEM", in aanvulling op onze maandelijkse Vraag aan de AEM Community Expert-serie. Koppelingen worden <a href="https://www.meetup.com/AEM-Technologist-Group/messages/boards/" format="https" scope="external"> hier geplaatst </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>

### Aanvullende AEM {#section_EB2C0B4AB8C542F9827D0DE582825D9E}
