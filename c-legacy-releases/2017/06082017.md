...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>In <span class="uicontrol"> Beleid </span> &gt; de Toewijzing van de Reeks van het <span class="uicontrol"> Rapport </span>, kunt u veelvoudige rapportreeksen nu selecteren, dan hen in kaart brengen aan een organisatie. (Eerder moest u ze afzonderlijk toewijzen.) </p> <p>De het rapportreeksen van de toewijzing aan één enkele organisatie helpen dwars-oplossingseigenschappen en de diensten in de Experience Cloud toelaten. Zie <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/report-suite-mapping.html" format="html" scope="external"> De Afbeelding van de Reeks van het Rapport </a> voor meer informatie. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Updates voor publiek Experience Cloud </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In versie 4.13.6 zijn de volgende SDK-verbeteringen aangebracht in iOS en Android: </p> 
    <ul id="ul_B4DC25FD25B745A6BB39B8965D22ECAD"> 
     <li id="li_17282AB9A66A4484917CB9B703AA6DE8">In de Marketing Cloud-id-service kunt u met de API's voor <span class="varname"> </span> syncIdentifiers nu een bestaande waarde voor een id overschrijven. </li> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics introduceerde drie nieuwe product-SKU's: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI is een suite van bedrijfsanalytische dashboards om data te analyseren en inzichten te delen. De integratie van Adobe Analytics met Power BI omvat de capaciteit om de gegevens van de Analytics van Report Builder binnen de Power BI van Microsoft te visualiseren. </p> <p>Met Power BI, kunt u Adobe Analytics met extra gegevensbronnen (b.v. verkooppunt, CRM) integreren om unieke klanteninzichten, verenigingen, en kansen te ontdekken, en hen gemakkelijk te delen over uw organisatie. Het combineren van het vermogen van de rapportgeneratie van Report Builder met eigenschappen van Power BI maakt informatie toegankelijker Web voor iedereen in de organisatie. </p> <p>Dankzij de integratie met Adobe Report Builder kunt u: </p> 
    <ul id="ul_48CC72D3E88B4CCAB6762A32E68E5764"> 
     <li id="li_AC7B3FF2796442A8B7269BEB0824831C"> Publiceer de geplande werkboeken van de Report Builder aan Power BI. </li> 
     <li id="li_5F609B1158D849F7886EB789CA78488D">Publiceer alle geformatteerde lijsten in het werkboek als Lijsten van de Dataset van de Power BI. </li> 
     <li id="li_646E75669B4F40EE8577B5194365F22C">Publiceer alle verzoeken van Report Builder als Lijsten van de Dataset van de Power BI. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">Probleem verholpen waarbij een fout met het maken van segmenten werd veroorzaakt bij het controleren van "Dit als een publiek met een Marketing Cloud maken". (AN-142218, AN-143300) </li> 
     ...
     <li id="li_74750379709445DC97F22CC212C80E21">Probleem verholpen waarbij Ad Hoc Analysis niet kon worden geactiveerd of gedeactiveerd voor een rapportsuite. (AN-142529) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">Probleem verholpen waarbij de optie 'Koppeling naar dit rapport maken' niet beschikbaar was toen de gebruiker zich via de Marketing Cloud aanmeldde. (AN-118492) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C375006CB8A4723B3FC07A8FF7FF6E6"> 
      <li id="li_C8B5B5AE90964673BBE3AC8271F6A2EA">Probleem verholpen waarbij een oude naam van een rapportsuite in Report Builder werd weergegeven, ook al was de naam ervan gewijzigd in de beheerfuncties (AN-139276) </li> 
      <li id="li_BC279F05086144CE8BE0A9A60C5FE865">Probleem verholpen waarbij aanmelden bij Report Builder met Marketing Cloud SSO-aanmelding werd voorkomen. (AN-138557) </li> 
      <li id="li_310B2FCF1091411BA9983E8FC1BF8714">Probleem verholpen waarbij een mengeling van talen werd weergegeven in de interface Report Builder. (AN-137183) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BFC1B2ABAC8C41B69A7AE72B1BF191DA"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Bijgewerkt naar LinkedIn API versie 2.0 voor organisaties. Dit heeft geen invloed op functies, maar zorgt ervoor dat <span class="keyword"> Adobe Social </span>up-to-date is met de nieuwste API's. 
     <!--AS-39691--></p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> AEM 6.2 SP1-GVB4, vrijgegeven 7 juni, 2017, is een belangrijke update die zeer belangrijke klantenmoeilijke situaties omvat die sinds de algemene beschikbaarheid van AEM 6.2 SP1 in December 2016 worden vrijgegeven. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <a href="https://helpx.adobe.com/experience-manager/kb/troubleshooting-companion-app.html" format="https" scope="external"> De gids van het Oplossen van problemen voor AEM Desktop App </a> die wordt bijgewerkt om architecturale veranderingen in de recentste versies te weerspiegelen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM 6.3 documentatie-updates </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Tickets voor IMMERSE17-sessies op aanvraag zijn beschikbaar. Koop hier <a href="https://vts.inxpo.com/Launch/QReg.htm?ShowKey=35334" format="https" scope="external"> en gebruik </a> <code>OD#1AEM</code> code. </p> <p>Beschikbare sessies zijn: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Mei-sessie: Het gebruiken van Lzybones en Bewerkbare malplaatjes in AEM projecten. </p> <p> Sluit zich aan bij Ankur Ahlawat en Scott Macdonald voor een discussie over het gebruik van Lazybones en Editable template in AEM projecten. </p> <p>Door deze zitting te herzien, kunt u leren hoe te om AEM projecten te bouwen die uit Lazybones en de nieuwe Bewerkbare Malplaatjes in uw projecten voordeel halen. Opgenomen op 30 mei 2017, 08:00 PDT ( <a href="https://bit.ly/ATACE517" format="http" scope="external"> https://bit.ly/ATACE517 </a>). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>De naam van het communityforum van Advertising Cloud is veranderd in de Advertising Cloud-gemeenschap en bevindt zich op <a href="https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview" format="https" scope="external"> https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Alleen bètaop de lijst met gewenste personen staan adverteerders) Nieuwe functies zijn: </p> <p> 
