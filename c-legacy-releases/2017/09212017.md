...
* Toegevoegde nieuwe documentatie, het Beleid van de Veiligheid van de [Inhoud en de Dienst](https://docs.adobe.com/content/help/en/id-service/using/reference/csp.html) van identiteitskaart van de Marketing Cloud die verklaart hoe te vraag aan Adobe domeinen toe te staan die door de dienst van identiteitskaart worden gebruikt.
...
De klanten van Analytics kunnen douaneintegratie voor ExactTarget uitvoeren gebruikend standaardAnalytics eigenschappen en APIs, met inbegrip van Classificaties, Gegevensbronnen, de Regels van de Verwerking, en de uitvoer van de Data Warehouse. Indien nodig kunnen afspraken met het Adobe-consultingteam worden overwogen.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p> Tijdgekoppelde dimensies in Analysis Workspace </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>U kunt nu de instellingen voor meerdere kolommen tegelijk wijzigen. Dit is heel eenvoudig: selecteer meerdere kolommen en klik op het instellingenpictogram van een van de kolommen. Alle wijzigingen die u aanbrengt, worden toegepast op alle kolommen waarin u cellen hebt geselecteerd. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/column-settings.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Flow: interdimensionale labels </p> </td> 
   <td colname="col2"> <p>Een nieuw dimensielabel boven aan elke flowkolom maakt het gebruik van meerdere dimensies in een flowvisualisatie intuïtiever. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/multi-dimensional-flow.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Nieuwe telmethode "Hit" in histogrammen </p> </td> 
   <td colname="col2"> <p>Voorheen waren er 2 telmethoden in een histogramvisualisatie: bezoek en bezoeker (standaard). </p> <p>U kunt nu een derde telmethode, "Hit", gebruiken als segmentcontainer. "Voorkomen"wordt gebruikt als y-as metrisch in de vrije vormlijst. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/histogram.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   ...
   <td colname="col2"> <p>In plaats van elk element handmatig te verwijderen, kunt u nu alle elementen in de volgende Workspace-gebieden wissen: </p> 
    <ul id="ul_73E06D64CDCA4E83B9FEC2FD99D41CD3"> 
     <li id="li_A51EF8FADFA04CC19FD79C1675597659"> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/run-contribution-analysis.html" format="html" scope="external"> Uitgesloten componenten voor bijdrage-analyse </a> </li> 
     <li id="li_30E612D5A7584484967260931DB9E30E"> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/compare-segments.html" format="html" scope="external"> Uitgesloten componenten voor segmentvergelijking </a> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Bijgewerkte namen van weergaven in de samenvatting voor wijzigingen </p> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p> Uitgebreid aantal decimalen bij afkorting van aantallen/wijzigingen in samenvatting </p> </td> 
   <td colname="col2"> <p>Afgekorte visualisaties van aantallen/wijzigingen bevatten voorheen geen decimalen. </p> <p>U kunt nu 0-3 decimalen kiezen om uw rapportage te verbeteren. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/summary-number-change.html" format="html" scope="external"> Meer... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> Analysebeheer </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> </td> 
  </tr> 
  <tr> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Analyses en beheerfuncties </p> </td> 
   <td colname="col2"> <p> 
     <ul id="ul_5BA908ECDF46494081D73CA9602553CF"> 
      ...
      <li id="li_BDB795408EDD40B5858A684BF1828098"> <b>Verificatie</b>: Probleem verholpen dat optrad tijdens het aanmelden via de Marketing Cloud - gebruikers hadden geen toegang tot bepaalde virtuele-rapportsuites. (AN-148185, AN-147504) </li> 
      ...
      <li id="li_F083F9EA28FA49B4A894936093DF3A4D"> <b>Beheerder</b>: Probleem verholpen waarbij verschillende typen beheerders werden weergegeven in verschillende interface's: Analytische beheerders (gebruikers hebben een beheerder ingesteld in de gebruikersinterface voor analyse) en Marketing Cloud Admins (gebruikers hebben een beheerder ingesteld in de Marketing Cloud), wat resulteert in een inconsistente telling. (AN-140044) </li> 
      ...
      <li id="li_B2B9D11D205E4F16B28901FA5596E576"> <b>Rapporten en analyses</b>: Probleem verholpen waarbij geen gebruik werd gemaakt van rapportensuites die werden weergegeven in de rapportsuite-kiezer, in gevallen waarin een speciaal teken in de bedrijfsnaam werd weergegeven. (AN-147934) </li> 
      <li id="li_DEC97E3662D14125A8AF43A9D960F516"> <b>Rapporten en analyses</b>: Probleem verholpen waarbij de tijd van geplande rapporten verstreek en niet werd afgeleverd. (AN-140336) </li> 
      <li id="li_3051E23A85544CA997778CE515D62D5C"> <b>Segmentatie</b>: Oplossing voor een probleem dat optrad bij het maken van een segment in Analytics en het delen ervan met de Marketing Cloud: 2 segmenten werden gelijktijdig gecreeerd in Audience Manager met de zelfde naam, maar verschillende rapportreeksen. We publiceren het segment alleen naar ÉÉN rapportsuite. (AN-148432) </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> Probleem verholpen waarbij het gebruik van "java_enabled" voor segmenten niet correct werd verwerkt voor taken van Data Warehouse. (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Actiegerichte logboekbestanden </p> </td> 
   <td colname="col2"> <p> Met Handbare logbestanden kunt u mediagegevens vastleggen uit Google DCM-logbestanden en de gegevens gebruiken als kenmerken in de Audience Manager. Leg impressies vast, klik op en conversies van advertentieservers als onderdelen zonder dat u pixelaanroepen hoeft te gebruiken. See <a href="https://marketing.adobe.com/resources/help/en_US/aam/actionable-log-files.html" format="https" scope="external"> Actionable Log Files </a>. </p> </td> 
  </tr> 
  <tr> 
...
* Herziene tekstbeschrijvingen voor API&#39;s voor gegevensinvoer en de API&#39;s voor parameters voor kenmerkverzoeken en reacties. (AAM-31901, AAM-31914)

**Opgeloste problemen in DIL, Verbeteringen en Verouderde code**

DIL is de code voor de API-gegevensverzameling [!DNL  Audience Manager]. De release van september verhoogt DIL naar versie 6.12.


>[!IMPORTANT]
>
>De ondersteuning van DIL voor Internet Explorer 6, 7 en 8 is afgekeurd en wordt stopgezet. (CORE-4932)


* Oplossing voor een Chrome-gerelateerde fout die veroorzaakte dat DIL een fout veroorzaakte wanneer het klikken op de achterste knop in die browser. (CORE-5135)
* Ongebruikte codemodules zijn verwijderd. (CORE-4554)
* DIL brandt nu de syncs van identiteitskaart opnieuw wanneer gebied identiteitskaart in de reactie van de gebeurtenisvraag verandert. (CORE-4304)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> Abonnement voor massa met oorsprong en datum </p> </td> 
...
[Aanvullende resources](../../c-legacy-releases/2017/09212017.md#section_B1FAFE0975E74070812BC036D994FBE3)
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Deze release biedt nieuwe automatiserings- en leveringsmogelijkheden voor klanten van Dynamic Media en is de eerste versie die bedoeld is voor bestaande klanten van Dynamic Media Classic (S7)-AEM om over te stappen op Dynamic Media. </p> <p> 
     <ul id="ul_9EC225383CFB4B61948229D4C929EACC"> 
      ...
      <li id="li_BE5C8368468542D6AE198A85ECDC177B"> <a href="https://exploreadobe.com/dynamic-media-upgrade/index.html" format="http" scope="external"> portal Dynamische media-upgrade </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Productonderhoud</b> </p> </td> 
   <td colname="col2"> <p>AEM 6.2 Service Pack 1-Cumulatief Fix Pack 7 </p> </td> 
   <td colname="col3"> <p> AEM 6.2 SP1-GVB7, vrijgegeven 12 september, 2017, is een belangrijke update die zeer belangrijke klantenmoeilijke situaties omvat die sinds de algemene beschikbaarheid AEM 6.2 SP1 in December, 2016 worden vrijgegeven. </p> <p> 
  ...
  <tr> 
   <td colname="col2"> <p> Forms-gegevensintegratie </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>De nieuwe ontwikkelaar 6.3 Aan de slag-zelfstudie is beschikbaar op basis van de volgende nieuwste AEM technologieën: </p> <p> 
     <ul id="ul_C8D9CDD14C754A7D9A181D5A1F39260A"> 
      ...
      <li id="li_79696C5019CE42719BC28ACEDD88B74E"> <a href="https://docs.adobe.com/docs/en/aem/6-3/develop/the-basics/touch-ui-concepts.html" format="https" scope="external"> Concepten van de AEM aanraakbare gebruikersinterface </a> </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Er is nieuwe AEM Screens 6.3-documentatie beschikbaar. U kunt ook een Quickstart gebruiken waarmee een gebruiker in 5 minuten een Digital Signage-ervaring kan maken. Zie de volgende bronnen: </p> <p> 
     <ul id="ul_E2B910A6E00244D9A963384C36988D5B"> 
      ...
      <li id="li_FE500F69C813462AB793B0EBCF7A8DDB"> <a href="https://docs.adobe.com/docs/en/aem/6-3/author/authoring-screens.html" format="https" scope="external"> Inhoud beheren voor AEM Screens </a> </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <b>Dynamic Media Feature Pack: Architectuur en probleemoplossing</b> </p> <p> 
     <ul id="ul_4B68CC8CF9534D88A7874E0C63BAD6FE"> 
      <li id="li_41A24144372347DDB1260D5D8E3D2428">Overzicht van de nieuwe Dynamic Media Feature Pack-mogelijkheden. </li> 
