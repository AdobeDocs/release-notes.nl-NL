...
### Gegevensconnectors {#section_190F5136147643AFB77E9CF1A067C438}

**Integratie van de ExactTarget-gegevensconnector met Adobe Analytics**
...
De klanten van Analytics kunnen douaneintegratie voor ExactTarget uitvoeren gebruikend standaardAnalysefuncties en APIs, met inbegrip van Classificaties, Gegevensbronnen, de Regels van de Verwerking, en de uitvoer van het Pakhuis van Gegevens. Eventuele afspraken met het consultingteam van Adobe kunnen worden overwogen.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>Time-paring afmetingen in analysewerkruimte </p> </td> 
   <td colname="col2"> <p>Dimensies die zijn gebaseerd op tijdstempel, zijn offline toegevoegd aan de analysewerkruimte. Afmetingen zijn: </p> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> </td> 
   <td colname="col2"> <p> Adobe Analytics Cloud kan nu de prestaties bijhouden van intelligente assistenten met spraakfunctionaliteit, zoals Amazon Alexa, Google Assistant, Microsoft Cortana en Apple Siri. </p> <p>Zie <a href="https://marketing.adobe.com/resources/help/en_US/reference/voice-analytics-faq.html" format="html" scope="external"> Veelgestelde vragen </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_5BA908ECDF46494081D73CA9602553CF"> 
      ...
      <li id="li_F083F9EA28FA49B4A894936093DF3A4D"> <b>Beheerder</b>: Probleem verholpen waarbij verschillende typen beheerders werden weergegeven in verschillende interface's: Analysebeheerders (gebruikers hebben een beheerder ingesteld in de gebruikersinterface voor Analytics) en Marketing Cloud Admins (gebruikers hebben een beheerder ingesteld in de marketingcloud), wat resulteert in een inconsistente telling. (AN-140044) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7FBF4B0EBC384CCBA1640F06FA379EAA"> 
      <li id="li_EB0401D8344340209AF1AFEABE440A34"> Probleem verholpen waarbij segmenten die "java_enabled" gebruiken, niet correct werden afgehandeld voor taken in Data Warehouse. (AN-147372) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b> Meting van <span class="keyword"> app </span> voor JavaScript</b> </p> <p>JavaScript versie 2.5.0 </p> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>LiveStream-API </b> </p> <p> LiveStream-API maakt nieuwe "pageEvent"- en "exclude"-velden in de uitvoer beschikbaar. In deze update kunt u informatie uit het veld Paginagebeurtenis opnemen, zodat klanten kunnen bepalen of de treffer een paginaweergave, koppelingsaanroep of mediaquery is. </p> <p>Zie <a href="https://marketing.adobe.com/developer/documentation/analytics-live-stream/metrics-dimensions" format="https" scope="external"> Metriek en Afmetingen </a>. </p> 
<!-- <draft-comment> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Met Handbare logbestanden kunt u mediagegevens vastleggen uit Google DCM-logbestanden en de gegevens als kenmerken gebruiken in Audience Manager. Leg impressies vast, klik op en conversies van advertentieservers als onderdelen zonder dat u pixelaanroepen hoeft te gebruiken. Zie <a href="https://marketing.adobe.com/resources/help/en_US/aam/actionable-log-files.html" format="https" scope="external"> Werkbare logbestanden </a>. </p> </td> 
  </tr> 
  <tr> 
...
* Oplossing voor een probleem dat ervoor zorgde dat Lab [van](https://marketing.adobe.com/resources/help/en_US/aam/audience-lab.html) publiek niet tijdig kon worden geladen. (AM-32249)
* Oplossing voor een probleem dat ertoe leidde dat de regels van de Fusie van het Profiel rapportgegevens onjuist op het summiere dashboard in vergelijking met de detailspagina tonen. (AM-31118)
* Oplossing voor een bug in de Model Builder en de Segment Builder die beschrijvingen afknot als de tekst dubbele aanhalingstekens bevatte. (AM-31314)
* Correctie van een probleem waarbij bijgewerkte segmentnamen van Audience Manager niet naar Google DFP-doelen werden verzonden. (AM-31677)
...
<table id="table_7B50E9D0E6D340C1A589CE0713767285"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Met deze Mass Subscription-uitbreiding kunt u abonnementsgegevens (oorsprong en datum) nu rechtstreeks in de Adobe Campagne Standard-database opslaan via de activiteit Subscription Services in een workflow. </p> </td> 
  </tr> 
 </tbody> 
</table>

**Adobe-campagne v7 17.9**
...
<table id="table_0225913B8D5D4B52982ED2E7F2095EEE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Het is nu mogelijk gedragsgegevens van Adobe Campaign Standard terug te sturen naar Adobe Campaign v7, zodat marketers en gegevensanalisten een 360°-weergave van marketingcampagnes kunnen maken. geavanceerde doelgroepen en segmenten te creëren waarin ACS-gedragsgegevens zijn verwerkt; en het rendement van de marketingactiviteiten doeltreffender te meten. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> SAP HANA-aansluiting </p> </td> 
   <td colname="col2"> <p>Breek de silo's en gebruik al uw externe gegevens ‪ in ‪ Adobe-campagne in real-time met Federated Data Access ‪ connectors, die nu ook SAP HANA ondersteunen. Met Federated ‪ Data Access ‪ kunnen gebruikers meerdere, uiteenlopende, ‪ externe ‪ databases verbinden met Adobe Campaign. Vraag gegevens in real time van om het even welke bron zonder het invoeren ‪ de ‪ dataset of het opslaan binnen het platform van de Campagne van Adobe. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Hadoop Connector via HiveSQL </p> </td> 
   <td colname="col2"> <p>Wanneer het over het behandelen van grote gegevensreeksen komt, heeft Hadoop het voordeel boven relationele gegevensbestandbeheersystemen, en zijn waarde voor om het even welke groottezaken zal blijven stijgen aangezien de ongestructureerde gegevens blijven groeien. De Campagne van Adobe kan de macht van Hadoop door de Schakelaar van het Hadoop via HiveSQL gebruiken waar klanten tot schema's direct van de UI van de Campagne van Adobe kunnen toegang hebben om geavanceerde, hoogst gesegmenteerde publiek op snelle, flexibele, en scalable manier tot stand te brengen. </p> </td> 
  </tr> 
  <tr> 
...
### Opmerkingen bij de release van AEM {#section_0D030B9BE20E4D4A883A8F8917420558}
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>Deze release biedt nieuwe automatiserings- en leveringsmogelijkheden voor klanten van Dynamic Media en is de eerste versie die bedoeld is voor bestaande klanten van Dynamic Media Classic (S7)-AEM om over te stappen op Dynamic Media. </p> <p> 
     <ul id="ul_9EC225383CFB4B61948229D4C929EACC"> 
      ...
      <li id="li_8DF0DE76403B474F80BA5BAD0CDEC8AF"> <a href="https://docs.adobe.com/docs/en/aem/6-3/release-notes/dynamic-media-featurepack-14410.html" format="https" scope="external"> Opmerkingen bij de release </a> </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> AEM 6.2 SP1-GFP7, vrijgegeven 12 september, 2017, is een belangrijke update die zeer belangrijke klantenmoeilijke situaties omvat die sinds de algemene beschikbaarheid AEM 6.2 SP1 in December, 2016 worden vrijgegeven. </p> <p> 
     <ul id="ul_43836805FC5B4A5CA3CCD419B468D38D"> 
      <li id="li_546B0856E60F4A07860C85DD1AC70DA5"> <a href="https://helpx.adobe.com/experience-manager/release-notes--aem-6-2-cumulative-fix-pack.html" format="https" scope="external"> Opmerkingen bij de release </a> </li> 
  ...
  <tr> 
   <td colname="col1" morerows="10"> <p> <b>Zelfhulp</b> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>U kunt AEM Forms-bestanden en -mappen uitsluiten van de ontoegankelijke virusscantoepassing om de prestaties van uw Forms-server te verbeteren. </p> <p>Zie Prestaties afstemmen van AEM Forms Server <a href="https://helpx.adobe.com/aem-forms/6-3/performance-tuning-aem-forms.html" format="https" scope="external"> </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Oplossing voor verschillende problemen en installatie- en upgradedocumentatie voor AEM 6.3 Forms JEE. </p> <p>Zie <a href="https://helpx.adobe.com/aem-forms/6-3/user-guide.html" format="https" scope="external"> AEM Forms on JEE installeren of upgraden </a> onder <b>Onderwerpen</b> in het linkerdeelvenster. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>De nieuwe zelfstudie Aan de slag voor ontwikkelaar 6.3 is beschikbaar op basis van de volgende nieuwste AEM-technologieën: </p> <p> 
     ...
     </ul> </p> <p>Zie <a href="https://docs.adobe.com/docs/en/aem/6-3/develop/the-basics/getting-started.html" format="https" scope="external"> Aan de slag met het ontwikkelen van AEM-sites 6.3 - WKND-zelfstudie </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col2"> <p> AEM-schermen 6.3 Documentatie met behulp van clientbibliotheken </p> </td> 
   <td colname="col3"> <p>Er is nieuwe AEM-documentatie voor schermen 6.3 beschikbaar. U kunt ook een Quickstart gebruiken waarmee een gebruiker in 5 minuten een Digital Signage-ervaring kan maken. Zie de volgende bronnen: </p> <p> 
     <ul id="ul_E2B910A6E00244D9A963384C36988D5B"> 
      <li id="li_A062B0619A594DD2AB0D9C679559E28A"> <a href="https://docs.adobe.com/docs/en/aem/6-3/deploy/aem-screens-introduction.html" format="https" scope="external"> AEM-schermen: Een inleiding </a> </li> 
      ...
      <li id="li_FE500F69C813462AB793B0EBCF7A8DDB"> <a href="https://docs.adobe.com/docs/en/aem/6-3/author/authoring-screens.html" format="https" scope="external"> Inhoud voor AEM-schermen beheren </a> </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <b>Dynamic Media Feature Pack: Architectuur en probleemoplossing</b> </p> <p> 
     ...
     </ul> </p> <p>Opnemen: https://bit.ly/AEMGEM83017 <a href="https://bit.ly/AEMGEM83017" format="http" scope="external"></a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads begint op 25 september met het migreren van via de cloud beheerde accounts naar het nieuwe sitelink-model (gedeelde sitelinks); het proces zal naar verwachting vier dagen duren . Tussen 22 september en de voltooiing van de migratie naar uw account zijn sitelinks niet toegankelijk in de Advertising Cloud en worden ten onrechte weergegeven als verwijderd. Als u wijzigingen in uw sitelinks moet aanbrengen voordat de migratie is voltooid, werkt u rechtstreeks in de Bing Ads-editor. uw wijzigingen worden naar het nieuwe model gemigreerd en gesynchroniseerd door Advertising Cloud nadat de migratie is voltooid. Functionaliteit voor ondersteuning van gedeelde sitelinks is beschikbaar in de release van oktober. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Bèta zoeken in campagnes </p> </td> 
