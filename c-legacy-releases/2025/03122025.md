...
| Maart 2025 | [!DNL AEM Headless as a Cloud Service] | [ Next.js App ](https://experienceleague.adobe.com/nl/docs/experience-manager-learn/getting-started-with-aem-headless/how-to/example-apps/next-js) | Nieuwe video | Voorbeelden van toepassingen zijn ideaal om de mogelijkheden zonder kop van Adobe [!DNL Experience Manager] (AEM) te verkennen. Deze `Next.js` -toepassing laat zien hoe u inhoud kunt opvragen met AEM GraphQL API&#39;s met behulp van doorlopende query&#39;s. |
