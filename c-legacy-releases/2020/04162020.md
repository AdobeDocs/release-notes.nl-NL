...
| [Inleiding tot de Java™ Content Repository (JCR)](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/underlying-technology/introduction-jcr.html) | Een inleiding op de Java™ Content Repository (JCR) die door Adobe Experience Manager wordt gebruikt. |
...
* Adobe Campaign Classic: [Documentatie](https://experienceleague.adobe.com/docs/campaign-classic.html) - [Hoe kan ik-video&#39;s](https://experienceleague.adobe.com/docs/campaign-learn/campaign-classic-tutorials/overview.html)
