...
Zie [Cumulatieve opmerkingen bij de release](https://experienceleague.corp.adobe.com/docs/core-services/interface/release-notes/release-notes.html) voor de meest recente releasegegevens voor de Experience Cloud-interface (klantkenmerken, soorten publiek, gebruikers- en productbeheer).
...
* [Werkruimte voor gegevenswetenschap](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#dsw)
* [Doelen](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#destinations)
* [Bronnen](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#sources)
...
* Augustusrelease - [Meer informatie](https://experienceleague.corp.adobe.com/docs/journeys/using/release-notes/release-notes.html#august-release)
...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: beschikbaarheid in EMEA en APAC | 31 augustus 2020 | [Cross-Device ](https://experienceleague.corp.adobe.com/docs/analytics/components/cda/overview.html) Analytics en een persoonlijke grafiek zijn beschikbaar voor klanten in EMEA en APAC. |
...
AEM 6.4, Service Pack 8, Cumulative Fix Pack 2 (6.4.8.2 vrijgegeven op 3 september 2020) is een belangrijke update die verscheidene interne en klantenmoeilijke situaties omvat sinds de algemene beschikbaarheid van AEM 6.4, Service Pack 8 (6.4.8.0), Maart 2020.
   * [Aanvullende informatie](https://experienceleague.corp.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Mogelijkheid in [!UICONTROL AEM as a Cloud Service] om pagina&#39;s en subpagina&#39;s (paginastructuren) te herstellen naar een eerdere versie](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).[
...
Zie [Testen van contentcontrole.](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)
...
* **Experience Manager  [!UICONTROL Desktop App] 2.0.3.2**
   ...
   * Zie de [releaseopmerkingen.](https://experienceleague.corp.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html)
...
* **AEM[!UICONTROL Assets Brand Portal]**
   ...
   * Zie de [releaseopmerkingen.](https://experienceleague.corp.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
...
* **CDN-validatie in[!UICONTROL Dynamic Media]**
   ...
   Zie [De CDN-cache ongeldig maken met behulp van [!UICONTROL Dynamic Media].](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)
...
| 17 augustus 2020 | [Toegang tot AEM configureren](https://video.tv.adobe.com/v/39230) | Video | Onderzoek hoe de gebruikers voor authentiek verklaren gebruikend Adobe IMS aan [!UICONTROL AEM as a Cloud Service], en hoe de Gebruikers van Adobe IMS, [!UICONTROL User Groups], en [!UICONTROL Product Profiles] worden gebruikt om toegang tot AEM en zijn eigenschappen en functionaliteiten te controleren. |
| 17 augustus 2020 | [Toegang tot AEM doorlopen configureren](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/cloud-service/accessing/walk-through.html) | Video | Een verkorte stap-hoewel het vormen van gebruikers van Adobe IMS, [!UICONTROL User Groups], en [!UICONTROL Product Profiles] in Adobe [!UICONTROL Admin Console]. Leer ook hoe u deze Adobe IMS-abstracties in [!UICONTROL AEM Author] kunt benutten om specifieke op groepen gebaseerde machtigingen te definiëren en te beheren. |
...
| 12 augustus 2020 | [Lokale ontwikkeling met AEM als Cloud Service SDK](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/commerce/develop.html) | Video | Leer hoe u een lokale ontwikkelomgeving instelt voor [!UICONTROL AEM Commerce] en de SDK [!UICONTROL AEM as a Cloud Service]. |
...
* [Gebruikershandleidingen voor AEM as a Cloud Service](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/landing/home.html)
...
* Release 20.2.2 - [meer informatie](https://experienceleague.corp.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html#release-20-2-2-build-9180)
