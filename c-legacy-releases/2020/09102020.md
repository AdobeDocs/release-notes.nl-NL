...
* [Analytics](#analytics) (Bijgewerkt september 29, 2020) en [Customer Journey Analytics](#cust-journey)
...
Zie [Cumulatieve opmerkingen bij de release](https://docs.adobe.com/content/help/en/core-services/interface/release-notes/release-notes.html) voor de meest recente releasegegevens voor de Experience Cloud-interface (klantkenmerken, soorten publiek, gebruikers- en productbeheer).
...
* Augustusrelease - [Meer informatie](https://docs.adobe.com/content/help/en/journeys/using/release-notes/release-notes.html#august-release)
...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: beschikbaarheid in EMEA en APAC | 31 augustus 2020 | [Cross-Device ](https://docs.adobe.com/content/help/nl-NL/analytics/components/cda/overview.html) Analytics en een persoonlijke grafiek zijn beschikbaar voor klanten in EMEA en APAC. |
...
* Probleem verholpen waarbij segmenten die aan Facebook zijn toegewezen niet zouden worden bijgewerkt omdat een veld `traitAlias` in een API-aanroep ontbreekt. [!UICONTROL People-based destinations] (AAM-55952)
...
AEM 6.4, Service Pack 8, Cumulative Fix Pack 2 (6.4.8.2 vrijgegeven op 3 september 2020) is een belangrijke update die verscheidene interne en klantenmoeilijke situaties omvat sinds de algemene beschikbaarheid van AEM 6.4, Service Pack 8 (6.4.8.0), Maart 2020.
   * [Aanvullende informatie](https://docs.adobe.com/content/help/nl-NL/experience-manager-64/release-notes/cfp-release-notes.html)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Mogelijkheid in [!UICONTROL AEM as a Cloud Service] om pagina&#39;s en subpagina&#39;s (paginastructuren) te herstellen naar een eerdere versie](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).[
   ...
   * U kunt de CDN-cache (Content Delivery Network) nu direct invalideren vanuit [!UICONTROL Dynamic Media] in [!UICONTROL AEM as a Cloud Service] (in tegenstelling tot het gebruik van [!UICONTROL Dynamic Media Classic]) om ervoor te zorgen dat de nieuwste elementen binnen minuten in plaats van uren worden aangeboden. Zie [De CDN-cache ongeldig maken via Dynamic Media.](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)
...
Zie [Testen van contentcontrole.](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)
...
* **Experience Manager  [!UICONTROL Desktop App] 2.0.3.2**
   ...
   * Zie de [releaseopmerkingen.](https://docs.adobe.com/content/help/nl-NL/experience-manager-desktop-app/using/release-notes.html)
...
* **AEM[!UICONTROL Assets Brand Portal]**
   ...
   * Zie de [releaseopmerkingen.](https://docs.adobe.com/content/help/nl-NL/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
...
* **CDN-validatie in[!UICONTROL Dynamic Media]**
   ...
   Zie [De CDN-cache ongeldig maken met behulp van [!UICONTROL Dynamic Media].](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)

* **In- en uittijden voor het publiceren van pagina&#39;s**

   Wanneer u pagina&#39;s publiceert met [Aan en Uit Times](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/sites/authoring/fundamentals/page-properties.html#basic), raadpleegt u het tabblad Standaard van Pagina-eigenschappen. U kunt Automatische replicatie nu [vooraf configureren](https://docs.adobe.com/help/en/experience-manager-cloud-service/operations/replication.html#on-and-off-times-trigger-configuration).
...
| 12 augustus 2020 | [Lokale ontwikkeling met AEM als Cloud Service SDK](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/commerce/develop.html) | Video | Leer hoe u een lokale ontwikkelomgeving instelt voor [!UICONTROL AEM Commerce] en de SDK [!UICONTROL AEM as a Cloud Service]. |
...
* [Releaseopmerkingen bij AEM 6.4 Cumulative Fix Pack](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
