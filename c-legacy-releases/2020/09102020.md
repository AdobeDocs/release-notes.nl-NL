...
| 12 augustus 2020 | [Het begrip en het Vormen van de Klant van Google Poort op mensen-Gebaseerde Bestemming](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/data-activation/people-based-destinations/understanding-and-configuring-the-google-customer-match-pbd.html) | Video | Deze video bespreekt u de details en het gebruiksgeval van de Gelijke [!UICONTROL People-Based Destination] van de Klant van Google, en omvat een doorloop van het creëren van een segment en het in kaart brengen van het aan een bestemming. Het toont ook het publiek dat landt in de Google Ad Console. |
...
* **Nieuwe gereedschappen voor[!UICONTROL AEM as a Cloud Service Transitions]**
   ...
   * [!UICONTROL AEM Dispatcher Converter] uitgebreid om omzettingen van  [!UICONTROL Managed Services Dispatcher] configuraties On-premise en Adobe in AEM as a Cloud Service compatibele configuraties van de Verzender te steunen. Zie het middel GitHub [AEM Cloud Service Dispatcher Converter](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/dispatcher-converter) voor meer details.
