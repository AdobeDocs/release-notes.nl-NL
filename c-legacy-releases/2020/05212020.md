...
* [[!DNL Target]](https://experienceleague.adobe.com/content/help/en/target/using/release-notes/target-release-notes.html) (koppelingen naar de Help-pagina van Target)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
* [Ondersteuning van klantkenmerken voor CCPA](https://experienceleague.adobe.com/content/help/en/core-services/interface/customer-attributes/ccpa.html) (California Consumer Privacy Act)
* [Ondersteuning van klantkenmerken voor GDPR](https://experienceleague.adobe.com/content/help/en/core-services/interface/customer-attributes/gdpr.html) (General Data Protection Regulation)
...
* [Documentatie](https://experienceleague.adobe.com/content/help/en/journeys/using/journey-orchestration-home.html)
* [Releaseopmerkingen](https://experienceleague.adobe.com/content/help/en/journeys/using/release-notes/release-notes.html)
* [Instructievideo&#39;s](https://experienceleague.adobe.com/content/help/en/platform-learn/tutorials/journey-orchestration/introduction.html)
...
Zie [Informatie over het bijhouden van Player-status](https://experienceleague.adobe.com/content/help/en/media-analytics/using/player-state-tracking/player-state-overview.html).
...
Zie [AppMeasurement voor Javascript-releaseopmerkingen](https://experienceleague.adobe.com/content/help/en/analytics/implementation/appmeasurement-updates.html). Versie 2.20.0 is uitgebracht op 5 maart 2020.
...
| [Uitbreiding Donkere modus voor Analysis Workspace](https://experienceleague.adobe.com/content/help/en/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html) | Schakel de Reader Chrome-uitbreiding Donker in om Analysis Workspace donker te maken. |
...
| [Schema&#39;s voor metadatamappen](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/configuring/metadata-folder-schemas.html) | Met schema&#39;s voor metadatamappen kunnen gebruikers metadata die aan assetmappen zijn gekoppeld, zelf beheren en controleren in plaats van via assets. |
...
| [Metadataschema&#39;s](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/configuring/metadata-schemas.html) | Metadataschema&#39;s definiëren de interface die metadata van assets in AEM beschikbaar maakt. In deze video wordt de combinatie van methoden voor het toepassen van assets besproken. |

### Aanvullende bronnen

* [Releaseopmerkingen bij AEM as a Cloud Service](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
* [AEM as a Cloud Service-documentatie](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/landing/home.html)
...
* [Adobe Campaign Standard 20.3-release](https://experienceleague.adobe.com/content/help/en/campaign-standard/using/release-notes/release-notes.html)
...
| Inhoud | Beschrijving |
| -----------| ---------- |  
| [Beheer van big data op Snowflake](https://experienceleague.adobe.com/content/help/en/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html) | Krijg inzicht in het gebruik van de Snowflake-connector in Adobe Campaign Classic. |
...
* Adobe Campaign - Configuratiescherm: [Documentatie](https://experienceleague.adobe.com/content/help/en/control-panel/using/control-panel-home.html) - [Releaseopmerkingen](https://experienceleague.adobe.com/content/help/en/control-panel/using/release-notes.html)
