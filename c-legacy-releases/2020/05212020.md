...
>[!NOTE]
>
>Meld u aan voor [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html) om via e-mail op de hoogte te worden gesteld van komende releases.
...
* [[!DNL Target]](https://experienceleague.corp.adobe.com/docs/target/using/release-notes/target-release-notes.html?lang=en) (koppelingen naar de Help-pagina van Target)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
Hulp nodig? Bezoek [[!DNL Adobe Experience League]](https://experienceleague.adobe.com/#home) om cursussen met Adobe-cursus, technische documentatie, snelle antwoorden, inzicht in de gebruikersgemeenschap, en instructeur-geleide opleiding te vinden.
...
* [Ondersteuning van klantkenmerken voor CCPA](https://experienceleague.corp.adobe.com/docs/core-services/interface/customer-attributes/ccpa.html) (California Consumer Privacy Act)
* [Ondersteuning van klantkenmerken voor GDPR](https://experienceleague.corp.adobe.com/docs/core-services/interface/customer-attributes/gdpr.html) (General Data Protection Regulation)
...
* [Documentatie](https://experienceleague.corp.adobe.com/docs/journeys/using/journey-orchestration-home.html)
* [Releaseopmerkingen](https://experienceleague.corp.adobe.com/docs/journeys/using/release-notes/release-notes.html)
* [Instructievideo&#39;s](https://experienceleague.corp.adobe.com/docs/platform-learn/tutorials/journey-orchestration/introduction.html)
...
Zie [Informatie over het bijhouden van Player-status](https://experienceleague.corp.adobe.com/docs/media-analytics/using/player-state-tracking/player-state-overview.html).
...
Zie [AppMeasurement voor Javascript-releaseopmerkingen](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html). Versie 2.20.0 is uitgebracht op 5 maart 2020.
...
| [Uitbreiding Donkere modus voor Analysis Workspace](https://experienceleague.corp.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html) | Schakel de Reader Chrome-uitbreiding Donker in om Analysis Workspace donker te maken. |
...
* **Niet-ondersteunde afbeeldingsindelingen in Dynamic Media**
   ...
   Zie [Niet-ondersteunde indelingen van rasterafbeeldingen in Dynamische media](https://experienceleague.corp.adobe.com/docs/experience-manager-65/assets/administer/assets-formats.html#unsupported-image-formats-dynamic-media).
...
| [Schema&#39;s voor metadatamappen](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-folder-schemas.html) | Met schema&#39;s voor metadatamappen kunnen gebruikers metadata die aan assetmappen zijn gekoppeld, zelf beheren en controleren in plaats van via assets. |
...
| [Metadataschema&#39;s](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-schemas.html) | Metadataschema&#39;s definiëren de interface die metadata van assets in AEM beschikbaar maakt. In deze video wordt de combinatie van methoden voor het toepassen van assets besproken. |

### Aanvullende bronnen

* [Releaseopmerkingen bij AEM as a Cloud Service](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
* [AEM as a Cloud Service-documentatie](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/landing/home.html)
...
* [Adobe Campaign Standard 20.3-release](https://experienceleague.corp.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html)
...
| Inhoud | Beschrijving |
| -----------| ---------- |  
| [Beheer van big data op Snowflake](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html) | Krijg inzicht in het gebruik van de Snowflake-connector in Adobe Campaign Classic. |
...
* Adobe Campaign - Configuratiescherm: [Documentatie](https://experienceleague.corp.adobe.com/docs/control-panel/using/control-panel-home.html) - [Releaseopmerkingen](https://experienceleague.corp.adobe.com/docs/control-panel/using/release-notes.html)
