...
Hulp nodig? Bezoek [[!DNL Experience League] &#x200B;](https://experienceleague.adobe.com/nl#home) om Adobe-geleide cursussen, technische documentatie, snelle antwoorden, gemeenschapsinzicht, en instructeur-geleide opleiding te vinden.
...
* [Ondersteuning van klantkenmerken voor CCPA](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/ccpa.html?lang=nl-NL) (California Consumer Privacy Act)
* [Ondersteuning van klantkenmerken voor GDPR](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/gdpr.html?lang=nl-NL) (General Data Protection Regulation)
...
* [Instructievideo&#39;s](https://experienceleague.adobe.com/docs/platform-learn/tutorials/journey-orchestration/introduction.html?lang=nl-NL)
...
Zie [Informatie over het bijhouden van Player-status](https://experienceleague.adobe.com/docs/media-analytics/using/player-state-tracking/player-state-overview.html?lang=nl-NL).
...
| Inhoud | Beschrijving |
| -----------| ---------- |
| [Trainingstutorialsjabloon in Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/navigating-workspace-projects/training-tutorial-template-in-analysis-workspace.html?lang=nl-NL) | In de [!UICONTROL Analysis Workspace] Trainingstutorials doorloopt u de gebruikelijke terminologie en stappen voor het opzetten van uw eerste project in [!UICONTROL Workspace]. |
| [Vergelijkingen van voorafgaande maanden en jaar toevoegen aan trends](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/calendar-and-date-ranges/adding-prior-month-and-year-comparisons-to-trends.html?lang=nl-NL) | Leer hoe u aangepaste datumbereiken toepast om maandelijkse en jaarlijkse trendvergelijkingen te maken voor alle cijfers in [!UICONTROL Analysis Workspace]. |
| [Uitbreiding Donkere modus voor Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html?lang=nl-NL) | Schakel de Reader Chrome-uitbreiding Donker in om Analysis Workspace donker te maken. |
| [Kleurenpipetextensie voor het definiëren van aangepaste paletten](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/color-eyedropper-extension-for-defining-custom-palettes.html?lang=nl-NL) | Leer hoe u de Chrome-extensie ColorPick EyeDropper Chrome gebruikt om eenvoudig de hexadecimale waarden te vinden die u nodig hebt voor een aangepast kleurenpalet in uw [!UICONTROL Workspace]-projecten. |
...
| Inhoud | Beschrijving |
| -----------| ---------- |  
| [Inzicht in basisterminologie en -concepten in Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/intro-to-audience-manager/understanding-basic-terms-and-concepts-in-audience-manager.html?lang=nl-NL) | In deze video worden enkele basistermen en -concepten besproken waarmee u in Audience Manager aan de slag kunt, zoals signalen, kenmerken, segmenten, enzovoort. |
| [Inzicht in de datastroom in Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/intro-to-audience-manager/understanding-the-data-flow-in-audience-manager.html?lang=nl-NL) | Door deze video krijgt u meer inzicht in Adobe Audience Manager door een beschrijving van de datastroom naar, door en vanuit de applicatie. |
| [Audience Manager - Overzicht van een DMP](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/intro-to-audience-manager/audience-manager-overview-of-a-dmp.html?lang=nl-NL) | Krijg inzicht in de belangrijkste uitdagingen voor personalisatie via verschillende kanalen en in de manier waarop Adobe Audience Manager het klanttraject aanstuurt. Ontdek ook welke datatypen in Audience Manager kunnen worden opgenomen en welke ad-tech eco-systeempartners met Audience Manager zijn geïntegreerd. |
| [Gebruiksscenario&#39;s van Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/intro-to-audience-manager/audience-manager-use-cases.html?lang=nl-NL) | In deze video identificeren we vier gemeenschappelijke gebruiksscenario&#39;s van Audience Manager, en beschrijven we de best practices voor elk scenario. |
| [Inzicht in cijfers voor verschillende apparaten in Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/profile-merge/understanding-cross-device-metrics-in-audience-manager.html?lang=nl-NL) | In deze video bespreken we het verschil tussen apparaatprofielen en cross-device-apparaatprofielen en laten we zien waar de getallen in de gebruikersinterface overeenkomen met deze verschillende profieltypen. |
| [Voorspelbare doelgroepen in Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/algorithmic-models/understanding-predictive-audiences.html?lang=nl-NL) | In deze video bespreken we wat voorspelbare doelgroepen in Audience Manager zijn, leggen we uit hoe ze werken en geven we voorbeelden van het gebruik. |
| [Configureer en rapporteer over voorspelbare doelgroepen in Audience Manager](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/algorithmic-models/configure-and-report-on-predictive-audiences.html?lang=nl-NL) | In deze video doorlopen we de configuratie van voorspelbare doelgroepen in de interface van Audience Manager. We bekijken ook de rapporten die de resultaten van het model laten zien. |
...
* **Niet-ondersteunde afbeeldingsindelingen in Dynamic Media**
  ...
  Zie [Niet-ondersteunde indelingen van rasterafbeeldingen in Dynamische media](https://experienceleague.adobe.com/docs/experience-manager-65/assets/administer/assets-formats.html?lang=nl-NL#unsupported-image-formats-dynamic-media).

* **Contentfragmenten**

  Informatie over [Ondersteuning voor contentfragmenten in de HTTP-API van AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/assets-api-content-fragments.html?lang=nl-NL), samen met [Contentfragmenten aanpassen en uitbreiden](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-customizing.html?lang=nl-NL) en [Onderdelen in Contentfragmenten configureren voor rendering](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/configuring-and-extending/content-fragments-configuring-components-rendering.html?lang=nl-NL).
...
| [Schema&#39;s voor metadatamappen](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-folder-schemas.html?lang=nl-NL) | Met schema&#39;s voor metadatamappen kunnen gebruikers metadata die aan assetmappen zijn gekoppeld, zelf beheren en controleren in plaats van via assets. |
| [Tags](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/tagging.html?lang=nl-NL) | Tags zijn een integrale tool voor het beheer van assets in de maphiërarchie van assets. Het instellen van een tagtaxonomie is cruciaal om het voor gebruikers mogelijk te maken assets te ontdekken en te ordenen in AEM. |
| [Metadataprofielen](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-profiles.html?lang=nl-NL) | Met metadataprofielen kunnen standaardmetadata automatisch worden toegepast op assets in assetmappen. Dit verkleint de last van metadatabeheer voor AEM-gebruikers en vergroot de consistentie van metadata. |
| [Metadataschema&#39;s](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-schemas.html?lang=nl-NL) | Metadataschema&#39;s definiëren de interface die metadata van assets in AEM beschikbaar maakt. In deze video wordt de combinatie van methoden voor het toepassen van assets besproken. |

### Aanvullende bronnen

* [Releaseopmerkingen bij AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=nl-NL)
* [AEM as a Cloud Service-documentatie](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=nl-NL)
...
* [Adobe Campaign Standard 20.3-release](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=nl-NL)

### Campaign Classic

* [Adobe Campaign Classic 20.1.3](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=nl-NL#release-20-1-3-build-9124)
* [Adobe Campaign Classic 19.1.4](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=nl-NL#release-19-1-4-build-9032)
...
| Inhoud | Beschrijving |
| -----------| ---------- |  
| [Besturingsdeelvenster - Google TXT-recordbeheer](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/administrating/control-panel/google-txt-record-management.html?lang=nl-NL) | Leer hoe u verificatiedata van de Google TXT-site toevoegt aan al uw subdomeinen die worden gebruikt om e-mails naar GMAIL-adressen te verzenden via het Campaign-besturingsdeelvenster. |
| [Een workflow configureren en uitvoeren met de externe-API-activiteit](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/managing-processes-and-data/data-management-activities/external-api-activity.html?lang=nl-NL) | Leer een extern REST-API-eindpunt op te roepen met de externe-API-activiteit. |
...
| Inhoud | Beschrijving |
| -----------| ---------- |  
| [Beheer van big data op Snowflake](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html?lang=nl-NL) | Krijg inzicht in het gebruik van de Snowflake-connector in Adobe Campaign Classic. |
| [Besturingsdeelvenster - Google TXT-recordbeheer](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/administrating/control-panel-acc/google-txt-record-management.html?lang=nl-NL) | Leer hoe u verificatiedata van de Google TXT-site toevoegt aan al uw subdomeinen die worden gebruikt om e-mails naar GMAIL-adressen te verzenden via het Campaign-besturingsdeelvenster. |
