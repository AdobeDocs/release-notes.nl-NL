...
* **AEM 6.5.3.0** AEM 6.5, Service Pack 3.0 (6.5.3.0 vrijgegeven 12 december 2019) is een belangrijke update die zeer belangrijke klantenmoeilijke situaties omvat die sinds de algemene beschikbaarheid van AEM 6.5, April 2019 worden vrijgegeven.
...
* **AEM Project-archetype**
   ...
   De module [ui.frontend](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/archetype/uifrontend.html) van het [AEM Archetype](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/archetype/overview.html) van het Project is een nuttig en flexibel hulpmiddel om front-end ontwikkeling voor uw AEM project gemakkelijker te maken.
...
* SSL-certificaat van een subdomein vernieuwen - Meer [informatie](https://docs.adobe.com/content/help/nl-NL/control-panel/using/subdomains-and-certificates/renewing-subdomain-certificate.html)
