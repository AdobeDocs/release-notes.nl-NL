...
Voor productdocumentatie, zie [&#x200B; Experience Cloud &#x200B;](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html).
...
Zie [&#x200B; AppMeasurement voor Javascript versienota&#39;s &#x200B;](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html).
...
* **Adobe Asset Link 1.1 beëindigt steun voor AEM 6.3.x**
   ...
   * [&#x200B; de Verbinding van Activa van Adobe &#x200B;](https://helpx.adobe.com/enterprise/admin-guide.html/enterprise/using/adobe-asset-link.ug.html)
...
* **NIEUW: AEM as a Cloud Service**
   ...
   * [&#x200B; de Informatie van de Versie &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/home.html)
...
* **Geautomatiseerde Dienst van de Omzetting van Vormen**
   ...
   * [&#x200B; vorm de dienst &#x200B;](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   * [&#x200B; zet PDF forms in adaptieve vormen om &#x200B;](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)
...
Zie [&#x200B; Previewing 3D activa &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html).
...
* **AEM Project-archetype**
  ...
  De [&#x200B; module ui.frontend &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/uifrontend.html) van [&#x200B; Archetype van het Project van AEM &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/developing/archetype/overview.html) is een nuttig en flexibel hulpmiddel om front-end ontwikkeling voor uw project van AEM gemakkelijker te maken.
