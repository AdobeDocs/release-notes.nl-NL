...
* Met uw Adobe ID kunt u zich abonneren op gebeurtenismeldingen op basis van uw product-, regio- en gebeurtenisvoorkeuren. Gebruikers die hun abonnementsvoorkeuren configureren, worden op de hoogte gesteld van alleen relevante productincidenten en onderhoudsgebeurtenissen zodra ze worden geopend, bijgewerkt of gesloten. Ga aan de slag op [status.adobe.com/subscriptions](https://status.adobe.com/proactive-notifications/subscriptions/edit).
...
Adobe past de instelling `same-site` voor cookies aan om wijzigingen voor te bereiden die Chrome aanbrengt in Chrome 80 (uit te brengen in februari 2020).
...
* **AEM Desktop App 2.0.1.1**
   ...
   * [Releaseopmerkingen](https://docs.adobe.com/content/help/nl-NL/experience-manager-desktop-app/using/release-notes.html)
...
* **Adobe Asset Link 1.1 beëindigt ondersteuning voor AEM 6.3.x**
   ...
   * [Adobe-itemkoppeling](https://helpx.adobe.com/nl/enterprise/using/adobe-asset-link.html)
...
* **NIEUW: AEM als Cloud Service**
   ...
   * [Geen informatie](https://docs.adobe.com/content/help/nl-NL/experience-manager-cloud-service/release-notes/home.html)
...
Zie [Voorvertoning van 3D-elementen](https://docs.adobe.com/content/help/en/experience-manager-65/assets/using/previewing-3d-assets.html).

* **Kernonderdelen**

   De Componenten 2.8.0 van de kern, met talrijke moeilijke situaties, is nu beschikbaar samen met [authoring documentatie](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) en [ontwikkelaardetails en projectdownload beschikbaar op GitHub](https://github.com/adobe/aem-core-wcm-components).

* **AEM Project-archetype**

   De [ui.frontend module](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/archetype/uifrontend.html) van [AEM Project Archetype](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/developing/archetype/overview.html) is een nuttig en flexibel hulpmiddel om front-end ontwikkeling voor uw AEM project gemakkelijker te maken.
...
* Een nieuw subdomein instellen - [Meer informatie](https://docs.adobe.com/content/help/nl-NL/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html)
* SSL-certificaat van een subdomein vernieuwen - [Meer lezen](https://docs.adobe.com/content/help/nl-NL/control-panel/using/subdomains-and-certificates/renewing-subdomain-certificate.html)
