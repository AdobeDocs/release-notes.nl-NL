...
| Functie | Beschrijving |
| -----------| ---------- |
| GDPR-kader voor transparantie en instemming | Advertising Cloud verbetert zijn steun voor het IAB-kader voor transparantie en instemming tot versie 2.0 tegen 15 augustus 2020. Op dit moment zijn er geen wijzigingen aan de kant van de klant nodig.  Als Data Processor voor elk van onze klanten beschikt Adobe Advertising Cloud over de mogelijkheden die klanten hebben om te voldoen aan hun verplichtingen uit hoofde van de GDPR die van toepassing zijn op het gebruik van onze producten en services. |
| Audience Manager-integratie | (Alleen Beta voor Adobe Audience Manager-klanten met Adobe Experience Platform) DSP kunnen via de Adobe Experience Platform actioneerbare logbestanden met de gegevens van een adverteerder naar Audience Manager sturen. In de Audience Manager, kunnen de adverteerders de gegevens voor geavanceerde segmentatie en gebruik in inzichtshulpmiddelen, zoals de Rapporten van het Audience Optimization gebruiken. |
| Speciale acties voor afbeeldingen op verschillende apparaten | Zelf-serverklanten kunnen een apparatengrafiek (de Co-op van het Apparaat van de Adobe of LiveRamp) voor op mensen-gebaseerd richten en frequentiebeheer over nieuwe campagnes gebruiken. Dit zorgt ervoor dat adverteerders hun publiek kunnen bereiken op hun eigen apparaten, maar de blootstelling beperken. Bovendien wordt het bulksgewijs bewerken van instellingen voor apparaatgerichtheid nu in bèta weergegeven. Neem contact op met de accountmanager van de Adobe om de bètaversie voor uw account in te schakelen. |
...
| Rapporten | (Alleen Beta voor Adobe Experience Platform-klanten) Een nieuw rapport voor meerdere kanalen in Advertising Cloud Search biedt een uniforme weergave van media-uitgaven voor DSP en zoeken, met dagelijkse meetgegevens voor DSP plaatsingen en zoekcampagnes. |
