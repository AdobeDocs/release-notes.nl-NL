...
* [](#analytics) Analytici en  [Customer Journey Analytics](#cust-journey)  (bijgewerkt op 14 juli 2020)
...
Raadpleeg de [productdocumentatie](https://experienceleague.corp.adobe.com/docs/core-services/interface/experience-cloud.html) van de Experience Cloud-interface voor een voorbeeld.
...
* Er is een probleem verholpen in het [Onboarding Status Report](https://experienceleague.adobe.com/help/en/audience-manager/user-guide/reporting/onboarding-status-report.html) waardoor klanten een andere datum zagen wanneer ze op een balk in de grafiek klikten dan de datum in de tabel. (AAM-55235)
...
* **Dynamic Media Classic**
   ...
   Zie [Adobe Dynamic Media Classic Desktop-app - Nu beschikbaar.](https://experienceleague.corp.adobe.com/docs/dynamic-media-classic/using/new-ui-2020.html)
...
* **Ondersteuning voor 3D-assets toegevoegd aan Dynamic Media**
   ...
   * Zie [Werken met 3D-assets in Dynamic Media](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html) in AEM as a Cloud Service.
   * Zie in AEM 6.5 [Werken met 3D-assets in Dynamic Media.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/assets/dynamic/assets-3d.html)
...
* **AEM 6.5.5 Updates in de documentatie over formulieren**
   ...
   * Nieuwe functies en verbeteringen in de versie 6.5.5:
      ...
      * [Pas Adobe Experience Manager Inbox-kolommen aan](https://experienceleague.corp.adobe.com/docs/experience-manager-65/authoring/essentials/inbox.html#inbox-admin-control).
      * [Interactieve communicatie opslaan als concept.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html#save-as-draft)
      ...
      * [Toegankelijkheidsverbeteringen.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html#accessibility-improvements)
      * [X-509 op certificaat gebaseerde verificatie voor op SOAP gebaseerde webservices in het formulierdatamodel.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html#configure-soap-web-services)
      * [Oracle RAC-ondersteuning.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html#other-improvements)
      * [Foutregistratie verbeterd bij transactierapportage.](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html#view-transaction-reporting-logs)
   * Nieuwe functies en verbeteringen in versie 6.4.8.1:
      * [X-509 op certificaat gebaseerde verificatie voor op SOAP gebaseerde webservices in het formulierdatamodel.](https://experienceleague.corp.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html#configure-soap-web-services)
      * [Foutregistratie verbeterd bij transactierapportage.](https://experienceleague.corp.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html#view-transaction-reporting-logs)
...
| 23 juni 2020 | [Profielen verwerken](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/configuring/processing-profiles.html) | Video | Met verwerkingsprofielen worden de weergaven gedefinieerd die moeten worden gemaakt voor assets in AEM as a Cloud Service. |
...
| 3 juni 2020 | [HTML5-formulierverzending verwerken - tutorial](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/forms/html5-forms/handle-mobile-form-submission.html) | Artikel | Leer hoe u toegang krijgt tot verzonden data in de aangepaste verzendingshandler. |
...
* Nieuwe, stabiele Gold Standard-build. [Meer informatie](https://experienceleague.corp.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html#release-19-1-4-build-9032)

#### Campaign-besturingsdeelvenster

* Leverbaarheidsaudit voor subdomein - [Meer informatie](https://experienceleague.corp.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html)

* GPG-sleutelbeheer - [Meer informatie](https://experienceleague.corp.adobe.com/docs/control-panel/using/instances-settings/gpg-keys-management.html)
...
| 12 juni 2020 | [Een ad-hoc-e-mailleveringssjabloon implementeren](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/deploying-ad-hoc-email-delivery-template.html) | Campaign Classic | Leer hoe u een ad-hoc-e-mailsjabloon kunt implementeren |
| 12 juni 2020 | [Een leveringssjabloon configureren](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/configuring-a-delivery-template.html) | Campaign Classic | Leer hoe u een e-mailsjabloon kunt configureren |
| 12 juni 2020 | [Eigenschappen van leveringssjablonen instellen](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/using-delivery-templates/setting-delivery-template-properties.html) | Campaign Classic | Leer hoe u e-mailsjablooneigenschappen instelt |
| 12 juni 2020 | [GPG-sleutelbeheer](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/administrating/control-panel-acc/gpg-key-management-overview.html) | Campaign Classic/Configuratiescherm | Leer hoe u een openbaar/persoonlijk GPG-sleutelpaar voor dataversleuteling kunt genereren en installeren, en hoe u een openbare sleutel voor dataontsleuteling kunt importeren en installeren. |
