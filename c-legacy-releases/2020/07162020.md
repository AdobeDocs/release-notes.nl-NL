...
| 3 juni 2020 | [HTML5-formulierverzending verwerken - tutorial](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/html5-forms/handle-mobile-form-submission.html) | Artikel | Leer hoe u toegang krijgt tot verzonden data in de aangepaste verzendingshandler. |
...
* Leverbaarheidsaudit voor subdomein - [Meer informatie](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html)

* GPG-sleutelbeheer - [Meer informatie](https://experienceleague.adobe.com/docs/control-panel/using/instances-settings/gpg-keys-management.html)
