...
* **AEM Assets configureren met Brand Portal**
   ...
   AEM Assets is now configured with [!UICONTROL Brand Portal] through Adobe I/O, which procures an IMS token for authorization of the Brand Portal tenant. Eerder, werd het gevormd in Klassieke interface door middel van de [!UICONTROL Oudere Gateway OAuth.]
