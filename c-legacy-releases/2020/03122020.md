...
* **AEM Assets configureren met Brand Portal**
   ...
   AEM Assets wordt nu gevormd met [!UICONTROL Brand Portal] door Adobe I/O, die een teken IMS voor vergunning van de huurder van het Portaal van het Merk koopt. Eerder, werd het gevormd in Klassieke interface door middel van [!UICONTROL Legacy OAuth Gateway.]
