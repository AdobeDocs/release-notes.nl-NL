...
* [&#x200B; de interface en de kerndiensten van Experience Cloud &#x200B;](#ecloud) (toegevoegde datum: **26 februari, 2020**)
...
* **Laboratoria (de Voorproeven van de Technologie):** Deze nieuwe eigenschap van Analytics laat u nieuwe eigenschapprototypen in productie testen en waardevolle verstrekken terugkoppelen aan Adobe. [Meer informatie...](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html)
...
Zie [&#x200B; AppMeasurement voor de versienota&#39;s van JavaScript &#x200B;](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html). Versie 2.19.0 is uitgebracht op 21 februari 2020.
...
* Het probleem waarbij de gebruikersinterface werd onderbroken tijdens het navigeren door de aanmaakstroom voor algoritmische modellen (AAM-37942) is opgelost.
* Oplossing voor een bug waarbij de selectie voor gegevensexport niet werd opgeslagen bij het opslaan van besturingselementen voor gegevensexport voor nieuwe of bestaande doelen, voor klanten die de Adobe Experience Platform-integratie gebruiken (AAM-52814).
* Oplossing voor een bug waarbij aanbevelingen voor externe traits onjuist werden uitgevoerd voor traits die verticale strepen (`|`) in de naam bevatten (AAM-51635).
...
* **Cloud Manager 2020.2.0**
  ...
  Zie [&#x200B; de nota&#39;s van de Versie &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-manager/using/release-notes/release-notes-current.html).

### Zelfondersteuning

* **Leerprogramma&#39;s voor Experience Manager as a Cloud Service**

  Krijg snel begonnen met de [&#x200B; leerprogramma&#39;s voor Experience Manager as a Cloud Service &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html).
...
Zie [&#x200B; veelvoudige interactieve mededelingen produceren gebruikend Partij API &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/generate-multiple-interactive-communication-using-batch-api.html).

* **Gesteunde Platforms voor AEM Forms op JEE**

  Extra ondersteuning voor Oracle 19c voor AEM Forms op JEE-klanten.
Zie [&#x200B; Gesteunde Platforms voor AEM Forms op JEE &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-65/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms.html).
