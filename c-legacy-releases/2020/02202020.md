...
* **Labs (Technology Previews):** met deze nieuwe functie Analytics kunt u prototypen van nieuwe functies in productie testen en waardevolle feedback geven aan Adobe. [Meer informatie...](https://docs.adobe.com/content/help/en/analytics/analyze/tech-previews/overview.html)
...
| [DIL 9.4](https://docs.adobe.com/content/help/en/audience-manager/user-guide/dil-api/dil-release-notes.html) | We hebben [!DNL Data Integration Library] ([!DNL DIL]) bijgewerkt naar versie 9.4. Deze update verbetert de compatibiliteit met [!DNL Google Chrome] [!DNL SameSite] cookies. |
...
* Probleem verholpen waarbij de aanbevelingen van de eigenschap van derden onjuist werken voor kenmerken die verticale strepen (`|`) in de naam bevatten (AAM-51635).
...
* [AEM as a Cloud Service](https://docs.adobe.com/content/help/nl-NL/experience-manager-cloud-service/landing/home.html)
