...
**Levenscyclus:** toegevoegde een nieuwe API,  `pauseCollectingLifecycleData`om de abnormale gegevens van de zittingslengte te verlichten die van sommige oude apparaten van iOS werden gemeld.
...
* **Tutorials voor as a Cloud Service Experience Manager**
   ...
   Begin snel met de [zelfstudies voor Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en).
...
| Zoeken > Campagnes, rapporten | De prominentiemetriek `Impr. (Abs. Top) %` en `Impr. (Top) %` van Google Ads zijn nu beschikbaar in alle basisrapporten en op entiteitsniveau campagnebeheermeningen behalve die voor het winkelen van productgroepen, in [!UICONTROL Campaign Daily Impression Share] en [!UICONTROL Keyword Daily Impression Share] rapporten, en in de etiketten en beperkingsmeningen. |
...
* **Microsoft® Dynamics  _Change Owner in Microsoft®_ Flow Action:** Wijzig een lead of contactpersoon rechtstreeks vanuit Marketo Engage.
