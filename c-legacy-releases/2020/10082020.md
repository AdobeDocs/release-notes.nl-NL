...
| 21 september 2020 | [Adobe I/O-project probleemloos instellen](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/set-up/firefly.html) | Video | De toepassingen van de asset compute zijn speciaal bepaalde projecten van het Project van de Adobe, en als dusdanig vereisen de toegang tot het Project van de Adobe Vuurwerk in de Console van Adobe Developer om hen te opstelling en op te stellen. |
