...
| dinsdag 14 september 2020 | [ Creërend Onbewaakte Beelden ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-onboarded-traits.html) | Video | Leer tips voor het maken van ongebogen karakteristieken in de Audience Manager. |
...
| zaterdag 25 september 2020 | [ verifieer gebruikers gebruikend hun mobiele telefoonaantallen ](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/some-useful-integrations/two-factor-authentication.html) | Artikel | Leer hoe u OTP-verificatie uitvoert met SMS in uw adaptieve formulieren. |
...
| dinsdag 21 september 2020 | [ vorm manifest.yml ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/develop/manifest.html) | Artikel | manifest.yml van het project van de Asset compute, beschrijft alle arbeiders in deze toepassing die moeten worden opgesteld. |
| zaterdag 25 september 2020 | [ pas het Bericht van de Taak toewijzen ](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/handling-af-form-submissions/customize-assign-task-notification.html) aan | Artikel | Gebruik formuliergegevens in e-mails met taakmeldingen in AEM workflows. |
...
| dinsdag 21 september 2020 | [ Asset compute microservices rekbaarheid ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/asset-compute/overview.html) | Video | Zelfstudie die door het creëren van een douane middelarbeider van de activa voor AEM as a Cloud Service loopt. |
