---
title: Opmerkingen bij de release - juli 2021
...
* **30 juni 2021** [Opmerkingen bij de release Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html)
* **17 mei 2021** [Opmerkingen bij de release Experience Platform-tags](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html) (voorheen, Experience Platform Launch)
...
| Juli 2021 | [Aan de slag met CDP in real time voor Marketers](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2021.1.rtcdp) | Cursus | In deze cursus, kunt u alles leren u begint Real-time Customer Data Platform (in real time CDP) als bedrijfspraktijk te gebruiken. |
| Juli 2021 | [Aan de slag met Data Science Workspace voor Data Scientists](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2021.1.dsw) | Cursus | Meer informatie over Data Science Workspace in Adobe Experience Platform. Deze cursus is ontworpen voor gegevenswetenschappers die willen leren hoe ze deze kunnen gebruiken [!DNL JupyterLab] De laptops om inzichten en vraaggegevens af te leiden, profiel-toegelaten datasets tot stand te brengen, geautomatiseerde machine het leren modellen te publiceren, en machine-geleerde inzichten aan zowel Adobe als niet-Adobe toepassingen te activeren. |
...
* **Release juni 2021:** Met de AI-classificatie kunt u verschillende classificatiestrategieën maken (op basis van uw bedrijfsdoelstellingen) die door een getraind modelsysteem worden gebruikt om de in aanmerking komende aanbiedingen voor weergave voor een bepaald profiel te rangschikken.

Zie [Opmerkingen bij de release offer decisioning](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html) om up-to-date te blijven.
...
**Gebeurtenis:** [Implementatie van Adobe Analytics - tips en trucs](https://www.youtube.com/watch?v=lxOvLCzEGBI)
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juli 2021 | [De Donut-visualisatie gebruiken in uw project](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/using-the-donut-visualization.html) | Video | Leer hoe u de Donut-visualisatie toevoegt en configureert in uw Analysis Workspace-project. |
...
Adobe raadt vaak een bezoek aan [Updates van de release van Experience Managers en routekaarten](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/home.html) om actuele informatie over de release te blijven gebruiken.

* **Experience Manager as a Cloud Service**

  Nieuwe functies in as a Cloud Service Experience Manager:

   * **Experience Manager-hulplijnen as a Cloud Service**

      * **Inhoudsbeheersysteem voor cloud-native componenten** - Experience Manager Guides is available as a Cloud Service. Kies voor de omgeving waarin u documentatie en inhoud op schaal kunt ontwerpen, beheren en leveren.
      * **Documentatie op basis van AI** - Mogelijkheid voor slimme tags voor het automatisch identificeren en extraheren van relevante metagegevenstrefwoorden uit de tekst voor metagegevenslabels.
      * **Nieuwe vormgeving voor webeditor** - Nieuwe vormgeving en nieuwe functionaliteit dankzij wijzigingen in de gebruikersinterface maakt deze intuïtiever. De onderliggende architectuur is veranderd van koraal in een op reacties gebaseerd spectrum.

     Bezoek [Hulplijnen Experience Manager](https://business.adobe.com/products/experience-manager/guides/aem-guides.html) voor meer informatie .

   * **Cloud Manager in AEM as a Cloud Service**

      * [!UICONTROL Preview Service] op doorlopende basis wordt ingezet voor alle programma&#39;s. Klanten worden op de hoogte gesteld van hun product wanneer hun programma is ingeschakeld voor [!UICONTROL Preview Service]. Zie [Voorvertoningsservice openen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html).
      ...
      * De standaardvertakkingsnaam die tijdens zowel de projectverwezenlijking als in het gebrek wordt gebruikt [!UICONTROL Push] de opdracht voor het beheren van it-workflows is gewijzigd in `main`.
      ...
      * De kwaliteitsregels `CQBP-84andCQBP-84--dependencies` zijn in één regel geconsolideerd. Als onderdeel van deze consolidatie, identificeert het aftasten van gebiedsdelen nauwkeuriger kwesties in derdegebiedsdelen die aan runtime van de Experience Manager worden opgesteld.
      ...
      * Er is een nieuwe regel voor de kwaliteit van de code toegevoegd om de structuur van `damAssetLucene`indexen. Zie [Aangepaste DAM-indexen voor luyleen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/custom-code-quality-rules.html).
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * [!UICONTROL Content Automation] Met deze functionaliteit kan Experience Manager Assets de Adobe Creative Cloud API&#39;s gebruiken om de productie van bedrijfsmiddelen op schaal te automatiseren. Het verbetert de snelheid van de inhoud door de benodigde tijd en herhalingen aanzienlijk te verminderen om variaties van hetzelfde element te maken. Voor deze functionaliteit is geen programmering vereist en werken vanuit de DAM. Zie [Variaties van elementen genereren met Adobe Creative Cloud-integratie](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/cc-api-integration.html).
      * [Adobe Asset Link 3.0](https://helpx.adobe.com/nl/enterprise/using/adobe-asset-link.html) voor Adobe Photoshop, Adobe Illustrator en Adobe InDesign en Adobe [Adobe Asset Link 2.0](https://helpx.adobe.com/enterprise/using/adobe-asset-link-for-xd.html) voor Adobe XD is beschikbaar. Het steunt Assets Essentials en de capaciteit om automatisch met Experience Manager as a Cloud Service of Assets Essentials te verbinden.
      * De [Hulpmiddel voor het bulkmiddel](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html) Hiermee kunt u metagegevens toevoegen tijdens een bulkopname.
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **Experience Manager Forms as a Cloud Service - Communicatie** - Via communicatie-API&#39;s kunt u XDP-sjablonen en XML-gegevens combineren om afdrukdocumenten in verschillende indelingen te genereren. Met de service kunt u documenten in synchrone modus genereren. Met de API&#39;s kunt u toepassingen maken waarmee u:
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juli 2021 | [Hulplijnen Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/tutorials/overview.html) | Artikel | Meer informatie over [!UICONTROL XML Documentation Solution] biedt alle kernfuncties CCMS aan, zoals samenwerking, overzicht, vertaling, onderzoek, en rapporten voor inhoud DITA. Met deze functies kunnen auteurs meer doen in minder tijd dankzij efficiënt hergebruik van inhoud en krachtige workflows. |
| Juli 2021 | [GraphQL Postman-collecties zonder koppen AEM](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/video-series/modeling-basics.html) | Video | Leer hoe u inhoudsfragmenten in Adobe Experience Manager (AEM) definieert en gebruikt voor gebruik met GraphQL. |
...
* [Opmerkingen bij de as a Cloud Service release van Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html)
...
* [Opmerkingen bij de release Campagne v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html)
...
| Juli 2021 | [Lidmaatschapsservices configureren en beheren](https://experienceleague.adobe.com/docs/campaign-learn/tutorials/sending-messages/configure-and-manage-subscription-services.html) | Campaign v8 | Leer lidmaatschappen instellen en beheren en leden targeten. |
...
| Functie | Beschrijving |
| ------- | ----------- |
| [!UICONTROL Tools] | Als uw adverteerderaccount is geconfigureerd voor hybride optimalisatie, dan [!DNL Advertising Cloud Search] U kunt optioneel de doelstellingen voor de portfolio&#39;s van de account uploaden naar Google Ads als conversies, zodat u deze kunt gebruiken voor hybride optimalisatie. U kunt de functie inschakelen vanuit **[!UICONTROL Search]** > **[!UICONTROL Tools]** > **[!UICONTROL Conversion Upload Setup]**. |
...
| Juli 2021 | [Student-leraar Samenwerking met Adobe Document Services-API&#39;s](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/educationcollab.html) | Artikel | Meer informatie over een officiële SDK voor `Node.js` toepassingen om tot PDF Services API toegang te hebben. Op deze manier kunt u documenten zoals Microsoft® Word of Microsoft® Excel converteren naar PDF. |
| Juli 2021 | [Job Posting with Adobe Document Services APIs](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/jobposting.html) | Artikel | Als u een website met meerdere gebruikers maakt, is het van cruciaal belang dat u een ervaring ontwerpt die iedereen een vloeiende ervaring biedt. Leer hoe u alle geüploade documenten automatisch omzet in PDF en deze inline insluit tijdens het posten. |
| Juli 2021 | [Maken en bewerken van rapporten met Adobe Document Services-API&#39;s](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reportcreation.html) | Artikel | Met PDF kunt u eenvoudig rijke documenten met tabellen, afbeeldingen en interactieve inhoud delen in een indeling die iedereen kan bekijken. Leer hoe u deze statistieken kunt delen met hun bestuurders, aandeelhouders, donoren of andere belanghebbenden. |
| Juli 2021 | [Revisies en goedkeuringen met API&#39;s van Adobe Document Services](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html) | Artikel | Leer hoe u een praktijkvoorbeeld en een goedkeuringskwestie kunt oplossen met behulp van verschillende Adobe Document Services-API&#39;s. |
...
| Juli 2021 | [Facturen verwerken met de Adobe Document Generation API](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/invoices.html) | Artikel | Leer hoe u de API voor het genereren van Adobe-documenten kunt gebruiken om automatisch facturen te genereren, de PDF met een wachtwoord te beschermen en elke klant een factuur te sturen. Het enige wat nodig is, is een beetje kennis van Node.js, JavaScript, Express.js, HTML en CSS. |
