---
title: Opmerkingen bij de release - maart 2021
...
De oplossingen en de diensten van het Experience Cloud worden bijgewerkt maandelijks. Deze pagina is uw centrale locatie voor het zoeken naar de meest recente release-updates, documentatie en zelfstudies voor [!DNL Experience Cloud] -producten en -services. U vindt ook nieuwe documentatie voor [!DNL Creative Cloud for Enterprise] en [!DNL Document Cloud] .

>[!NOTE]
>
>Abonneer aan de maandelijkse [ Update van het Product van de Prioriteit van de Adobe ](https://www.adobe.com/subscription/priority-product-update.html) om e-mailberichten over updates aan deze pagina te ontvangen. Deze pagina wordt gedurende de hele maand onderhouden en bevat mogelijk inhoud die vóór een releasedatum kan worden gewijzigd. Controleer regelmatig of er updates beschikbaar zijn voor de documentatie van het product en Experience League van de Adobe.
...
De meest recente updates aan de Status van het Systeem van de Adobe worden gevonden bij [ Status van het Systeem van de Adobe - 21 mei, 2020 ](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html).

## ](/assets/ec_appicon_24.png) de Componenten van UI van het Experience Cloud van 0} Pictogram {, de Diensten, en Beleid![ {#ecloud}

| Functie | Beschrijving |
| -----------| ---------- |
| Unified Search | Het verenigde Onderzoek, dat voor Experience Platform beschikbaar is, steunt nu onderzoek op Bronnen en Doelen voor de gebruikers van het Experience Platform. Deze eigenschap laat u toe om Segmenten, Datasets, Schema&#39;s, Bronnen, en Doelen te zoeken. |
...
* [ de versienota&#39;s van de Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html). (Bijgewerkt op 24 februari 2021)
* [ de versienota&#39;s van de Experience Platform Launch ](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html). (Bijgewerkt op 18 februari 2021)
...
De Versie van februari 2021 - ontdek meer over de recentste mogelijkheden, de verbeteringen, en de moeilijke situaties in de [ Nota&#39;s van de Versie van de Journey Orchestration ](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html).
...
De Versie van februari 2021 - vind meer over de recentste mogelijkheden in de [ Nota&#39;s van de Versie van de Offer decisioning ](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new).
...
| [!UICONTROL Same-as-SiteCatalyst VISTA Processing] = ON | donderdag 17 maart 2021 | Op 17 juni 2021 worden alle rapportsuites bijgewerkt en wordt [!UICONTROL Same-as-SiteCatalyst VISTA Processing] ingesteld op ON. Deze wijziging is van invloed op de [!UICONTROL Data Warehouse] -rapportage doordat de gegevens worden verwerkt overeenkomstig de verwerkingsregels. Raadpleeg de Adobe van de klantenservice voor vragen of verduidelijkingen. |
...
| maandag 21 maart 2021 | [ Begrijpend Schema&#39;s en XDM in Echt - tijd CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.html#other-integrations) | Video | Terwijl u van Audience Manager naar Real-time Customer Data Platform (Real-time CDP) gaat, zult u een aantal nieuwe concepten en werkwijzen tegenkomen. Schemas en XDM vallen in die categorie. In deze video worden deze concepten uitgelegd. |
| donderdag 17 maart 2021 | [ Begrijpend Signalen in real time CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-signals-for-aam-users.html) | Video | Deze video is bedoeld voor de gebruikers van de Audience Manager die zich aan Real-time Customer Data Platform (in real time CDP) bewegen, en bespreekt hoe de signalen (zeer belangrijk-waardeparen) die u in Audience Manager gebruikt om eigenschappen te bouwen in Platform worden gebruikt. |
| zaterdag 12 maart 2021 | [ Begrijpend Schema&#39;s en XDM in Echt - tijd CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-schemas-xdm-for-aam-users.html) | Video | Terwijl u van Audience Manager naar Real-time Customer Data Platform (Real-time CDP) gaat, zult u een aantal nieuwe concepten en werkwijzen tegenkomen. Schemas en XDM vallen in die categorie. In deze video worden deze concepten uitgelegd. |
| zaterdag 12 maart 2021 | [ Begrijpend de Ingestie van de Gegevens van het Web in Real-time CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-web-ingestion-for-aam-users.html) | Video | Leer de concepten betreffende het brengen van websitegegevens in Real-time Customer Data Platform (Real-time CDP), en omvat een aanraking op hoog niveau waar de Verbinding van Gegevens van de Audience Manager past, evenals hoe de gegevens zich van de website direct door het Web SDK in Real-time CDP kunnen bewegen. |
| donderdag 3 maart 2021 | [ Begrip Segmenten in real time CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-segments-for-aam-users.html#other-integrations) | Video | Leer de verschillen in segmenten en segmentverwezenlijking tussen Audience Manager en in real time CDP. |
| donderdag 3 maart 2021 | [ Begrijpend Tanden in Echte tijd CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-traits-for-aam-users.html#other-integrations) | Video | Leer de eigenschappen in Audience Manager en wat het equivalent in real time CDP is. |
| donderdag 3 maart 2021 | [ Begrijpend de Ingestie van Gegevens van 1st Partij in Echte tijd CDP voor de Gebruikers van de Audience Manager ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/other-integrations/integrating-with-rtcdp/rtcdp-1pd-ingestion-for-aam-users.html#other-integrations) | Video | Leer over 1st-partij off-line gegevensopname in Real-time Customer Data Platform (Echte - tijd CDP). Leer over sommige van de belangrijkste verschillen tussen de twee producten betreffende gegevensopname en toont hoe de Verbinding van Gegevens van de Audience Manager als stophiaat kan worden gebruikt tot de processen over naar CDP in real time zijn verplaatst. |
| dinsdag 1 maart 2021 | [ Commercialiseer uw Bezit publiek door op Audience Marketplace aan te bieden ](https://experienceleague.adobe.com/docs/audience-manager-learn/tutorials/audience-marketplace/selling-data/commercialize-owned-audiences-on-marketplace.html#audience-marketplace) | Video | Leer hoe u uw gegevens instelt als persoonlijke of openbare gegevensinvoer op het Audience Marketplace, waardoor u een gegevensaanbieder van gegevens van derden of derden bent. |
...
* **AEM 6.5.8.0**
AEM 6.5 is Service Pack 8 (6.5.8.0 uitgebracht op 11 maart 2021) een belangrijke update die nieuwe eigenschappen, zeer belangrijke klantenverhogingen, betere prestaties, stabiliteit, en veiligheid omvat, die sinds de algemene beschikbaarheid van AEM 6.5, April 2019 wordt vrijgegeven.
...
* **AEM 6.4.8.4**
AEM 6.4, Service Pack 8, Cumulative Fix Pack 4 (6.4.8.4 vrijgegeven 25 februari, 2021) is een belangrijke update die verscheidene interne en klantenmoeilijke situaties omvat sinds de algemene beschikbaarheid van AEM 6.4, Service Pack 8 (6.4.8.0), Maart 2020.
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Sites als Cloud Service**
      ...
      * [ de Component RemotePage ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html): Toegevoegde steun voor het bekijken van en het uitgeven van externe SPA binnen Experience Manager het gebruiken.
      * [ Uitgevend een Externe SPA binnen Experience Manager ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/editing-external-spa.html): Toegevoegde capaciteit om een standalone enig-paginatoepassing aan een instantie van de Experience Manager te uploaden, editable secties van inhoud toe te voegen, en creatie toe te laten.

   * **Experience Manager Assets as a Cloud Service**

      * Experience Manager Assets as a Cloud Service heeft recht op een vooraf geconfigureerde Brand Portal-instantie. De Cloud Manager-gebruiker kan Brand Portal activeren op Experience Manager Assets as a Cloud Service. Zie [ Brand Portal activeren gebruikend Brand Portal ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html).
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * Uitgegeven CIF Venia Reference Site - 2021.02.24 die de nieuwste CIF Core Components versie 1.8.0 bevat. Zie [ CIF de Plaats 2021.02.24 van de Verwijzing van Venia ](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.02.24) voor meer details.
      * Uitgegeven CIF Core Components versie 1.8.0. Zie [ CIF de Componenten van de Kern 1.8.0 ](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.8.0) voor meer details.
   ...
   * **Cloud Manager**
      ...
      * **AEM het etiket van de Update van de Duw** wordt nu getoond voor zowel *de Uitvoering van de Pijpleiding* als *de schermen van de Activiteit*.
      * Als een milieu gehiberneerd is, maar er is ook een beschikbare update van de Experience Manager, neemt de **Gesamberneerde** status belangrijkheid over **beschikbare Update**.
      ...
      * De lijsten met klasse- en methodeafbrekingen zijn bijgewerkt op basis van versie `2021.3.4997.20210303T022849Z-210225` van de Experience Manager Cloud Service SDK.
      * De pijpleiding van de Productie van Cloud Manager omvat nu ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/functional-testing.html#custom-ui-testing) vermogen van het Testen UI van de Douane [.

### **Community**

* **Adobe Developers Live 2021 | Volledige lijst met sessies**

  [ hier ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-developers-live-2021-complete-session-list/m-p/394595#M27875) is een bijeengevoegde lijst van alle Experience Manager zittingen die bij **Adobe Developers Live** voorkomen.

* **Adobe Summit 2021 | Volledige lijst van de Zitting van de Experience Manager**

  [ hier ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344) is een bijeengevoegde lijst van alle Experience Manager zittingen die bij **Adobe Summit 2021** voorkomen.
...
| Maart 2021 | [ Headless inhoudsbeheer die GraphQL APIs gebruiken ](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.headless) | Cursus | Ontdek hoe AEM GraphQL API&#39;s en headless mogelijkheden kunnen worden gebruikt om ervaringen in een externe app kracht bij te zetten. |
...
| Maart 2021 | [ LinRelate en Onverwante Assets - de Videoktext van de Eigenschap ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/relate-unrelate.html) | Video | Leer hoe u relaties tussen elementen in AEM tot stand brengt en beheert. |
...
| Maart 2021 | [ Redacteur van het Werkschema ](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/workflow/use-the-workflow-editor.html#workflow) | Video | De workflow maakt bedrijfsprocesbeheer in Experience Manager mogelijk en wordt gebruikt voor automatische verwerking van inhoud en voor het vergemakkelijken van governance en processen waarvoor menselijke besluitvorming vereist is. |
...
| woensdag 23 februari 2021 | [ Leverbaarheid - Stommen ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/bounces.html) | Campaign Classic/standaard | Meer informatie over de verschillende typen bounces. |
...
| woensdag 23 februari 2021 | [ Leverbaarheid - Spam Traps ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/metrics-for-deliverability/spam-traps.html) | Campaign Classic/standaard | Meer informatie over de verschillende typen bounces. |
...
| woensdag 23 februari 2021 | [ Leverbaarheid - het proces van de Overgang - Infrastructuur ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/infrastructure.html) | Campaign Classic/standaard | Leer wat nodig is om een e-mailinfrastructuur correct te bouwen. |
...
| donderdag 24 februari 2021 | [ Leverbaarheid - het proces van de Overgang: Volume ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/transition-process/volume.html) | Campaign Classic/standaard | Begrijp hoe het verzenden van volume de leverbaarheid van uw e-mailcampagnes beïnvloedt. |
...
| vrijdag 25 februari 2021 | [ Leverbaarheid - Eerste beelden - Welkome e-mail ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/first-impressions/welcome-emails.html) | Campaign Classic/standaard | Leer wat de belangrijkste elementen van uw welkomststrategie moeten zijn. |
...
| zaterdag 26 februari 2021 | [ Leverbaarheid - de duurzaamheid van de afzender ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/sender-permanence.html) | Campaign Classic/standaard | Leer waarom het belangrijk is om een verenigbaar verzendend volume te vestigen. |
| zaterdag 26 februari 2021 | [ Leverbaarheid - Doorlopende controle ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/ongoing-monitoring.html) | Campaign Classic/standaard | Weet op welke problemen u moet letten wanneer u uw leveringen controleert. |
| zaterdag 26 februari 2021 | [ Leverbaarheid - het plaatsen van het in praktijk ](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/putting-it-in-practice.html) | Campaign Classic/standaard | Vier sleutelpijlers voor succes. |
...
| zaterdag 5 maart 2021 | [ Periodieke Vervalsing van het Aantal ](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/deploy/cceserial.html) | Video | Leer de stappen die nodig zijn om ervoor te zorgen dat uw eindgebruikers toegang hebben tot hun Adobe-apps en -services. |
| maart 2021 | [ opstellen en Landing beheren - ondersteunend element ](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/deploy/overview-deploy.html) | Video | Leer hoe Creative Cloud voor Enterprise aangepaste implementaties en flexibele licentievermogen ondersteunt, en het werkt met andere Adobe Enterprise-producten. |
...
| zaterdag 5 maart 2021 | [ pas een ladende het schermanimatie met Adobe Stock en XD ](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/loadingscreen.html) aan | Video | Pas vectorillustraties vanuit Adobe Stock aan om een animatie voor het koelen van een scherm voor een mobiele app te maken. |
