...
| [Vervaging van de Hub voor klantactiviteiten](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html) | Leer hoe externe toepassingen toegang hebben tot Adobe Experience Platform&#39;s [!UICONTROL Real-time Customer Profile]. |
...
>[!IMPORTANT]
>
>Meer informatie over [vereiste configuratieupdates](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/acc-config-updates.html?lang=en) voor Adobe Campaign Classic.
