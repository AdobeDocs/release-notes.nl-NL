...
Experience Cloud oplossingen en services worden maandelijks bijgewerkt. Dit is uw centrale locatie voor het zoeken naar de meest recente release-updates, documentatie en zelfstudies voor [!DNL Experience Cloud] producten en diensten. U kunt ook nieuwe documentatie vinden voor [!DNL Creative Cloud for Enterprise] en [!DNL Document Cloud].

>[!NOTE]
>
>Abonneren op de maandelijkse [Adobe Priority-productupdate](https://www.adobe.com/subscription/priority-product-update.html) om e-mailmeldingen te ontvangen over updates voor deze pagina. Deze pagina wordt gedurende de hele maand onderhouden en bevat mogelijk inhoud die vóór een releasedatum kan worden gewijzigd. Controleer regelmatig of er updates beschikbaar zijn voor de documentatie van Adobe-bedrijfsproducten en -Experiencen League.

Laatste update: **6 april 2021**

* [Digitale beleving blauwdrukken](#blueprints) (nieuwe implementatiedocumentatie)
* [Adobe-systeemstatus](#status)
* [Experience Cloud UI-componenten, -services en -beheer](#ecloud)
* [Experience Platform](#platform)
* [Journey Orchestration](#journey-orch)
* [offer decisioning](#offer-decisioning)
* [Analyse](#analytics) **(bijgewerkt op 6 april 2021)** en [Customer Journey Analytics](#cust-journey)
...
## ![Pictogram](/assets/adobe.png) Digitale beleving blauwdrukken {#blueprints}
...
| [Vervaging van de Hub voor klantactiviteiten](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html) | Meer informatie over hoe externe toepassingen toegang kunnen krijgen tot Adobe Experience Platform [!UICONTROL Real-time Customer Profile]. |
...
| [Aangepaste gegevenswetenschap voor blauwdruk van profielverrijking](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-exploration/data-science.html) | Leer hoe de gegevens in Adobe Experience Platform worden gebruikt door [!UICONTROL Data Science Workspace] om modellen op te leiden, te implementeren en te scoren om computerleerinzicht te bieden. |
| [Voorbereiding van gegevens en vervagingsblauwdruk](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-ingestion/overview.html) | Leer hoe u brongegevens toewijst aan de [!UICONTROL Experience Data Model] (XDM) schema. Deze blauwdruk omvat ook het uitvoeren van transformaties op gegevens, waaronder datumopmaak, veldsplitsen, samenvoegen en conversies, en het samenvoegen, samenvoegen en opnieuw genereren van records. |
| [Blauwdruk voor Enterprise Data Exploration &amp; Reporting](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-exploration/overview.html) | Experience Platform [!UICONTROL Query Service] staat SQL vragen toe om op de gegevens worden uitgevoerd. Meer informatie [!UICONTROL Data Science Workspace] maakt het mogelijk gegevensexploratie, gegevenswetenschap en werklasten voor het leren van machines uit te voeren op de gegevens. |
| [Blauwdruk voor gegevensverzameling op de server-side Enterprise](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-ingestion/server-side-collection.html) | Leer hoe gegevens die met Adobe Experience Platform Web en Mobiele SDKs worden verzameld van Experience Platform kunnen door:sturen [!UICONTROL Edge Network] naar een gewenst doel. |
...
De meest recente updates voor de status van het Adobe-systeem vindt u op [Status van Adobe-systeem - 21 mei 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html).
...
* [Releaseopmerkingen bij Experience Platform Launch](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html). (Bijgewerkt op 18 februari 2021)
...
| Maart 2021 | [Gegevens streamen met behulp van Bronverbindingen](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/streaming-ingestion-source-connector.html) | Video | Deze video laat zien hoe gegevens in real-time kunnen worden gestreamd van een bron voor cloudopslag naar Platform en hoe de gegevens in real-time kunnen worden gebruikt voor de betrokkenheid van de klant. |
...
| Maart 2021 | [De Azure Blob-bestemming configureren](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-the-azure-blob-destination.html#destinations) | Video | Leer hoe u door de stappen kunt lopen die nodig zijn voor het instellen en configureren en de Azure Blob Storage-bestemming in [!UICONTROL Real-time Customer Data Platform] (Real-time CDP). |
| 5 maart 2021 | [Aan de slag met Offer decisioning voor markeertekens](https://experienceleague.adobe.com/?recommended=ExperiencePlatform-U-1-2020.1.offerdecisioning) | Cursus | Meer informatie over de [!UICONTROL Offer Decisioning] toepassingsservice gebouwd op Adobe Experience Platform. Deze cursus wordt ontworpen voor marketers die opbrengst, klantenervaring en loyaliteit willen drijven door de beste aanbiedingen aan hun klanten te leveren. |
...
| 5 maart 2021 | [Bronconnectors](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/overview.html#sources) | Video | Deze video geeft een overzicht van Bronnen, of Bron schakelaars, in Experience Platform. |
| 5 maart 2021 | [Adobe Developer Console Export Postman Details](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=nl) | Video | Leer hoe u Experience Platform-API&#39;s kunt verifiëren en openen. |
...
Release van februari 2021 - Meer informatie over de nieuwste mogelijkheden, verbeteringen en oplossingen in de [Opmerkingen bij de release Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html).
...
Release van februari 2021 - Meer informatie over de nieuwste mogelijkheden in de [Opmerkingen bij de release offer decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new).
...
* [Belangrijke kennisgevingen voor analysebeheerders](#aa-notices) **(bijgewerkt op 6 april 2021)**
* [AppMeasurement](#appm)
...
* Probleem verholpen met [!UICONTROL Alert Previews] komt niet overeen met het aantal geactiveerd exemplaren [!UICONTROL Alerts]. (AN-249392; AN-250804)
...
* Probleem verholpen waarbij een onjuiste dubbele segmenttoewijzingsvalidatie werd uitgevoerd voor **[!UICONTROL People-Based Destinations]**. (AAM-56631)
* Probleem verholpen waardoor sommige gebruikers geen toegang meer kregen tot **[!UICONTROL Audience Reports]**. (AAM-57412)
* Een patroon [!UICONTROL Remote Code Execution] kwetsbaarheid die aanvallers kunnen gebruiken om toegang te krijgen tot gevoelige gegevens. (AAM-57495)
...
* **voor Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Sites als Cloud Service**
      ...
      * [De RemotePage-component](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html): Extra ondersteuning voor het weergeven en bewerken van externe SPA in Experience Manager met.
      * [Een externe SPA bewerken in de Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/editing-external-spa.html): Mogelijkheid toegevoegd om een zelfstandige toepassing van één pagina te uploaden naar een instantie van een Experience Manager, bewerkbare gedeelten van inhoud toe te voegen en het schrijven van inhoud in te schakelen.

   * **Experience Manager Assets as a Cloud Service**

      * Experience Manager Assets as a Cloud Service heeft recht op een vooraf geconfigureerde Brand Portal-instantie. De gebruiker van Cloud Manager kan Brand Portal activeren op Experience Manager Assets as a Cloud Service. Zie [Brand Portal activeren met Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html).
      * Bedrijven kunnen nu elementen aanschaffen met Brand Portal. De functie voor het aanschaffen van bedrijfsmiddelen maakt gebruik van Brand Portal om klanten te helpen bij het aanschaffen van bedrijfsmiddelen voor nieuwe marketingcampagnes, foto&#39;s en projecten. Zie [Overzicht van Asset Souring](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html) in de Brand Portal Guide.
      * In het Brand Portal-gebruiksrapport worden nu alleen de actieve gebruikers weergegeven. De inactieve gebruikers worden nu niet weergegeven. Actieve gebruikers zijn de gebruikers van wie de account is toegewezen aan een productprofiel in de Admin Console. Zie [Werken met rapporten](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/admin-tools/brand-portal-reports.html) in de Brand Portal Guide.
      * In Brand Portal wordt een nieuwe downloadinstelling geïntroduceerd waarmee u voor elk element een aparte map kunt maken wanneer u mappen, verzamelingen en dergelijke downloadt. Zie [Asset Download](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/download/brand-portal-download-assets.html) in **Middelen downloaden van Brand Portal** in de Brand Portal Guide.
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * Uitgebrachte CIF Venia Reference Site - 2021.02.24 met de nieuwste versie van CIF Core Components 1.8.0. Zie [CIF Venia Referentiegebied 2021.02.24](https://github.com/adobe/aem-cif-guides-venia/releases/tag/venia-2021.02.24) voor meer informatie .
   ...
   * **Cloud Manager**
      ...
      * Klanten met omgevingen die al aangepaste domeinnaamconfiguraties hebben voor [IP-Lijsten van gewenste personen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/ip-allow-lists/managing-ip-allow-lists.html#pre-existing-cdn), [SSL-certificaten](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-ssl-certificates/managing-certificates.html#pre-existing-cdn), en [Aangepaste domeinnamen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/custom-domain-names/check-domain-name-status.html#pre-existing-cdn) zie nu een bericht over hun eerder bestaande configuraties. Ze kunnen ook zelf dienen via de gebruikersinterface.
      ...
      * Als een omgeving gehiberneerd is, maar er ook een Experience Manager-update beschikbaar is, wordt **Gesamberneerd** status heeft voorrang op **Update beschikbaar**.
      * Gebruikers kunnen nu hun rollen van Cloud Manager bekijken door **Rollen in Cloud Manager weergeven** na het navigeren aan het pictogram van het Profiel van de Gebruiker (hoogste recht) van Verenigde Shell.
      ...
      * De productiepijplijn van Cloud Manager bevat nu [Aangepaste UI-tests](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/functional-testing.html#custom-ui-testing) capaciteit.
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Maart 2021 | [Helpx-artikel migreren naar soorten Forms en Documenten](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/document-services/pdf-forms-and-documents.html#document-services) | Artikel | Een artikel waarin de verschillende typen PDF forms en documenten worden uitgelegd. |
| Maart 2021 | [Beheer van inhoud zonder hoofd met GraphQL API&#39;s](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.headless) | Cursus | Ontdek hoe AEM GraphQL API&#39;s en headless mogelijkheden kunnen worden gebruikt om ervaringen in een externe app kracht bij te zetten. |
...
| Maart 2021 | [Verifiëren voor AEM as a Cloud Service vanuit een externe toepassing](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.aemcs) | Cursus | Leer hoe een externe toepassing de Tokens van de Toegang van de Lokale Ontwikkeling en de Verantwoordelijkheden van de Dienst kan gebruiken programmatically voor authentiek te verklaren om as a Cloud Service over HTTP te AEM. |
...
| Maart 2021 | [Projectstramienen](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/projects/use-project-masters.html#delete-project-masters) | Video | Het schrappen van een master project resulteert in onbruikbaar afgeleide projecten. |
...
* [Opmerkingen bij de release Campaign Classic](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html).
...
Laatst bijgewerkt: **29 maart 2022, voor release van 27 maart**

| Functie | Beschrijving |
| -----------| ---------- |
| [!UICONTROL Search Campaigns]<br> Rapporten | (Microsoft-advertentiecampagnes) Er is nu ondersteuning voor biedingen beschikbaar voor de Microsoft-strategie met verbeterde kosten per klik (eCPC), de standaardbiedstrategie voor reclamecampagnes van Microsoft. U kunt nu een campagne-niveau opgeven [!UICONTROL Bid Strategy] voor uw campagnes. Opties omvatten [!UICONTROL Manual CPC] en [!UICONTROL Enhanced CPC]. U kunt [!UICONTROL Enhanced CPC] met zoekacties, bestaande dynamische zoekopdrachten en winkelcampagnes.<br>Wanneer u een campagne met eCPC toevoegt aan een geoptimaliseerde Advertising Cloud-portfolio, optimaliseert Advertising Cloud de basisbiedingen en — wanneer de optie &#39;De budgetlimieten voor campagnes automatisch aanpassen&#39; is ingeschakeld — het campagnebudget. Microsoft® past alle biedingsaanpassingen toe en kan de door Advertising Cloud gegenereerde biedingen wijzigen op het moment dat de gebruiker een query uitvoert op basis van eigen gegevens en inzichten.<br>De [!UICONTROL Bid Strategy] aangepaste kolom is beschikbaar in het dialoogvenster [!UICONTROL Campaigns] en in rapporten. |
| [!UICONTROL Search Campaigns]<br> [!UICONTROL Bulksheets] | (Microsoft®-advertentiecampagnes) Voor uitgebreide tekstadvertenties is nu ondersteuning beschikbaar voor een optionele derde kopregel ([!UICONTROL Ad Title 3]) en een optionele tweede beschrijving ([!UICONTROL Description 2]). De steun is beschikbaar in [!UICONTROL Ads] bekijken en in [!UICONTROL Bulksheets]. |
| [!UICONTROL Advertising Insights] | Twee nieuwe [!UICONTROL Advertising Insights] zijn beschikbaar:<ul><li>[!UICONTROL Delayed Revenue]: Hiermee wordt de omzettingsvertraging (de tijd die is verstreken tussen een SEM-klik en een daaropvolgende conversie) van een portefeuille gemeten en worden eventuele verschillen in gewogen opbrengsten, ROI en modelnauwkeurigheid wegens de vertraging weergegeven.</li><li>[!UICONTROL Query Cross Matching]: Zoekt instanties van onderzoeksvragen die Google aan meer dan één sleutelwoord aanpaste en verstrekt suggesties voor waar te om verkeer te leiden.</li></ul> |
