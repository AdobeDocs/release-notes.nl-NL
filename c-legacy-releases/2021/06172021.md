...
* **Mei 26, 2021:** [ de versienota&#39;s van Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html)
* **Mei 17, 2021:** [ de versienota&#39;s van de Verzameling van de Gegevens van Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html) (vroeger, de Lancering van het Platform van de Ervaring)
...
* Bijgewerkt Juni 2021 - [ de versienota&#39;s van Journey Orchestration ](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html)
...
* Bijgewerkt April 2021 - [ de versienota&#39;s van Offer Decisioning ](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new)
...
* Bijgewerkt de documentatie over [ de gevallengevoeligheid van eVar in het melden van ](https://experienceleague.adobe.com/docs/analytics/components/dimensions/evar.html). (AN-246438)
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [Aan de slag met Customer Journey Analytics voor beheerders](https://experienceleague.adobe.com/?recommended=CustomerJourneyAnalytics-A-1-2020.1) | Cursus | Leer hoe u Customer Journey Analytics kunt instellen, configureren en beheren. Leer sommige basisconcepten om u een stichting te geven, en dan in meer configuratiestappen te bewegen. De cursus wordt vervolgens afgesloten met enkele aanbevelingen voor het migreren van berekende metriek en segmenten van Adobe Analytics naar Customer Journey Analytics. |
...
* [ one-Stop-Shop voor alle Blogs van Experience Manager ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/bd-p/adobe-experience-manager-discussions)
...
* **Adobe Campaign Classic v7 versie 21.1.3:** leer meer in de [ de Nota&#39;s van de Versie van Campaign Classic v7 ](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html).

* **Adobe Campaign Standard 21.2 versie:** leer meer in de [ Nota&#39;s van de Versie van Campaign Standard ](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html).

### Nieuwe cursussen en zelfstudies in [!UICONTROL Campaign] {#tutorials-campaign}

| Gepubliceerd | Naam | Oplossing | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [ integreer Campaign Standard met Analytics om uw e-mailmarketing te optimaliseren ](https://experienceleague.adobe.com/?recommended=Campaign-U-1-2021.1.integration) | Campaign Standard | (Cursus) Leer hoe u Campaign Standard kunt integreren met Adobe Analytics en hoe u uw marketingstrategieën voor e-mail kunt optimaliseren met behulp van realtime gegevens. Deze cursus laat u zien hoe u een Campaign Standard-rapport maakt in Adobe Analytics. Dan, leer hoe te om de Triggers van Experience Cloud en Platform Launch te gebruiken om marketing en transactionele berichten te vormen die op klantenactiviteit worden gebaseerd. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [ Adobe Acrobat voor de Aandrijving van Google ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/integrations/acrobatandgoogle.html) | Video | Profiteer rechtstreeks in de Google Drive-app van toegang tot tijdbesparende PDF-tools en workflows voor e-handtekeningen. |
