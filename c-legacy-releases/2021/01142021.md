...
| 26 oktober 2020 (bijgewerkt) | [ Samenvatting Gegevens die de Schakelaar van Source van Salesforce CRM gebruiken ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html) | Video | Met de Salesforce CRM Source-connector kunt u eenvoudig en op een naadloze en schaalbare manier gegevens van Salesforce CRM toevoegen aan Adobe Experience Platform Real-time Customer Profile and Experience Data Lake. |
| 13 oktober 2020 (bijgewerkt) | [ Samenvatting Gegevens die de Schakelaar van Source van Salesforce CRM gebruiken ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html) | Video | Met de Salesforce CRM Source-connector kunt u eenvoudig en op een naadloze en schaalbare manier gegevens van Salesforce CRM toevoegen aan Adobe Experience Platform Real-time Customer Profile and Experience Data Lake. |
...
Releasedatum: **vrijdag 14 januari 2021**
...
| Gepubliceerd | Naam | Oplossing | Beschrijving |
| ----------- | ----------- | ---------- | ---------- |
| 14 november 2020 | [ creeer Advertising Dashboards met Adobe Analytics ](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-dashboards-a4adc.html) | Video | Technieken voor het creëren van een dashboard van Advertising voor levende campagnemonitoring. |
| 14 november 2020 | [ creeer de Rapporten van de Ingang van de Plaats van Advertising ](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-site-entry-a4adc.html#analytics) | Video | Een Advertising-sitemelding maken om de dag van de week, het tijdstip van de dag, de browser en de geografische invloed te controleren. |
| 14 november 2020 | [ creeer de Metriek van de Douane van de Analyse met de Gegevens van Advertising ](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-custom-metrics-a4adc.html#analytics) | Video | Nuttige aangepaste maateenheden die u kunt maken wanneer u Advertising-gegevens gebruikt in Adobe Analytics. |
| 14 november 2020 | [Analytics-segmenten maken voor activering en rapportage](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-segments-a4adc.html#analytics) | Video | Advertising-dimensies gebruiken om segmenten te maken voor een betere rapportage en analyse. |
...
| 14 november 2020 | [ creeer een Analyse van de Campagne pre-Lancering met Adobe Analytics ](https://experienceleague.adobe.com/docs/advertising-cloud-learn/tutorials/analytics/analytics-pre-launch-a4adc.html) | Video | Hoe Adobe Analytics gebruiken om de basis te leggen voor een Advertising-mediacampagne. |
