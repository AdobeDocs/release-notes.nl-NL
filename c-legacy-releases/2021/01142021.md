...
Zie [Opmerkingen bij de release van Experience Platforms](http://www.adobe.com/go/platform-release-notes-en) voor de meest recente updates die van toepassing zijn op:
...
| Bijwerken op Ad Hoc Analysis Java™ 8-compatibiliteit | 21 aug. 2020 | Ad Hoc Analysis is momenteel niet compatibel met Java™ 8 versies 1.8.0_261+. Om ervoor te zorgen dat de toegang tot dit hulpmiddel niet wordt onderbroken voordat de [einddatum van de levensduur](https://spark.adobe.com/page/S9Bhp66VJ2fEn/) wordt bereikt, raden we u aan een Java™ 8-versie te onderhouden vóór 1.8.0_261. |
