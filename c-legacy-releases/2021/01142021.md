...
## ![ de diensten en het beleid van Experience Cloud van 0&rbrace; Pictogram &lbrace;](/assets/ec_appicon_24.png) {#ecloud}
...
Zie [ de versienota&#39;s van Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) voor de meest recente updates die op van toepassing zijn:
...
| 13 oktober 2020 (bijgewerkt) | [ vorm Attributie AI ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/intelligent-services/configure-attribution-ai.html) | Video | Leer hoe u een instantie van Attribution AI maakt om de impact van uw marketingkanalen en campagnes te begrijpen. |
...
| 22 december 2020 | [Toegang tot ingebouwde rapporten](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/reporting/accessing-built-in-reports.html) | Campaign Classic | (Video)  Begrijpen  ingebouwde rapportage en analyse in Campaign Classic en leer hoe u een leveringsrapport kunt genereren. |
...
| 28 december 2020 | [ voorbereidend Toegankelijke dossiers van PDF ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/accessibility.html) | Artikel | Maak algemeen toegankelijke PDF-bestanden. |
| 28 december 2020 | [ Werkend met vormgegevens ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/formdata.html) | Artikel | Als u een set ingevulde formulieren hebt en de gegevens moet compileren, kunt u de reacties in Acrobat DC samenvoegen tot één werkblad. |
| 28 december 2020 | [ Verminder dossiergrootte en optimaliseer ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/reduce.html) | Artikel | Verminder grote bestanden en optimaliseer uw PDF&#39;s zonder de kwaliteit voor delen, posten of archiveren in gevaar te brengen. |
| 21 december 2020 | [ het maken van PDF stempels Toegankelijker ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/by-industry/gov/pdfs/making-pdf-ballots-accessible.html) | Webinar | Ontdek de belangrijkste toegankelijkheidsgebieden van PDF die nodig zijn om gebruikers van ondersteunende hulpmiddelen, zoals schermlezers, in staat te stellen hun stembiljetten te lezen en te voltooien. |
| 21 december 2020 | [ redigeren &amp; Sanitize ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/redact.html) | Artikel | Gebruik het gereedschap Redigeren om persoonlijke of vertrouwelijke gegevens permanent te verwijderen uit uw PDF- en Sanitize-document. |
| 18 december 2020 | [ Tovenaar van de Actie ](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/action.html) | Artikel | Maak een handeling om automatisch een set opdrachten toe te passen op een of meerdere bestanden. |
