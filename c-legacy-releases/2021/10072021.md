...
| Oktober 2021 | [[!UICONTROL Dispatcher]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/dispatcher.html) | Video | Leer meer over AEM [!UICONTROL Dispatcher] voor AEM as a Cloud Service, waarbij u zich richt op opmerkelijke wijzigingen van [!UICONTROL Dispatcher] for AEM 6, het [!UICONTROL Dispatcher] -omzettingsprogramma en het gebruik van Dispatcher Tools SDK. |
