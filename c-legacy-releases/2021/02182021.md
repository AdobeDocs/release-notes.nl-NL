...
| ----------- | ---------- | ----- |
| Analysis Workspace - Componentselectie | vrijdag 4 februari 2021 | De vervolgkeuzelijst/dropzone-component in [!UICONTROL Quick Insights] is toegevoegd aan alle dropzones in [!UICONTROL Workspace] . Dankzij deze verbetering kunt u kiezen uit een vervolgkeuzelijst met compatibele componenten of de ruimte blijven gebruiken als een neerzetzone. |
| CJA API | vrijdag 18 februari 2021 | De API&#39;s voor CJA zijn nu beschikbaar. Met deze API&#39;s kunt u componenten programmatisch bewerken en rapporten ophalen. Zie [ CJA API documentatie ](https://www.adobe.io/cja-apis/docs) voor meer informatie. |
...
* **as a Cloud Service Experience Manager**
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * **SDK bouwt Analyzers**
        ...
        De Experience Manager as a Cloud Service SDK Build Analyzer Maven stop-in ontdekt problemen in een bepaald project, met inbegrip van ontbrekende gebiedsdelen. Het biedt ontwikkelaars de mogelijkheid om problemen te zoeken tijdens lokale ontwikkeling, lang voordat ze met Cloud Manager naar Cloud-omgevingen implementeren.
...
| vrijdag 11 februari 2021 | [ Relate en maak Assets ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/relate-unrelate.html) los | Video | Leer hoe u relaties tussen elementen in Experience Manager kunt instellen en beheren. |
...
| dinsdag 1 februari 2021 | [ Publish Assets ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/publish.html) | Video | Leer hoe u elementen en de bijbehorende uitvoeringen publiceert van Auteur van Experience Managers naar AEM Publish. |
...
| vrijdag 4 februari 2021 | [ de Structuur van het Project ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/project-structure.html) | Video | Ontdek de beste praktijken voor het structureren van een Experience Manager Maven-project voor AEM as a Cloud Service. |
...
| woensdag 2 februari 2021 | [ Inleiding aan AEM SDK ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/aem-sdk.html) | Video | Het gebruiken en het vormen van SDK voor Experience Manager as a Cloud Service. |
| woensdag 2 februari 2021 | [ wat is AEM Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html) | Video | Onderzoek wat Experience Manager as a Cloud Service is, en hoe het van andere versie van Adobe Experience Manager verschilt. |
| woensdag 2 februari 2021 | [ Rol van Cloud Manager ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/cloud-manager.html) | Video | Ontdek het doel van [!UICONTROL Cloud Manager] en hoe het met Experience Manager as a Cloud Service werkt. |
...
| woensdag 2 februari 2021 | [ vorm Pijpleidingen ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/configure-pipelines.html) | Video | Onderzoek de verschillende types van pijpleidingen in Cloud Manager en hoe te om hen voor een succesvol project te vormen. |
| woensdag 2 februari 2021 | [ beheert de Configuraties van Dispatcher ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/dispatcher-configurations.html) | Video | Gebruik de beste praktijken en voorbeelden om te onderzoeken hoe de verzender met Experience Manager als Cloud Service en Cloud Manager werkt. |
| woensdag 2 februari 2021 | [ Ononderbroken Integraties en Cloud Manager ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/continuous-integration.html) | Video | Begrijp beste praktijken en voortdurende integratie gebruikend Adobe Cloud Manager. |
| woensdag 2 februari 2021 | [ het samenvoegen AEM projecten voor plaatsing gebruikend Cloud Manager ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/merge-projects.html) | Video | Onderzoek hoe de veelvoudige projecten aan in één enkel project voor plaatsing aan Experience Manager as a Cloud Service kunnen worden samengevoegd gebruikend Cloud Manager. |
...
| dinsdag 1 februari 2021 | [ creeer een Levering van SMS ](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/sending-messages/sms-channel/create-a-sms-delivery.html) | Campaign Classic | Leer hoe u een sms-levering maakt. |
| dinsdag 1 februari 2021 | [Cross-channel campagnes maken](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/orchestration/cross-channel-campaigns.html) | Campaign Classic | Leer hoe u een campagne voor meerdere kanalen maakt en uitvoert. |
