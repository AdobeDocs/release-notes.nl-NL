...
* [](#analytics) **AnalyticsUpdated 10 maart 2021**
...
Zie [Systeemstatus Adobe - 21 mei 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=en) voor de meest recente releasegegevens.

## ![](/assets/ec_appicon_24.png) IconExperience Cloud Services and administration {#ecloud}

[Experience Cloud-services en ](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=en) beheerdocumentatie omvatten klantkenmerken, Audience Library ([!UICONTROL People] service), activering, gebruikers- en productbeheer en Experience Cloud-cookies.
...
| 3 februari 2021 | [Gegevens activeren voor niet-Adobe toepassingen](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html) | Video | Leer hoe CDP van Adobe in real time u helpt ware verpersoonlijkingsstrategieën met uw publiek tot stand brengen. Leer ook hoe het zich in uw bestaande ecosysteem en niet-Adobe toepassingen van Microsoft®, Google, en Facebook vouwt. |
...
* [Belangrijke kennisgevingen voor analytische ](#aa-notices) **beheerdersBijgewerkt op 10 maart 2021**
...
* **Adobe Developers Live 2021 | Volledige lijst met sessies**
   ...
   Door populair verzoek, [hier](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-developers-live-2021-complete-session-list/m-p/394595/thread-id/27875) is een geaggregeerde lijst van alle zittingen van de Experience Manager die bij de Ontwikkelaars Live van de Adobe voorkomen. Alle opname en Vragen en antwoorden voor elke sessie worden naar de respectievelijke contextuele threads gepost.
...
* [Experience Managers als hulplijnen voor Cloud Servicen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=en)
