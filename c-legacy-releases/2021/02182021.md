...
[ de diensten van Experience Cloud en beleid ](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html) documentatie omvat de Attributen van de Klant, de Bibliotheek van het publiek ([!UICONTROL People] dienst), Activatie, gebruiker en productbeheer, en de koekjes van Experience Cloud.

**vrijdag 4 februari 2021**

* **Sign-in update:** een update aan Experience Cloud verwijdert het aanvankelijke teken-binnen van Experience Cloud introductiescherm. Vanaf 4 februari wordt u rechtstreeks vanuit `https://experience.adobe.com/login` naar het aanmeldingsscherm van Adobe verzonden.
...
* [ de versienota&#39;s van Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html). (27 januari 2021)
* [ de versienota&#39;s van de Lozing van het Platform van de Ervaring ](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html). (13 januari 2021)
...
| donderdag 10 februari 2021 | [ vorm de Azure BlobBestemming ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-the-azure-blob-destination.html#destinations) | Video | Leer hoe u de stappen doorloopt die nodig zijn voor het instellen en configureren en Azure Blob Storage-bestemming in Real-time Customer Data Platform (Real-time CDP). |
...
| donderdag 13 januari 2021 | [ Inleiding aan het Worden Begonnen met Offer Decisioning voor Marketers ](https://video.tv.adobe.com/v/330520?quality=12&learn=on) | Video | Introductie tot de cursus Aan de slag met Offer Decisioning for Marketers. |
...
| dinsdag 1 februari 2021 | [ publiceer Assets ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/publish.html) | Video | Leer hoe u elementen en de bijbehorende uitvoeringen publiceert van Experience Manager Author naar AEM Publish. |
...
| woensdag 2 februari 2021 | [ wat de Dienst van de Wolk AEM is ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html) | Video | Ontdek wat Experience Manager as a Cloud Service is en hoe het verschilt van andere versies van Adobe Experience Manager. |
| woensdag 2 februari 2021 | [ Rol van Cloud Manager ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/cloud-manager.html) | Video | Ontdek het doel van [!UICONTROL Cloud Manager] en hoe het werkt met Experience Manager as a Cloud Service. |
| woensdag 2 februari 2021 | [ Architectuur van AEM as a Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/architecture.html) | Video | Verken de onderliggende architectuur en belangrijke onderdelen van Experience Manager as a Cloud Service. Neem diepe duiken in Cloud Manager en de API&#39;s. |
...
| vrijdag 28 januari 2021 | [ op token-gebaseerde authentificatie - het Token van de Toegang van de Lokale Ontwikkeling ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/local-development-access-token.html#authentication) | Video | Leer hoe de Experience Manager Developer Console ontwikkelaars toestaat om tijdelijke toegangstokens zelf te produceren die kunnen worden gebruikt om tot Experience Manager programmatically toegang te hebben. |
| vrijdag 28 januari 2021 | [ Op token-gebaseerde authentificatie aan AEM as a Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/overview.html#authentication) | Video | Leer hoe een externe toepassing programmatically met Experience Manager as a Cloud Service over HTTP voor authentiek verklaart en met elkaar in wisselwerking staat gebruikend toegangstokens. |
