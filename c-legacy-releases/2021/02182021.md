...
* [ de versienota&#39;s van de Experience Platform ](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html?lang=nl-NL). (27 januari 2021)
* [ de versienota&#39;s van de Experience Platform Launch ](https://experienceleague.adobe.com/docs/experience-platform/tags/release-notes/current.html?lang=nl-NL). (13 januari 2021)
...
| -----------| ---------- | ---------- | ---------- |
| zaterdag 26 februari 2021 | [ de gegevensstroom van de Monitor in Adobe Experience Platform ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html?lang=nl-NL#data-ingestion) | Leer hoe u gegevens die in Adobe Experience Platform worden ingevoerd, kunt controleren en volgen met de gebruikersinterface en API van het platform. |
| donderdag 10 februari 2021 | [ vorm de Azure BlobBestemming ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configure-the-azure-blob-destination.html?lang=nl-NL#destinations) | Video | Leer hoe u door de stappen kunt lopen die nodig zijn voor het instellen en configureren en Azure Blob Storage-bestemming in Real-time Customer Data Platform (Real-time CDP). |
| vrijdag 4 februari 2021 | [ Identiteitsgrafieken van de Mening ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/identities/view-identity-graphs.html?lang=nl-NL) | Video | Hoe te om de de kijkerseigenschap van de identiteitsgrafiek te gebruiken om identiteitsgrafieken voor bevestiging en het zuiveren te zoeken, te onderzoeken en te filtreren. |
| donderdag 3 februari 2021 | [ overzicht van de gegevensopname van de Partij ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/batch-ingestion-overview.html?lang=nl-NL) | Video | Een overzicht van de invoer van batchgegevens in Adobe Experience Platform. Leer hoe u batchgegevens kunt invoeren met de API. |
| donderdag 3 februari 2021 | [ activeer gegevens aan niet-Adobe Toepassingen ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=nl-NL) | Video | Leer hoe de Real-Time CDP van de Adobe u helpt ware verpersoonlijkingsstrategieën met uw publiek tot stand te brengen. Leer ook hoe het zich vouwt in uw bestaande ecosysteem- en niet-Adobe toepassingen van Microsoft®, Google en Facebook. |
...
| maandag 31 januari 2021 | [ gegevens van de Lading in JupyterLab laptops ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-science-workspace/load-data-in-jupyterlab-notebooks.html?lang=nl-NL) | Video | Meer informatie over JupyterLab in Data Science Workspace. |
| woensdag 12 januari 2021 | [ creeer het Beleid van de Fusie ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/create-merge-policies.html?lang=nl-NL) | Video | Leer hoe u in Adobe Experience Platform beleid voor samenvoegen maakt. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| zaterdag 22 januari 2021 | [Van de ene journey naar de andere gaan](https://experienceleague.adobe.com/docs/journey-orchestration-learn/tutorials/building-a-journey/jumping-to-another-journey.html?lang=nl-NL) | Video | Leer hoe u individuele gebruikers van de ene journey naar de andere kunt sturen. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| dinsdag 8 februari 2021 | [ toevoegend Trendlines aan de Visualisaties van de Lijn ](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/adding-trendlines-to-line-visualizations.html?lang=nl-NL) | Video | In de Montages van de Visualisatie, kunt u verkiezen om een regressie of het bewegen gemiddelde trendline aan uw lijnreeks toe te voegen. Met deze functie kunt u een duidelijker patroon in de gegevens weergeven. |
| dinsdag 8 februari 2021 | [ Toevoegend Insteekmodules van de Implementatie in Platform launch ](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/implementation/via-adobe-launch/adding-implementation-plug-ins-in-launch.html?lang=nl-NL#implementation) | Video | Plug-ins voor implementatie zijn stukjes JavaScript-code die u kunt toevoegen aan uw Analytics-implementatie om aanvullende, aangepaste gegevens bij te houden. Leer in deze video hoe en waar u de code in Platform launch wilt toevoegen. |
...
* **as a Cloud Service Experience Manager**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * **Hoofdloze Dienst van het Inhoudsbeheer**
         ...
         * [ GraphQL API voor de Levering van het Fragment van de Inhoud ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/graphql-api-content-fragments.html?lang=nl-NL): Mogelijkheid om de Fragmenten van de Inhoud te vragen gebruikend de syntaxis van GraphQL, en schema&#39;s die op de modellen van het Fragment van de Inhoud worden gebaseerd, voor output in formaat JSON.
         * [ Steun van de Authentificatie voor GraphQL API Verzoeken ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/graphql-authentication-content-fragments.html?lang=nl-NL): Mogelijkheid om GraphQL API verzoeken met toegangstokens voor server-kant APIs voor authentiek te verklaren.
         * [ de Component RemotePage ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/remote-page.html?lang=nl-NL): Toegevoegde steun voor het bekijken van en het uitgeven van externe SPA binnen AEM gebruiken.
         * [ Uitgevend een Externe SPA binnen AEM ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/hybrid/editing-external-spa.html?lang=nl-NL): Toegevoegde capaciteit om een stand-alone enig-paginatoepassing aan een AEM instantie te uploaden, editable secties van inhoud toe te voegen, en creatie toe te laten.
      ...
      * **Progressieve Apps van het Web (PWA)**
         ...
         * [ A Progressieve versie van de Web App (PWA) van een plaats ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html?lang=nl-NL) kan nu op het projectniveau via eenvoudige configuratie worden toegelaten.

   * **Experience Manager Assets as a Cloud Service**

      * Experience Manager as a Cloud Service breidt de functionaliteit Slimme tags uit ter ondersteuning van de identificatie van trefwoorden en entiteiten in op tekst gebaseerde elementen. De tekst wordt geïdentificeerd, geïndexeerd, en ter beschikking gesteld als meta-gegevens om de onderzoekservaring zonder de behoefte aan om het even welke configuratie te verbeteren. Zie [ Slimme Markeringen ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/smart-tags.html?lang=nl-NL).
      * MXF-bestandsindeling wordt nu ondersteund. Zie [ gesteunde dossierformaten ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/file-format-support.html?lang=nl-NL#video-formats).
...
Zie [ Gebruikend het Hulpmiddel van de Toewijzing van de Gebruiker ](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-migration/content-transfer-tool/using-user-mapping-tool.html?lang=nl-NL).
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| vrijdag 11 februari 2021 | [ voor authentiek verklaren aan AEM as a Cloud Service van een externe toepassing ](https://experienceleague.adobe.com/?lang=nl&recommended=ExperienceManager-D-1-2020.1.aemcs) | Cursus | Leer hoe een externe toepassing [!UICONTROL Local Development Access Tokens] en [!UICONTROL Service Credentials] kan gebruiken om programmatically voor authentiek te verklaren aan Experience Manager as a Cloud Service over HTTP. |
| vrijdag 11 februari 2021 | [ Relate en maak Assets ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/authoring/relate-unrelate.html?lang=nl-NL) los | Video | Leer hoe u relaties tussen elementen in Experience Manager kunt instellen en beheren. |
| dinsdag 8 februari 2021 | [ AEM Sites - WKND Leerprogramma ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html?lang=nl-NL) | Tutorial | Welkom bij een meerdelige zelfstudie die is ontworpen voor ontwikkelaars die nog niet over Experience Manager beschikken. In deze zelfstudie wordt de implementatie besproken van een site voor Experience Managers voor een fictieve levensstijl, het WKND. |
| dinsdag 1 februari 2021 | [ Publish Assets ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/sharing/publish.html?lang=nl-NL) | Video | Leer hoe u elementen en de bijbehorende uitvoeringen publiceert van Auteur van Experience Managers naar AEM Publish. |
| vrijdag 4 februari 2021 | [ Lokale Ontwikkeling ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/local-development-environment.html?lang=nl-NL) | Video | Leer hoe u een lokale ontwikkelomgeving downloadt en instelt met de Experience Manager as a Cloud Service SDK. |
| vrijdag 4 februari 2021 | [ de Structuur van het Project ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/project-structure.html?lang=nl-NL) | Video | Ontdek de beste praktijken voor het structureren van een Experience Manager Maven-project voor AEM as a Cloud Service. |
| vrijdag 4 februari 2021 | [ Migreer de Configuraties van Dispatcher ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/dispatcher-configuration.html?lang=nl-NL) | Video | Overzicht van de verschillen in Dispatcher-configuraties en tips en trucs voor het migreren van de Dispatcher van Adobe Managed Services (AMS) naar Experience Manager as a Cloud Service. |
| woensdag 2 februari 2021 | [ Inleiding aan AEM SDK ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/aem-sdk.html?lang=nl-NL) | Video | Het gebruiken en het vormen van SDK voor Experience Manager as a Cloud Service. |
| woensdag 2 februari 2021 | [ wat is AEM Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html?lang=nl-NL) | Video | Onderzoek wat Experience Manager as a Cloud Service is, en hoe het van andere versie van Adobe Experience Manager verschilt. |
| woensdag 2 februari 2021 | [ Rol van Cloud Manager ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/cloud-manager.html?lang=nl-NL) | Video | Ontdek het doel van [!UICONTROL Cloud Manager] en hoe het met Experience Manager as a Cloud Service werkt. |
| woensdag 2 februari 2021 | [ Architectuur van AEM as a Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/architecture.html?lang=nl-NL) | Video | Verken de onderliggende architectuur en belangrijke stukken as a Cloud Service van de Experience Manager. Neem diepe duiken in Cloud Manager en de API&#39;s. |
...
| woensdag 2 februari 2021 | [ Analyseer de Resultaten van de Test ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/cloud-manager/devops/analyze-test-results.html?lang=nl-NL) | Video | Onderzoek om het even welke compilatiefouten in uw code en of deze code best practices voor Experience Manager as a Cloud Service volgt |
...
| vrijdag 28 januari 2021 | [ op token-gebaseerde authentificatie - het Token van de Toegang van de Lokale Ontwikkeling ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/local-development-access-token.html?lang=nl-NL#authentication) | Video | Leer hoe de Developer Console van de Experience Manager ontwikkelaars toestaat om tijdelijke toegangstokens zelf te produceren die kunnen worden gebruikt om tot Experience Manager programmatically toegang te hebben. |
| vrijdag 28 januari 2021 | [ Op token-gebaseerde authentificatie aan AEM as a Cloud Service ](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/overview.html?lang=nl-NL#authentication) | Video | Leer hoe een externe toepassing programmatically voor authentiek verklaart en met Experience Manager as a Cloud Service over HTTP kan in wisselwerking staan gebruikend toegangstokens. |
...
| zaterdag 8 januari 2021 | [ Bulk de Invoer ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/bulk-import.html?lang=nl-NL) | Video | Met het gereedschap Bulk importeren in Experience Manager as a Cloud Service kunnen beheerders op een veilige en efficiënte manier onverpakt middelen importeren uit de cloudopslag (Azure Blob Storage of Amazon S3). |
...
| dinsdag 1 februari 2021 | [Cross-channel campagnes maken](https://experienceleague.adobe.com/docs/campaign-classic-learn/tutorials/orchestration/cross-channel-campaigns.html?lang=nl-NL) | Campaign Classic | Leer hoe u een campagne voor meerdere kanalen maakt en uitvoert. |
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| dinsdag 8 februari 2021 | [ Overzicht Landing - het Steun Activa ](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/overview.html?lang=nl-NL) | Leercentrum | Welkom bij de Adobe Sign Learning Hub. U zult een brede waaier van het leren ervaring vinden die op Adobe Sign wordt geconcentreerd. Onze zelfstudies, webinars en gebruiksscenario&#39;s zijn ontworpen om zowel beginners als beheerders snel up-to-speed op Adobe Sign te brengen. |
