...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| September 2021 | [&#128279;](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2019.1.backend) Grondbeginselen van de Ontwikkelaar van 0&rbrace; Experience Manager aan de achterzijde | Cursus | Neem een diepe duik in achterwaartse ontwikkeling met Adobe Experience Manager. Leer de beste werkwijzen voor het werken met Java™ API&#39;s, Sling Models en het testen van eenheden. |
