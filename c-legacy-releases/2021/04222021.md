...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * Uitgebrachte CIF Core Components 1.9.0. Zie {de Componenten 1.9.0 van de Kern van CIF 1}.0 ](https://github.com/adobe/aem-core-cif-components/releases/tag/core-cif-components-reactor-1.9.0) voor meer details.[
