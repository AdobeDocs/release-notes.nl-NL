...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Sites as a Cloud Service**
      ...
      * [&#x200B; Een Progressieve versie van het Web App (PWA) van een plaats &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html?lang=nl-NL) kan nu op het projectniveau als eenvoudige configuratie worden toegelaten.
...
* **Adobe Developers Live 2021 | Volledige lijst met sessies**
  ...
  [&#x200B; hier &#x200B;](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-developers-live-2021-complete-session-list/m-p/394595?profile.language=nl#M27875) is een bijeengevoegde lijst van alle zittingen die van Experience Manager bij **Adobe Developers Live** voorkomen.

* **Adobe Summit 2021 | Volledige lijst Experience Manager-sessie**

  [&#x200B; hier &#x200B;](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344?profile.language=nl) is een bijeengevoegde lijst van alle zittingen die van Experience Manager bij **Adobe Summit 2021** voorkomen.
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| April 2021 | [[Adobe Sign] Herinneringen verzenden met Adobe Sign for Salesforce and Marketo - Feature Video &#x200B;](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/integrations/marketo/marketo-salesforce-reminder-video.html?lang=nl-NL) | Video | Leer hoe u een e-mailherinnering van Marketo verzendt wanneer een overeenkomst na een bepaalde periode niet is ondertekend. Bij deze integratie wordt Adobe Sign for Salesforce, Marketo en de synchronisatie Marketo en Salesforce gebruikt. |
...
| April 2021 | [&#x200B; plaatsende Voorwaardelijke Inhoud &#x200B;](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggerconditional.html?lang=nl-NL) | Video | In deze video leert u hoe u secties in Microsoft® Word-sjablonen eenvoudig kunt instellen met Adobe Document Generation Tagger, zodat secties van een document dynamisch kunnen worden opgenomen in of uitgesloten op basis van gegevens met de Adobe-API voor het genereren van documenten. |
| April 2021 | [[Doc Services] Setting Numerical Calcalculation tags - Feature Video &#x200B;](https://experienceleague.adobe.com/docs/document-services/tutorials/docgen/docgentemplates/taggercalculations.html?lang=nl-NL) (Engelstalig) | Video | Leer hoe u eenvoudig numerieke berekeningstags kunt instellen in Microsoft® Word-sjablonen met Adobe Document Generation Tagger voor het berekenen van aggregaties of rekenkundige van gegevenswaarden met de Adobe-API voor het genereren van documenten. |
