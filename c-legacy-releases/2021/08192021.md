...
U kunt de recentste versieinformatie voor de Status van het Systeem van Adobe in vinden [21 mei 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=en) opmerkingen bij de release.
...
| -----------| ---------- | ---------- | ---------- |
| Augustus 2021 | [Profielen en segmenten naar een doel activeren](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-profiles-and-segments-to-a-destination.html?lang=en) | Video | Leer de stappen die de marketers kunnen nemen om publiekssegmenten aan bestemmingen in CDP in real time te activeren. Zie hoe u deze werkstroom kunt starten in het dialoogvenster [!UICONTROL Destinations] of [!UICONTROL Segments] interfaces, welke het geschiktst voor u is. |
...
* Bijgewerkt in juli 2021 - [Opmerkingen bij de release Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)
...
Zie [Opmerkingen bij de release offer decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html?lang=en#new) om up-to-date te blijven.
...
Voor de meest recente updates over AppMeasurement-releases (versie 2.22.1) raadpleegt u [AppMeasurement voor JavaScript-releaseopmerkingen](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=en).
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * U kunt de dienst van de Automatede form conversion nu gebruiken aan [PDF forms converteren in het Frans, Duits en Spaans](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/extending-the-default-meta-model.html?lang=en#language-specific-meta-model) aan adaptieve formulieren.
      ...
      * **[!UICONTROL Acroform-based Document of Record]** - U kunt ook [Adobe Acrobat Form PDF gebruiken (Acroform PDF)](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=en) als een sjabloon voor Document of Record naast XFA-formuliersjabloon.
...
* [Opmerkingen bij de as a Cloud Service release van Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=en)
