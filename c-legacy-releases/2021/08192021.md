...
## ![Pictogram](/assets/experience-league.png) Experience League Live {#events}

**26 augustus 2021** | [Maak uw volgende publiekssegment slimmer dan ooit](https://www.youtube.com/watch?v=rogVKsTFbWk) - Ken de Segment Builder in Experience Platform met Doug Moore, Aaron Shields, Yaya Wang en Andres Monroy!
...
U kunt de recentste versieinformatie voor de Status van het Systeem van Adobe in vinden [21 mei 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html) opmerkingen bij de release.
...
Zie [Opmerkingen bij de release Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) voor meer informatie.
...
| -----------| ---------- | ---------- | ---------- |
| Augustus 2021 | [Profielen en segmenten naar een doel activeren](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-profiles-and-segments-to-a-destination.html) | Video | Leer de stappen die de marketers kunnen nemen om publiekssegmenten aan bestemmingen in CDP in real time te activeren. Zie hoe u deze werkstroom kunt starten in het dialoogvenster [!UICONTROL Destinations] of [!UICONTROL Segments] interfaces, welke het geschiktst voor u is. |
| Augustus 2021 | [Cloudopslag voor bestanden of marketingdoelen voor e-mail configureren](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html) | Video | Krijg uiteinden tijdens een analyse van de configuratie van een op dossier-gebaseerde bestemming in Adobe Real-time Customer Data Platform (CDP). |
...
* Bijgewerkt in juli 2021 - [Opmerkingen bij de release Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html)
...
* **Release juli 2021:** De nieuwe [!UICONTROL Overview] bevat een overzicht van de belangrijkste stappen voor het maken van beslissingen over aanbiedingen. Zodra aan boord, staat het zelfde lusje snelle toegang tot uw meest recente aanbiedingen, inzamelingen en besluiten toe.

Zie [Opmerkingen bij de release offer decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new) om up-to-date te blijven.
...
* [Nieuwe functies in Customer Journey Analytics](#cust-journey) (Bijgewerkt) **17 augustus 2021**)
...
* Oplossing voor een probleem dat door klanten die de [Gereedschappen voor bulkbeheer](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html). Klanten ondervonden fouten vanwege de `traitAlias` veld, bij het bijwerken van de segmenttoewijzing naar bestemming. (AAM-58789)
* Probleem verholpen dat zich voordeed wanneer de toegang tot een gegevensfeed werd ingetrokken of geannuleerd. Het e-mailbericht dat naar verwijderde gebruikers is verzonden, bevat de ontvangers **Naar** veld in plaats van **Bcc**. (AAM-58512)
...
* **Experience Manager as a Cloud Service**
  ...
  De [Overzicht release juli 2021](https://video.tv.adobe.com/v/335580) video voor een overzicht van de toegevoegde functies.

   * **[!UICONTROL Cloud Acceleration Manager]**

      * [!UICONTROL Cloud Acceleration Manager] is een cloudgebaseerde toepassing die is ontworpen om uw IT-teams te begeleiden tijdens de transitietraject, van de planning tot het live gaan met de Cloud Service. Stel uw teams in voor een geslaagde migratie met de door Adobe aanbevolen tips, documentatie en tools voor elke fase van de reis naar as a Cloud Service Experience Manager. Zie [Aan de slag met Cloud Acceleration Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-acceleration-manager/using-cam/getting-started-cam.html).

     De [Cloud Acceleration Manager](https://video.tv.adobe.com/v/335547) demo video.

   * **Experience Manager as a Cloud Service Stichting**

      * Meer flexibiliteit [!UICONTROL Dispatcher] configuratie: Projecten kunnen gemakkelijker worden georganiseerd. U kunt nu bijvoorbeeld meerdere herschrijfregelbestanden opnemen die de sitestructuur weerspiegelen. [Meer informatie over deze flexibele modus](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/content-delivery/disp-overview.html#validation-debug), met inbegrip van hoe te om uw configuratie van de Verzender te structureren om uit het voordeel te halen.
      * De boomreplicatie UI onder de replicatieagent [!UICONTROL Distribute] tab moet als afgekeurd worden beschouwd; het is gepland voor verwijdering na 30 september 2021. [Meer informatie over alternatieve replicatiestrategieën](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html#tree-activation).
   ...
   * **[!UICONTROL Cloud Manager]**
      ...
      * Klanten kunnen nu 8 en 11 JDK&#39;s gebruiken voor hun [!UICONTROL Cloud Manager] processen ontwikkelen. Zij kunnen of selecteren om één van deze JDKs voor toolketins-compatibele Maven stop of de volledige Maven procesuitvoering te gebruiken.
      * Uitgaande uitgang IP wordt nu het programma geopend in het dossier van het bouwstijlstaplogboek.
      * Fase- en productieomgevingen met oude versies van Experience Manager rapporteren nu de status van **Update beschikbaar**.
      ...
      * De **[!UICONTROL Manage Git]** knop is hernoemd naar **[!UICONTROL Access Git Info]** en het dialoogvenster is visueel vernieuwd.
...
| Gepubliceerd | Naam | Type | Beschrijving |
| -----------| ---------- | ---------- | ---------- |
| Augustus 2021 | [Adobe Asset Link 3.0](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/creative-workflows/adobe-asset-link.html) | Video | [!UICONTROL Asset Link] De extensie voor Adobe Creative Cloud for enterprise breidt de mogelijkheid uit om metagegevens van Experience Manager-elementen in Creative Cloud-toepassingen te zoeken en weer te geven, te sorteren, voor te vertonen, te uploaden, uit te checken, te wijzigen, in te checken en weer te geven. |
| Augustus 2021 | [Assets Essentials](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/managing.html) | Video | Leer meer over de Essentiële elementen van bedrijfsmiddelen, zoals de mapstructuur en basisbewerkingen zoals verplaatsen, kopiëren en hernoemen. Nieuwe video&#39;s bevatten ook informatie over [elementen gebruiken](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/using.html), [inhoud maken](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/creating.html), en [samenwerken](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/creating.html) op middelenbeheer met opmerkingen, annotaties en taken. |
| Augustus 2021 | [Assets Essentials](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/basics/using.html) | Video | Leer hoe u middelen in Assets Essentials kunt filteren, zoeken en downloaden. |
| Augustus 2021 | [Overzicht van pijplijn - Rondleiding](https://video.tv.adobe.com/v/335668) | Video | Bekijk een overzicht van AEM as a Cloud Service [!UICONTROL Cloud Manager Pipeline]. |
...
* [Opmerkingen bij de as a Cloud Service release van Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
...
* [Opmerkingen bij de release van Campaign Classic v7 21.1.3](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html)
...
Laatst bijgewerkt: **12 augustus 2021, voor release van 11 augustus**
