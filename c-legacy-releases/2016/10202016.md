...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b> Meting van <span class="keyword"> app </span> voor JavaScript</b> </p> <p>Versie 1.7.0: </p> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Zie ook:</b> Service <a href="../../c-legacy-releases/2016/10202016.md#mcvid" format="dita" scope="local"> voor marketingcloud-id </a> (voorheen <span class="term"> bezoekersidentiteitsservice </span>) </p> </td> 
  </tr> 
  <tr> 
...
* In het [!UICONTROL  statusrapport]over instapweigering is de tabel met samenvattingscijfers voor geluids- en foutpercentages beperkt tot 5 rijen plus de geaggregeerde totalen. (AM-25485)
