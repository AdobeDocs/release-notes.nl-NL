...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Klantenbeheerders van de marketingcloud kunnen productconfiguraties gebruiken die vooraf zijn gemaakt en zijn toegewezen aan standaardmachtigingsgroepen voor Analytics en Dynamic Tag Management. </p> <p>Deze optimalisatie is beschikbaar voor nieuw ingerichte organisaties en beperkt de tijd die organisaties nodig hebben om gebruikers in het Enterprise-dashboard te beheren. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Voederverbetering </p> </td> 
   <td colname="col2"> <p> Wanneer het creëren van een nieuw bericht in de Diervoed van de Wolk van de Marketing, gebruikt aan lijn nu het momenteel actieve onderwerp in plaats van het gebruiken van de organisatie door gebrek.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Probleem verholpen waarbij miniaturen niet konden zien voor elementen die werden gedeeld van Assets op aanvraag naar de Feed van de Marketing Cloud. (MAC-29955)
...
* Toegevoegde [!UICONTROL  Impressies] / [!UICONTROL  Betrokkenheid] voor berichtgeving binnen de app. Vereist versie 4.9.0 van de Android- of iOS-SDK.
...
<table id="table_899AD81646E24BE49EB86F7FF75718E1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Het probleem waarbij de verkeerde bedrijfsnaam werd geretourneerd, is opgelost als er meerdere organisatie-id's zijn. (AM-23861) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Documentatie</b> </p> </td> 
   <td colname="col2"> <p>Toegevoegde nieuwe documentatie waarin wordt beschreven hoe u de id van de marketingcloud kunt integreren in de Data Workbench. Zie <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-dwb.html.html" format="https" scope="external"> Data Workbench en de Marketing Cloud ID Service </a>. (AM-23727) </p> </td> 
  </tr> 
 </tbody> 
</table>

Raadpleeg de productdocumentatie van de [Marketing Cloud ID Services](https://marketing.adobe.com/resources/help/en_US/mcvid/) .
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Analyse van werkruimte: Toegevoegd filtertype </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_B6AD0D7125EB43A990C9B3D87F9C8A1D"> 
     <li id="li_1AD24DDE8C4149DCAB3BAB6E19D5313D">De Internet Explorer-extensie van Activity Map kan nu worden gedownload en geïnstalleerd. </li> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_40B5A397A5F84EA4986BF103D28A18DB">Probleem verholpen met het bewerken van virtuele rapportsuites: tags, segmenten en rapportsuites zijn soms leeg weergegeven in de <span class="wintitle"> Virtual Report Suite Manager </span>. (AN-122688) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BA66BD95515B43BFBD024B92B66EBAD8"> 
      ...
      <li id="li_F16C545817B445348A393476C6533733">Probleem verholpen met de time-outwaarde voor de sessie <span class="wintitle"> </span> Activiteitenkaart en instellen op 30 dagen. (AN-122807) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Probleem verholpen waarbij enkele geannuleerde verzoeken van Data Warehouse ertoe leidden de verkeerde status weer te geven. (AN-122436) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"><p> <b> Meting van <span class="keyword"> app </span> voor JavaScript</b> </p> <p>JavaScript versie 1.5.6 </p> 
    <ul id="ul_F303CB7334E04F3B9489EB7C0F778A3E"> 
     <li id="li_99AC87DB34984CC9BAC77AC5C3671B72">Opname van de Bezoeker-API 1.5.6 (nieuwste <a href="../../c-legacy-releases/2016/05192016.md#mcvid" format="dita" scope="local"> service voor id van marketingcloud </a>) </li> 
...
* Oplossing voor een bug in de Regels van de Fusie van het Profiel die een 1 dagdatumwaaier in de Voor authentiek verklaarde Metriek van de Identiteit toonde. (AM-24100)
* Oplossing voor een probleem in de beheerdersinterface dat ervoor zorgde dat een gebruikersaccount niet kon worden gedeactiveerd wanneer deze zich in de status In behandeling bevond. (AM-16087)
* Het probleem dat ervoor zorgde dat een gepauzeerd segment niet opnieuw kon worden geactiveerd, is opgelost. (AM-23938)
* Het probleem waarbij het selectievakje Regel voor samenvoegen van profielen niet werd gewist, is opgelost. (AM-23359)
* Het probleem dat ervoor zorgde dat een persoonlijke gegevensfeed niet kon worden geactiveerd, is opgelost. (AAM-23395 en aanverwante zaken, AAM-23377)
* Het probleem waarbij demonstratiegegevens werden weergegeven in Audience Marketplace is opgelost. (AM-23837)
* Oplossing voor een bug in het zoekgereedschap Doelen waarbij de zoekresultaten behouden bleven wanneer u weg van de pagina navigeerde en later terugkeerde. (AM-23860)
* Het probleem dat ervoor zorgde dat de breedbandnavigatie niet kon worden bijgewerkt terwijl u naar verschillende schermen bewoog, is opgelost. (AM-24120)
* Het probleem waarbij de rasters en grafieken van Trait niet correct werden weergegeven, is opgelost. (AM-24141)
* Oplossing van een fout die ervoor zorgde dat de secties Gebruikers en Groepen niet correct werden weergegeven. Beïnvloedt gebruikers met slechts de toegang van het Beleid. (AM-24144)
...
* Probleem verholpen die ertoe leidde dat een &quot;antwoord ontbrak&quot;bericht aan vertoning in [!UICONTROL  Moderatie] wanneer het antwoorden op een post LinkedIn.
* Oplossing voor een probleem dat inconsistente gegevens veroorzaakte tussen het rapport [!UICONTROL  Moderation Overview] en het gedownloade rapport.
* Probleem opgelost in Overal [!UICONTROL  publiceren waarin een aangepast merkdomein] [!DNL  Adobe Social] niet werd herkend. Deze oplossing is bedoeld voor overal [!UICONTROL  publiceren en niet voor] Uitgever [!UICONTROL  en] Inhoudskalender .
...
<table id="table_04819C0464594ECFB211C253C34E69CA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Er is een hotfix-verpakking gepland voor release in juni 2016. Het hotfix-pakket verhelpt verschillende <a href="https://docs.adobe.com/docs/en/aem/6-2/release-notes/known-issues.html" format="https" scope="external"> bekende problemen in AEM 6.2 </a>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D0FFD1AD5C0D4BAA81BAEC60E8B2290F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://communities.adobe.com/content/usergenerated/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/_jcr_content/par/calendar/ask_the_aem_communit_0.form.html/content/cush/en/communities/aem_technologistsdevelopersarchitects/events/upcoming-event-detail" format="https" scope="external"> Diepteduik in AEM-gemeenschappen op 24 mei 2016 </a> </p> </td> 
   <td colname="col2"> <p>Sluit u aan bij ons op 24 mei 2016 voor deze diepgaande sessie over hoe functionaliteit van de gebruikersgemeenschap werkt in Experience Manager. Naast de presentatie en de live demo zullen vakspecialisten uw vragen met betrekking tot AEM-gemeenschappen beantwoorden. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Experience Manager bevat de klassieke en geoptimaliseerde interface. Als dusdanig, kan het onderwerp "van de Aanbevelingen van het Gebruikersinterface voor Klanten"u helpen beslissen welke UI voor u tijdens projectimplementatie het best is te gebruiken, of wanneer u van een vroegere versie bijwerkt. </p> </td> 
  </tr> 
  <tr> 
