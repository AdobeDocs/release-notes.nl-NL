...
Marketing Cloud: Nieuwe functies zijn onder andere verbeteringen in Marketing Cloud Assets en een verbeterde workflow voor het koppelen van oplossingsaccounts aan uw Adobe ID. Adobe Mobile: Updates voor de integratie van Apteligent en appFigures. Analytics: Nieuwe Real-Time de toestemmingsconfiguratie van het Rapport in Hulpmiddelen Admin. Audience Manager: Deactiveer gegevensfeeds in Audience Marketplace. Experience Manager: servicepakketten en hotfixes. Bovendien worden algemene correcties en verbeteringen aangebracht voor de onderhoudrelease van februari.
...
Als u via de **[!UICONTROL  Marketing Cloud > Activation]** interface toegang krijgt tot Dynamic Tag Management, maar uw Dynamic Tag Management-account niet is gekoppeld aan de Marketing Cloud (Adobe ID), kunt u zich niet aanmelden bij Dynamic Tag Management. Navigeer rechtstreeks naar [https://dtm.adobe.com](https://dtm.adobe.com) in een nieuw browsertabblad om dit probleem te voorkomen.
...
<table frame="all" colsep="1" rowsep="1" id="table_812CAB7DDC364DAABB7CDEDE55532E39"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Vanaf Android SDK 4.8.3 zijn privacy-instellingen die zijn ingesteld via de <span class="codeph"> setPrivacyStatus- </span> methode van invloed op de activiteit van <span class="keyword"> Analytics </span>, <span class="keyword"> Target </span> en <span class="keyword"> Audience Manager </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table frame="all" colsep="1" rowsep="1" id="table_AA26B14D271948FFBA44D4D06E3B71AA"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Vanaf iOS SDK 4.8.5 zijn privacy-instellingen die zijn ingesteld via de <span class="codeph"> setPrivacyStatus- </span> methode van invloed op de activiteiten van <span class="keyword"> Analytics </span>, <span class="keyword"> Target </span>en <span class="keyword"> Audience Manager </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
### Belangrijke berichten over Analytics {#analytics_notices}

>[!IMPORTANT]
>
>In de volgende tabel vindt u Analytics-meldingen over problemen die van invloed kunnen zijn op gegevensverzameling en -rapportage, het einde van de levensduur van het product, enzovoort.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Vanaf begin februari 2016 biedt Adobe Analytics geen ondersteuning meer voor SSLv3. Deze verandering beïnvloedt de Bouwer van het Rapport, verzoeken van de gegevensinzameling, en verzoeken aan Analytics Web Services APIs. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Enige tijd tussen de de Versies van het Onderhoud van Februari en van maart, zal de volgende de gegevensverwerkingsverandering van Analytics worden uitgevoerd: </p> <p>Als u de variabele Product gebruikt zonder dat een gebeurtenis is ingesteld, wordt de gebeurtenis standaard ingesteld op ProdView, die eerder wordt verwerkt (voordat de verwerkingsregels van kracht worden). De gebeurtenis wordt nu ingesteld na de verwerkingsregels om conflicten te voorkomen met de werking van mobiele gegevensverwerking. Deze wijziging heeft de volgende downstreameffecten: </p> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Rapporten en Analytics-correcties </td> 
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     ...
     <li id="li_C3EED22E8F2D4938BD44B103CA119774">Probleem met segmentering verholpen waarbij de dimensie "Browserbreedte - korrelig" niet compatibel was met <span class="wintitle"> Data warehouse </span>. (AN-115465) </li> 
  ...
  <tr> 
   <td colname="col1"> Data warehouse correcties </td> 
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      ...
      <li id="li_142ACEB3BA1D40F4A6DACBD970860278">Probleem verholpen waarbij Data warehouse-rapportage eVars 76+ niet correct classificeerde. (AN-118867) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Audience Marketplace-gegevensproviders kunnen de toegang van kopers tot een geabonneerde feed intrekken. Voor informatie over hoe verkopers feeds intrekken en wat er met kopers gebeurt, zie: </p> 
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Verbeter uw kennis over taken en overwegingen nodig om Adobe Experience Manager met MongoDB met succes op te stellen. </p> </td> 
  </tr> 
  <tr> 
...
* Scene7 het Publiceren Systeem: [Opmerkingen bij de release van Scene7 Publishing System](https://docs.adobe.com/content/help/nl-NL/dynamic-media-developer-resources/release-notes/s7rn2017.html)
...
Documentatieaanvullingen en updates voor laptops in de Adobe Marketing Cloud van eerdere releases.
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>In Marketing Cloud Assets kunt u uw digitale middelen opslaan, delen en synchroniseren vanaf één centrale locatie. Marketing Cloud Assets maakt gebruik van enkele van de functies die beschikbaar zijn in <span class="keyword"> Adobe Experience Manager </span> (AEM). </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Analytics-beheerders: Als u een beheerder bent in de Marketing Cloud, raadpleegt u <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/user_mgmt_admin.html" format="https" scope="external"> Gebruikers en groepen </a> voor bijgewerkte informatie over het toewijzen van Analytics-groepen aan bredere Adobe-groepen en het toevoegen of bulksgewijs toevoegen van gebruikers via het <a href="http://adminconsole.adobe.html/#" format="http" scope="external"> Enterprise-dashboard </a>. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Zie de <a href="../../c-legacy-releases/2015/03192015.md#analytics" format="dita" scope="local"> sectie Nieuwe functies </a> in Analytics voor een vervollediging van nieuwe documentatie voor de Analytics-release van het voorjaar van 2015. </p> </td> 
   <td colname="col3"> <p>19 maart 2015 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Analytics <a href="https://marketing.adobe.com/resources/help/en_US/reference/classification_rule_set.html" format="https" scope="external"> Classification Rules </a> - overschrijven van bestaande waarden </p> </td> 
