---
description: Nieuwe functies voor het op de markt brengen van Cloud omvatten verbeteringen aan de marketingmiddelen van de cloud en een verbeterde workflow voor het koppelen van oplossingsaccounts aan uw Adobe-id. Adobe Mobile-updates voor de integratie van Apteligent en appFigures. Analytics New Real-Time Report permission configuration in Admin Tools. Audience Manager deactivate Data Feeds in Audience Marketplace. De dienstpakken en hotfixes van de Manager van de ervaring. Bovendien worden algemene correcties en verbeteringen aangebracht voor de onderhoudrelease van februari.
keywords: release notes
seo-description: Nieuwe functies voor het op de markt brengen van Cloud omvatten verbeteringen aan de marketingmiddelen van de cloud en een verbeterde workflow voor het koppelen van oplossingsaccounts aan uw Adobe-id. Adobe Mobile-updates voor de integratie van Apteligent en appFigures. Analytics New Real-Time Report permission configuration in Admin Tools. Audience Manager deactivate Data Feeds in Audience Marketplace. De dienstpakken en hotfixes van de Manager van de ervaring. Bovendien worden algemene correcties en verbeteringen aangebracht voor de onderhoudrelease van februari.
...
Marketing Cloud: Nieuwe functies zijn onder andere verbeteringen in Marketing Cloud Assets en een verbeterde workflow voor het koppelen van oplossingsaccounts aan uw Adobe-id. Adobe Mobile: Updates voor de integratie van Apteligent en appFigures. Analyse: Nieuwe Real-Time de toestemmingsconfiguratie van het Rapport in Hulpmiddelen Admin. Audience Manager: Gegevens deactiveren op de markt van het publiek. Experience Manager: servicepakketten en hotfixes. Bovendien worden algemene correcties en verbeteringen aangebracht voor de onderhoudrelease van februari.
...
Als u via de interface **[!UICONTROL Marketing Cloud > Activation]** toegang krijgt tot Dynamic Tag Management, maar uw Dynamic Tag Management-account is niet gekoppeld aan de Marketing Cloud (Adobe-id), kunt u zich niet aanmelden bij Dynamic Tag Management. Navigeer rechtstreeks naar [https://dtm.adobe.com](https://dtm.adobe.com) in een nieuw browsertabblad om dit probleem te voorkomen.
...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <b>Apteligent Integration: </b> Crashes- <span class="wintitle"> </span> rapport </p> verslag </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <b>integratie appFigures: </b><span class="wintitle"> App Store - </span> overzichtsrapport </p> verslag </td> 
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Vanaf begin februari 2016 biedt Adobe Analytics geen ondersteuning meer voor SSLv3. Deze verandering beïnvloedt de Bouwer van het Rapport, verzoeken van de gegevensinzameling, en verzoeken aan de Diensten APIs van het Web van Analytics. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
     ...
     <li id="li_741A006D5EEE4612AD7BF748BB6742A4">Probleem verholpen met gebruikersbeheer/wachtwoord opnieuw instellen waarbij de beheerder die zich aanmeldde met aanmeldingsgegevens voor de Marketing Cloud, een fout veroorzaakte. (AN-108518) </li> 
  ...
  <tr> 
   <td colname="col1"> Oplossingen voor Data Warehouse </td> 
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Probleem verholpen waarbij de geplande rapporten van Data Warehouse niet werden geleverd. (AN-118182) </li> 
      <li id="li_142ACEB3BA1D40F4A6DACBD970860278">Probleem verholpen waarbij de rapportage van Data Warehouse eVars 76+ niet correct classificeerde. (AN-118867) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement </span> voor andere platforms</b> </p> <p>Zie <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html" scope="external" format="https"> de Historie van de release AppMeasurement </a> als volgt voor een releasegeschiedenis van <span class="keyword"> AppMeasurement </span> op de volgende platformen: </p> 
    ...
    </ul> <p> <b>Zie ook:</b> Service <a href="../../c-legacy-releases/2016/02182016.md#mcvid" format="dita" scope="local"> voor marketingcloud-id </a> (voorheen <span class="term"> bezoekersidentiteitsservice </span>) </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Publiek Marktgegevensaanbieders kunnen de toegang van kopers tot een geabonneerde feed intrekken. Voor informatie over hoe verkopers feeds intrekken en wat er met kopers gebeurt, zie: </p> 
...
* Oplossing voor een API, maar voor de weergegeven provider-id&#39;s in gegevensfeeds zonder branding. Betrokken bron- en eigenschaps-API&#39;s. (AM-22430)
* Oplossing voor een probleem dat ervoor zorgde dat rapportaccounts van Tableau niet konden worden verwijderd wanneer een gebruikersaccount was verwijderd. (AM-16048)
* In [!UICONTROL  Doelen] (de sectie van de Toewijzing  van het Segment), bevond een insect dat u verhinderde segmentprioriteit te veranderen. (AM-22942)
...
* In de Bouwer [!UICONTROL  van het Segment (de sectie van de Mening] van de [!UICONTROL  Code), veranderde het etiket van de de lijstkolom van het bezit in identiteitskaart] van het [!UICONTROL  Segment van identiteitskaart] van het [!UICONTROL  Bezit]. (AM-15950)
* In [!UICONTROL  Profiel samenvoegen], herzien waarschuwingsbericht om erop te wijzen dat de gebruikers de Grafiek  van het Apparaat van de Verbinding van het Profiel met de huidige en laatst geverifieerde opties kunnen selecteren. (AM-22521)
* In de Details [!UICONTROL  van de]Gegevensbron, veranderde een optie van het Type [!UICONTROL  van] identiteitskaart in de **[!UICONTROL Advertising ID]** van het Apparaat van **[!UICONTROL Mobiel]**. (AM-22947)
...
* [Naam en inhoudsvereisten voor id-synchronisatiebestanden](https://marketing.adobe.com/resources/help/en_US/aam/c_file_based_id_sync.html)
* [Amazon S3-naamvereisten voor binnenkomende gegevensbestanden](https://marketing.adobe.com/resources/help/en_US/aam/inbound-s3-filenames.html)
...
* Probleem opgelost in het rapport [!UICONTROL  Social Buzz] dat ervoor zorgde dat gegevens niet konden worden bijgewerkt en weergegeven. (AS-35600)
* Probleem verholpen in het rapport [!UICONTROL  Post Analytics] dat ervoor zorgde dat koppelingen en bijlagen werden weergegeven in HTML-indeling in plaats van als tekstkoppelingen zoals verwacht. (AS-35825)
* Probleem opgelost waarbij het filter [!UICONTROL  Eigenschap] in het rapport [!UICONTROL  Post Analytics] niet goed functioneerde. (AS-35792)
* Probleem verholpen in het rapport [!UICONTROL  Post Details] waarin het onjuiste aantal opmerkingen voor LinkedIn-berichten werd weergegeven. (AS-35791)
...
* Probleem verholpen waarbij tags voor LinkedIn-berichten niet werden weergegeven in het rapport [!UICONTROL  Posten] .
* Probleem verholpen in het rapport Overzicht [!UICONTROL  van] Eigenschappen dat ertoe leidde dat [!UICONTROL  Post] -gegevens niet werden weergegeven. (AS-35544)
* Probleem verholpen waarbij de knop [!UICONTROL  Escaleren] soms niet zichtbaar was tijdens de escalatieworkflow van de moderatie. (AS-35876)
* Probleem verholpen waardoor een optie [!UICONTROL  Verbergen] niet goed werkte tijdens de moderatieworkflow. (AS-35869)
* Probleem verholpen waardoor [!DNL  Social] moderatieregels berichten die woorden in de lijst [!UICONTROL  Onjuiste woorden] bevatten, niet konden verwijderen van Facebook-pagina&#39;s. (AS-35461)
...
<table id="table_99BD3F007D164A2AA415E78C633D7927"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/experience-manager/kb/aem61-available-hotfixes.html" format="https" scope="external"> Hotfixes in AEM 6.1 </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/experience-manager/kb/cq561-available-hotfixes.html" format="https" scope="external"> hotfixes voor AEM 5.6.1 </a> </p> </td> 
