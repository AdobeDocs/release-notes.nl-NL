...
* [Target](https://docs.adobe.com/content/help/en/target/using/release-notes/release-notes.htmltarget_release_notes.html) - koppelingen naar Help voor oplossingen
...
* Problemen met prestaties verholpen waarbij u zich via de Experience Cloud aanmeldde bij Analytics. (AN-169254)
* Probleem opgelost waarbij de zoekfunctie in Reports &amp; Analytics niet goed werkte. (AN-170354)
...
* Probleem verholpen waarbij participatiemetriek niet langer werkte met Ad hoc analysis lijstvariabelen. (AN-166027)
...
In 8.1 hebben we DIL compatibel gemaakt met strenger beveiligingsbeleid van Google Tag Manager. Deze versie is alleen beschikbaar in DTM en als zelfstandige code, niet [!DNL Launch] of AppMeasurement Audience Manager Module. Deze wijziging wordt in toekomstige versies opgenomen. (CORE-24189)

### Oplossingen in [!DNL Audience Manager]

* We hebben de zoekervaring in Audience Marketplace verbeterd en een snellere ervaring, zonder onderbrekingen. (AAM-43421)
...
* We hebben een bug opgelost in Audience Marketplace, waar klanten die in december zelf impressievolumes willen rapporteren, de drukken van november nog zouden zien op de rapporteringsgebieden. (AAM-43814)
...
* De kolom Uitchecken wordt niet correct weergegeven in de lijstweergave AEM Assets.
...
| Verbeteringen in bètaberichten in de app | De bètafunctie voor berichten in de app is uitgebreid met de volgende mogelijkheden: Beta-kanaal in de app is compatibel met GDPR; integratie met Analytics API&#39;s om dropdowns van Triggers te vullen; Intuïtief uiterlijk en beschrijving van leveringssjablonen; Verbeteringen van de ontwerpinterface vanuit het oogpunt van bruikbaarheid. Raadpleeg de gedetailleerde documentatie voor meer informatie. |
...
U kunt Google Ads nu toestaan om meerdere campagnes te optimaliseren naar één ROAS-doel (return on ad expedent) of een CPA-doel (cost per purchase) met de nieuwe Advertising Cloud-uitgavenstrategieën &quot;Google Target CPA&quot; en &quot;Google Target ROAS&quot;. Met deze uitgavenstrategieën hebben alle toegewezen Google Ads-campagnes de opgegeven biedstrategie en het opgegeven doel. campagnes met andere zoekmachines worden genegeerd . Alle andere portfolioinstellingen zijn uitgeschakeld.

In de sectie Bodaanpassingswaarden automatisch optimaliseren van het portfolio optimaliseert de optie &#39;Publiek Target&#39; nu de lijst met opnieuw in de handel brengen van Google Ads, de klantovereenkomst en vergelijkbare soorten publiek (die u kunt maken in Google Ads) op campagne- en advertentieniveau. Eerder werd een optie &quot;Lijst met opmerkingen&quot; alleen geoptimaliseerd voor het opnieuw op de markt brengen van lijsten op advertentieniveau.
