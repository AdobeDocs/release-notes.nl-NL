...
* Probleem verholpen waarbij de [!UICONTROL People] [!UICONTROL Offers] kernservices en -services niet toegankelijk waren via het hoofdmenu Experience Cloud. (AN-184294)
...
* We hebben een fout opgelost waarbij dubbele Audience Marketplace-feeds afkomstig waren van één gegevensbron-id. Er moet een 1:1-koppeling zijn tussen gegevensbronnen en [!DNL Marketplace] feeds. (AAM-48504)
...
* We hebben een probleem opgelost in de API voor gegevensbronnen, waarbij het instellen van de queryparameter gegevensbronnen van de rapportsuite `ExcludeReportSuites=true` niet van Adobe Analytics uitsloot. (AAM-48545)
...
Zie de routekaart van de AEM onderhoudsversie zoals [hier](https://helpx.adobe.com/experience-manager/maintenance-releases-roadmap.html)gepubliceerd.
...
Documentatie voor de service voor automatische conversie van AEM Forms-formulieren is nu beschikbaar. See [Introduction to Automated Forms Conversion service](https://helpx.adobe.com/experience-manager/Automated-Forms-Conversion-Service/introduction-to-automated-form-conversion-service.html).
...
[!DNL Digital Publishing Suite Classic] (DPSC) eindigt op 31 augustus 2019. Raadpleeg de veelgestelde vragen over [[!DNL Digital Publishing Suite Classic] einde levensduur](https://helpx.adobe.com/digital-publishing-suite/help/eol-statement-for-dpsc.html)voor meer informatie.
