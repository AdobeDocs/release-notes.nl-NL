...
# Opmerkingen bij de release van Adobe Experience Cloud - juni 2019
...
* Zie Opmerkingen bij de release van [Experience Platform](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) op Adobe.io voor de meest recente updates van Experience Platform.
...
| **Segmentering** | Nieuwe segmentoperatoren: **[!UICONTROL Equals Any of]** en **[!UICONTROL Does not Equal Any of]**. |
| **Foutopsporing** | Wanneer u zich aanmeldt met uw Adobe ID, hebt u nu de mogelijkheid om nabewerkte hits op te halen in de Experience Cloud Debugger. Nabewerkte hits zijn serveraanroepen nadat ze door de regels [!UICONTROL Processing Rules] en VISTA zijn gegaan, zodat u uw regels voor VISTA kunt valideren [!UICONTROL Processing Rules] en controleren. **Opmerking**: Als u A4T (SupplementalDataID) gebruikt, kunnen de gegevens na verwerking een paar minuten duren om terug te komen. |
| **Analysis Workspace:** | Nieuwe filters uit de doos aan de linkerspooronderzoek toegevoegd. Buiten wat u vandaag ziet (Afmetingen, Metriek, Goedgekeurd, enz.), nieuwe filters zoals Berekende Metriek, Klantkenmerken, Vars, Props, Video, enz. zijn toegevoegd om het gemakkelijker te maken om de gewenste componenten te vinden. |
...
Geïnteresseerd in het leren hoe de processen van DevOps dagelijkse activiteiten voor Adobe Experience Manager beheer in de wolk kunnen vereenvoudigen? Cloud Manager biedt de eerste generatie cloudnative functionaliteit voor Adobe Experience Manager die cloudflexibiliteit mogelijk maakt, of uw organisatie nu met de DevOps-transformatie begint of op zoek is naar strategieën om bestaande DevOps-processen te versterken.

[In deze maandelijkse reeks](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)kunt u rechtstreeks van het productteam van Adobe leren hoe u aan de slag kunt en de functies van Cloud Manager kunt gebruiken om het beheer van Adobe Experience Managers in de cloud te vereenvoudigen.

U leert het volgende:
* Aan de slag met Cloud Manager en de CI/CD Pipeline instellen
* Hoe Autoscaling en Transparant servicelevering werken en het omgevingsbeheer van de Adobe Experience Manager in de cloud kan vereenvoudigen
...
### Campaign Classic 19.1-veringsrelease

| Functionaliteit | Beschrijving |
| ------------- | ----------- |
| Deelvenster Beheer | Om de efficiëntie van uw werk als Admin-gebruiker te verhogen, beheert u de instellingen van uw SFTP-servers door opslag te controleren, IP-adressen toe te staan en SSH-sleutels voor elke instantie te installeren. Houd er rekening mee dat het Configuratiescherm vanaf vandaag alleen beschikbaar is voor klanten die op AWS worden gehost. [Meld u aan via de Experience Cloud](https://experiencecloud.adobe.com/campaign/controlpanel/). <br> Raadpleeg voor meer informatie de [gedetailleerde documentatie](https://helpx.adobe.com/campaign/kb/control-panel.html) en de [Hoe kan ik-video](https://helpx.adobe.com/campaign/kt/acc/using/acc-control-panel-video-use.html). |
| Audittrail | Als beheerder verhoogt u de productiviteit door de wijzigingen te controleren en te beheren die zijn aangebracht in de Adobe Campaign Classic-instantie. Het audittrail zal acties registreren die op BronSchema, Werkschema en Optie worden gemaakt. U kunt snel zien of is een element gecreeerd, gewijzigd of geschrapt.<br>Raadpleeg voor meer informatie de [gedetailleerde documentatie](https://docs.campaign.adobe.com/doc/AC/en/PRO_Production_procedures_Audit_trail.html) en de [Hoe kan ik-video](https://helpx.adobe.com/campaign/kt/acc/using/acc-audit-trail-feature-video-use.html). |
| Guardrail, robuustheid en schaalbaarheid | Campaign Classic heeft een aantal verbeteringen aangebracht. De verbeteringen op het gebied van geleidelijkheid, robuustheid en schaalbaarheid worden vermeld in de Opmerkingen [bij de release van](https://docs.adobe.com/content/help/nl-NL/campaign-classic/using/release-notes/latest-release.translate.html)Campaign Classic. |
...
### Campaign Standard 19.2-veringsrelease
...
[Opmerkingen bij de release van Target (preRelease)](https://docs.adobe.com/content/help/nl-NL/target/using/release-notes/target-release-notes.html)

[Opmerkingen bij de release van Target (huidige)](https://docs.adobe.com/content/help/en/target/using/release-notes/release-notes.html)
