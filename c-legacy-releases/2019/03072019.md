...
| Nieuwe Help voor migratie naar Analytics-gebruikers | 10 mei 2018 | We hebben de migratiehulp voor Analytics-gebruikers bijgewerkt met informatie over het migreren van Enterprise- en Federated ID&#39;s naar de Admin Console. See [Migrate Analytics user accounts for Enterprise and Federated IDs](https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/migrate-enterprise.html). |
