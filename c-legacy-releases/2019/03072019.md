...
| Regionale versnelling voor China | De optie Chinese versnelling is nu beschikbaar in Instellingen van Analytics Report Suite. Met deze optie verbetert u de gebruikerservaring van Adobe Analytics Reporting voor gebruikers in het Chinese vasteland. Elke gebruiker van Adobe Analytics kan deze optie in- of uitschakelen. Selecteer deze optie niet voor gebruikers buiten het Chinese vasteland, omdat dit de prestaties negatief beïnvloedt. [Meer](https://marketing.adobe.com/resources/help/en_US/sc/user/report_settings.html) |
...
| API 2.0: Ondersteuning voor JWT-verificatie | De API van Adobe Analytics 2.0 ondersteunt nu JWT-verificatie. Meer informatie over JWT-verificatie vindt u hier: [https://github.com/AdobeDocs/analytics-2.0-apis/blob/master/jwt.md](https://github.com/AdobeDocs/analytics-2.0-apis/blob/master/jwt.md) |

### Media Analytics SDK 2.2 voor: Chromecast, Roku, Apple TV en de Uitbreiding van het [!DNL Launch] Web {#aa-va}

| Functie | Beschrijving |
| -----------| ---------- |
| Adobe Analytics voor audio | Sluit de streamingaudioservice van een listener aan op zijn volledige digitale gedrag. U kunt begrijpen wie luistert waar, wanneer, en hoe vaak, en gebruikersgedrag in een algemeen gefragmenteerde audiomarkt evalueert. <br/> Deze eigenschap laat ondernemingen toe om het bereik van hun luisteraars te meten, de populariteit van hun inhoud te meten, en verstrekt inzicht in hoe te om gebruikers betrokken te houden gebaseerd op hun gedrag en blik-als modellering. Meet 10-secondenaudio-inhoud en 1-seconde streaming advertenties met onze best-in-klasse SDK&#39;s, om zowel kwaliteit van ervaring (stagnerend, fouten, tijd om te beginnen) als inhoud plus KPI&#39;s te evalueren. |
...
* **Analyse van werkruimte:** Probleem verholpen waarbij gegevens niet konden worden weergegeven in de Kaart-visualisatie. (AN-170626)
* Probleem verholpen waarbij de voornaam/achternaam van een (gemigreerde) gebruiker in Analytics anders was dan de naam die aan de Adobe-id van de gebruiker in Experience Cloud was gekoppeld. Als u de naam Analytics wilt bijwerken met de naam in Experience Cloud, gaat u naar **[!UICONTROL Admin** > **!UICONTROL Gebruikersbeheer (Verouderd)**> Gebruikers**!UICONTROL ** bewerken en klikt u op de gebruikersnaam. Klik vervolgens op **!UICONTROL Bijwerken vanuit Experience Cloud **. (AN-172825)
...
* Probleem verholpen in de modus Doeltoewijzing in Segmentbouwer, waarbij gebruikers die meerdere keren op de knop Doel toevoegen klikken, meerdere toewijzingen in plaats van één zouden maken. (AM-37177)
