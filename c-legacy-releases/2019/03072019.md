...
Zie [Experience Cloud ID Services](https://docs.adobe.com/content/help/nl-NL/id-service/using/home.html) productdocumentatie.

Zie [Experience Cloud ID service](https://docs.adobe.com/content/help/en/id-service/using/home.html) voor productdocumentatie.
...
| Nieuwe LiveStream-variabelen | * **drager**: De draadloze provider voor het mobiele apparaat. <br/>*  **tnt:** het test-en-doelgebied dat in Doel wordt gebruikt. De _actionId_ en _actionName_ hebben nooit waarden.<br/>*  **tntAction:** Het verbeterde test-en-doelveld dat in Doel wordt gebruikt. In tegenstelling tot het tintveld, hebben _actionId_ en _actionName_ waarden ingesteld. |
...
### Media Analytics SDK 2.2 voor: Chromecast, Roku, Apple TV en [!DNL Launch] Webextensie {#aa-va}
...
* **Analysis Workspace:** Probleem verholpen waarbij gegevens niet konden worden weergegeven in de Kaartweergave. (AN-170626)
...
* Op de overzichtspagina [trait](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_tb_trait_summary.html) wordt nu het type kenmerk weergegeven. (AAM-25784)
* De [segment summiere pagina](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_summary.html) bevat nu een hyperlink aan de gegevensbron van het segment, voor gemakkelijkere navigatie. (AAM-40015)
...
* Probleem verholpen waarbij het selectievakje **[!UICONTROL Select All]** ontbrak in Algorithmic Models op de pagina [Selecteer Traits om uit te sluiten](https://experiencecloud.adobe.com/resources/help/en_US/aam/trait-exclusion-algo-models.html). (AAM-42462)
...
Zie [Push notification report](https://helpx.adobe.com/campaign/standard/reporting/using/push-notification-report.html) voor meer informatie.
...
Voor meer informatie, zie [Ongeveer in-App overseinen](https://helpx.adobe.com/campaign/standard/channels/using/about-in-app-messaging.html) en specifieke [In-App leerprogramma](https://helpx.adobe.com/campaign/kt/acs/using/acs-in-app-message-tutorial.html).
...
* **De** activiteiten van de  **** Segmentatie van Queryand laten u nu een uitgaande overgang toelaten als de activiteiten geen gegevens terugwinnen.
...
Zie de bijbehorende [Opmerkingen bij de release](https://docs.adobe.com/content/help/nl-NL/experience-manager-cloud-manager/using/release-notes/release-notes-current.html).
...
Zie [Nieuwe functies in AEM Assets Brand Portal](https://helpx.adobe.com/experience-manager/brand-portal/using/whats-new.html) en [Opmerkingen bij de release](https://helpx.adobe.com/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html) voor meer informatie.
