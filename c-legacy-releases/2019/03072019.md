...
* [Experience Cloud-kernservices en -administratie](#experiencecloud)
* [Analytics](#analytics)
...
Opmerkingen bij de release voor de Experience Cloud-interface, inclusief [!UICONTROL Platform] kernservices en productbeheer.
...
Target - De sessie-id en EdgeHost blijven nu geldig voor alle toepassingssessies.

**iOS versie 4.18.1**

* Target - De sessie-id en EdgeHost blijven nu geldig voor alle toepassingssessies.
* Target - Oplossing voor een probleem dat was ontstaan wanneer meerdere aanroepen van targetPrefetchContent achtereenvolgens werden uitgevoerd.
...
### Analytics - Oplossingen en updates
...
* Probleem verholpen waarbij de voornaam/achternaam van een (gemigreerde) gebruiker in Analytics anders was dan de naam die aan de Adobe ID van de gebruiker in Experience Cloud was gekoppeld. Als u de Analytics-naam wilt bijwerken met de naam in Experience Cloud, gaat u naar **[!UICONTROL Admin** > **!UICONTROL User Management (Legacy)** > **!UICONTROL Edit Users** en klikt u op de gebruikersnaam. Klik vervolgens **!UICONTROL Update from Experience Cloud**. (AN-172825)
...
| Nieuwe Help voor migratie naar Analytics-gebruikers | 10 mei 2018 | We hebben de migratiehulp voor Analytics-gebruikers bijgewerkt met informatie over het migreren van Enterprise- en Federated ID&#39;s naar de Admin Console. Zie [Analytics-gebruikersaccounts migreren voor Enterprise- en Federated ID&#39;s](https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/migrate-enterprise.html). |
...
| Koppeling naar gebruikersaccount | 26 oktober 2017 | Analytics-gebruikers hoeven hun accounts niet meer handmatig te koppelen tussen de Experience Cloud en Analytics. Gebruikers kunnen contact opnemen met hun Admin Console-beheerder om Analytics-toegang aan te vragen. Met de migratie naar Analytics-gebruikers-id kunnen beheerders eenvoudig gebruikersaccounts migreren van Analytics User Management naar Adobe Admin Console. Nadat uw gebruikers zijn gemigreerd, hebben ze toegang tot de aangeschafte oplossingen en kernservices die beschikbaar zijn in de Experience Cloud. [Meer weten over de migratie naar](https://marketing.adobe.com/resources/help/en_US/experience-cloud/admin-console/analytics-migration/)Analytics-gebruikersnamen? |

## Audience Manager {#aam}

| Functie | Beschrijving |
| -----------| ---------- |  
| [Aanbevolen stappen](https://experiencecloud.adobe.com/resources/help/en_US/aam/trait-recommendations.html) | Trait Recommendations, aangedreven door [Adobe Sensei](https://www.adobe.com/sensei.html), brengt gegevenswetenschap in uw dagelijkse werkschema&#39;s van de Audience Manager. <br/>Met de Aanbevelingen van het Aanzicht, wanneer u bouwt of een segment in de Bouwer [van het](https://experiencecloud.adobe.com/resources/help/en_US/aam/t_create_segment.html)Segment uitgeeft, krijgt u aanbevelingen op extra eigenschappen u kunt omvatten, die aan de eigenschappen in de segmentregel gelijkaardig zijn. Voeg de geadviseerde eigenschappen aan uw segment toe om uw doelpubliek te verhogen. |
...
Voor meer informatie, zie het [Gebruiken van Adobe Experience Platform SDK](https://helpx.adobe.com/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49).
...
* [Opmerkingen bij de Klassieke Adobe Campaign-release](https://docs.adobe.com/content/help/nl-NL/campaign-classic/using/release-notes/latest-release.translate.html)
* [Adobe Campaign Classic Learn &amp; Support](https://helpx.adobe.com/nl/support/campaign/classic.html)
...
De release van Cloud Manager 2019.2.0 voegt System Monitoring toe. Met deze nieuwe functie kunnen klanten de status van hun Adobe Managed Services-omgevingen op systeemniveau bekijken.
...
[Maak kennis met de nieuwe Adobe Experience Manager: cloud](https://theblog.adobe.com/adobe-experience-manager-2019-cloud-content-personalization-CXM/), content en persoonlijke verbeteringen in Advance Customer Experience Management (CXM) voor marketers en IT.

**AEM Assets Brand-portaal 6.4.4**
...
Voor details, zie [Nieuw in de Portaal](https://helpx.adobe.com/experience-manager/brand-portal/using/whats-new.html) van de Merk van [AEM Assets en de Nota&#39;s](https://helpx.adobe.com/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html)van deVersie.
...
* HTL
* Cloud Manager
* Adobe Experience Cloud-bibliotheek
