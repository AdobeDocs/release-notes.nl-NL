...
Zie [Experience Cloud en Core Services voor productdocumentatie](https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html)
...
| -----------| ---------- | ---------- |
| Aanstaande wijziging in _Totale_ berekeningen rapporteren | 16 april 2019 | Op 13 juni 2019 zal Adobe Analytics de _rapporttotale_ berekeningen consistent maken in alle dimensies en maatstaven. Dit zal resulteren in een verandering in de totalen voor sommige rapporten (typisch, Prop of de rapporten van de Attributen van de Klant). Voorafgaand aan deze verandering, omvatte sommige Totalen van het Rapport inconsistent of uitgesloten de _Niet gespecificeerde_ lijnpunt in het totaal, ongeacht of _Niet gespecificeerd_ in het rapport verscheen. <br/>Vanaf 13 juni 2019 wordt _Niet opgegeven_ altijd weergegeven in het rapporttotaal, zelfs als dit item niet als een lijnitem in het rapport wordt weergegeven. Deze wijziging is van invloed op Analysis Workspace, Reports &amp; Analytics, Ad Hoc Analysis, Report Builder en de API voor rapportage. |
...
* Gebruikers zien nu een foutbericht wanneer zij een [!UICONTROL Algorithmic Model] standaardtype met een kenmerk proberen te maken dat afwijkt van een op regels gebaseerd type, segment of opgenomen kenmerk. Het foutbericht is: &quot;Alleen op regels gebaseerde kenmerken, ongebogen kenmerken en segmenten kunnen als basislijn worden gebruikt.&quot; (AAM-45235).
* De [!UICONTROL Lifetime] metrische waarde is verwijderd van de pagina&#39;s [!UICONTROL Traits] en [!UICONTROL Folder Traits] pagina&#39;s.
* De begin- en einddatum van de segmenttoewijzing zijn nu opgenomen in de [!UICONTROL Destinations General Report] (AAM-44997).

### Oplossingen

* Probleem verholpen waarbij het object in sommige situaties [!UICONTROL Outbound File History Report] niet werd geladen (AAM-45713).
* Probleem verholpen waarbij de eerder geselecteerde eigenschap werd toegevoegd [!UICONTROL Segment Builder] [!UICONTROL Add Trait] wanneer op een leeg veld werd geklikt (AAM-45599).
...
Advertising Cloud Help is beschikbaar in het product onder de Help **?** -menu.
