...
* Alle klantenaccounts die na 1 juli 2019 worden gemaakt, krijgen automatisch een [!DNL Tableau]-licentie toegewezen, waardoor ze toegang hebben tot hun rapporten. Neem contact op met de klantenservice als uw account vóór 1 juli 2019 is gemaakt en u nog steeds geen toegang hebt tot uw [!DNL Tableau]-rapporten.
* We hebben een bug opgelost die een onjuiste generatie activiteitskenmerken veroorzaakte en kunstmatig verhoogde match-rates en publieksformaten. Na deze correctie kan het zijn dat de grootte van segmenten die zijn gemaakt met automatisch gegenereerde activiteitskenmerken, afneemt. Dit is normaal, verwacht gedrag (AAM-45371).
* Ongeldige id&#39;s voor algemene apparaten zijn verwijderd uit algemene gegevensbronnen. Zie [Algemene gegevensbronnen](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/data-sources/global-data-sources.html) om te leren welke geldige apparaat-id&#39;s eruit moeten zien als geaccepteerd door Audience Manager (AAM-41259).
...
* Wanneer het uitgeven van bestemmingen voor Twitter Getagd publiek, is de [!UICONTROL Account] selecteur nu actief slechts als de bestemming geen [!DNL Twitter Ads] rekening (AAM-49975) toegewezen heeft.
* Oplossing voor een probleem waarbij werd voorkomen dat gebruikers [!UICONTROL Audience Marketplace]-gegevensfeeds konden uitschakelen wanneer abonnementen waren uitgeschakeld (AAM-49640).
...
* **AEM 6.5.2.0**
AEM 6.5, Service Pack 2.0 (6.5.2.0 vrijgegeven 19 september, 2019) is een belangrijke update die zeer belangrijke klantenmoeilijke situaties omvat die sinds de algemene beschikbaarheid van AEM 6.5, April 2019 worden vrijgegeven.
...
Zie [Elementen opnieuw verwerken in een map nadat u het verwerkingsprofiel ervan hebt bewerkt](https://helpx.adobe.com/experience-manager/6-5/assets/using/processing-profiles.html#Reprocessingassetsinafolderafteryouhaveediteditsprocessingprofile).
...
Zie [Dynamic Media-viewers integreren met Adobe Analytics en Adobe starten](https://helpx.adobe.com/experience-manager/6-5/assets/using/launch.html).

* **Bureaubladapp AEM**

   AEM desktop app 2.0 is nu beschikbaar voor ontwerpers, marketers en zakelijke gebruikers om met AEM Assets te werken.
Zie de [Opmerkingen bij de release van de bureaublad-app.](https://docs.adobe.com/content/help/nl-NL/experience-manager-desktop-app/using/release-notes.html)
...
* **Kernonderdelen**
   ...
   * Core Components 2.6.0 introduceert een Experience Fragment-component. De component is nu beschikbaar samen met [ontwerpdocumentatie](https://docs.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html) en [ontwikkelaardetails en projectdownload beschikbaar op GitHub](https://github.com/adobe/aem-core-wcm-components).

* **AEM Assets**
   * Nieuwe documentatie voor zoekmogelijkheden op visuele/gelijkenis.
Zie [Vergelijkbare afbeeldingen zoeken](https://helpx.adobe.com/experience-manager/6-5/assets/using/search-assets.html#visualsearch).
...
Zie [Verbonden middelen gebruiken om DAM activa in AEM Sites te delen](https://helpx.adobe.com/experience-manager/6-5/assets/using/use-assets-across-connected-assets-instances.html).
   * Inhoud vernieuwen bij het zoeken en detecteren van elementen. Het _Doorzoek activa in AEM_ onderwerp is uw één-stop-shop voor informatie over het gebruiken, het vormen, het oplossen van problemen, beperkingen, en uiteinden.
